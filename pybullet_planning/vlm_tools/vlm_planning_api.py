...
def get_llamp_api(api_class_name):
    ...
    elif 'llama_l' in api_class_name:
        from rag_based_prompting.prompting.llama_planning_api import LlamaLocalPlanningApi
        return LlamaLocalPlanningApi
    elif 'llama_c' in api_class_name:
        from rag_based_prompting.prompting.llama_planning_api import LlamaClusterPlanningApi
        return LlamaClusterPlanningApi
    return LLAMPApi
