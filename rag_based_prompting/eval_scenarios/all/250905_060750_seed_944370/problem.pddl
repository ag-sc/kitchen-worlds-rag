...
(define
  (problem test_kitchen_chicken_soup_250905_060750_seed_944370)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn21494=1.78)
	(position counter#1::chewie_door_left_joint pstn21493=-1.872)
	(position oven#1::knob_joint_2 pstn21495=0.0)
	(position faucet#1::joint_faucet_0 pstn21497=0.0)
	(position oven#1::knob_joint_3 pstn21496=0.0)
	(position counter#1::chewie_door_right_joint pstn21492=1.872)

	(atposition fridge#1::fridge_door pstn21494=1.78)
	(atposition counter#1::chewie_door_left_joint pstn21493=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn21497=0.0)
	(atposition oven#1::knob_joint_3 pstn21496=0.0)
	(atposition counter#1::chewie_door_right_joint pstn21492=1.872)
	(atposition oven#1::knob_joint_2 pstn21495=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn21496=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21495=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21497=0.0)

	(pose chicken-leg p63367=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p63371=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p63370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p63368=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(pose braiserbody#1 p63366=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p63367=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p63368=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(atpose braiserbody#1 p63366=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p63370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p63371=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn21492=1.872)
	(isopenedposition fridge#1::fridge_door pstn21494=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn21493=-1.872)
	...
	(contained pepper-shaker p63371=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p63370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p63368=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823) counter#1::front_left_stove)
	(supported braiserbody#1 p63369=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
