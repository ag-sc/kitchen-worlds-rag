...
(define
  (problem test_kitchen_chicken_soup_250904_175731_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn11354=0.0)
	(atposition fridge#1::fridge_door pstn11351=1.78)
	(atposition counter#1::chewie_door_left_joint pstn11350=-1.872)
	(atposition oven#1::knob_joint_2 pstn11352=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11349=1.872)
	(atposition oven#1::knob_joint_3 pstn11353=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn11352=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11354=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11353=0.0)

	(isopenedposition fridge#1::fridge_door pstn11351=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11349=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11350=-1.872)

	(position counter#1::chewie_door_right_joint pstn11349=1.872)
	(position counter#1::chewie_door_left_joint pstn11350=-1.872)
	(position oven#1::knob_joint_3 pstn11353=0.0)
	(position faucet#1::joint_faucet_0 pstn11354=0.0)
	(position oven#1::knob_joint_2 pstn11352=0.0)
	(position fridge#1::fridge_door pstn11351=1.78)

	(pose braiserbody#1 p28592=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p28594=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(pose pepper-shaker p28597=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p28593=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p28596=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p28593=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p28597=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p28596=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p28592=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p28594=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	...
	(contained salt-shaker p28596=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p28597=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p28594=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
	(supported braiserbody#1 p28595=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
