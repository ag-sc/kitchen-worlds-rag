...
(define
  (problem test_kitchen_chicken_soup_250903_170448_seed_455268)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn11782=0.0)
	(position faucet#1::joint_faucet_0 pstn11783=0.0)
	(position oven#1::knob_joint_2 pstn11781=0.0)
	(position counter#1::chewie_door_right_joint pstn11778=1.872)
	(position counter#1::chewie_door_left_joint pstn11779=-1.872)
	(position fridge#1::fridge_door pstn11780=1.78)
	...
	(atposition oven#1::knob_joint_3 pstn11782=0.0)
	(atposition fridge#1::fridge_door pstn11780=1.78)
	(atposition counter#1::chewie_door_right_joint pstn11778=1.872)
	(atposition faucet#1::joint_faucet_0 pstn11783=0.0)
	(atposition oven#1::knob_joint_2 pstn11781=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11779=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn11781=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11782=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11783=0.0)

	(isopenedposition fridge#1::fridge_door pstn11780=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11778=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11779=-1.872)
	...
	(pose braiserlid#1 p24561=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279))
	(pose pepper-shaker p24564=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p24563=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p24560=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p24559=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p24561=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279))
	(atpose chicken-leg p24560=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p24559=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p24564=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p24563=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p24564=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p24563=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p24562=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p24561=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279) counter#1::front_left_stove)
