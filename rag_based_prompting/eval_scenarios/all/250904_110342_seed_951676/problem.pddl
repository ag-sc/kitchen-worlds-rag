...
(define
  (problem test_kitchen_chicken_soup_250904_110342_seed_951676)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p7449=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p7447=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(pose braiserbody#1 p7445=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p7450=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p7446=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p7446=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p7450=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p7449=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p7445=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p7447=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	...
	(contained salt-shaker p7449=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p7450=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p7447=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625) counter#1::front_left_stove)
	(supported braiserbody#1 p7448=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
