...
(define
  (problem test_kitchen_chicken_soup_250905_074053_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(supported braiserbody#1 p3=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
