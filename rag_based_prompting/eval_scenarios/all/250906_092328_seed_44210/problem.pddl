...
(define
  (problem test_kitchen_chicken_soup_250906_092328_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn734=1.78)
	(position faucet#1::joint_faucet_0 pstn737=0.0)
	(position counter#1::chewie_door_right_joint pstn732=1.872)
	(position counter#1::chewie_door_left_joint pstn733=-1.872)
	(position oven#1::knob_joint_3 pstn736=0.0)
	(position oven#1::knob_joint_2 pstn735=0.0)

	(atposition faucet#1::joint_faucet_0 pstn737=0.0)
	(atposition counter#1::chewie_door_right_joint pstn732=1.872)
	(atposition counter#1::chewie_door_left_joint pstn733=-1.872)
	(atposition oven#1::knob_joint_2 pstn735=0.0)
	(atposition oven#1::knob_joint_3 pstn736=0.0)
	(atposition fridge#1::fridge_door pstn734=1.78)

	(isclosedposition oven#1::knob_joint_2 pstn735=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn736=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn737=0.0)

	(isopenedposition fridge#1::fridge_door pstn734=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn733=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn732=1.872)
	...
	(atpose chicken-leg p4796=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p4800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p4797=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(atpose salt-shaker p4799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p4795=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p4800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4795=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p4796=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p4799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4797=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	...
	(contained salt-shaker p4799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p4800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4797=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
	(supported braiserbody#1 p4798=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
