...
(define
  (problem test_kitchen_chicken_soup_250904_094802_seed_854983)
  (:domain domain)
  ...
  (:init
	...
	(pose chicken-leg p1639=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p1638=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p1640=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(pose salt-shaker p1642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p1643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p1639=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p1638=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p1640=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(atpose pepper-shaker p1643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p1642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(supported braiserbody#1 p1641=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1640=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303) counter#1::front_left_stove)

	(contained pepper-shaker p1643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
