...
(define
  (problem test_kitchen_chicken_soup_250903_193241_seed_272790)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn16058=0.0)
	(position counter#1::chewie_door_left_joint pstn16056=-1.872)
	(position faucet#1::joint_faucet_0 pstn16060=0.0)
	(position oven#1::knob_joint_3 pstn16059=0.0)
	(position fridge#1::fridge_door pstn16057=1.78)
	(position counter#1::chewie_door_right_joint pstn16055=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn16058=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16060=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16059=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn16055=1.872)
	(atposition counter#1::chewie_door_left_joint pstn16056=-1.872)
	(atposition oven#1::knob_joint_2 pstn16058=0.0)
	(atposition faucet#1::joint_faucet_0 pstn16060=0.0)
	(atposition oven#1::knob_joint_3 pstn16059=0.0)
	(atposition fridge#1::fridge_door pstn16057=1.78)

	(pose braiserlid#1 p32557=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(pose braiserbody#1 p32555=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p32560=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p32556=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p32559=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p32556=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p32557=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(atpose salt-shaker p32559=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p32555=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p32560=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq88=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq280=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(isopenedposition counter#1::chewie_door_left_joint pstn16056=-1.872)
	(isopenedposition fridge#1::fridge_door pstn16057=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16055=1.872)

	(ataconf right aq280=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq88=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p32559=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p32560=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p32557=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401) counter#1::front_left_stove)
	(supported braiserbody#1 p32558=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
