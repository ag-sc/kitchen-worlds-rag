...
(define
  (problem test_kitchen_chicken_soup_250904_221140_seed_452553)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn15655=0.0)
	(atposition fridge#1::fridge_door pstn15653=1.78)
	(atposition counter#1::chewie_door_right_joint pstn15651=1.872)
	(atposition faucet#1::joint_faucet_0 pstn15656=0.0)
	(atposition oven#1::knob_joint_2 pstn15654=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15652=-1.872)
	(position fridge#1::fridge_door pstn15653=1.78)
	(position oven#1::knob_joint_3 pstn15655=0.0)
	(position oven#1::knob_joint_2 pstn15654=0.0)
	(position counter#1::chewie_door_right_joint pstn15651=1.872)
	(position counter#1::chewie_door_left_joint pstn15652=-1.872)
	(position faucet#1::joint_faucet_0 pstn15656=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn15656=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15654=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15655=0.0)

	(pose pepper-shaker p40697=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p40693=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p40692=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p40694=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(pose salt-shaker p40696=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq984=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq248=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p40697=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p40693=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p40692=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p40696=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p40694=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(isopenedposition counter#1::chewie_door_left_joint pstn15652=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15653=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn15651=1.872)

	(ataconf left aq984=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq248=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p40697=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p40696=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p40695=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p40694=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452) counter#1::front_left_stove)
