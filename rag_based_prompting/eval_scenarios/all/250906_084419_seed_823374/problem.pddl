...
(define
  (problem test_kitchen_chicken_soup_250906_084419_seed_823374)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn468=0.0)
	(position fridge#1::fridge_door pstn467=1.78)
	(position faucet#1::joint_faucet_0 pstn470=0.0)
	(position counter#1::chewie_door_right_joint pstn465=1.872)
	(position counter#1::chewie_door_left_joint pstn466=-1.872)
	(position oven#1::knob_joint_3 pstn469=0.0)
	...
	(atposition fridge#1::fridge_door pstn467=1.78)
	(atposition counter#1::chewie_door_right_joint pstn465=1.872)
	(atposition counter#1::chewie_door_left_joint pstn466=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn470=0.0)
	(atposition oven#1::knob_joint_2 pstn468=0.0)
	(atposition oven#1::knob_joint_3 pstn469=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn468=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn470=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn469=0.0)
	...
	(pose chicken-leg p2453=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p2452=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p2457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2454=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(pose salt-shaker p2456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn466=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn465=1.872)
	(isopenedposition fridge#1::fridge_door pstn467=1.78)

	(aconf left aq32=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq408=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p2457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2454=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(atpose chicken-leg p2453=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p2456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2452=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))

	(ataconf left aq32=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq408=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p2456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2455=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2454=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762) counter#1::front_left_stove)
