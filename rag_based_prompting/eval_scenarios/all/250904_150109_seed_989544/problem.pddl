...
(define
  (problem test_kitchen_chicken_soup_250904_150109_seed_989544)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn8180=1.78)
	(atposition oven#1::knob_joint_3 pstn8182=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8179=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn8178=1.872)
	(atposition oven#1::knob_joint_2 pstn8181=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8183=0.0)
	(position faucet#1::joint_faucet_0 pstn8183=0.0)
	(position fridge#1::fridge_door pstn8180=1.78)
	(position counter#1::chewie_door_left_joint pstn8179=-1.872)
	(position oven#1::knob_joint_3 pstn8182=0.0)
	(position oven#1::knob_joint_2 pstn8181=0.0)
	(position counter#1::chewie_door_right_joint pstn8178=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn8182=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8181=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8183=0.0)

	(atpose chicken-leg p18159=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p18158=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p18162=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p18160=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose pepper-shaker p18163=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p18163=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p18162=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p18160=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose braiserbody#1 p18158=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p18159=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn8179=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn8178=1.872)
	(isopenedposition fridge#1::fridge_door pstn8180=1.78)
	...
	(contained salt-shaker p18162=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p18163=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p18161=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p18160=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
