...
(define
  (problem test_kitchen_chicken_soup_250904_135651_seed_478395)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn7543=0.0)
	(position oven#1::knob_joint_2 pstn7542=0.0)
	(position fridge#1::fridge_door pstn7541=1.78)
	(position counter#1::chewie_door_right_joint pstn7539=1.872)
	(position faucet#1::joint_faucet_0 pstn7544=0.0)
	(position counter#1::chewie_door_left_joint pstn7540=-1.872)

	(atposition oven#1::knob_joint_2 pstn7542=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7540=-1.872)
	(atposition fridge#1::fridge_door pstn7541=1.78)
	(atposition faucet#1::joint_faucet_0 pstn7544=0.0)
	(atposition oven#1::knob_joint_3 pstn7543=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7539=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn7544=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7543=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7542=0.0)

	(pose braiserbody#1 p13585=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p13586=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p13587=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(pose salt-shaker p13589=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p13590=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn7540=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn7539=1.872)
	(isopenedposition fridge#1::fridge_door pstn7541=1.78)

	(atpose pepper-shaker p13590=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p13585=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p13586=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p13589=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p13587=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	...
	(contained pepper-shaker p13590=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p13589=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13588=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13587=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304) counter#1::front_left_stove)
