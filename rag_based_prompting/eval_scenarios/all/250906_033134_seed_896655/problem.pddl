...
(define
  (problem test_kitchen_chicken_soup_250906_033134_seed_896655)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn25323=1.78)
	(position oven#1::knob_joint_2 pstn25324=0.0)
	(position counter#1::chewie_door_left_joint pstn25322=-1.872)
	(position faucet#1::joint_faucet_0 pstn25326=0.0)
	(position oven#1::knob_joint_3 pstn25325=0.0)
	(position counter#1::chewie_door_right_joint pstn25321=1.872)

	(atposition fridge#1::fridge_door pstn25323=1.78)
	(atposition faucet#1::joint_faucet_0 pstn25326=0.0)
	(atposition oven#1::knob_joint_2 pstn25324=0.0)
	(atposition counter#1::chewie_door_left_joint pstn25322=-1.872)
	(atposition oven#1::knob_joint_3 pstn25325=0.0)
	(atposition counter#1::chewie_door_right_joint pstn25321=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn25323=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn25321=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn25322=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn25326=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn25324=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn25325=0.0)

	(pose salt-shaker p38780=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p38776=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p38781=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p38778=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(pose chicken-leg p38777=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p38780=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p38778=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(atpose braiserbody#1 p38776=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p38781=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p38777=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p38781=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p38780=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p38778=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987) counter#1::front_left_stove)
	(supported braiserbody#1 p38779=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
