...
(define
  (problem test_kitchen_chicken_soup_250905_192617_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn16545=0.0)
	(position counter#1::chewie_door_right_joint pstn16541=1.872)
	(position fridge#1::fridge_door pstn16543=1.78)
	(position counter#1::chewie_door_left_joint pstn16542=-1.872)
	(position oven#1::knob_joint_2 pstn16544=0.0)
	(position faucet#1::joint_faucet_0 pstn16546=0.0)

	(atposition oven#1::knob_joint_3 pstn16545=0.0)
	(atposition counter#1::chewie_door_right_joint pstn16541=1.872)
	(atposition fridge#1::fridge_door pstn16543=1.78)
	(atposition faucet#1::joint_faucet_0 pstn16546=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16542=-1.872)
	(atposition oven#1::knob_joint_2 pstn16544=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn16546=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16545=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16544=0.0)

	(pose braiserlid#1 p24510=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(pose pepper-shaker p24513=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p24512=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p24508=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p24509=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserbody#1 p24508=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p24509=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p24510=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(atpose pepper-shaker p24513=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p24512=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq800=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq264=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn16541=1.872)
	(isopenedposition fridge#1::fridge_door pstn16543=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn16542=-1.872)

	(ataconf left aq800=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq264=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p24512=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p24513=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p24510=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
	(supported braiserbody#1 p24511=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
