...
(define
  (problem test_kitchen_chicken_soup_250904_100912_seed_774211)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p3962=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p3960=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(pose pepper-shaker p3963=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p3959=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p3958=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p3963=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p3962=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p3960=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(atpose chicken-leg p3959=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p3958=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p3963=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3962=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p3961=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3960=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682) counter#1::front_left_stove)
