...
(define
  (problem test_kitchen_chicken_soup_250904_125345_seed_637146)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn5796=1.78)
	(atposition counter#1::chewie_door_right_joint pstn5794=1.872)
	(atposition oven#1::knob_joint_3 pstn5798=0.0)
	(atposition oven#1::knob_joint_2 pstn5797=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5795=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn5799=0.0)
	(position faucet#1::joint_faucet_0 pstn5799=0.0)
	(position fridge#1::fridge_door pstn5796=1.78)
	(position oven#1::knob_joint_2 pstn5797=0.0)
	(position counter#1::chewie_door_left_joint pstn5795=-1.872)
	(position counter#1::chewie_door_right_joint pstn5794=1.872)
	(position oven#1::knob_joint_3 pstn5798=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn5798=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5797=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5799=0.0)

	(atpose chicken-leg p10800=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p10799=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p10801=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(atpose pepper-shaker p10804=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p10803=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p10804=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p10799=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p10801=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(pose salt-shaker p10803=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p10800=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn5795=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5796=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5794=1.872)
	...
	(contained pepper-shaker p10804=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p10803=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p10801=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073) counter#1::front_left_stove)
	(supported braiserbody#1 p10802=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
