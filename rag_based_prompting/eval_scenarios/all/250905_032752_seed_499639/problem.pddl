...
(define
  (problem test_kitchen_chicken_soup_250905_032752_seed_499639)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn19896=0.0)
	(atposition fridge#1::fridge_door pstn19893=1.78)
	(atposition oven#1::knob_joint_2 pstn19894=0.0)
	(atposition oven#1::knob_joint_3 pstn19895=0.0)
	(atposition counter#1::chewie_door_left_joint pstn19892=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn19891=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn19894=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19895=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19896=0.0)

	(position counter#1::chewie_door_right_joint pstn19891=1.872)
	(position faucet#1::joint_faucet_0 pstn19896=0.0)
	(position oven#1::knob_joint_2 pstn19894=0.0)
	(position counter#1::chewie_door_left_joint pstn19892=-1.872)
	(position fridge#1::fridge_door pstn19893=1.78)
	(position oven#1::knob_joint_3 pstn19895=0.0)

	(pose chicken-leg p56815=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p56818=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p56814=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p56819=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p56816=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))

	(atpose braiserlid#1 p56816=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(atpose pepper-shaker p56819=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p56815=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p56814=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p56818=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn19892=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn19891=1.872)
	(isopenedposition fridge#1::fridge_door pstn19893=1.78)
	...
	(contained pepper-shaker p56819=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p56818=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p56816=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531) counter#1::front_left_stove)
	(supported braiserbody#1 p56817=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
