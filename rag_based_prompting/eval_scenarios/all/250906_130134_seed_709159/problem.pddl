...
(define
  (problem test_kitchen_chicken_soup_250906_130134_seed_709159)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn3930=0.0)
	(atposition oven#1::knob_joint_3 pstn3931=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3928=-1.872)
	(atposition fridge#1::fridge_door pstn3929=1.78)
	(atposition counter#1::chewie_door_right_joint pstn3927=1.872)
	(atposition faucet#1::joint_faucet_0 pstn3932=0.0)

	(position faucet#1::joint_faucet_0 pstn3932=0.0)
	(position counter#1::chewie_door_right_joint pstn3927=1.872)
	(position oven#1::knob_joint_3 pstn3931=0.0)
	(position oven#1::knob_joint_2 pstn3930=0.0)
	(position counter#1::chewie_door_left_joint pstn3928=-1.872)
	(position fridge#1::fridge_door pstn3929=1.78)

	(isclosedposition oven#1::knob_joint_3 pstn3931=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3932=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3930=0.0)
	...
	(pose pepper-shaker p21297=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p21293=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p21294=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(pose braiserbody#1 p21292=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p21296=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn3928=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3929=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn3927=1.872)

	(aconf left aq952=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq120=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p21297=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p21296=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p21293=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p21294=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(atpose braiserbody#1 p21292=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))

	(ataconf right aq120=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq952=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p21296=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p21297=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p21295=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p21294=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44) counter#1::front_left_stove)
