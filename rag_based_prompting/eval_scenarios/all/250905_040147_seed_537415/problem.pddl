...
(define
  (problem test_kitchen_chicken_soup_250905_040147_seed_537415)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn20638=0.0)
	(position oven#1::knob_joint_2 pstn20637=0.0)
	(position fridge#1::fridge_door pstn20636=1.78)
	(position counter#1::chewie_door_left_joint pstn20635=-1.872)
	(position faucet#1::joint_faucet_0 pstn20639=0.0)
	(position counter#1::chewie_door_right_joint pstn20634=1.872)
	...
	(atposition oven#1::knob_joint_2 pstn20637=0.0)
	(atposition faucet#1::joint_faucet_0 pstn20639=0.0)
	(atposition fridge#1::fridge_door pstn20636=1.78)
	(atposition counter#1::chewie_door_left_joint pstn20635=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn20634=1.872)
	(atposition oven#1::knob_joint_3 pstn20638=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn20639=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20638=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20637=0.0)

	(pose braiserbody#1 p57180=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p57184=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p57185=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p57182=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(pose chicken-leg p57181=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq176=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq648=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p57185=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p57180=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p57184=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p57182=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(atpose chicken-leg p57181=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_left_joint pstn20635=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn20634=1.872)
	(isopenedposition fridge#1::fridge_door pstn20636=1.78)

	(ataconf right aq648=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq176=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p57185=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p57184=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p57182=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718) counter#1::front_left_stove)
	(supported braiserbody#1 p57183=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
