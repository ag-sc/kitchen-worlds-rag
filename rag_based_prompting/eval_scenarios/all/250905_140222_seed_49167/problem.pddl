...
(define
  (problem test_kitchen_chicken_soup_250905_140222_seed_49167)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn9371=0.0)
	(position counter#1::chewie_door_left_joint pstn9367=-1.872)
	(position oven#1::knob_joint_2 pstn9369=0.0)
	(position oven#1::knob_joint_3 pstn9370=0.0)
	(position fridge#1::fridge_door pstn9368=1.78)
	(position counter#1::chewie_door_right_joint pstn9366=1.872)

	(atposition faucet#1::joint_faucet_0 pstn9371=0.0)
	(atposition oven#1::knob_joint_3 pstn9370=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9367=-1.872)
	(atposition fridge#1::fridge_door pstn9368=1.78)
	(atposition counter#1::chewie_door_right_joint pstn9366=1.872)
	(atposition oven#1::knob_joint_2 pstn9369=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn9371=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9370=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9369=0.0)

	(pose chicken-leg p14884=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p14885=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102))
	(pose pepper-shaker p14888=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p14883=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p14887=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p14884=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p14887=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p14888=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14883=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p14885=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102))

	(isopenedposition counter#1::chewie_door_left_joint pstn9367=-1.872)
	(isopenedposition fridge#1::fridge_door pstn9368=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn9366=1.872)
	...
	(contained salt-shaker p14887=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14888=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p14886=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p14885=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102) counter#1::front_left_stove)
