...
(define
  (problem test_kitchen_chicken_soup_250905_094429_seed_320213)
  (:domain domain)
  ...
  (:init
	...
	(pose pepper-shaker p8184=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p8179=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p8183=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p8180=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p8181=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))

	(atpose pepper-shaker p8184=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p8179=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p8183=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p8181=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(atpose chicken-leg p8180=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p8184=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p8183=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p8181=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62) counter#1::front_left_stove)
	(supported braiserbody#1 p8182=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
