...
(define
  (problem test_kitchen_chicken_soup_250830_030028_seed_452553)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn25627=0.0)
	(atposition oven#1::knob_joint_2 pstn25626=0.0)
	(atposition fridge#1::fridge_door pstn25625=1.78)
	(atposition counter#1::chewie_door_left_joint pstn25624=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn25628=0.0)
	(atposition counter#1::chewie_door_right_joint pstn25623=1.872)
	(position fridge#1::fridge_door pstn25625=1.78)
	(position faucet#1::joint_faucet_0 pstn25628=0.0)
	(position oven#1::knob_joint_3 pstn25627=0.0)
	(position oven#1::knob_joint_2 pstn25626=0.0)
	(position counter#1::chewie_door_right_joint pstn25623=1.872)
	(position counter#1::chewie_door_left_joint pstn25624=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn25626=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn25628=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn25627=0.0)
	...
	(pose chicken-leg p54001=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p54004=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p54000=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p54005=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p54002=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))

	(atpose salt-shaker p54004=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p54002=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(atpose pepper-shaker p54005=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p54001=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p54000=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq944=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq56=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn25624=-1.872)
	(isopenedposition fridge#1::fridge_door pstn25625=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn25623=1.872)

	(ataconf left aq944=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq56=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p54004=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p54005=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p54002=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452) counter#1::front_left_stove)
	(supported braiserbody#1 p54003=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
