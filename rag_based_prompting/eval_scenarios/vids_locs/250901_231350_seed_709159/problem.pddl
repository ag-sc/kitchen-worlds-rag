...
(define
  (problem test_kitchen_chicken_soup_250901_231350_seed_709159)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn19747=1.78)
	(position oven#1::knob_joint_2 pstn19748=0.0)
	(position counter#1::chewie_door_left_joint pstn19746=-1.872)
	(position counter#1::chewie_door_right_joint pstn19745=1.872)
	(position oven#1::knob_joint_3 pstn19749=0.0)
	(position faucet#1::joint_faucet_0 pstn19750=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn19749=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19750=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19748=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn19746=-1.872)
	(atposition oven#1::knob_joint_3 pstn19749=0.0)
	(atposition fridge#1::fridge_door pstn19747=1.78)
	(atposition counter#1::chewie_door_right_joint pstn19745=1.872)
	(atposition faucet#1::joint_faucet_0 pstn19750=0.0)
	(atposition oven#1::knob_joint_2 pstn19748=0.0)

	(pose braiserbody#1 p75615=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p75616=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p75619=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p75617=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(pose pepper-shaker p75620=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p75615=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p75620=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p75617=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(atpose chicken-leg p75616=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p75619=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn19745=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn19746=-1.872)
	(isopenedposition fridge#1::fridge_door pstn19747=1.78)
	...
	(contained salt-shaker p75619=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p75620=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p75617=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44) counter#1::front_left_stove)
	(supported braiserbody#1 p75618=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
