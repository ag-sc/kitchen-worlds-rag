...
(define
  (problem test_kitchen_chicken_soup_250830_041647_seed_280147)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn27590=0.0)
	(atposition oven#1::knob_joint_3 pstn27591=0.0)
	(atposition counter#1::chewie_door_left_joint pstn27588=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn27592=0.0)
	(atposition fridge#1::fridge_door pstn27589=1.78)
	(atposition counter#1::chewie_door_right_joint pstn27587=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn27589=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn27588=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn27587=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn27592=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn27591=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn27590=0.0)

	(position counter#1::chewie_door_right_joint pstn27587=1.872)
	(position counter#1::chewie_door_left_joint pstn27588=-1.872)
	(position faucet#1::joint_faucet_0 pstn27592=0.0)
	(position fridge#1::fridge_door pstn27589=1.78)
	(position oven#1::knob_joint_2 pstn27590=0.0)
	(position oven#1::knob_joint_3 pstn27591=0.0)

	(pose braiserbody#1 p57655=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p57657=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	(pose salt-shaker p57659=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p57656=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p57660=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p57659=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p57655=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p57656=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p57660=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p57657=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	...
	(contained salt-shaker p57659=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p57660=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p57657=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667) counter#1::front_left_stove)
	(supported braiserbody#1 p57658=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
