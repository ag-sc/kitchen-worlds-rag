...
(define
  (problem test_kitchen_chicken_soup_250901_180639_seed_74545)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn13750=0.0)
	(position fridge#1::fridge_door pstn13748=1.78)
	(position counter#1::chewie_door_right_joint pstn13746=1.872)
	(position faucet#1::joint_faucet_0 pstn13751=0.0)
	(position counter#1::chewie_door_left_joint pstn13747=-1.872)
	(position oven#1::knob_joint_2 pstn13749=0.0)
	...
	(atposition fridge#1::fridge_door pstn13748=1.78)
	(atposition counter#1::chewie_door_right_joint pstn13746=1.872)
	(atposition faucet#1::joint_faucet_0 pstn13751=0.0)
	(atposition counter#1::chewie_door_left_joint pstn13747=-1.872)
	(atposition oven#1::knob_joint_2 pstn13749=0.0)
	(atposition oven#1::knob_joint_3 pstn13750=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn13749=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13750=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13751=0.0)
	...
	(pose pepper-shaker p44957=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p44952=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p44953=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p44954=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(pose salt-shaker p44956=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p44954=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(atpose pepper-shaker p44957=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p44952=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p44956=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p44953=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn13746=1.872)
	(isopenedposition fridge#1::fridge_door pstn13748=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn13747=-1.872)
	...
	(contained pepper-shaker p44957=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p44956=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p44955=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p44954=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999) counter#1::front_left_stove)
