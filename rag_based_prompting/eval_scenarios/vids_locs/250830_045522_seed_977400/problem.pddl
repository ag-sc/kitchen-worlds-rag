...
(define
  (problem test_kitchen_chicken_soup_250830_045522_seed_977400)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn28574=0.0)
	(position oven#1::knob_joint_3 pstn28573=0.0)
	(position oven#1::knob_joint_2 pstn28572=0.0)
	(position counter#1::chewie_door_right_joint pstn28569=1.872)
	(position counter#1::chewie_door_left_joint pstn28570=-1.872)
	(position fridge#1::fridge_door pstn28571=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn28573=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn28572=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn28574=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn28570=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn28569=1.872)
	(atposition fridge#1::fridge_door pstn28571=1.78)
	(atposition oven#1::knob_joint_2 pstn28572=0.0)
	(atposition faucet#1::joint_faucet_0 pstn28574=0.0)
	(atposition oven#1::knob_joint_3 pstn28573=0.0)

	(pose pepper-shaker p59658=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p59655=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(pose salt-shaker p59657=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p59653=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p59654=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose pepper-shaker p59658=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p59655=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(atpose salt-shaker p59657=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p59653=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p59654=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_left_joint pstn28570=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn28569=1.872)
	(isopenedposition fridge#1::fridge_door pstn28571=1.78)
	...
	(contained salt-shaker p59657=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p59658=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p59656=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p59655=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695) counter#1::front_left_stove)
