...
(define
  (problem test_kitchen_chicken_soup_250829_154107_seed_240439)
  (:domain domain)
  ...
  (:init
	...
	(pose chicken-leg p4914=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p4915=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))
	(pose pepper-shaker p4918=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p4917=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4913=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p4914=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p4915=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))
	(atpose salt-shaker p4917=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p4913=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p4918=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p4918=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4917=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4915=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159) counter#1::front_left_stove)
	(supported braiserbody#1 p4916=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
