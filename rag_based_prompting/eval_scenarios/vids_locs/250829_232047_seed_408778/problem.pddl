...
(define
  (problem test_kitchen_chicken_soup_250829_232047_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn19479=0.0)
	(position counter#1::chewie_door_left_joint pstn19477=-1.872)
	(position faucet#1::joint_faucet_0 pstn19481=0.0)
	(position oven#1::knob_joint_3 pstn19480=0.0)
	(position fridge#1::fridge_door pstn19478=1.78)
	(position counter#1::chewie_door_right_joint pstn19476=1.872)

	(atposition faucet#1::joint_faucet_0 pstn19481=0.0)
	(atposition fridge#1::fridge_door pstn19478=1.78)
	(atposition counter#1::chewie_door_left_joint pstn19477=-1.872)
	(atposition oven#1::knob_joint_2 pstn19479=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19476=1.872)
	(atposition oven#1::knob_joint_3 pstn19480=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn19478=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn19477=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn19476=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn19481=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19480=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19479=0.0)

	(pose salt-shaker p38259=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p38257=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(pose chicken-leg p38256=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p38260=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p38255=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p38260=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p38257=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(atpose salt-shaker p38259=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p38256=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p38255=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p38260=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p38259=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p38257=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
	(supported braiserbody#1 p38258=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
