...
(define
  (problem test_kitchen_chicken_soup_250829_165947_seed_373761)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn8404=0.0)
	(position counter#1::chewie_door_left_joint pstn8402=-1.872)
	(position oven#1::knob_joint_3 pstn8405=0.0)
	(position counter#1::chewie_door_right_joint pstn8401=1.872)
	(position faucet#1::joint_faucet_0 pstn8406=0.0)
	(position fridge#1::fridge_door pstn8403=1.78)

	(atposition fridge#1::fridge_door pstn8403=1.78)
	(atposition oven#1::knob_joint_2 pstn8404=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8401=1.872)
	(atposition counter#1::chewie_door_left_joint pstn8402=-1.872)
	(atposition oven#1::knob_joint_3 pstn8405=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8406=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn8404=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8405=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8406=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn8403=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn8401=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn8402=-1.872)
	...
	(pose salt-shaker p9303=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p9300=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p9304=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p9301=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))
	(pose braiserbody#1 p9299=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p9303=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p9300=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p9304=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p9301=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))
	(atpose braiserbody#1 p9299=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p9304=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p9303=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p9301=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998) counter#1::front_left_stove)
	(supported braiserbody#1 p9302=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
