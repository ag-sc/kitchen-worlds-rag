...
(define
  (problem test_kitchen_chicken_soup_250901_170313_seed_543413)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn12685=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12687=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12686=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn12684=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn12683=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn12682=1.872)

	(position counter#1::chewie_door_left_joint pstn12683=-1.872)
	(position oven#1::knob_joint_3 pstn12686=0.0)
	(position counter#1::chewie_door_right_joint pstn12682=1.872)
	(position oven#1::knob_joint_2 pstn12685=0.0)
	(position faucet#1::joint_faucet_0 pstn12687=0.0)
	(position fridge#1::fridge_door pstn12684=1.78)

	(atposition counter#1::chewie_door_right_joint pstn12682=1.872)
	(atposition oven#1::knob_joint_2 pstn12685=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12687=0.0)
	(atposition fridge#1::fridge_door pstn12684=1.78)
	(atposition counter#1::chewie_door_left_joint pstn12683=-1.872)
	(atposition oven#1::knob_joint_3 pstn12686=0.0)

	(pose braiserbody#1 p39083=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p39087=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p39088=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p39085=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(pose chicken-leg p39084=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose pepper-shaker p39088=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p39087=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p39084=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p39085=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(atpose braiserbody#1 p39083=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p39088=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p39087=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p39086=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p39085=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92) counter#1::front_left_stove)
