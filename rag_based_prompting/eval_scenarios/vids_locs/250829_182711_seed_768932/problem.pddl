...
(define
  (problem test_kitchen_chicken_soup_250829_182711_seed_768932)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn11925=0.0)
	(position faucet#1::joint_faucet_0 pstn11926=0.0)
	(position counter#1::chewie_door_left_joint pstn11922=-1.872)
	(position fridge#1::fridge_door pstn11923=1.78)
	(position oven#1::knob_joint_2 pstn11924=0.0)
	(position counter#1::chewie_door_right_joint pstn11921=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn11926=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11924=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11925=0.0)

	(atposition counter#1::chewie_door_right_joint pstn11921=1.872)
	(atposition oven#1::knob_joint_3 pstn11925=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11922=-1.872)
	(atposition fridge#1::fridge_door pstn11923=1.78)
	(atposition faucet#1::joint_faucet_0 pstn11926=0.0)
	(atposition oven#1::knob_joint_2 pstn11924=0.0)

	(pose chicken-leg p16402=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p16406=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p16403=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))
	(pose salt-shaker p16405=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p16401=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p16405=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p16401=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p16403=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))
	(atpose chicken-leg p16402=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p16406=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq96=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn11921=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11922=-1.872)
	(isopenedposition fridge#1::fridge_door pstn11923=1.78)

	(ataconf right aq96=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p16405=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p16406=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p16403=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469) counter#1::front_left_stove)
	(supported braiserbody#1 p16404=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
