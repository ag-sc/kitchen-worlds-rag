...
(define
  (problem test_kitchen_chicken_soup_250901_101525_seed_798018)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn1345=0.0)
	(position faucet#1::joint_faucet_0 pstn1347=0.0)
	(position oven#1::knob_joint_3 pstn1346=0.0)
	(position fridge#1::fridge_door pstn1344=1.78)
	(position counter#1::chewie_door_right_joint pstn1342=1.872)
	(position counter#1::chewie_door_left_joint pstn1343=-1.872)

	(atposition oven#1::knob_joint_2 pstn1345=0.0)
	(atposition fridge#1::fridge_door pstn1344=1.78)
	(atposition oven#1::knob_joint_3 pstn1346=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1342=1.872)
	(atposition counter#1::chewie_door_left_joint pstn1343=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn1347=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn1346=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1347=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1345=0.0)
	...
	(pose chicken-leg p4694=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p4695=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose braiserbody#1 p4693=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p4697=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p4698=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p4697=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p4698=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p4694=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p4695=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose braiserbody#1 p4693=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq32=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq384=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn1343=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1342=1.872)
	(isopenedposition fridge#1::fridge_door pstn1344=1.78)

	(ataconf right aq384=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq32=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p4698=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4697=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4695=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
	(supported braiserbody#1 p4696=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
