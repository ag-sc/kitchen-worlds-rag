...
(define
  (problem test_kitchen_chicken_soup_250901_204705_seed_431950)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn16698=0.0)
	(atposition fridge#1::fridge_door pstn16697=1.78)
	(atposition counter#1::chewie_door_right_joint pstn16695=1.872)
	(atposition oven#1::knob_joint_3 pstn16699=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16696=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn16700=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn16699=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16700=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16698=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn16697=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16695=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn16696=-1.872)

	(position counter#1::chewie_door_left_joint pstn16696=-1.872)
	(position oven#1::knob_joint_2 pstn16698=0.0)
	(position faucet#1::joint_faucet_0 pstn16700=0.0)
	(position counter#1::chewie_door_right_joint pstn16695=1.872)
	(position oven#1::knob_joint_3 pstn16699=0.0)
	(position fridge#1::fridge_door pstn16697=1.78)

	(atpose chicken-leg p61650=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p61651=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(atpose braiserbody#1 p61649=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p61653=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p61654=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p61654=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p61650=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p61651=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(pose braiserbody#1 p61649=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p61653=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p61653=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p61654=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p61652=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p61651=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642) counter#1::front_left_stove)
