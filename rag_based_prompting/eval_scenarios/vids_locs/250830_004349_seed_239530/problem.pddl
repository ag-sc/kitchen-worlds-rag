...
(define
  (problem test_kitchen_chicken_soup_250830_004349_seed_239530)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn21682=0.0)
	(atposition fridge#1::fridge_door pstn21679=1.78)
	(atposition oven#1::knob_joint_3 pstn21681=0.0)
	(atposition counter#1::chewie_door_left_joint pstn21678=-1.872)
	(atposition oven#1::knob_joint_2 pstn21680=0.0)
	(atposition counter#1::chewie_door_right_joint pstn21677=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn21680=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21682=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn21681=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn21677=1.872)
	(position fridge#1::fridge_door pstn21679=1.78)
	(position oven#1::knob_joint_2 pstn21680=0.0)
	(position counter#1::chewie_door_left_joint pstn21678=-1.872)
	(position faucet#1::joint_faucet_0 pstn21682=0.0)
	(position oven#1::knob_joint_3 pstn21681=0.0)

	(pose salt-shaker p45560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p45557=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p45558=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(pose braiserbody#1 p45556=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p45561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p45558=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(atpose braiserbody#1 p45556=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p45557=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p45561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p45560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn21677=1.872)
	(isopenedposition fridge#1::fridge_door pstn21679=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn21678=-1.872)
	...
	(contained pepper-shaker p45561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p45560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p45558=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285) counter#1::front_left_stove)
	(supported braiserbody#1 p45559=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
