...
(define
  (problem test_kitchen_chicken_soup_250901_132713_seed_607747)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn7014=1.78)
	(position oven#1::knob_joint_3 pstn7016=0.0)
	(position oven#1::knob_joint_2 pstn7015=0.0)
	(position counter#1::chewie_door_left_joint pstn7013=-1.872)
	(position faucet#1::joint_faucet_0 pstn7017=0.0)
	(position counter#1::chewie_door_right_joint pstn7012=1.872)

	(atposition fridge#1::fridge_door pstn7014=1.78)
	(atposition oven#1::knob_joint_2 pstn7015=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7013=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn7017=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7012=1.872)
	(atposition oven#1::knob_joint_3 pstn7016=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn7015=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn7017=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7016=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn7014=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn7012=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn7013=-1.872)

	(pose salt-shaker p22186=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p22184=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	(pose chicken-leg p22183=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p22187=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p22182=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p22186=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p22183=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p22187=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p22184=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	(atpose braiserbody#1 p22182=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p22187=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p22186=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p22184=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098) counter#1::front_left_stove)
	(supported braiserbody#1 p22185=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
