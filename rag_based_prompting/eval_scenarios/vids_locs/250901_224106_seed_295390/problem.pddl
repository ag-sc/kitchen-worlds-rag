...
(define
  (problem test_kitchen_chicken_soup_250901_224106_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn19061=1.78)
	(position oven#1::knob_joint_2 pstn19062=0.0)
	(position counter#1::chewie_door_right_joint pstn19059=1.872)
	(position faucet#1::joint_faucet_0 pstn19064=0.0)
	(position oven#1::knob_joint_3 pstn19063=0.0)
	(position counter#1::chewie_door_left_joint pstn19060=-1.872)

	(atposition fridge#1::fridge_door pstn19061=1.78)
	(atposition oven#1::knob_joint_2 pstn19062=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19059=1.872)
	(atposition faucet#1::joint_faucet_0 pstn19064=0.0)
	(atposition oven#1::knob_joint_3 pstn19063=0.0)
	(atposition counter#1::chewie_door_left_joint pstn19060=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn19064=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19062=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19063=0.0)

	(pose salt-shaker p72963=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p72960=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p72961=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(pose pepper-shaker p72964=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p72959=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p72960=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p72964=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p72961=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(atpose braiserbody#1 p72959=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p72963=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq688=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq896=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn19060=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn19059=1.872)
	(isopenedposition fridge#1::fridge_door pstn19061=1.78)

	(ataconf left aq688=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq896=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p72964=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p72963=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p72961=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
	(supported braiserbody#1 p72962=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
