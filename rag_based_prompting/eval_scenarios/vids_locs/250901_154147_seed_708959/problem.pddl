...
(define
  (problem test_kitchen_chicken_soup_250901_154147_seed_708959)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn10662=1.78)
	(position oven#1::knob_joint_3 pstn10664=0.0)
	(position counter#1::chewie_door_right_joint pstn10660=1.872)
	(position oven#1::knob_joint_2 pstn10663=0.0)
	(position faucet#1::joint_faucet_0 pstn10665=0.0)
	(position counter#1::chewie_door_left_joint pstn10661=-1.872)

	(atposition fridge#1::fridge_door pstn10662=1.78)
	(atposition oven#1::knob_joint_2 pstn10663=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10660=1.872)
	(atposition faucet#1::joint_faucet_0 pstn10665=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10661=-1.872)
	(atposition oven#1::knob_joint_3 pstn10664=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn10665=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10663=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10664=0.0)

	(pose salt-shaker p31906=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p31902=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p31903=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p31907=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p31904=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))

	(atpose chicken-leg p31903=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p31907=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p31906=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p31904=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(atpose braiserbody#1 p31902=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq736=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(isopenedposition counter#1::chewie_door_right_joint pstn10660=1.872)
	(isopenedposition fridge#1::fridge_door pstn10662=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn10661=-1.872)

	(ataconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq736=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p31907=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p31906=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p31904=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278) counter#1::front_left_stove)
	(supported braiserbody#1 p31905=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
