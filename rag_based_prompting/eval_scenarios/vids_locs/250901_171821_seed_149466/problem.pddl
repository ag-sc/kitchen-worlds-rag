...
(define
  (problem test_kitchen_chicken_soup_250901_171821_seed_149466)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn12880=0.0)
	(position faucet#1::joint_faucet_0 pstn12882=0.0)
	(position fridge#1::fridge_door pstn12879=1.78)
	(position counter#1::chewie_door_left_joint pstn12878=-1.872)
	(position counter#1::chewie_door_right_joint pstn12877=1.872)
	(position oven#1::knob_joint_3 pstn12881=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn12881=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12882=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12880=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn12879=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn12878=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn12877=1.872)

	(atposition counter#1::chewie_door_right_joint pstn12877=1.872)
	(atposition fridge#1::fridge_door pstn12879=1.78)
	(atposition counter#1::chewie_door_left_joint pstn12878=-1.872)
	(atposition oven#1::knob_joint_3 pstn12881=0.0)
	(atposition oven#1::knob_joint_2 pstn12880=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12882=0.0)

	(pose salt-shaker p41389=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p41390=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p41386=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p41387=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(pose braiserbody#1 p41385=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p41386=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p41389=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p41385=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p41387=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(atpose pepper-shaker p41390=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p41389=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p41390=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p41388=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p41387=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9) counter#1::front_left_stove)
