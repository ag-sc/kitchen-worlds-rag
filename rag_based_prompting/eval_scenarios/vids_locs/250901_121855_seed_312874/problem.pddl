...
(define
  (problem test_kitchen_chicken_soup_250901_121855_seed_312874)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn4993=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4994=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4995=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn4991=-1.872)
	(position faucet#1::joint_faucet_0 pstn4995=0.0)
	(position oven#1::knob_joint_2 pstn4993=0.0)
	(position counter#1::chewie_door_right_joint pstn4990=1.872)
	(position fridge#1::fridge_door pstn4992=1.78)
	(position oven#1::knob_joint_3 pstn4994=0.0)

	(atposition counter#1::chewie_door_right_joint pstn4990=1.872)
	(atposition oven#1::knob_joint_3 pstn4994=0.0)
	(atposition oven#1::knob_joint_2 pstn4993=0.0)
	(atposition fridge#1::fridge_door pstn4992=1.78)
	(atposition counter#1::chewie_door_left_joint pstn4991=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn4995=0.0)

	(pose salt-shaker p14463=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p14460=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p14464=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p14461=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(pose braiserbody#1 p14459=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p14463=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14459=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p14464=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p14460=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p14461=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))

	(isopenedposition counter#1::chewie_door_left_joint pstn4991=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4992=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4990=1.872)
	...
	(contained salt-shaker p14463=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14464=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14461=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441) counter#1::front_left_stove)
	(supported braiserbody#1 p14462=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
