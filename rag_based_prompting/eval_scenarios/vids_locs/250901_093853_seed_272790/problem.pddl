...
(define
  (problem test_kitchen_chicken_soup_250901_093853_seed_272790)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p350=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(pose chicken-leg p349=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p348=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p353=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p350=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	...
	(atpose braiserbody#1 p348=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p351=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p350=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401) counter#1::front_left_stove)
