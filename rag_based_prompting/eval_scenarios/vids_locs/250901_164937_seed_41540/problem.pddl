...
(define
  (problem test_kitchen_chicken_soup_250901_164937_seed_41540)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn12492=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12490=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12491=0.0)

	(position counter#1::chewie_door_right_joint pstn12487=1.872)
	(position fridge#1::fridge_door pstn12489=1.78)
	(position oven#1::knob_joint_3 pstn12491=0.0)
	(position counter#1::chewie_door_left_joint pstn12488=-1.872)
	(position oven#1::knob_joint_2 pstn12490=0.0)
	(position faucet#1::joint_faucet_0 pstn12492=0.0)

	(atposition counter#1::chewie_door_right_joint pstn12487=1.872)
	(atposition fridge#1::fridge_door pstn12489=1.78)
	(atposition oven#1::knob_joint_3 pstn12491=0.0)
	(atposition counter#1::chewie_door_left_joint pstn12488=-1.872)
	(atposition oven#1::knob_joint_2 pstn12490=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12492=0.0)

	(pose braiserlid#1 p37806=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(pose chicken-leg p37805=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p37809=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p37804=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p37808=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p37805=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p37806=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(atpose braiserbody#1 p37804=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p37809=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p37808=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq544=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn12487=1.872)
	(isopenedposition fridge#1::fridge_door pstn12489=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn12488=-1.872)

	(ataconf left aq544=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p37808=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p37809=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p37807=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p37806=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584) counter#1::front_left_stove)
