...
(define
  (problem test_kitchen_chicken_soup_250830_001108_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn20674=0.0)
	(atposition counter#1::chewie_door_right_joint pstn20671=1.872)
	(atposition counter#1::chewie_door_left_joint pstn20672=-1.872)
	(atposition fridge#1::fridge_door pstn20673=1.78)
	(atposition oven#1::knob_joint_3 pstn20675=0.0)
	(atposition faucet#1::joint_faucet_0 pstn20676=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn20674=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn20676=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20675=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn20671=1.872)
	(position counter#1::chewie_door_left_joint pstn20672=-1.872)
	(position faucet#1::joint_faucet_0 pstn20676=0.0)
	(position fridge#1::fridge_door pstn20673=1.78)
	(position oven#1::knob_joint_3 pstn20675=0.0)
	(position oven#1::knob_joint_2 pstn20674=0.0)

	(pose braiserbody#1 p42232=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p42234=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(pose chicken-leg p42233=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p42237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p42236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p42234=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(atpose pepper-shaker p42237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p42233=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p42236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p42232=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq184=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq96=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn20671=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn20672=-1.872)
	(isopenedposition fridge#1::fridge_door pstn20673=1.78)

	(ataconf right aq96=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq184=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p42236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p42237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p42235=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p42234=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
