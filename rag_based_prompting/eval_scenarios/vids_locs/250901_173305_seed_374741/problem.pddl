...
(define
  (problem test_kitchen_chicken_soup_250901_173305_seed_374741)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn13077=0.0)
	(position oven#1::knob_joint_2 pstn13075=0.0)
	(position counter#1::chewie_door_left_joint pstn13073=-1.872)
	(position counter#1::chewie_door_right_joint pstn13072=1.872)
	(position fridge#1::fridge_door pstn13074=1.78)
	(position oven#1::knob_joint_3 pstn13076=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn13075=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13077=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13076=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn13074=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn13073=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn13072=1.872)

	(atposition counter#1::chewie_door_left_joint pstn13073=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn13072=1.872)
	(atposition fridge#1::fridge_door pstn13074=1.78)
	(atposition oven#1::knob_joint_3 pstn13076=0.0)
	(atposition faucet#1::joint_faucet_0 pstn13077=0.0)
	(atposition oven#1::knob_joint_2 pstn13075=0.0)

	(pose chicken-leg p42681=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p42685=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p42682=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(pose salt-shaker p42684=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p42680=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p42682=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(atpose salt-shaker p42684=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p42680=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p42681=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p42685=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p42685=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p42684=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p42682=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355) counter#1::front_left_stove)
	(supported braiserbody#1 p42683=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
