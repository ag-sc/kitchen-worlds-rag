...
(define
  (problem test_kitchen_chicken_soup_250901_182513_seed_186208)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn247=0.0)
	(atposition oven#1::knob_joint_2 pstn246=0.0)
	(atposition faucet#1::joint_faucet_0 pstn248=0.0)
	(atposition counter#1::chewie_door_left_joint pstn244=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn243=1.872)
	(atposition fridge#1::fridge_door pstn245=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn247=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn246=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn248=0.0)

	(position counter#1::chewie_door_right_joint pstn243=1.872)
	(position faucet#1::joint_faucet_0 pstn248=0.0)
	(position fridge#1::fridge_door pstn245=1.78)
	(position counter#1::chewie_door_left_joint pstn244=-1.872)
	(position oven#1::knob_joint_3 pstn247=0.0)
	(position oven#1::knob_joint_2 pstn246=0.0)

	(pose braiserlid#1 p3342=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167))
	(pose braiserbody#1 p3340=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p3344=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p3341=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p3345=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p3341=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p3340=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p3342=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167))
	(atpose pepper-shaker p3345=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p3344=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn243=1.872)
	(isopenedposition fridge#1::fridge_door pstn245=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn244=-1.872)
	...
	(contained pepper-shaker p3345=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3344=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p3342=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167) counter#1::front_left_stove)
	(supported braiserbody#1 p3343=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
