...
(define
  (problem test_kitchen_chicken_soup_250902_132128_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn4516=1.78)
	(position faucet#1::joint_faucet_0 pstn4519=0.0)
	(position oven#1::knob_joint_3 pstn4518=0.0)
	(position oven#1::knob_joint_2 pstn4517=0.0)
	(position counter#1::chewie_door_left_joint pstn4515=-1.872)
	(position counter#1::chewie_door_right_joint pstn4514=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn4517=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4519=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4518=0.0)

	(atposition counter#1::chewie_door_right_joint pstn4514=1.872)
	(atposition counter#1::chewie_door_left_joint pstn4515=-1.872)
	(atposition fridge#1::fridge_door pstn4516=1.78)
	(atposition faucet#1::joint_faucet_0 pstn4519=0.0)
	(atposition oven#1::knob_joint_3 pstn4518=0.0)
	(atposition oven#1::knob_joint_2 pstn4517=0.0)

	(pose braiserbody#1 p27932=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p27936=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p27933=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p27937=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p27934=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))

	(atpose salt-shaker p27936=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p27932=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p27933=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p27934=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(atpose pepper-shaker p27937=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn4515=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn4514=1.872)
	(isopenedposition fridge#1::fridge_door pstn4516=1.78)
	...
	(contained pepper-shaker p27937=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p27936=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p27934=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
	(supported braiserbody#1 p27935=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
