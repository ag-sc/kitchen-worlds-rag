...
(define
  (problem test_kitchen_chicken_soup_250829_195001_seed_452363)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn12921=0.0)
	(atposition fridge#1::fridge_door pstn12920=1.78)
	(atposition faucet#1::joint_faucet_0 pstn12923=0.0)
	(atposition oven#1::knob_joint_3 pstn12922=0.0)
	(atposition counter#1::chewie_door_right_joint pstn12918=1.872)
	(atposition counter#1::chewie_door_left_joint pstn12919=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn12921=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12923=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12922=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn12918=1.872)
	(position counter#1::chewie_door_left_joint pstn12919=-1.872)
	(position oven#1::knob_joint_2 pstn12921=0.0)
	(position fridge#1::fridge_door pstn12920=1.78)
	(position faucet#1::joint_faucet_0 pstn12923=0.0)
	(position oven#1::knob_joint_3 pstn12922=0.0)

	(pose salt-shaker p26210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p26206=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p26207=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p26208=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))
	(pose pepper-shaker p26211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p26206=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p26210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p26207=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p26211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p26208=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))

	(aconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq856=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn12919=-1.872)
	(isopenedposition fridge#1::fridge_door pstn12920=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12918=1.872)

	(ataconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq856=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p26210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p26211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p26209=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p26208=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252) counter#1::front_left_stove)
