...
(define
  (problem test_kitchen_chicken_soup_250830_012644_seed_798018)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn26477=0.0)
	(position fridge#1::fridge_door pstn26476=1.78)
	(position faucet#1::joint_faucet_0 pstn26479=0.0)
	(position counter#1::chewie_door_left_joint pstn26475=-1.872)
	(position oven#1::knob_joint_3 pstn26478=0.0)
	(position counter#1::chewie_door_right_joint pstn26474=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn26478=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn26477=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn26479=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn26475=-1.872)
	(atposition oven#1::knob_joint_3 pstn26478=0.0)
	(atposition oven#1::knob_joint_2 pstn26477=0.0)
	(atposition counter#1::chewie_door_right_joint pstn26474=1.872)
	(atposition fridge#1::fridge_door pstn26476=1.78)
	(atposition faucet#1::joint_faucet_0 pstn26479=0.0)

	(atpose chicken-leg p47167=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p47170=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p47168=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose pepper-shaker p47171=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p47166=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p47171=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p47167=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p47170=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p47168=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose braiserbody#1 p47166=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq440=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq592=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn26475=-1.872)
	(isopenedposition fridge#1::fridge_door pstn26476=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn26474=1.872)

	(ataconf left aq440=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq592=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p47170=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p47171=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p47169=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p47168=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
