...
(define
  (problem test_kitchen_chicken_soup_250829_230159_seed_774211)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn21024=0.0)
	(position oven#1::knob_joint_2 pstn21023=0.0)
	(position faucet#1::joint_faucet_0 pstn21025=0.0)
	(position counter#1::chewie_door_right_joint pstn21020=1.872)
	(position counter#1::chewie_door_left_joint pstn21021=-1.872)
	(position fridge#1::fridge_door pstn21022=1.78)
	...
	(atposition oven#1::knob_joint_2 pstn21023=0.0)
	(atposition counter#1::chewie_door_right_joint pstn21020=1.872)
	(atposition counter#1::chewie_door_left_joint pstn21021=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn21025=0.0)
	(atposition fridge#1::fridge_door pstn21022=1.78)
	(atposition oven#1::knob_joint_3 pstn21024=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn21025=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21023=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn21024=0.0)

	(pose chicken-leg p40552=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p40555=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p40551=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p40553=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(pose pepper-shaker p40556=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p40555=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p40551=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p40556=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p40553=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(atpose chicken-leg p40552=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn21020=1.872)
	(isopenedposition fridge#1::fridge_door pstn21022=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn21021=-1.872)
	...
	(contained salt-shaker p40555=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p40556=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p40554=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p40553=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682) counter#1::front_left_stove)
