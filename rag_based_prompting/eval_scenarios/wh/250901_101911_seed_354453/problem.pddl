...
(define
  (problem test_kitchen_chicken_soup_250901_101911_seed_354453)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn2543=0.0)
	(position counter#1::chewie_door_right_joint pstn2540=1.872)
	(position counter#1::chewie_door_left_joint pstn2541=-1.872)
	(position fridge#1::fridge_door pstn2542=1.78)
	(position oven#1::knob_joint_3 pstn2544=0.0)
	(position faucet#1::joint_faucet_0 pstn2545=0.0)
	...
	(atposition fridge#1::fridge_door pstn2542=1.78)
	(atposition oven#1::knob_joint_3 pstn2544=0.0)
	(atposition oven#1::knob_joint_2 pstn2543=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2541=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn2545=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2540=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn2545=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2544=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2543=0.0)

	(pose braiserbody#1 p2726=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p2730=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2728=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(pose chicken-leg p2727=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p2731=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p2726=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p2728=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(atpose salt-shaker p2730=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2727=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p2731=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn2540=1.872)
	(isopenedposition fridge#1::fridge_door pstn2542=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2541=-1.872)
	...
	(contained pepper-shaker p2731=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2730=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p2728=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309) counter#1::front_left_stove)
	(supported braiserbody#1 p2729=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
