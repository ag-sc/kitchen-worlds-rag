...
(define
  (problem test_kitchen_chicken_soup_250901_124826_seed_662398)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p0=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p3=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574) counter#1::front_left_stove)
