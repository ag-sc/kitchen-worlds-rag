...
(define
  (problem test_kitchen_chicken_soup_250902_095526_seed_992418)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn838=0.0)
	(atposition counter#1::chewie_door_left_joint pstn835=-1.872)
	(atposition fridge#1::fridge_door pstn836=1.78)
	(atposition oven#1::knob_joint_2 pstn837=0.0)
	(atposition faucet#1::joint_faucet_0 pstn839=0.0)
	(atposition counter#1::chewie_door_right_joint pstn834=1.872)
	...
	(position fridge#1::fridge_door pstn836=1.78)
	(position oven#1::knob_joint_2 pstn837=0.0)
	(position faucet#1::joint_faucet_0 pstn839=0.0)
	(position counter#1::chewie_door_right_joint pstn834=1.872)
	(position oven#1::knob_joint_3 pstn838=0.0)
	(position counter#1::chewie_door_left_joint pstn835=-1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn836=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn834=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn835=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn839=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn837=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn838=0.0)

	(pose chicken-leg p7868=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p7869=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(pose pepper-shaker p7872=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p7871=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p7867=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p7872=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p7869=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(atpose salt-shaker p7871=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p7867=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p7868=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p7871=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p7872=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p7870=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p7869=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554) counter#1::front_left_stove)
