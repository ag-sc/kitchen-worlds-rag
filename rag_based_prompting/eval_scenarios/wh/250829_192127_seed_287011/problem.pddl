...
(define
  (problem test_kitchen_chicken_soup_250829_192127_seed_287011)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn12577=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12576=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12578=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn12573=1.872)
	(position oven#1::knob_joint_3 pstn12577=0.0)
	(position counter#1::chewie_door_left_joint pstn12574=-1.872)
	(position oven#1::knob_joint_2 pstn12576=0.0)
	(position faucet#1::joint_faucet_0 pstn12578=0.0)
	(position fridge#1::fridge_door pstn12575=1.78)

	(atposition counter#1::chewie_door_right_joint pstn12573=1.872)
	(atposition oven#1::knob_joint_2 pstn12576=0.0)
	(atposition oven#1::knob_joint_3 pstn12577=0.0)
	(atposition counter#1::chewie_door_left_joint pstn12574=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn12578=0.0)
	(atposition fridge#1::fridge_door pstn12575=1.78)

	(pose braiserbody#1 p23754=(0.7, 8.866, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p23759=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p23756=(0.567, 7.872, 0.712, 0.0, -0.0, 0.508))
	(pose chicken-leg p23755=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p23758=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p23758=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p23756=(0.567, 7.872, 0.712, 0.0, -0.0, 0.508))
	(atpose pepper-shaker p23759=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p23755=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p23754=(0.7, 8.866, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq64=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq736=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(isopenedposition counter#1::chewie_door_left_joint pstn12574=-1.872)
	(isopenedposition fridge#1::fridge_door pstn12575=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12573=1.872)

	(ataconf left aq64=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq736=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p23759=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23758=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p23756=(0.567, 7.872, 0.712, 0.0, -0.0, 0.508) counter#1::front_left_stove)
	(supported braiserbody#1 p23757=(0.7, 8.866, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
