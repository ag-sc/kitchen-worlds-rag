...
(define
  (problem test_kitchen_chicken_soup_250902_120719_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn3120=1.78)
	(atposition counter#1::chewie_door_right_joint pstn3118=1.872)
	(atposition oven#1::knob_joint_3 pstn3122=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3123=0.0)
	(atposition oven#1::knob_joint_2 pstn3121=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3119=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn3122=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3123=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3121=0.0)

	(position counter#1::chewie_door_right_joint pstn3118=1.872)
	(position oven#1::knob_joint_3 pstn3122=0.0)
	(position faucet#1::joint_faucet_0 pstn3123=0.0)
	(position oven#1::knob_joint_2 pstn3121=0.0)
	(position counter#1::chewie_door_left_joint pstn3119=-1.872)
	(position fridge#1::fridge_door pstn3120=1.78)

	(pose pepper-shaker p21652=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p21651=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p21647=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p21648=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p21649=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))

	(isopenedposition counter#1::chewie_door_left_joint pstn3119=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3120=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn3118=1.872)

	(atpose pepper-shaker p21652=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p21647=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p21649=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(atpose chicken-leg p21648=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p21651=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p21652=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p21651=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p21649=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
	(supported braiserbody#1 p21650=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
