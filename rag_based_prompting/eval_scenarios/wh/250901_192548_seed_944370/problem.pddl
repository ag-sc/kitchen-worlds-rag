...
(define
  (problem test_kitchen_chicken_soup_250901_192548_seed_944370)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn1005=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1003=-1.872)
	(atposition oven#1::knob_joint_3 pstn1006=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1007=0.0)
	(atposition fridge#1::fridge_door pstn1004=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1002=1.872)
	(position fridge#1::fridge_door pstn1004=1.78)
	(position counter#1::chewie_door_right_joint pstn1002=1.872)
	(position faucet#1::joint_faucet_0 pstn1007=0.0)
	(position oven#1::knob_joint_2 pstn1005=0.0)
	(position counter#1::chewie_door_left_joint pstn1003=-1.872)
	(position oven#1::knob_joint_3 pstn1006=0.0)

	(isopenedposition fridge#1::fridge_door pstn1004=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1003=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1002=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn1007=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1005=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1006=0.0)

	(pose salt-shaker p11414=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p11411=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p11410=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p11415=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p11412=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))

	(atpose braiserlid#1 p11412=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(atpose braiserbody#1 p11410=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p11414=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p11415=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p11411=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p11415=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p11414=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p11412=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823) counter#1::front_left_stove)
	(supported braiserbody#1 p11413=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
