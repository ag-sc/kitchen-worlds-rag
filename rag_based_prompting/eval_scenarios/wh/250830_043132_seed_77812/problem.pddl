...
(define
  (problem test_kitchen_chicken_soup_250830_043132_seed_77812)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn31685=0.0)
	(position oven#1::knob_joint_3 pstn31684=0.0)
	(position counter#1::chewie_door_left_joint pstn31681=-1.872)
	(position oven#1::knob_joint_2 pstn31683=0.0)
	(position counter#1::chewie_door_right_joint pstn31680=1.872)
	(position fridge#1::fridge_door pstn31682=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn31683=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn31684=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn31685=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn31681=-1.872)
	(atposition oven#1::knob_joint_2 pstn31683=0.0)
	(atposition counter#1::chewie_door_right_joint pstn31680=1.872)
	(atposition fridge#1::fridge_door pstn31682=1.78)
	(atposition faucet#1::joint_faucet_0 pstn31685=0.0)
	(atposition oven#1::knob_joint_3 pstn31684=0.0)

	(pose pepper-shaker p62572=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p62569=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(pose chicken-leg p62568=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p62567=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p62571=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq864=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq608=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p62572=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p62568=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p62567=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p62569=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(atpose salt-shaker p62571=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_left_joint pstn31681=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn31680=1.872)
	(isopenedposition fridge#1::fridge_door pstn31682=1.78)

	(ataconf left aq864=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq608=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p62571=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p62572=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p62569=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125) counter#1::front_left_stove)
	(supported braiserbody#1 p62570=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
