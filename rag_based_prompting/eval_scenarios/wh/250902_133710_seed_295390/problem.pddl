...
(define
  (problem test_kitchen_chicken_soup_250902_133710_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn5294=0.0)
	(position counter#1::chewie_door_right_joint pstn5289=1.872)
	(position counter#1::chewie_door_left_joint pstn5290=-1.872)
	(position oven#1::knob_joint_2 pstn5292=0.0)
	(position fridge#1::fridge_door pstn5291=1.78)
	(position oven#1::knob_joint_3 pstn5293=0.0)

	(atposition faucet#1::joint_faucet_0 pstn5294=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5289=1.872)
	(atposition counter#1::chewie_door_left_joint pstn5290=-1.872)
	(atposition oven#1::knob_joint_2 pstn5292=0.0)
	(atposition fridge#1::fridge_door pstn5291=1.78)
	(atposition oven#1::knob_joint_3 pstn5293=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn5294=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5293=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5292=0.0)

	(pose braiserbody#1 p28298=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p28300=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(pose salt-shaker p28302=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p28303=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p28299=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p28299=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p28300=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(atpose salt-shaker p28302=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p28303=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p28298=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn5290=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5291=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5289=1.872)
	...
	(contained salt-shaker p28302=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p28303=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p28300=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
	(supported braiserbody#1 p28301=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
