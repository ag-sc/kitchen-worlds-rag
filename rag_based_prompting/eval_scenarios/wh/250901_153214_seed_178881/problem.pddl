...
(define
  (problem test_kitchen_chicken_soup_250901_153214_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn4291=0.0)
	(position counter#1::chewie_door_left_joint pstn4289=-1.872)
	(position faucet#1::joint_faucet_0 pstn4293=0.0)
	(position fridge#1::fridge_door pstn4290=1.78)
	(position counter#1::chewie_door_right_joint pstn4288=1.872)
	(position oven#1::knob_joint_3 pstn4292=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn4293=0.0)
	(atposition oven#1::knob_joint_2 pstn4291=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4288=1.872)
	(atposition counter#1::chewie_door_left_joint pstn4289=-1.872)
	(atposition fridge#1::fridge_door pstn4290=1.78)
	(atposition oven#1::knob_joint_3 pstn4292=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn4292=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4293=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4291=0.0)
	...
	(pose salt-shaker p13737=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p13733=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p13735=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose chicken-leg p13734=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p13738=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p13735=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose braiserbody#1 p13733=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p13737=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p13738=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p13734=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_left_joint pstn4289=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn4288=1.872)
	(isopenedposition fridge#1::fridge_door pstn4290=1.78)
	...
	(contained salt-shaker p13737=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p13738=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13736=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13735=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
