...
(define
  (problem test_kitchen_chicken_soup_250902_204540_seed_77812)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn18613=1.78)
	(position oven#1::knob_joint_2 pstn18614=0.0)
	(position counter#1::chewie_door_left_joint pstn18612=-1.872)
	(position oven#1::knob_joint_3 pstn18615=0.0)
	(position faucet#1::joint_faucet_0 pstn18616=0.0)
	(position counter#1::chewie_door_right_joint pstn18611=1.872)

	(atposition faucet#1::joint_faucet_0 pstn18616=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18611=1.872)
	(atposition fridge#1::fridge_door pstn18613=1.78)
	(atposition oven#1::knob_joint_2 pstn18614=0.0)
	(atposition counter#1::chewie_door_left_joint pstn18612=-1.872)
	(atposition oven#1::knob_joint_3 pstn18615=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn18615=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18614=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn18616=0.0)

	(pose salt-shaker p58578=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p58579=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p58574=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p58575=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p58576=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))

	(atpose pepper-shaker p58579=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p58575=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p58574=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p58576=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(atpose salt-shaker p58578=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn18611=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn18612=-1.872)
	(isopenedposition fridge#1::fridge_door pstn18613=1.78)
	...
	(contained salt-shaker p58578=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p58579=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p58577=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p58576=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125) counter#1::front_left_stove)
