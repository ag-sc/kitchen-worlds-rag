...
(define
  (problem test_kitchen_chicken_soup_250903_033630_seed_452553)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn26944=0.0)
	(atposition counter#1::chewie_door_left_joint pstn26941=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn26945=0.0)
	(atposition oven#1::knob_joint_2 pstn26943=0.0)
	(atposition fridge#1::fridge_door pstn26942=1.78)
	(atposition counter#1::chewie_door_right_joint pstn26940=1.872)
	(position fridge#1::fridge_door pstn26942=1.78)
	(position counter#1::chewie_door_right_joint pstn26940=1.872)
	(position oven#1::knob_joint_3 pstn26944=0.0)
	(position counter#1::chewie_door_left_joint pstn26941=-1.872)
	(position faucet#1::joint_faucet_0 pstn26945=0.0)
	(position oven#1::knob_joint_2 pstn26943=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn26943=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn26944=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn26945=0.0)

	(isopenedposition fridge#1::fridge_door pstn26942=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn26940=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn26941=-1.872)

	(pose braiserlid#1 p88983=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(pose pepper-shaker p88986=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p88985=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p88981=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p88982=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p88983=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(atpose salt-shaker p88985=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p88986=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p88981=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p88982=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p88986=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p88985=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p88984=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p88983=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452) counter#1::front_left_stove)
