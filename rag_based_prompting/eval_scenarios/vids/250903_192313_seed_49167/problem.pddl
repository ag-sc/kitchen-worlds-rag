...
(define
  (problem test_kitchen_chicken_soup_250903_192313_seed_49167)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn965=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn964=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn963=0.0)

	(position counter#1::chewie_door_right_joint pstn960=1.872)
	(position oven#1::knob_joint_2 pstn963=0.0)
	(position counter#1::chewie_door_left_joint pstn961=-1.872)
	(position faucet#1::joint_faucet_0 pstn965=0.0)
	(position oven#1::knob_joint_3 pstn964=0.0)
	(position fridge#1::fridge_door pstn962=1.78)

	(atposition counter#1::chewie_door_right_joint pstn960=1.872)
	(atposition oven#1::knob_joint_2 pstn963=0.0)
	(atposition counter#1::chewie_door_left_joint pstn961=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn965=0.0)
	(atposition oven#1::knob_joint_3 pstn964=0.0)
	(atposition fridge#1::fridge_door pstn962=1.78)

	(pose braiserlid#1 p1630=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102))
	(pose braiserbody#1 p1628=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p1629=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p1632=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p1633=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p1632=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1628=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p1629=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p1630=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102))
	(atpose pepper-shaker p1633=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn960=1.872)
	(isopenedposition fridge#1::fridge_door pstn962=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn961=-1.872)
	...
	(contained pepper-shaker p1633=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1632=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p1630=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102) counter#1::front_left_stove)
	(supported braiserbody#1 p1631=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
