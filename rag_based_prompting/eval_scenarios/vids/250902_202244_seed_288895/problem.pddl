...
(define
  (problem test_kitchen_chicken_soup_250902_202244_seed_288895)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn18408=0.0)
	(position oven#1::knob_joint_2 pstn18407=0.0)
	(position fridge#1::fridge_door pstn18406=1.78)
	(position faucet#1::joint_faucet_0 pstn18409=0.0)
	(position counter#1::chewie_door_right_joint pstn18404=1.872)
	(position counter#1::chewie_door_left_joint pstn18405=-1.872)
	...
	(atposition oven#1::knob_joint_3 pstn18408=0.0)
	(atposition oven#1::knob_joint_2 pstn18407=0.0)
	(atposition fridge#1::fridge_door pstn18406=1.78)
	(atposition faucet#1::joint_faucet_0 pstn18409=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18404=1.872)
	(atposition counter#1::chewie_door_left_joint pstn18405=-1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn18406=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn18404=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn18405=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn18409=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18407=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn18408=0.0)

	(atpose braiserbody#1 p56291=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p56296=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p56292=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p56295=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p56293=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(pose salt-shaker p56295=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p56293=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(pose braiserbody#1 p56291=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p56296=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p56292=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p56295=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p56296=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p56294=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p56293=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247) counter#1::front_left_stove)
