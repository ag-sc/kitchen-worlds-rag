...
(define
  (problem test_kitchen_chicken_soup_250904_014934_seed_709159)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn3546=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3541=1.872)
	(atposition oven#1::knob_joint_3 pstn3545=0.0)
	(atposition fridge#1::fridge_door pstn3543=1.78)
	(atposition oven#1::knob_joint_2 pstn3544=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3542=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn3546=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3545=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3544=0.0)

	(position counter#1::chewie_door_left_joint pstn3542=-1.872)
	(position faucet#1::joint_faucet_0 pstn3546=0.0)
	(position counter#1::chewie_door_right_joint pstn3541=1.872)
	(position oven#1::knob_joint_3 pstn3545=0.0)
	(position fridge#1::fridge_door pstn3543=1.78)
	(position oven#1::knob_joint_2 pstn3544=0.0)

	(pose chicken-leg p12415=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p12414=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p12419=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p12416=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(pose salt-shaker p12418=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p12415=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p12414=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p12419=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p12416=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(atpose salt-shaker p12418=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn3542=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn3541=1.872)
	(isopenedposition fridge#1::fridge_door pstn3543=1.78)
	...
	(contained salt-shaker p12418=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12419=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p12416=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44) counter#1::front_left_stove)
	(supported braiserbody#1 p12417=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
