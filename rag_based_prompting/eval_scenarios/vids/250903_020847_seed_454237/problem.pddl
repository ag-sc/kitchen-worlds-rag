...
(define
  (problem test_kitchen_chicken_soup_250903_020847_seed_454237)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn25536=0.0)
	(position counter#1::chewie_door_left_joint pstn25533=-1.872)
	(position fridge#1::fridge_door pstn25534=1.78)
	(position oven#1::knob_joint_2 pstn25535=0.0)
	(position counter#1::chewie_door_right_joint pstn25532=1.872)
	(position faucet#1::joint_faucet_0 pstn25537=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn25537=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn25536=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn25535=0.0)

	(atposition counter#1::chewie_door_left_joint pstn25533=-1.872)
	(atposition fridge#1::fridge_door pstn25534=1.78)
	(atposition oven#1::knob_joint_2 pstn25535=0.0)
	(atposition counter#1::chewie_door_right_joint pstn25532=1.872)
	(atposition faucet#1::joint_faucet_0 pstn25537=0.0)
	(atposition oven#1::knob_joint_3 pstn25536=0.0)

	(atpose salt-shaker p82688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p82684=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p82686=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129))
	(atpose chicken-leg p82685=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p82689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p82689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p82686=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129))
	(pose salt-shaker p82688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p82684=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p82685=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq736=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn25533=-1.872)
	(isopenedposition fridge#1::fridge_door pstn25534=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn25532=1.872)

	(ataconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq736=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p82688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p82689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p82686=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129) counter#1::front_left_stove)
	(supported braiserbody#1 p82687=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
