...
(define
  (problem test_kitchen_chicken_soup_250903_045429_seed_280147)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn28864=0.0)
	(position fridge#1::fridge_door pstn28862=1.78)
	(position counter#1::chewie_door_right_joint pstn28860=1.872)
	(position faucet#1::joint_faucet_0 pstn28865=0.0)
	(position oven#1::knob_joint_2 pstn28863=0.0)
	(position counter#1::chewie_door_left_joint pstn28861=-1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn28862=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn28861=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn28860=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn28865=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn28864=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn28863=0.0)

	(atposition counter#1::chewie_door_left_joint pstn28861=-1.872)
	(atposition oven#1::knob_joint_3 pstn28864=0.0)
	(atposition fridge#1::fridge_door pstn28862=1.78)
	(atposition counter#1::chewie_door_right_joint pstn28860=1.872)
	(atposition faucet#1::joint_faucet_0 pstn28865=0.0)
	(atposition oven#1::knob_joint_2 pstn28863=0.0)

	(pose braiserlid#1 p94152=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	(pose pepper-shaker p94155=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p94150=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p94151=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p94154=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p94150=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p94152=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	(atpose pepper-shaker p94155=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p94151=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p94154=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p94155=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p94154=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p94153=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p94152=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667) counter#1::front_left_stove)
