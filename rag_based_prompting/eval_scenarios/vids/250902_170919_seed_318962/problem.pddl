...
(define
  (problem test_kitchen_chicken_soup_250902_170919_seed_318962)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn13260=0.0)
	(atposition fridge#1::fridge_door pstn13259=1.78)
	(atposition counter#1::chewie_door_right_joint pstn13257=1.872)
	(atposition oven#1::knob_joint_3 pstn13261=0.0)
	(atposition counter#1::chewie_door_left_joint pstn13258=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn13262=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn13260=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13261=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13262=0.0)

	(position counter#1::chewie_door_left_joint pstn13258=-1.872)
	(position faucet#1::joint_faucet_0 pstn13262=0.0)
	(position oven#1::knob_joint_2 pstn13260=0.0)
	(position fridge#1::fridge_door pstn13259=1.78)
	(position counter#1::chewie_door_right_joint pstn13257=1.872)
	(position oven#1::knob_joint_3 pstn13261=0.0)

	(pose chicken-leg p43152=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p43151=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p43153=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79))
	(pose salt-shaker p43155=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p43156=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p43153=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79))
	(atpose braiserbody#1 p43151=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p43155=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p43156=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p43152=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq184=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn13258=-1.872)
	(isopenedposition fridge#1::fridge_door pstn13259=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn13257=1.872)

	(ataconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq184=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p43155=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p43156=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p43154=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p43153=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79) counter#1::front_left_stove)
