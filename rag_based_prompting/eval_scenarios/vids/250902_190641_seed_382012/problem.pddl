...
(define
  (problem test_kitchen_chicken_soup_250902_190641_seed_382012)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn16425=0.0)
	(atposition fridge#1::fridge_door pstn16424=1.78)
	(atposition counter#1::chewie_door_left_joint pstn16423=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn16422=1.872)
	(atposition oven#1::knob_joint_3 pstn16426=0.0)
	(atposition faucet#1::joint_faucet_0 pstn16427=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn16426=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16427=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16425=0.0)

	(isopenedposition fridge#1::fridge_door pstn16424=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn16423=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16422=1.872)

	(position counter#1::chewie_door_right_joint pstn16422=1.872)
	(position oven#1::knob_joint_3 pstn16426=0.0)
	(position faucet#1::joint_faucet_0 pstn16427=0.0)
	(position oven#1::knob_joint_2 pstn16425=0.0)
	(position fridge#1::fridge_door pstn16424=1.78)
	(position counter#1::chewie_door_left_joint pstn16423=-1.872)

	(pose braiserlid#1 p52279=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(pose chicken-leg p52278=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p52281=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p52277=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p52282=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p52278=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p52277=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p52282=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p52279=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(atpose salt-shaker p52281=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p52281=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p52282=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p52279=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928) counter#1::front_left_stove)
	(supported braiserbody#1 p52280=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
