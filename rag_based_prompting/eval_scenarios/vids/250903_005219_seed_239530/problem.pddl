...
(define
  (problem test_kitchen_chicken_soup_250903_005219_seed_239530)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn24128=0.0)
	(position oven#1::knob_joint_2 pstn24127=0.0)
	(position faucet#1::joint_faucet_0 pstn24129=0.0)
	(position counter#1::chewie_door_left_joint pstn24125=-1.872)
	(position fridge#1::fridge_door pstn24126=1.78)
	(position counter#1::chewie_door_right_joint pstn24124=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn24128=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24127=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24129=0.0)

	(atposition counter#1::chewie_door_left_joint pstn24125=-1.872)
	(atposition fridge#1::fridge_door pstn24126=1.78)
	(atposition counter#1::chewie_door_right_joint pstn24124=1.872)
	(atposition oven#1::knob_joint_3 pstn24128=0.0)
	(atposition oven#1::knob_joint_2 pstn24127=0.0)
	(atposition faucet#1::joint_faucet_0 pstn24129=0.0)

	(pose pepper-shaker p75741=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p75738=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(pose braiserbody#1 p75736=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p75737=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p75740=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p75741=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p75738=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(atpose chicken-leg p75737=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p75740=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p75736=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn24125=-1.872)
	(isopenedposition fridge#1::fridge_door pstn24126=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn24124=1.872)
	...
	(contained salt-shaker p75740=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p75741=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p75739=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p75738=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285) counter#1::front_left_stove)
