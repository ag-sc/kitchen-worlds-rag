...
(define
  (problem test_kitchen_chicken_soup_250902_165256_seed_25295)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn12486=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12487=0.0)
	(atposition fridge#1::fridge_door pstn12484=1.78)
	(atposition counter#1::chewie_door_right_joint pstn12482=1.872)
	(atposition oven#1::knob_joint_2 pstn12485=0.0)
	(atposition counter#1::chewie_door_left_joint pstn12483=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn12486=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12485=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12487=0.0)

	(isopenedposition fridge#1::fridge_door pstn12484=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12482=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn12483=-1.872)

	(position counter#1::chewie_door_right_joint pstn12482=1.872)
	(position oven#1::knob_joint_2 pstn12485=0.0)
	(position counter#1::chewie_door_left_joint pstn12483=-1.872)
	(position oven#1::knob_joint_3 pstn12486=0.0)
	(position faucet#1::joint_faucet_0 pstn12487=0.0)
	(position fridge#1::fridge_door pstn12484=1.78)

	(pose pepper-shaker p42790=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p42787=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(pose chicken-leg p42786=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p42789=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p42785=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p42787=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(atpose pepper-shaker p42790=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p42785=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p42786=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p42789=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p42790=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p42789=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p42788=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p42787=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662) counter#1::front_left_stove)
