...
(define
  (problem test_kitchen_chicken_soup_250903_203900_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn4122=1.78)
	(atposition counter#1::chewie_door_right_joint pstn4120=1.872)
	(atposition oven#1::knob_joint_2 pstn4123=0.0)
	(atposition oven#1::knob_joint_3 pstn4124=0.0)
	(atposition faucet#1::joint_faucet_0 pstn4125=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4121=-1.872)

	(isclosedposition oven#1::knob_joint_3 pstn4124=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4125=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4123=0.0)

	(position counter#1::chewie_door_right_joint pstn4120=1.872)
	(position oven#1::knob_joint_2 pstn4123=0.0)
	(position oven#1::knob_joint_3 pstn4124=0.0)
	(position faucet#1::joint_faucet_0 pstn4125=0.0)
	(position counter#1::chewie_door_left_joint pstn4121=-1.872)
	(position fridge#1::fridge_door pstn4122=1.78)

	(pose braiserbody#1 p12279=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p12280=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p12284=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p12281=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(pose salt-shaker p12283=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn4121=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4122=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4120=1.872)

	(aconf left aq592=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq384=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p12284=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p12281=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(atpose chicken-leg p12280=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p12283=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p12279=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))

	(ataconf left aq592=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq384=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p12283=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12284=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p12281=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
	(supported braiserbody#1 p12282=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
