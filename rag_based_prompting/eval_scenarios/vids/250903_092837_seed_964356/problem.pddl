...
(define
  (problem test_kitchen_chicken_soup_250903_092837_seed_964356)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn34824=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn34825=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn34826=0.0)

	(position counter#1::chewie_door_right_joint pstn34821=1.872)
	(position oven#1::knob_joint_3 pstn34825=0.0)
	(position oven#1::knob_joint_2 pstn34824=0.0)
	(position counter#1::chewie_door_left_joint pstn34822=-1.872)
	(position faucet#1::joint_faucet_0 pstn34826=0.0)
	(position fridge#1::fridge_door pstn34823=1.78)

	(atposition counter#1::chewie_door_left_joint pstn34822=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn34826=0.0)
	(atposition fridge#1::fridge_door pstn34823=1.78)
	(atposition counter#1::chewie_door_right_joint pstn34821=1.872)
	(atposition oven#1::knob_joint_3 pstn34825=0.0)
	(atposition oven#1::knob_joint_2 pstn34824=0.0)

	(pose chicken-leg p110326=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p110327=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318))
	(pose salt-shaker p110329=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p110330=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p110325=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p110327=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318))
	(atpose salt-shaker p110329=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p110330=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p110325=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p110326=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn34821=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn34822=-1.872)
	(isopenedposition fridge#1::fridge_door pstn34823=1.78)
	...
	(contained salt-shaker p110329=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p110330=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p110328=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p110327=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318) counter#1::front_left_stove)
