...
(define
  (problem test_kitchen_chicken_soup_250902_181719_seed_411808)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn15224=0.0)
	(position counter#1::chewie_door_right_joint pstn15221=1.872)
	(position fridge#1::fridge_door pstn15223=1.78)
	(position oven#1::knob_joint_3 pstn15225=0.0)
	(position faucet#1::joint_faucet_0 pstn15226=0.0)
	(position counter#1::chewie_door_left_joint pstn15222=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15225=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15224=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15226=0.0)

	(isopenedposition fridge#1::fridge_door pstn15223=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn15221=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15222=-1.872)

	(atposition counter#1::chewie_door_right_joint pstn15221=1.872)
	(atposition fridge#1::fridge_door pstn15223=1.78)
	(atposition oven#1::knob_joint_3 pstn15225=0.0)
	(atposition faucet#1::joint_faucet_0 pstn15226=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15222=-1.872)
	(atposition oven#1::knob_joint_2 pstn15224=0.0)

	(atpose braiserbody#1 p48542=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p48544=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(atpose chicken-leg p48543=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p48546=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p48547=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p48547=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p48543=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p48542=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p48544=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(pose salt-shaker p48546=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p48547=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p48546=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p48545=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p48544=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148) counter#1::front_left_stove)
