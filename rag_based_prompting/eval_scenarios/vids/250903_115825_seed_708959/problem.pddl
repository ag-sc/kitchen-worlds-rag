...
(define
  (problem test_kitchen_chicken_soup_250903_115825_seed_708959)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn38895=0.0)
	(position faucet#1::joint_faucet_0 pstn38897=0.0)
	(position fridge#1::fridge_door pstn38894=1.78)
	(position oven#1::knob_joint_3 pstn38896=0.0)
	(position counter#1::chewie_door_left_joint pstn38893=-1.872)
	(position counter#1::chewie_door_right_joint pstn38892=1.872)
	...
	(atposition oven#1::knob_joint_3 pstn38896=0.0)
	(atposition counter#1::chewie_door_left_joint pstn38893=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn38892=1.872)
	(atposition oven#1::knob_joint_2 pstn38895=0.0)
	(atposition faucet#1::joint_faucet_0 pstn38897=0.0)
	(atposition fridge#1::fridge_door pstn38894=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn38897=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn38895=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn38896=0.0)

	(pose salt-shaker p116180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p116177=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p116176=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p116178=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(pose pepper-shaker p116181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p116180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p116177=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p116178=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(atpose braiserbody#1 p116176=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p116181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn38893=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn38892=1.872)
	(isopenedposition fridge#1::fridge_door pstn38894=1.78)
	...
	(contained salt-shaker p116180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p116181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p116178=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278) counter#1::front_left_stove)
	(supported braiserbody#1 p116179=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
