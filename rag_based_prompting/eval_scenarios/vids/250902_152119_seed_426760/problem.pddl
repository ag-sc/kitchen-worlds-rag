...
(define
  (problem test_kitchen_chicken_soup_250902_152119_seed_426760)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn9545=0.0)
	(atposition faucet#1::joint_faucet_0 pstn9547=0.0)
	(atposition fridge#1::fridge_door pstn9544=1.78)
	(atposition counter#1::chewie_door_right_joint pstn9542=1.872)
	(atposition oven#1::knob_joint_3 pstn9546=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9543=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn9545=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9546=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9547=0.0)

	(position counter#1::chewie_door_right_joint pstn9542=1.872)
	(position oven#1::knob_joint_3 pstn9546=0.0)
	(position counter#1::chewie_door_left_joint pstn9543=-1.872)
	(position oven#1::knob_joint_2 pstn9545=0.0)
	(position faucet#1::joint_faucet_0 pstn9547=0.0)
	(position fridge#1::fridge_door pstn9544=1.78)

	(pose braiserlid#1 p34939=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352))
	(pose braiserbody#1 p34937=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p34942=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p34938=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p34941=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p34937=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p34939=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352))
	(atpose pepper-shaker p34942=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p34938=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p34941=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn9543=-1.872)
	(isopenedposition fridge#1::fridge_door pstn9544=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn9542=1.872)
	...
	(contained salt-shaker p34941=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p34942=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p34939=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352) counter#1::front_left_stove)
	(supported braiserbody#1 p34940=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
