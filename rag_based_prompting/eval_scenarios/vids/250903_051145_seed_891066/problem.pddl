...
(define
  (problem test_kitchen_chicken_soup_250903_051145_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn29071=0.0)
	(position counter#1::chewie_door_left_joint pstn29068=-1.872)
	(position counter#1::chewie_door_right_joint pstn29067=1.872)
	(position fridge#1::fridge_door pstn29069=1.78)
	(position faucet#1::joint_faucet_0 pstn29072=0.0)
	(position oven#1::knob_joint_2 pstn29070=0.0)
	...
	(atposition fridge#1::fridge_door pstn29069=1.78)
	(atposition faucet#1::joint_faucet_0 pstn29072=0.0)
	(atposition oven#1::knob_joint_2 pstn29070=0.0)
	(atposition oven#1::knob_joint_3 pstn29071=0.0)
	(atposition counter#1::chewie_door_left_joint pstn29068=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn29067=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn29071=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn29070=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn29072=0.0)

	(pose salt-shaker p96127=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p96123=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p96128=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p96125=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose chicken-leg p96124=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p96127=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p96123=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p96125=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose pepper-shaker p96128=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p96124=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq888=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq552=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn29068=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn29067=1.872)
	(isopenedposition fridge#1::fridge_door pstn29069=1.78)

	(ataconf left aq888=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq552=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p96127=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p96128=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p96125=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)
	(supported braiserbody#1 p96126=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
