...
(define
  (problem test_kitchen_chicken_soup_250902_145238_seed_455268)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn8577=0.0)
	(atposition fridge#1::fridge_door pstn8574=1.78)
	(atposition oven#1::knob_joint_2 pstn8575=0.0)
	(atposition oven#1::knob_joint_3 pstn8576=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8572=1.872)
	(atposition counter#1::chewie_door_left_joint pstn8573=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn8575=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8577=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8576=0.0)

	(position counter#1::chewie_door_left_joint pstn8573=-1.872)
	(position faucet#1::joint_faucet_0 pstn8577=0.0)
	(position fridge#1::fridge_door pstn8574=1.78)
	(position oven#1::knob_joint_2 pstn8575=0.0)
	(position oven#1::knob_joint_3 pstn8576=0.0)
	(position counter#1::chewie_door_right_joint pstn8572=1.872)

	(pose braiserlid#1 p32519=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279))
	(pose salt-shaker p32521=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p32522=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p32518=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p32517=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p32519=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279))
	(atpose salt-shaker p32521=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p32522=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p32518=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p32517=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn8573=-1.872)
	(isopenedposition fridge#1::fridge_door pstn8574=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn8572=1.872)
	...
	(contained pepper-shaker p32522=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p32521=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p32520=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p32519=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279) counter#1::front_left_stove)
