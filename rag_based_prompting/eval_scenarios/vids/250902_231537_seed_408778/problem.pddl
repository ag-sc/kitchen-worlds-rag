...
(define
  (problem test_kitchen_chicken_soup_250902_231537_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn22505=1.78)
	(atposition oven#1::knob_joint_2 pstn22506=0.0)
	(atposition counter#1::chewie_door_left_joint pstn22504=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn22503=1.872)
	(atposition faucet#1::joint_faucet_0 pstn22508=0.0)
	(atposition oven#1::knob_joint_3 pstn22507=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn22506=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn22508=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn22507=0.0)

	(isopenedposition fridge#1::fridge_door pstn22505=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn22504=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn22503=1.872)

	(position counter#1::chewie_door_right_joint pstn22503=1.872)
	(position faucet#1::joint_faucet_0 pstn22508=0.0)
	(position oven#1::knob_joint_3 pstn22507=0.0)
	(position fridge#1::fridge_door pstn22505=1.78)
	(position oven#1::knob_joint_2 pstn22506=0.0)
	(position counter#1::chewie_door_left_joint pstn22504=-1.872)

	(pose braiserbody#1 p67832=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p67833=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p67836=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p67837=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p67834=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))

	(atpose braiserbody#1 p67832=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p67836=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p67833=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p67834=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(atpose pepper-shaker p67837=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p67836=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p67837=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p67834=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
	(supported braiserbody#1 p67835=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
