...
(define
  (problem test_kitchen_chicken_soup_250903_211025_seed_190390)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn4585=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4580=1.872)
	(atposition fridge#1::fridge_door pstn4582=1.78)
	(atposition counter#1::chewie_door_left_joint pstn4581=-1.872)
	(atposition oven#1::knob_joint_3 pstn4584=0.0)
	(atposition oven#1::knob_joint_2 pstn4583=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn4583=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4584=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4585=0.0)

	(position counter#1::chewie_door_right_joint pstn4580=1.872)
	(position fridge#1::fridge_door pstn4582=1.78)
	(position oven#1::knob_joint_3 pstn4584=0.0)
	(position counter#1::chewie_door_left_joint pstn4581=-1.872)
	(position faucet#1::joint_faucet_0 pstn4585=0.0)
	(position oven#1::knob_joint_2 pstn4583=0.0)

	(pose braiserlid#1 p14899=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(pose braiserbody#1 p14897=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p14901=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p14902=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p14898=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn4581=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn4580=1.872)
	(isopenedposition fridge#1::fridge_door pstn4582=1.78)

	(atpose pepper-shaker p14902=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p14899=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(atpose chicken-leg p14898=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p14901=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14897=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p14902=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p14901=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14899=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928) counter#1::front_left_stove)
	(supported braiserbody#1 p14900=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
