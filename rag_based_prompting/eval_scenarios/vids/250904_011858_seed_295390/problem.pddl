...
(define
  (problem test_kitchen_chicken_soup_250904_011858_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn2314=0.0)
	(position faucet#1::joint_faucet_0 pstn2315=0.0)
	(position counter#1::chewie_door_left_joint pstn2311=-1.872)
	(position fridge#1::fridge_door pstn2312=1.78)
	(position oven#1::knob_joint_2 pstn2313=0.0)
	(position counter#1::chewie_door_right_joint pstn2310=1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn2315=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2311=-1.872)
	(atposition fridge#1::fridge_door pstn2312=1.78)
	(atposition oven#1::knob_joint_2 pstn2313=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2310=1.872)
	(atposition oven#1::knob_joint_3 pstn2314=0.0)

	(isclosedposition faucet#1::joint_faucet_0 pstn2315=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2313=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2314=0.0)

	(pose braiserlid#1 p9496=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(pose braiserbody#1 p9494=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p9495=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p9498=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p9499=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p9498=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p9494=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p9495=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p9499=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p9496=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))

	(isopenedposition counter#1::chewie_door_right_joint pstn2310=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn2311=-1.872)
	(isopenedposition fridge#1::fridge_door pstn2312=1.78)
	...
	(contained pepper-shaker p9499=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p9498=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p9497=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p9496=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
