...
(define
  (problem test_kitchen_chicken_soup_250903_001239_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn23138=1.78)
	(atposition counter#1::chewie_door_left_joint pstn23137=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn23141=0.0)
	(atposition oven#1::knob_joint_2 pstn23139=0.0)
	(atposition oven#1::knob_joint_3 pstn23140=0.0)
	(atposition counter#1::chewie_door_right_joint pstn23136=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn23141=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn23140=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn23139=0.0)

	(position counter#1::chewie_door_left_joint pstn23137=-1.872)
	(position faucet#1::joint_faucet_0 pstn23141=0.0)
	(position oven#1::knob_joint_2 pstn23139=0.0)
	(position oven#1::knob_joint_3 pstn23140=0.0)
	(position counter#1::chewie_door_right_joint pstn23136=1.872)
	(position fridge#1::fridge_door pstn23138=1.78)

	(pose braiserlid#1 p73083=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(pose salt-shaker p73085=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p73082=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p73081=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p73086=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p73082=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p73081=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p73086=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p73083=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(atpose salt-shaker p73085=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn23136=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn23137=-1.872)
	(isopenedposition fridge#1::fridge_door pstn23138=1.78)
	...
	(contained salt-shaker p73085=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p73086=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p73084=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p73083=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
