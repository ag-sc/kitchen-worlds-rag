...
(define
  (problem test_kitchen_chicken_soup_250904_010640_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1472=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1470=1.872)
	(atposition oven#1::knob_joint_2 pstn1473=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1471=-1.872)
	(atposition oven#1::knob_joint_3 pstn1474=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1475=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn1473=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1474=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1475=0.0)

	(isopenedposition fridge#1::fridge_door pstn1472=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1470=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1471=-1.872)

	(position counter#1::chewie_door_left_joint pstn1471=-1.872)
	(position fridge#1::fridge_door pstn1472=1.78)
	(position counter#1::chewie_door_right_joint pstn1470=1.872)
	(position oven#1::knob_joint_2 pstn1473=0.0)
	(position oven#1::knob_joint_3 pstn1474=0.0)
	(position faucet#1::joint_faucet_0 pstn1475=0.0)

	(atpose salt-shaker p7881=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p7877=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p7878=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p7879=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(atpose pepper-shaker p7882=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p7882=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p7877=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p7881=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p7878=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p7879=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	...
	(contained pepper-shaker p7882=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p7881=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p7879=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
	(supported braiserbody#1 p7880=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
