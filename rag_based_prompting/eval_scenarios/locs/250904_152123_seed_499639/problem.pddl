...
(define
  (problem test_kitchen_chicken_soup_250904_152123_seed_499639)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn8281=0.0)
	(atposition fridge#1::fridge_door pstn8279=1.78)
	(atposition counter#1::chewie_door_right_joint pstn8277=1.872)
	(atposition faucet#1::joint_faucet_0 pstn8282=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8278=-1.872)
	(atposition oven#1::knob_joint_2 pstn8280=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn8281=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8280=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8282=0.0)

	(position counter#1::chewie_door_right_joint pstn8277=1.872)
	(position faucet#1::joint_faucet_0 pstn8282=0.0)
	(position counter#1::chewie_door_left_joint pstn8278=-1.872)
	(position fridge#1::fridge_door pstn8279=1.78)
	(position oven#1::knob_joint_2 pstn8280=0.0)
	(position oven#1::knob_joint_3 pstn8281=0.0)

	(pose chicken-leg p30910=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p30911=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(pose salt-shaker p30913=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p30909=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p30914=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn8277=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn8278=-1.872)
	(isopenedposition fridge#1::fridge_door pstn8279=1.78)

	(aconf left aq112=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq872=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p30914=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p30909=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p30910=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p30911=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(atpose salt-shaker p30913=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(ataconf left aq112=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq872=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p30914=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p30913=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p30912=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p30911=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531) counter#1::front_left_stove)
