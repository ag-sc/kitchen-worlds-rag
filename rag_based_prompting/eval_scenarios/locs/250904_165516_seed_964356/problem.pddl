...
(define
  (problem test_kitchen_chicken_soup_250904_165516_seed_964356)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn10012=0.0)
	(position fridge#1::fridge_door pstn10011=1.78)
	(position faucet#1::joint_faucet_0 pstn10014=0.0)
	(position counter#1::chewie_door_left_joint pstn10010=-1.872)
	(position counter#1::chewie_door_right_joint pstn10009=1.872)
	(position oven#1::knob_joint_3 pstn10013=0.0)

	(atposition oven#1::knob_joint_2 pstn10012=0.0)
	(atposition oven#1::knob_joint_3 pstn10013=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10010=-1.872)
	(atposition fridge#1::fridge_door pstn10011=1.78)
	(atposition counter#1::chewie_door_right_joint pstn10009=1.872)
	(atposition faucet#1::joint_faucet_0 pstn10014=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn10012=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10014=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10013=0.0)

	(pose pepper-shaker p40459=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p40455=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p40454=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p40458=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p40456=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318))

	(atpose pepper-shaker p40459=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p40455=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p40458=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p40454=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p40456=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318))
	(isopenedposition counter#1::chewie_door_right_joint pstn10009=1.872)
	(isopenedposition fridge#1::fridge_door pstn10011=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn10010=-1.872)
	...
	(contained salt-shaker p40458=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p40459=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p40456=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318) counter#1::front_left_stove)
	(supported braiserbody#1 p40457=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
