...
(define
  (problem test_kitchen_chicken_soup_250904_105023_seed_239530)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn2647=0.0)
	(position counter#1::chewie_door_left_joint pstn2645=-1.872)
	(position counter#1::chewie_door_right_joint pstn2644=1.872)
	(position oven#1::knob_joint_3 pstn2648=0.0)
	(position faucet#1::joint_faucet_0 pstn2649=0.0)
	(position fridge#1::fridge_door pstn2646=1.78)

	(atposition faucet#1::joint_faucet_0 pstn2649=0.0)
	(atposition oven#1::knob_joint_3 pstn2648=0.0)
	(atposition oven#1::knob_joint_2 pstn2647=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2645=-1.872)
	(atposition fridge#1::fridge_door pstn2646=1.78)
	(atposition counter#1::chewie_door_right_joint pstn2644=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn2649=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2647=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2648=0.0)

	(pose salt-shaker p5930=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p5928=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(pose chicken-leg p5927=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p5926=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5931=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p5930=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p5928=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(atpose chicken-leg p5927=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p5926=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	...
	(isopenedposition counter#1::chewie_door_right_joint pstn2644=1.872)
	(isopenedposition fridge#1::fridge_door pstn2646=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2645=-1.872)
	...
	(supported braiserlid#1 p5928=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285) counter#1::front_left_stove)
	(supported braiserbody#1 p5929=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
