...
(define
  (problem test_kitchen_chicken_soup_250904_213513_seed_190390)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn15984=0.0)
	(position counter#1::chewie_door_left_joint pstn15980=-1.872)
	(position fridge#1::fridge_door pstn15981=1.78)
	(position counter#1::chewie_door_right_joint pstn15979=1.872)
	(position oven#1::knob_joint_3 pstn15983=0.0)
	(position oven#1::knob_joint_2 pstn15982=0.0)

	(atposition faucet#1::joint_faucet_0 pstn15984=0.0)
	(atposition oven#1::knob_joint_2 pstn15982=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15980=-1.872)
	(atposition oven#1::knob_joint_3 pstn15983=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15979=1.872)
	(atposition fridge#1::fridge_door pstn15981=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15983=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15984=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15982=0.0)

	(pose braiserbody#1 p58250=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p58251=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p58254=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p58252=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(pose pepper-shaker p58255=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p58250=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p58251=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p58255=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p58254=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p58252=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))

	(isopenedposition counter#1::chewie_door_right_joint pstn15979=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15980=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15981=1.78)
	...
	(contained salt-shaker p58254=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p58255=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p58252=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928) counter#1::front_left_stove)
	(supported braiserbody#1 p58253=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
