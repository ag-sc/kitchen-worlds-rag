...
(define
  (problem test_kitchen_chicken_soup_250904_025105_seed_426760)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn5539=0.0)
	(atposition oven#1::knob_joint_3 pstn5540=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5537=-1.872)
	(atposition fridge#1::fridge_door pstn5538=1.78)
	(atposition faucet#1::joint_faucet_0 pstn5541=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5536=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn5539=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5540=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5541=0.0)

	(position counter#1::chewie_door_left_joint pstn5537=-1.872)
	(position counter#1::chewie_door_right_joint pstn5536=1.872)
	(position fridge#1::fridge_door pstn5538=1.78)
	(position oven#1::knob_joint_2 pstn5539=0.0)
	(position faucet#1::joint_faucet_0 pstn5541=0.0)
	(position oven#1::knob_joint_3 pstn5540=0.0)

	(pose salt-shaker p19746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p19747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p19742=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p19744=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352))
	(pose chicken-leg p19743=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p19743=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p19742=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p19744=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352))
	(atpose salt-shaker p19746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p19747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn5537=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn5536=1.872)
	(isopenedposition fridge#1::fridge_door pstn5538=1.78)
	...
	(contained pepper-shaker p19747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p19746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p19745=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p19744=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352) counter#1::front_left_stove)
