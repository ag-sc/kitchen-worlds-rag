...
(define
  (problem test_kitchen_chicken_soup_250904_055910_seed_798018)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn11671=0.0)
	(position counter#1::chewie_door_right_joint pstn11667=1.872)
	(position counter#1::chewie_door_left_joint pstn11668=-1.872)
	(position faucet#1::joint_faucet_0 pstn11672=0.0)
	(position oven#1::knob_joint_2 pstn11670=0.0)
	(position fridge#1::fridge_door pstn11669=1.78)
	...
	(atposition oven#1::knob_joint_3 pstn11671=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11667=1.872)
	(atposition counter#1::chewie_door_left_joint pstn11668=-1.872)
	(atposition oven#1::knob_joint_2 pstn11670=0.0)
	(atposition faucet#1::joint_faucet_0 pstn11672=0.0)
	(atposition fridge#1::fridge_door pstn11669=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn11671=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11672=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11670=0.0)

	(isopenedposition fridge#1::fridge_door pstn11669=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11667=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11668=-1.872)

	(pose braiserbody#1 p35831=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p35836=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p35835=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p35833=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose chicken-leg p35832=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose pepper-shaker p35836=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p35835=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p35833=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose braiserbody#1 p35831=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p35832=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p35835=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p35836=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p35834=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p35833=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
