...
(define
  (problem test_kitchen_chicken_soup_250904_111629_seed_662398)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn3320=1.78)
	(position oven#1::knob_joint_2 pstn3321=0.0)
	(position oven#1::knob_joint_3 pstn3322=0.0)
	(position faucet#1::joint_faucet_0 pstn3323=0.0)
	(position counter#1::chewie_door_left_joint pstn3319=-1.872)
	(position counter#1::chewie_door_right_joint pstn3318=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn3322=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3321=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3323=0.0)

	(isopenedposition fridge#1::fridge_door pstn3320=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn3318=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3319=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn3319=-1.872)
	(atposition oven#1::knob_joint_3 pstn3322=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3318=1.872)
	(atposition fridge#1::fridge_door pstn3320=1.78)
	(atposition oven#1::knob_joint_2 pstn3321=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3323=0.0)

	(pose braiserlid#1 p8200=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(pose braiserbody#1 p8198=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p8199=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p8203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p8202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p8200=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(atpose chicken-leg p8199=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p8198=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p8203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p8202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p8203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p8202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p8201=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p8200=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574) counter#1::front_left_stove)
