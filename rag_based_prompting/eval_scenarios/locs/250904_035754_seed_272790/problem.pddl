...
(define
  (problem test_kitchen_chicken_soup_250904_035754_seed_272790)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn7979=0.0)
	(position counter#1::chewie_door_right_joint pstn7975=1.872)
	(position fridge#1::fridge_door pstn7977=1.78)
	(position oven#1::knob_joint_2 pstn7978=0.0)
	(position counter#1::chewie_door_left_joint pstn7976=-1.872)
	(position faucet#1::joint_faucet_0 pstn7980=0.0)
	...
	(atposition fridge#1::fridge_door pstn7977=1.78)
	(atposition faucet#1::joint_faucet_0 pstn7980=0.0)
	(atposition oven#1::knob_joint_3 pstn7979=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7975=1.872)
	(atposition oven#1::knob_joint_2 pstn7978=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7976=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn7978=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn7980=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7979=0.0)

	(pose braiserlid#1 p25797=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(pose braiserbody#1 p25795=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p25796=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p25800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p25799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p25795=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p25796=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p25800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p25799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p25797=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))

	(isopenedposition counter#1::chewie_door_right_joint pstn7975=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn7976=-1.872)
	(isopenedposition fridge#1::fridge_door pstn7977=1.78)
	...
	(contained salt-shaker p25799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p25800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p25797=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401) counter#1::front_left_stove)
	(supported braiserbody#1 p25798=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
