...
(define
  (problem test_kitchen_chicken_soup_250905_010716_seed_823374)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn20032=0.0)
	(position fridge#1::fridge_door pstn20031=1.78)
	(position counter#1::chewie_door_left_joint pstn20030=-1.872)
	(position counter#1::chewie_door_right_joint pstn20029=1.872)
	(position oven#1::knob_joint_3 pstn20033=0.0)
	(position faucet#1::joint_faucet_0 pstn20034=0.0)

	(atposition oven#1::knob_joint_3 pstn20033=0.0)
	(atposition counter#1::chewie_door_left_joint pstn20030=-1.872)
	(atposition fridge#1::fridge_door pstn20031=1.78)
	(atposition faucet#1::joint_faucet_0 pstn20034=0.0)
	(atposition counter#1::chewie_door_right_joint pstn20029=1.872)
	(atposition oven#1::knob_joint_2 pstn20032=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn20034=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20033=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20032=0.0)

	(pose salt-shaker p70807=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p70804=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p70803=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p70805=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(pose pepper-shaker p70808=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p70805=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(atpose braiserbody#1 p70803=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p70804=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p70808=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p70807=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn20030=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn20029=1.872)
	(isopenedposition fridge#1::fridge_door pstn20031=1.78)
	...
	(contained pepper-shaker p70808=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p70807=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p70805=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762) counter#1::front_left_stove)
	(supported braiserbody#1 p70806=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
