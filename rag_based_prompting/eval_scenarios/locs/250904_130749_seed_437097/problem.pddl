...
(define
  (problem test_kitchen_chicken_soup_250904_130749_seed_437097)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn5715=0.0)
	(atposition oven#1::knob_joint_3 pstn5716=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5712=1.872)
	(atposition fridge#1::fridge_door pstn5714=1.78)
	(atposition faucet#1::joint_faucet_0 pstn5717=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5713=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn5715=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5716=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5717=0.0)

	(isopenedposition fridge#1::fridge_door pstn5714=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5712=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5713=-1.872)

	(position counter#1::chewie_door_left_joint pstn5713=-1.872)
	(position oven#1::knob_joint_3 pstn5716=0.0)
	(position faucet#1::joint_faucet_0 pstn5717=0.0)
	(position oven#1::knob_joint_2 pstn5715=0.0)
	(position counter#1::chewie_door_right_joint pstn5712=1.872)
	(position fridge#1::fridge_door pstn5714=1.78)

	(atpose chicken-leg p17803=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p17807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p17806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p17802=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p17804=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(pose pepper-shaker p17807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p17803=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p17802=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p17806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p17804=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	...
	(contained pepper-shaker p17807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p17806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p17804=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96) counter#1::front_left_stove)
	(supported braiserbody#1 p17805=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
