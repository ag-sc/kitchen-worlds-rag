...
(define
  (problem test_kitchen_chicken_soup_250904_153431_seed_537415)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn8742=0.0)
	(atposition oven#1::knob_joint_2 pstn8741=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8743=0.0)
	(atposition fridge#1::fridge_door pstn8740=1.78)
	(atposition counter#1::chewie_door_left_joint pstn8739=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn8738=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn8741=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8743=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8742=0.0)

	(isopenedposition fridge#1::fridge_door pstn8740=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8739=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn8738=1.872)

	(position counter#1::chewie_door_left_joint pstn8739=-1.872)
	(position counter#1::chewie_door_right_joint pstn8738=1.872)
	(position oven#1::knob_joint_3 pstn8742=0.0)
	(position fridge#1::fridge_door pstn8740=1.78)
	(position oven#1::knob_joint_2 pstn8741=0.0)
	(position faucet#1::joint_faucet_0 pstn8743=0.0)

	(pose chicken-leg p31327=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p31326=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p31328=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(pose pepper-shaker p31331=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p31330=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p31328=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(atpose braiserbody#1 p31326=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p31331=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p31330=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p31327=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p31331=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p31330=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p31328=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718) counter#1::front_left_stove)
	(supported braiserbody#1 p31329=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
