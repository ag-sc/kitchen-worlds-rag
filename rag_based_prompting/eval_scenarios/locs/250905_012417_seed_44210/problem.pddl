...
(define
  (problem test_kitchen_chicken_soup_250905_012417_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn20227=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20228=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn20229=0.0)

	(isopenedposition fridge#1::fridge_door pstn20226=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn20224=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn20225=-1.872)

	(position counter#1::chewie_door_right_joint pstn20224=1.872)
	(position counter#1::chewie_door_left_joint pstn20225=-1.872)
	(position faucet#1::joint_faucet_0 pstn20229=0.0)
	(position fridge#1::fridge_door pstn20226=1.78)
	(position oven#1::knob_joint_3 pstn20228=0.0)
	(position oven#1::knob_joint_2 pstn20227=0.0)

	(atposition counter#1::chewie_door_left_joint pstn20225=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn20229=0.0)
	(atposition oven#1::knob_joint_3 pstn20228=0.0)
	(atposition fridge#1::fridge_door pstn20226=1.78)
	(atposition oven#1::knob_joint_2 pstn20227=0.0)
	(atposition counter#1::chewie_door_right_joint pstn20224=1.872)

	(pose braiserbody#1 p72082=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p72084=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(pose salt-shaker p72086=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p72083=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p72087=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p72086=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p72083=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p72084=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(atpose braiserbody#1 p72082=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p72087=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p72086=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p72087=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p72085=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p72084=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
