...
(define
  (problem test_kitchen_chicken_soup_250904_224040_seed_236439)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn17341=1.78)
	(position oven#1::knob_joint_2 pstn17342=0.0)
	(position counter#1::chewie_door_left_joint pstn17340=-1.872)
	(position oven#1::knob_joint_3 pstn17343=0.0)
	(position faucet#1::joint_faucet_0 pstn17344=0.0)
	(position counter#1::chewie_door_right_joint pstn17339=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn17343=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17344=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17342=0.0)

	(atposition counter#1::chewie_door_right_joint pstn17339=1.872)
	(atposition faucet#1::joint_faucet_0 pstn17344=0.0)
	(atposition oven#1::knob_joint_2 pstn17342=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17340=-1.872)
	(atposition oven#1::knob_joint_3 pstn17343=0.0)
	(atposition fridge#1::fridge_door pstn17341=1.78)

	(pose braiserbody#1 p62558=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p62563=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p62559=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p62560=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024))
	(pose salt-shaker p62562=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p62558=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p62559=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p62560=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024))
	(atpose pepper-shaker p62563=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p62562=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn17340=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn17339=1.872)
	(isopenedposition fridge#1::fridge_door pstn17341=1.78)
	...
	(contained salt-shaker p62562=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p62563=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p62561=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p62560=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024) counter#1::front_left_stove)
