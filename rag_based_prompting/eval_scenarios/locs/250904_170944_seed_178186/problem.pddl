...
(define
  (problem test_kitchen_chicken_soup_250904_170944_seed_178186)
  (:domain domain)
  ...
  (:init
	...
	(isopenedposition fridge#1::fridge_door pstn10212=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn10211=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn10210=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn10215=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10214=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10213=0.0)

	(position counter#1::chewie_door_left_joint pstn10211=-1.872)
	(position oven#1::knob_joint_3 pstn10214=0.0)
	(position oven#1::knob_joint_2 pstn10213=0.0)
	(position counter#1::chewie_door_right_joint pstn10210=1.872)
	(position fridge#1::fridge_door pstn10212=1.78)
	(position faucet#1::joint_faucet_0 pstn10215=0.0)

	(atposition counter#1::chewie_door_right_joint pstn10210=1.872)
	(atposition oven#1::knob_joint_3 pstn10214=0.0)
	(atposition faucet#1::joint_faucet_0 pstn10215=0.0)
	(atposition fridge#1::fridge_door pstn10212=1.78)
	(atposition counter#1::chewie_door_left_joint pstn10211=-1.872)
	(atposition oven#1::knob_joint_2 pstn10213=0.0)

	(pose salt-shaker p41743=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p41744=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p41740=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p41739=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p41741=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))

	(atpose salt-shaker p41743=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p41744=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p41740=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p41739=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p41741=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	...
	(contained pepper-shaker p41744=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p41743=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p41742=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p41741=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036) counter#1::front_left_stove)
