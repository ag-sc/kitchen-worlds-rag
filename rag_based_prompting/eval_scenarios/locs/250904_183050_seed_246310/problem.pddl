...
(define
  (problem test_kitchen_chicken_soup_250904_183050_seed_246310)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn11774=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11776=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11775=0.0)

	(isopenedposition fridge#1::fridge_door pstn11773=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11771=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11772=-1.872)

	(position counter#1::chewie_door_right_joint pstn11771=1.872)
	(position counter#1::chewie_door_left_joint pstn11772=-1.872)
	(position fridge#1::fridge_door pstn11773=1.78)
	(position oven#1::knob_joint_3 pstn11775=0.0)
	(position oven#1::knob_joint_2 pstn11774=0.0)
	(position faucet#1::joint_faucet_0 pstn11776=0.0)

	(atposition counter#1::chewie_door_left_joint pstn11772=-1.872)
	(atposition oven#1::knob_joint_2 pstn11774=0.0)
	(atposition faucet#1::joint_faucet_0 pstn11776=0.0)
	(atposition fridge#1::fridge_door pstn11773=1.78)
	(atposition oven#1::knob_joint_3 pstn11775=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11771=1.872)

	(pose braiserlid#1 p48915=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))
	(pose salt-shaker p48917=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p48918=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p48913=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p48914=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p48915=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))
	(atpose salt-shaker p48917=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p48913=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p48914=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p48918=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p48917=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p48918=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p48915=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612) counter#1::front_left_stove)
	(supported braiserbody#1 p48916=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
