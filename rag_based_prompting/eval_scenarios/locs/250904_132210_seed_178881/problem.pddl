...
(define
  (problem test_kitchen_chicken_soup_250904_132210_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn6201=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6197=1.872)
	(atposition counter#1::chewie_door_left_joint pstn6198=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn6202=0.0)
	(atposition oven#1::knob_joint_2 pstn6200=0.0)
	(atposition fridge#1::fridge_door pstn6199=1.78)

	(position faucet#1::joint_faucet_0 pstn6202=0.0)
	(position oven#1::knob_joint_3 pstn6201=0.0)
	(position counter#1::chewie_door_right_joint pstn6197=1.872)
	(position counter#1::chewie_door_left_joint pstn6198=-1.872)
	(position oven#1::knob_joint_2 pstn6200=0.0)
	(position fridge#1::fridge_door pstn6199=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn6202=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6200=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6201=0.0)

	(pose salt-shaker p18154=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p18155=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p18151=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p18150=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p18152=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(atpose salt-shaker p18154=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p18155=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p18150=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p18151=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p18152=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(isopenedposition counter#1::chewie_door_left_joint pstn6198=-1.872)
	(isopenedposition fridge#1::fridge_door pstn6199=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6197=1.872)
	...
	(contained pepper-shaker p18155=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p18154=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p18153=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p18152=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
