...
(define
  (problem test_kitchen_chicken_soup_250904_201828_seed_543413)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn14205=0.0)
	(position oven#1::knob_joint_3 pstn14204=0.0)
	(position counter#1::chewie_door_left_joint pstn14201=-1.872)
	(position fridge#1::fridge_door pstn14202=1.78)
	(position counter#1::chewie_door_right_joint pstn14200=1.872)
	(position oven#1::knob_joint_2 pstn14203=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn14203=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14205=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14204=0.0)

	(atposition counter#1::chewie_door_left_joint pstn14201=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn14200=1.872)
	(atposition oven#1::knob_joint_2 pstn14203=0.0)
	(atposition oven#1::knob_joint_3 pstn14204=0.0)
	(atposition fridge#1::fridge_door pstn14202=1.78)
	(atposition faucet#1::joint_faucet_0 pstn14205=0.0)

	(pose chicken-leg p53471=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p53470=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p53475=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p53474=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p53472=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))

	(atpose chicken-leg p53471=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p53470=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p53475=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p53472=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(atpose salt-shaker p53474=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq808=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq288=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn14201=-1.872)
	(isopenedposition fridge#1::fridge_door pstn14202=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn14200=1.872)

	(ataconf left aq808=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq288=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p53475=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p53474=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p53473=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p53472=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92) counter#1::front_left_stove)
