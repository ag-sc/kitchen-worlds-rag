...
(define
  (problem test_kitchen_chicken_soup_250829_214849_seed_889162)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p26945=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209))
	(pose salt-shaker p26947=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p26943=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p26948=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p26944=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p26947=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p26943=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p26945=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209))
	(atpose chicken-leg p26944=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p26948=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p26948=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p26947=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p26945=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209) counter#1::front_left_stove)
	(supported braiserbody#1 p26946=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
