...
(define
  (problem test_kitchen_chicken_soup_250829_143400_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(position counter#1::chewie_door_left_joint pstn1966=-1.872)
	(position counter#1::chewie_door_right_joint pstn1965=1.872)
	(position fridge#1::fridge_door pstn1967=1.78)
	...
	(atposition fridge#1::fridge_door pstn1967=1.78)
	...
	(atposition counter#1::chewie_door_left_joint pstn1966=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1965=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn1967=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1966=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1965=1.872)
	...
	(pose chicken-leg p3431=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p3432=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(pose salt-shaker p3434=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p3435=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3430=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p3430=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p3431=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p3432=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(atpose pepper-shaker p3435=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p3434=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p3434=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3435=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p3432=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
	(supported braiserbody#1 p3433=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
