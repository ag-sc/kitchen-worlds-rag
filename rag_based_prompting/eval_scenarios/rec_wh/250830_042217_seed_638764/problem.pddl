...
(define
  (problem test_kitchen_chicken_soup_250830_042217_seed_638764)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn15143=0.0)
	(atposition fridge#1::fridge_door pstn15141=1.78)
	(atposition counter#1::chewie_door_left_joint pstn15140=-1.872)
	(atposition oven#1::knob_joint_2 pstn15142=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15139=1.872)
	(atposition faucet#1::joint_faucet_0 pstn15144=0.0)

	(position faucet#1::joint_faucet_0 pstn15144=0.0)
	(position fridge#1::fridge_door pstn15141=1.78)
	(position oven#1::knob_joint_3 pstn15143=0.0)
	(position counter#1::chewie_door_left_joint pstn15140=-1.872)
	(position counter#1::chewie_door_right_joint pstn15139=1.872)
	(position oven#1::knob_joint_2 pstn15142=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15143=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15144=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15142=0.0)
	...
	(pose braiserbody#1 p56384=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p56386=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827))
	(pose salt-shaker p56388=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p56389=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p56385=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p56386=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827))
	(atpose salt-shaker p56388=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p56384=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p56385=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p56389=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn15139=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15140=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15141=1.78)
	...
	(contained salt-shaker p56388=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p56389=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p56386=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827) counter#1::front_left_stove)
	(supported braiserbody#1 p56387=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
