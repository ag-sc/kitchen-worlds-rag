...
(define
  (problem test_kitchen_chicken_soup_250901_094933_seed_74545)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn223=0.0)
	(atposition oven#1::knob_joint_2 pstn221=0.0)
	(atposition fridge#1::fridge_door pstn220=1.78)
	(atposition counter#1::chewie_door_left_joint pstn219=-1.872)
	(atposition oven#1::knob_joint_3 pstn222=0.0)
	(atposition counter#1::chewie_door_right_joint pstn218=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn223=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn222=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn221=0.0)

	(position counter#1::chewie_door_left_joint pstn219=-1.872)
	(position fridge#1::fridge_door pstn220=1.78)
	(position oven#1::knob_joint_3 pstn222=0.0)
	(position oven#1::knob_joint_2 pstn221=0.0)
	(position counter#1::chewie_door_right_joint pstn218=1.872)
	(position faucet#1::joint_faucet_0 pstn223=0.0)

	(pose salt-shaker p2299=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p2296=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p2295=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2297=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(pose pepper-shaker p2300=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p2295=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p2300=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2296=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p2299=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2297=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))

	(isopenedposition counter#1::chewie_door_left_joint pstn219=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn218=1.872)
	(isopenedposition fridge#1::fridge_door pstn220=1.78)
	...
	(contained salt-shaker p2299=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2300=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p2297=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999) counter#1::front_left_stove)
	(supported braiserbody#1 p2298=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
