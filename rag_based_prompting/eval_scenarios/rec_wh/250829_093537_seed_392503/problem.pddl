...
(define
  (problem test_kitchen_chicken_soup_250829_093537_seed_392503)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974))
	(pose braiserbody#1 p0=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p4=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974))
	(atpose braiserbody#1 p0=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974) counter#1::front_left_stove)
	(supported braiserbody#1 p3=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
