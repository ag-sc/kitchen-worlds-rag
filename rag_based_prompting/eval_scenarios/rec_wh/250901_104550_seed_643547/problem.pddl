...
(define
  (problem test_kitchen_chicken_soup_250901_104550_seed_643547)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn1419=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1421=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1417=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1416=1.872)
	(atposition fridge#1::fridge_door pstn1418=1.78)
	(atposition oven#1::knob_joint_3 pstn1420=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn1418=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1416=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1417=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn1421=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1419=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1420=0.0)

	(position counter#1::chewie_door_left_joint pstn1417=-1.872)
	(position counter#1::chewie_door_right_joint pstn1416=1.872)
	(position faucet#1::joint_faucet_0 pstn1421=0.0)
	(position fridge#1::fridge_door pstn1418=1.78)
	(position oven#1::knob_joint_2 pstn1419=0.0)
	(position oven#1::knob_joint_3 pstn1420=0.0)

	(pose braiserbody#1 p6220=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p6222=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(pose salt-shaker p6224=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p6225=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p6221=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq952=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p6225=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p6222=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(atpose braiserbody#1 p6220=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p6221=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p6224=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(ataconf right aq952=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p6225=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p6224=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p6222=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313) counter#1::front_left_stove)
	(supported braiserbody#1 p6223=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
