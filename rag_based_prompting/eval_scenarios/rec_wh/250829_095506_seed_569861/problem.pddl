...
(define
  (problem test_kitchen_chicken_soup_250829_095506_seed_569861)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(pose chicken-leg p1=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p5=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022) counter#1::front_left_stove)
