...
(define
  (problem test_kitchen_chicken_soup_250901_151630_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn9089=0.0)
	(position faucet#1::joint_faucet_0 pstn9091=0.0)
	(position counter#1::chewie_door_left_joint pstn9087=-1.872)
	(position oven#1::knob_joint_3 pstn9090=0.0)
	(position fridge#1::fridge_door pstn9088=1.78)
	(position counter#1::chewie_door_right_joint pstn9086=1.872)
	...
	(atposition oven#1::knob_joint_3 pstn9090=0.0)
	(atposition faucet#1::joint_faucet_0 pstn9091=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9087=-1.872)
	(atposition fridge#1::fridge_door pstn9088=1.78)
	(atposition counter#1::chewie_door_right_joint pstn9086=1.872)
	(atposition oven#1::knob_joint_2 pstn9089=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn9089=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9090=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9091=0.0)

	(isopenedposition fridge#1::fridge_door pstn9088=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn9086=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn9087=-1.872)

	(pose chicken-leg p23389=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p23390=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(pose salt-shaker p23392=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p23393=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p23388=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p23392=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p23393=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p23388=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p23390=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(atpose chicken-leg p23389=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p23393=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23392=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p23391=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p23390=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
