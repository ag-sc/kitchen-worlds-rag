...
(define
  (problem test_kitchen_chicken_soup_250830_001736_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn10581=0.0)
	(position oven#1::knob_joint_3 pstn10582=0.0)
	(position counter#1::chewie_door_right_joint pstn10578=1.872)
	(position faucet#1::joint_faucet_0 pstn10583=0.0)
	(position counter#1::chewie_door_left_joint pstn10579=-1.872)
	(position fridge#1::fridge_door pstn10580=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn10582=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10583=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10581=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn10580=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn10579=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn10578=1.872)

	(atposition counter#1::chewie_door_right_joint pstn10578=1.872)
	(atposition faucet#1::joint_faucet_0 pstn10583=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10579=-1.872)
	(atposition fridge#1::fridge_door pstn10580=1.78)
	(atposition oven#1::knob_joint_3 pstn10582=0.0)
	(atposition oven#1::knob_joint_2 pstn10581=0.0)

	(pose braiserlid#1 p36828=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose chicken-leg p36827=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p36831=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p36826=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p36830=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p36828=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(atpose pepper-shaker p36831=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p36830=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p36827=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p36826=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p36830=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p36831=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p36829=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p36828=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
