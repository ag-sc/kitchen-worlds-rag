...
(define
  (problem test_kitchen_chicken_soup_250829_165213_seed_662398)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn2748=0.0)
	(atposition oven#1::knob_joint_3 pstn2749=0.0)
	(atposition fridge#1::fridge_door pstn2747=1.78)
	(atposition counter#1::chewie_door_left_joint pstn2746=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn2745=1.872)
	(atposition faucet#1::joint_faucet_0 pstn2750=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn2748=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2750=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2749=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn2745=1.872)
	(position oven#1::knob_joint_2 pstn2748=0.0)
	(position faucet#1::joint_faucet_0 pstn2750=0.0)
	(position fridge#1::fridge_door pstn2747=1.78)
	(position counter#1::chewie_door_left_joint pstn2746=-1.872)
	(position oven#1::knob_joint_3 pstn2749=0.0)

	(pose braiserlid#1 p6788=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(pose pepper-shaker p6791=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p6790=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p6786=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p6787=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p6790=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p6788=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(atpose pepper-shaker p6791=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p6787=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p6786=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn2745=1.872)
	(isopenedposition fridge#1::fridge_door pstn2747=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2746=-1.872)
	...
	(contained pepper-shaker p6791=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p6790=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p6788=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574) counter#1::front_left_stove)
	(supported braiserbody#1 p6789=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
