...
(define
  (problem test_kitchen_chicken_soup_250901_143931_seed_195627)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn8086=0.0)
	(position counter#1::chewie_door_right_joint pstn8082=1.872)
	(position counter#1::chewie_door_left_joint pstn8083=-1.872)
	(position oven#1::knob_joint_2 pstn8085=0.0)
	(position faucet#1::joint_faucet_0 pstn8087=0.0)
	(position fridge#1::fridge_door pstn8084=1.78)
	...
	(atposition fridge#1::fridge_door pstn8084=1.78)
	(atposition oven#1::knob_joint_3 pstn8086=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8082=1.872)
	(atposition counter#1::chewie_door_left_joint pstn8083=-1.872)
	(atposition oven#1::knob_joint_2 pstn8085=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8087=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn8086=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8087=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8085=0.0)

	(pose braiserlid#1 p20744=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268))
	(pose salt-shaker p20746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p20747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p20742=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p20743=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p20744=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268))
	(atpose pepper-shaker p20747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p20742=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p20743=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p20746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn8082=1.872)
	(isopenedposition fridge#1::fridge_door pstn8084=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8083=-1.872)
	...
	(contained salt-shaker p20746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p20747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p20745=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p20744=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268) counter#1::front_left_stove)
