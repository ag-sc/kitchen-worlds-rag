...
(define
  (problem test_kitchen_chicken_soup_250901_153349_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn9295=0.0)
	(position counter#1::chewie_door_left_joint pstn9293=-1.872)
	(position counter#1::chewie_door_right_joint pstn9292=1.872)
	(position faucet#1::joint_faucet_0 pstn9297=0.0)
	(position fridge#1::fridge_door pstn9294=1.78)
	(position oven#1::knob_joint_3 pstn9296=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn9294=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn9292=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn9293=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn9297=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9295=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9296=0.0)

	(atposition counter#1::chewie_door_left_joint pstn9293=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn9292=1.872)
	(atposition faucet#1::joint_faucet_0 pstn9297=0.0)
	(atposition fridge#1::fridge_door pstn9294=1.78)
	(atposition oven#1::knob_joint_3 pstn9296=0.0)
	(atposition oven#1::knob_joint_2 pstn9295=0.0)

	(pose braiserbody#1 p25702=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p25707=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p25704=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(pose salt-shaker p25706=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p25703=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p25704=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(atpose pepper-shaker p25707=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p25702=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p25703=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p25706=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p25707=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p25706=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p25704=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
	(supported braiserbody#1 p25705=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
