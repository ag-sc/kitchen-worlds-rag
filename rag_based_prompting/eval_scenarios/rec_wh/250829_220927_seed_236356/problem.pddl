...
(define
  (problem test_kitchen_chicken_soup_250829_220927_seed_236356)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn8179=0.0)
	(position counter#1::chewie_door_left_joint pstn8177=-1.872)
	(position fridge#1::fridge_door pstn8178=1.78)
	(position oven#1::knob_joint_3 pstn8180=0.0)
	(position faucet#1::joint_faucet_0 pstn8181=0.0)
	(position counter#1::chewie_door_right_joint pstn8176=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn8179=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8180=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8181=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn8176=1.872)
	(atposition faucet#1::joint_faucet_0 pstn8181=0.0)
	(atposition oven#1::knob_joint_2 pstn8179=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8177=-1.872)
	(atposition oven#1::knob_joint_3 pstn8180=0.0)
	(atposition fridge#1::fridge_door pstn8178=1.78)

	(pose salt-shaker p29236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p29237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p29232=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p29234=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))
	(pose chicken-leg p29233=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p29233=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p29234=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))
	(atpose braiserbody#1 p29232=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p29236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p29237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn8177=-1.872)
	(isopenedposition fridge#1::fridge_door pstn8178=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn8176=1.872)
	...
	(contained pepper-shaker p29237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p29236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p29234=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647) counter#1::front_left_stove)
	(supported braiserbody#1 p29235=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
