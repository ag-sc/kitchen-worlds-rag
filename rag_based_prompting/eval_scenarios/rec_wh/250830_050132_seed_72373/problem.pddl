...
(define
  (problem test_kitchen_chicken_soup_250830_050132_seed_72373)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn15564=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15559=1.872)
	(atposition fridge#1::fridge_door pstn15561=1.78)
	(atposition counter#1::chewie_door_left_joint pstn15560=-1.872)
	(atposition oven#1::knob_joint_2 pstn15562=0.0)
	(atposition oven#1::knob_joint_3 pstn15563=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15563=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15562=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15564=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn15559=1.872)
	(position oven#1::knob_joint_3 pstn15563=0.0)
	(position faucet#1::joint_faucet_0 pstn15564=0.0)
	(position counter#1::chewie_door_left_joint pstn15560=-1.872)
	(position fridge#1::fridge_door pstn15561=1.78)
	(position oven#1::knob_joint_2 pstn15562=0.0)

	(pose chicken-leg p60337=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p60341=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p60340=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p60336=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p60338=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373))

	(atpose braiserbody#1 p60336=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p60340=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p60341=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p60338=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373))
	(atpose chicken-leg p60337=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn15559=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15560=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15561=1.78)
	...
	(contained pepper-shaker p60341=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p60340=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p60339=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p60338=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373) counter#1::front_left_stove)
