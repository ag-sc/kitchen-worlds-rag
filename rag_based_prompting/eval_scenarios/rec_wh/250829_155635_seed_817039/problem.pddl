...
(define
  (problem test_kitchen_chicken_soup_250829_155635_seed_817039)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p3728=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p3729=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p3730=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose pepper-shaker p3733=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p3732=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p3730=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose salt-shaker p3732=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p3728=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p3729=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p3733=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(supported braiserbody#1 p3731=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3730=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)

	(contained pepper-shaker p3733=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3732=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
