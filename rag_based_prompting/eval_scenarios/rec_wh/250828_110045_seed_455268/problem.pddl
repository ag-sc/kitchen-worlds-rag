...
(define
  (problem test_kitchen_chicken_soup_250828_110045_seed_455268)
  (:domain domain)
  ...
  (:init
	...
	(atpose braiserbody#1 p0=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p5=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279))
	...
	(pose braiserbody#1 p0=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279))
	...
	(supported braiserbody#1 p3=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279) counter#1::front_left_stove)
