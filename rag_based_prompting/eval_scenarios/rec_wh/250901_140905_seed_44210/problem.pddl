...
(define
  (problem test_kitchen_chicken_soup_250901_140905_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(position counter#1::chewie_door_left_joint pstn7127=-1.872)
	(position counter#1::chewie_door_right_joint pstn7126=1.872)
	(position faucet#1::joint_faucet_0 pstn7131=0.0)
	(position fridge#1::fridge_door pstn7128=1.78)
	...
	(isopenedposition fridge#1::fridge_door pstn7128=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn7127=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn7126=1.872)

	(atposition counter#1::chewie_door_left_joint pstn7127=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn7126=1.872)
	(atposition faucet#1::joint_faucet_0 pstn7131=0.0)
	(atposition fridge#1::fridge_door pstn7128=1.78)
	(atposition oven#1::knob_joint_2 pstn7129=0.0)
	(atposition oven#1::knob_joint_3 pstn7130=0.0)

	(pose chicken-leg p19009=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p19013=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p19012=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p19010=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(pose braiserbody#1 p19008=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p19010=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(atpose braiserbody#1 p19008=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p19013=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p19009=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p19012=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p19012=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p19013=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p19011=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p19010=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
