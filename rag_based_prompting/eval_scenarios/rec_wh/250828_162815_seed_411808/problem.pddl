...
(define
  (problem test_kitchen_chicken_soup_250828_162815_seed_411808)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn1096=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1098=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1097=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn1093=1.872)
	(position fridge#1::fridge_door pstn1095=1.78)
	(position counter#1::chewie_door_left_joint pstn1094=-1.872)
	(position faucet#1::joint_faucet_0 pstn1098=0.0)
	(position oven#1::knob_joint_2 pstn1096=0.0)
	(position oven#1::knob_joint_3 pstn1097=0.0)

	(atposition counter#1::chewie_door_right_joint pstn1093=1.872)
	(atposition fridge#1::fridge_door pstn1095=1.78)
	(atposition counter#1::chewie_door_left_joint pstn1094=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn1098=0.0)
	(atposition oven#1::knob_joint_2 pstn1096=0.0)
	(atposition oven#1::knob_joint_3 pstn1097=0.0)

	(pose braiserbody#1 p490=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p491=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p495=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p492=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(pose salt-shaker p494=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p494=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p491=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p495=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p490=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p492=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))

	(isopenedposition counter#1::chewie_door_right_joint pstn1093=1.872)
	(isopenedposition fridge#1::fridge_door pstn1095=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1094=-1.872)
	...
	(contained pepper-shaker p495=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p494=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p492=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148) counter#1::front_left_stove)
	(supported braiserbody#1 p493=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
