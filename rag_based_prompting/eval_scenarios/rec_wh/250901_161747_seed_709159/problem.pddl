...
(define
  (problem test_kitchen_chicken_soup_250901_161747_seed_709159)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn10298=1.78)
	(position oven#1::knob_joint_3 pstn10300=0.0)
	(position oven#1::knob_joint_2 pstn10299=0.0)
	(position counter#1::chewie_door_left_joint pstn10297=-1.872)
	(position faucet#1::joint_faucet_0 pstn10301=0.0)
	(position counter#1::chewie_door_right_joint pstn10296=1.872)

	(isopenedposition fridge#1::fridge_door pstn10298=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn10296=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn10297=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn10301=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10300=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10299=0.0)

	(atposition counter#1::chewie_door_left_joint pstn10297=-1.872)
	(atposition fridge#1::fridge_door pstn10298=1.78)
	(atposition oven#1::knob_joint_2 pstn10299=0.0)
	(atposition oven#1::knob_joint_3 pstn10300=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10296=1.872)
	(atposition faucet#1::joint_faucet_0 pstn10301=0.0)

	(pose braiserbody#1 p27341=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p27343=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(pose chicken-leg p27342=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p27345=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p27346=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq728=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq408=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p27346=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p27343=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(atpose salt-shaker p27345=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p27341=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p27342=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(ataconf right aq408=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq728=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p27345=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p27346=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p27344=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p27343=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44) counter#1::front_left_stove)
