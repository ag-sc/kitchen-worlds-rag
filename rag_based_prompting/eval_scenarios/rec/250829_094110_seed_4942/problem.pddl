...
(define
  (problem test_kitchen_chicken_soup_250829_094110_seed_4942)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn426=0.0)
	(position fridge#1::fridge_door pstn423=1.78)
	(position counter#1::chewie_door_right_joint pstn421=1.872)
	(position oven#1::knob_joint_3 pstn425=0.0)
	(position counter#1::chewie_door_left_joint pstn422=-1.872)
	(position oven#1::knob_joint_2 pstn424=0.0)

	(atposition faucet#1::joint_faucet_0 pstn426=0.0)
	(atposition counter#1::chewie_door_right_joint pstn421=1.872)
	(atposition oven#1::knob_joint_3 pstn425=0.0)
	(atposition counter#1::chewie_door_left_joint pstn422=-1.872)
	(atposition oven#1::knob_joint_2 pstn424=0.0)
	(atposition fridge#1::fridge_door pstn423=1.78)

	(isclosedposition oven#1::knob_joint_2 pstn424=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn426=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn425=0.0)
	...
	(atpose salt-shaker p2444=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2440=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p2442=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(atpose pepper-shaker p2445=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2441=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p2445=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p2444=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2440=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2442=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(pose chicken-leg p2441=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn422=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn421=1.872)
	(isopenedposition fridge#1::fridge_door pstn423=1.78)
	...
	(contained salt-shaker p2444=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2445=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2443=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2442=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391) counter#1::front_left_stove)
