...
(define
  (problem test_kitchen_chicken_soup_250826_225342_seed_398825)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn18052=1.78)
	(position oven#1::knob_joint_2 pstn18053=0.0)
	(position counter#1::chewie_door_right_joint pstn18050=1.872)
	(position oven#1::knob_joint_3 pstn18054=0.0)
	(position counter#1::chewie_door_left_joint pstn18051=-1.872)
	(position faucet#1::joint_faucet_0 pstn18055=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn18054=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn18055=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18053=0.0)

	(atposition counter#1::chewie_door_left_joint pstn18051=-1.872)
	(atposition fridge#1::fridge_door pstn18052=1.78)
	(atposition oven#1::knob_joint_2 pstn18053=0.0)
	(atposition faucet#1::joint_faucet_0 pstn18055=0.0)
	(atposition oven#1::knob_joint_3 pstn18054=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18050=1.872)

	(pose braiserlid#1 p21268=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854))
	(pose braiserbody#1 p21266=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p21267=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p21271=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p21270=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq280=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq456=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p21271=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p21267=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p21270=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p21268=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854))
	(atpose braiserbody#1 p21266=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn18050=1.872)
	(isopenedposition fridge#1::fridge_door pstn18052=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn18051=-1.872)

	(ataconf right aq456=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq280=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p21270=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p21271=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p21268=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854) counter#1::front_left_stove)
	(supported braiserbody#1 p21269=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
