...
(define
  (problem test_kitchen_chicken_soup_250828_132618_seed_149466)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p0=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))

	(atpose pepper-shaker p5=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(atpose salt-shaker p4=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p0=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p3=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9) counter#1::front_left_stove)
