...
(define
  (problem test_kitchen_chicken_soup_250826_211536_seed_288895)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn13271=0.0)
	(position counter#1::chewie_door_right_joint pstn13268=1.872)
	(position faucet#1::joint_faucet_0 pstn13273=0.0)
	(position oven#1::knob_joint_3 pstn13272=0.0)
	(position fridge#1::fridge_door pstn13270=1.78)
	(position counter#1::chewie_door_left_joint pstn13269=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn13272=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn13271=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13273=0.0)

	(atposition counter#1::chewie_door_left_joint pstn13269=-1.872)
	(atposition oven#1::knob_joint_2 pstn13271=0.0)
	(atposition oven#1::knob_joint_3 pstn13272=0.0)
	(atposition counter#1::chewie_door_right_joint pstn13268=1.872)
	(atposition faucet#1::joint_faucet_0 pstn13273=0.0)
	(atposition fridge#1::fridge_door pstn13270=1.78)

	(pose salt-shaker p18398=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p18394=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p18395=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p18396=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(pose pepper-shaker p18399=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq472=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(atpose pepper-shaker p18399=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p18394=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p18398=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p18396=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(atpose chicken-leg p18395=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_left_joint pstn13269=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn13268=1.872)
	(isopenedposition fridge#1::fridge_door pstn13270=1.78)

	(ataconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq472=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p18399=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p18398=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p18396=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247) counter#1::front_left_stove)
	(supported braiserbody#1 p18397=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
