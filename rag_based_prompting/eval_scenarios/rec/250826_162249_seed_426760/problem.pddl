...
(define
  (problem test_kitchen_chicken_soup_250826_162249_seed_426760)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn1810=1.78)
	(position faucet#1::joint_faucet_0 pstn1813=0.0)
	(position oven#1::knob_joint_2 pstn1811=0.0)
	(position counter#1::chewie_door_right_joint pstn1808=1.872)
	(position counter#1::chewie_door_left_joint pstn1809=-1.872)
	(position oven#1::knob_joint_3 pstn1812=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn1813=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1811=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1812=0.0)

	(atposition counter#1::chewie_door_left_joint pstn1809=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1808=1.872)
	(atposition oven#1::knob_joint_3 pstn1812=0.0)
	(atposition fridge#1::fridge_door pstn1810=1.78)
	(atposition oven#1::knob_joint_2 pstn1811=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1813=0.0)

	(pose braiserbody#1 p1073=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p1074=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1075=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352))
	(pose pepper-shaker p1078=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p1077=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p1074=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p1077=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p1078=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1073=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p1075=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352))

	(isopenedposition counter#1::chewie_door_right_joint pstn1808=1.872)
	(isopenedposition fridge#1::fridge_door pstn1810=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1809=-1.872)
	...
	(contained pepper-shaker p1078=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1077=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p1076=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1075=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352) counter#1::front_left_stove)
