...
(define
  (problem test_kitchen_chicken_soup_250828_110758_seed_638764)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn719=1.78)
	(atposition counter#1::chewie_door_right_joint pstn717=1.872)
	(atposition oven#1::knob_joint_3 pstn721=0.0)
	(atposition oven#1::knob_joint_2 pstn720=0.0)
	(atposition counter#1::chewie_door_left_joint pstn718=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn722=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn720=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn721=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn722=0.0)

	(position counter#1::chewie_door_left_joint pstn718=-1.872)
	(position fridge#1::fridge_door pstn719=1.78)
	(position oven#1::knob_joint_2 pstn720=0.0)
	(position oven#1::knob_joint_3 pstn721=0.0)
	(position faucet#1::joint_faucet_0 pstn722=0.0)
	(position counter#1::chewie_door_right_joint pstn717=1.872)

	(atpose braiserbody#1 p492=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p494=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827))
	...
	(pose braiserbody#1 p492=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p494=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827))

	(isopenedposition counter#1::chewie_door_left_joint pstn718=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn717=1.872)
	(isopenedposition fridge#1::fridge_door pstn719=1.78)
	...
	(supported braiserbody#1 p495=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p494=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827) counter#1::front_left_stove)
