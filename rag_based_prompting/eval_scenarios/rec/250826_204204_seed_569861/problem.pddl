...
(define
  (problem test_kitchen_chicken_soup_250826_204204_seed_569861)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn12186=0.0)
	(position fridge#1::fridge_door pstn12184=1.78)
	(position faucet#1::joint_faucet_0 pstn12187=0.0)
	(position counter#1::chewie_door_right_joint pstn12182=1.872)
	(position counter#1::chewie_door_left_joint pstn12183=-1.872)
	(position oven#1::knob_joint_2 pstn12185=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn12187=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12186=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12185=0.0)

	(atposition counter#1::chewie_door_right_joint pstn12182=1.872)
	(atposition oven#1::knob_joint_2 pstn12185=0.0)
	(atposition oven#1::knob_joint_3 pstn12186=0.0)
	(atposition counter#1::chewie_door_left_joint pstn12183=-1.872)
	(atposition fridge#1::fridge_door pstn12184=1.78)
	(atposition faucet#1::joint_faucet_0 pstn12187=0.0)

	(pose braiserlid#1 p16548=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(pose salt-shaker p16550=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p16547=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p16551=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p16546=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p16547=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p16546=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p16551=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p16548=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(atpose salt-shaker p16550=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn12183=-1.872)
	(isopenedposition fridge#1::fridge_door pstn12184=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12182=1.872)
	...
	(contained pepper-shaker p16551=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p16550=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p16548=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022) counter#1::front_left_stove)
	(supported braiserbody#1 p16549=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
