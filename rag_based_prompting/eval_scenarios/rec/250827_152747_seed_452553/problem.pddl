...
(define
  (problem test_kitchen_chicken_soup_250827_152747_seed_452553)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn14478=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14474=-1.872)
	(atposition fridge#1::fridge_door pstn14475=1.78)
	(atposition oven#1::knob_joint_2 pstn14476=0.0)
	(atposition oven#1::knob_joint_3 pstn14477=0.0)
	(atposition counter#1::chewie_door_right_joint pstn14473=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn14478=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14477=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14476=0.0)

	(position counter#1::chewie_door_right_joint pstn14473=1.872)
	(position oven#1::knob_joint_3 pstn14477=0.0)
	(position counter#1::chewie_door_left_joint pstn14474=-1.872)
	(position fridge#1::fridge_door pstn14475=1.78)
	(position oven#1::knob_joint_2 pstn14476=0.0)
	(position faucet#1::joint_faucet_0 pstn14478=0.0)

	(pose chicken-leg p33769=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p33770=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(pose braiserbody#1 p33768=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p33773=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p33772=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p33768=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p33770=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(atpose pepper-shaker p33773=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p33769=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p33772=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq992=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq16=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn14474=-1.872)
	(isopenedposition fridge#1::fridge_door pstn14475=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn14473=1.872)

	(ataconf right aq16=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq992=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p33773=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p33772=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p33771=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p33770=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452) counter#1::front_left_stove)
