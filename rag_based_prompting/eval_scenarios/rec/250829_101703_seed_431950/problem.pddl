...
(define
  (problem test_kitchen_chicken_soup_250829_101703_seed_431950)
  (:domain domain)
  ...
  (:init
	...
	(pose chicken-leg p355=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p356=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(pose salt-shaker p358=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p354=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p359=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p356=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(atpose braiserbody#1 p354=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p359=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p355=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p358=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p359=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p358=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p357=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p356=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642) counter#1::front_left_stove)
