...
(define
  (problem test_kitchen_chicken_soup_250828_142343_seed_190390)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p0=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	...
	(atpose braiserbody#1 p0=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p3=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
