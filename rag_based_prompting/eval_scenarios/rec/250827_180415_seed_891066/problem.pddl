...
(define
  (problem test_kitchen_chicken_soup_250827_180415_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn20405=0.0)
	(position counter#1::chewie_door_left_joint pstn20401=-1.872)
	(position oven#1::knob_joint_3 pstn20404=0.0)
	(position fridge#1::fridge_door pstn20402=1.78)
	(position counter#1::chewie_door_right_joint pstn20400=1.872)
	(position oven#1::knob_joint_2 pstn20403=0.0)

	(atposition faucet#1::joint_faucet_0 pstn20405=0.0)
	(atposition counter#1::chewie_door_left_joint pstn20401=-1.872)
	(atposition fridge#1::fridge_door pstn20402=1.78)
	(atposition counter#1::chewie_door_right_joint pstn20400=1.872)
	(atposition oven#1::knob_joint_3 pstn20404=0.0)
	(atposition oven#1::knob_joint_2 pstn20403=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn20405=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20404=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20403=0.0)

	(pose braiserbody#1 p49885=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p49889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p49890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p49887=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose chicken-leg p49886=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p49889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p49887=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose chicken-leg p49886=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p49885=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p49890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq736=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq0=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn20401=-1.872)
	(isopenedposition fridge#1::fridge_door pstn20402=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn20400=1.872)

	(ataconf right aq0=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq736=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(supported braiserbody#1 p49888=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p49887=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)

	(contained pepper-shaker p49890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p49889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
