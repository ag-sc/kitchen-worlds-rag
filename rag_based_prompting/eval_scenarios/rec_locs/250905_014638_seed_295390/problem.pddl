...
(define
  (problem test_kitchen_chicken_soup_250905_014638_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn21273=0.0)
	(position fridge#1::fridge_door pstn21272=1.78)
	(position counter#1::chewie_door_left_joint pstn21271=-1.872)
	(position oven#1::knob_joint_3 pstn21274=0.0)
	(position counter#1::chewie_door_right_joint pstn21270=1.872)
	(position faucet#1::joint_faucet_0 pstn21275=0.0)
	...
	(atposition fridge#1::fridge_door pstn21272=1.78)
	(atposition counter#1::chewie_door_right_joint pstn21270=1.872)
	(atposition faucet#1::joint_faucet_0 pstn21275=0.0)
	(atposition oven#1::knob_joint_2 pstn21273=0.0)
	(atposition counter#1::chewie_door_left_joint pstn21271=-1.872)
	(atposition oven#1::knob_joint_3 pstn21274=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn21274=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21275=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21273=0.0)

	(pose salt-shaker p37472=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p37468=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p37469=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p37473=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p37470=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))

	(atpose braiserlid#1 p37470=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(atpose salt-shaker p37472=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p37468=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p37473=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p37469=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn21271=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn21270=1.872)
	(isopenedposition fridge#1::fridge_door pstn21272=1.78)
	...
	(contained salt-shaker p37472=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p37473=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p37470=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
	(supported braiserbody#1 p37471=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
