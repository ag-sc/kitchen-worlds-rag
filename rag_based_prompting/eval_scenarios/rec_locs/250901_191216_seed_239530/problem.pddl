...
(define
  (problem test_kitchen_chicken_soup_250901_191216_seed_239530)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn19443=1.78)
	(atposition counter#1::chewie_door_left_joint pstn19442=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn19446=0.0)
	(atposition oven#1::knob_joint_3 pstn19445=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19441=1.872)
	(atposition oven#1::knob_joint_2 pstn19444=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn19444=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19446=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19445=0.0)

	(position counter#1::chewie_door_left_joint pstn19442=-1.872)
	(position faucet#1::joint_faucet_0 pstn19446=0.0)
	(position counter#1::chewie_door_right_joint pstn19441=1.872)
	(position oven#1::knob_joint_2 pstn19444=0.0)
	(position oven#1::knob_joint_3 pstn19445=0.0)
	(position fridge#1::fridge_door pstn19443=1.78)

	(pose pepper-shaker p39421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p39416=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p39420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p39417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p39418=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))

	(atpose braiserlid#1 p39418=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(atpose pepper-shaker p39421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p39416=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p39417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p39420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq592=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq80=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn19441=1.872)
	(isopenedposition fridge#1::fridge_door pstn19443=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn19442=-1.872)

	(ataconf right aq80=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq592=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p39420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p39421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p39418=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285) counter#1::front_left_stove)
	(supported braiserbody#1 p39419=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
