...
(define
  (problem test_kitchen_chicken_soup_250904_034855_seed_186208)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn15732=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15729=1.872)
	(atposition oven#1::knob_joint_3 pstn15733=0.0)
	(atposition faucet#1::joint_faucet_0 pstn15734=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15730=-1.872)
	(atposition fridge#1::fridge_door pstn15731=1.78)

	(position faucet#1::joint_faucet_0 pstn15734=0.0)
	(position counter#1::chewie_door_right_joint pstn15729=1.872)
	(position counter#1::chewie_door_left_joint pstn15730=-1.872)
	(position oven#1::knob_joint_3 pstn15733=0.0)
	(position fridge#1::fridge_door pstn15731=1.78)
	(position oven#1::knob_joint_2 pstn15732=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn15732=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15733=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15734=0.0)

	(atpose braiserbody#1 p46675=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p46679=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p46680=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p46676=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p46677=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167))

	(pose pepper-shaker p46680=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p46675=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p46677=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167))
	(pose salt-shaker p46679=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p46676=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn15730=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15731=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn15729=1.872)
	...
	(supported braiserbody#1 p46678=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p46677=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167) counter#1::front_left_stove)

	(contained pepper-shaker p46680=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p46679=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
