...
(define
  (problem test_kitchen_chicken_soup_250904_063434_seed_178186)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn22215=0.0)
	(position faucet#1::joint_faucet_0 pstn22217=0.0)
	(position fridge#1::fridge_door pstn22214=1.78)
	(position oven#1::knob_joint_3 pstn22216=0.0)
	(position counter#1::chewie_door_left_joint pstn22213=-1.872)
	(position counter#1::chewie_door_right_joint pstn22212=1.872)
	...
	(atposition oven#1::knob_joint_2 pstn22215=0.0)
	(atposition faucet#1::joint_faucet_0 pstn22217=0.0)
	(atposition oven#1::knob_joint_3 pstn22216=0.0)
	(atposition counter#1::chewie_door_right_joint pstn22212=1.872)
	(atposition fridge#1::fridge_door pstn22214=1.78)
	(atposition counter#1::chewie_door_left_joint pstn22213=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn22215=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn22217=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn22216=0.0)

	(isopenedposition fridge#1::fridge_door pstn22214=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn22213=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn22212=1.872)

	(pose braiserbody#1 p55238=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p55239=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p55243=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p55240=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	(pose salt-shaker p55242=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p55240=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	(atpose salt-shaker p55242=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p55238=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p55243=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p55239=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p55243=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p55242=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p55241=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p55240=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036) counter#1::front_left_stove)
