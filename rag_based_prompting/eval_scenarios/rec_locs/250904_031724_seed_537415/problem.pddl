...
(define
  (problem test_kitchen_chicken_soup_250904_031724_seed_537415)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn15340=0.0)
	(atposition fridge#1::fridge_door pstn15338=1.78)
	(atposition counter#1::chewie_door_left_joint pstn15337=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn15341=0.0)
	(atposition oven#1::knob_joint_2 pstn15339=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15336=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn15339=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15340=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15341=0.0)

	(isopenedposition fridge#1::fridge_door pstn15338=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn15336=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15337=-1.872)

	(position counter#1::chewie_door_right_joint pstn15336=1.872)
	(position faucet#1::joint_faucet_0 pstn15341=0.0)
	(position fridge#1::fridge_door pstn15338=1.78)
	(position counter#1::chewie_door_left_joint pstn15337=-1.872)
	(position oven#1::knob_joint_2 pstn15339=0.0)
	(position oven#1::knob_joint_3 pstn15340=0.0)

	(pose chicken-leg p44176=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p44177=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(pose salt-shaker p44179=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p44180=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p44175=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p44180=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p44175=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p44176=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p44177=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(atpose salt-shaker p44179=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p44179=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p44180=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p44177=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718) counter#1::front_left_stove)
	(supported braiserbody#1 p44178=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
