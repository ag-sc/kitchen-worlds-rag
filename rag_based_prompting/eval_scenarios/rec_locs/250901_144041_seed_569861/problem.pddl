...
(define
  (problem test_kitchen_chicken_soup_250901_144041_seed_569861)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn9321=1.78)
	(position counter#1::chewie_door_left_joint pstn9320=-1.872)
	(position counter#1::chewie_door_right_joint pstn9319=1.872)
	(position faucet#1::joint_faucet_0 pstn9324=0.0)
	(position oven#1::knob_joint_2 pstn9322=0.0)
	(position oven#1::knob_joint_3 pstn9323=0.0)
	...
	(atposition fridge#1::fridge_door pstn9321=1.78)
	(atposition counter#1::chewie_door_right_joint pstn9319=1.872)
	(atposition faucet#1::joint_faucet_0 pstn9324=0.0)
	(atposition oven#1::knob_joint_2 pstn9322=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9320=-1.872)
	(atposition oven#1::knob_joint_3 pstn9323=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn9323=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9322=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9324=0.0)
	...
	(pose braiserlid#1 p23454=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(pose salt-shaker p23456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p23452=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p23453=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p23457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn9320=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn9319=1.872)
	(isopenedposition fridge#1::fridge_door pstn9321=1.78)

	(aconf left aq440=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p23457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p23454=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(atpose salt-shaker p23456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p23452=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p23453=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(ataconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq440=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p23457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p23454=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022) counter#1::front_left_stove)
	(supported braiserbody#1 p23455=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
