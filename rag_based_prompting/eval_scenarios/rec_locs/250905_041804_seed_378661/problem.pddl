...
(define
  (problem test_kitchen_chicken_soup_250905_041804_seed_378661)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn24262=0.0)
	(atposition counter#1::chewie_door_left_joint pstn24259=-1.872)
	(atposition fridge#1::fridge_door pstn24260=1.78)
	(atposition faucet#1::joint_faucet_0 pstn24263=0.0)
	(atposition oven#1::knob_joint_2 pstn24261=0.0)
	(atposition counter#1::chewie_door_right_joint pstn24258=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn24260=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn24258=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn24259=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn24263=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24261=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24262=0.0)

	(position counter#1::chewie_door_right_joint pstn24258=1.872)
	(position counter#1::chewie_door_left_joint pstn24259=-1.872)
	(position faucet#1::joint_faucet_0 pstn24263=0.0)
	(position fridge#1::fridge_door pstn24260=1.78)
	(position oven#1::knob_joint_2 pstn24261=0.0)
	(position oven#1::knob_joint_3 pstn24262=0.0)

	(pose salt-shaker p45159=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p45155=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p45156=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p45157=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	(pose pepper-shaker p45160=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p45159=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p45155=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p45156=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p45160=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p45157=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	...
	(contained salt-shaker p45159=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p45160=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p45158=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p45157=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993) counter#1::front_left_stove)
