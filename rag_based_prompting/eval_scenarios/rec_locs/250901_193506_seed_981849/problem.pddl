...
(define
  (problem test_kitchen_chicken_soup_250901_193506_seed_981849)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn19681=0.0)
	(position faucet#1::joint_faucet_0 pstn19682=0.0)
	(position counter#1::chewie_door_left_joint pstn19678=-1.872)
	(position counter#1::chewie_door_right_joint pstn19677=1.872)
	(position oven#1::knob_joint_2 pstn19680=0.0)
	(position fridge#1::fridge_door pstn19679=1.78)
	...
	(atposition oven#1::knob_joint_3 pstn19681=0.0)
	(atposition fridge#1::fridge_door pstn19679=1.78)
	(atposition oven#1::knob_joint_2 pstn19680=0.0)
	(atposition faucet#1::joint_faucet_0 pstn19682=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19677=1.872)
	(atposition counter#1::chewie_door_left_joint pstn19678=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn19681=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19680=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19682=0.0)

	(pose salt-shaker p40735=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p40731=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p40733=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(pose pepper-shaker p40736=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p40732=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p40735=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p40731=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p40736=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p40733=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(atpose chicken-leg p40732=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn19678=-1.872)
	(isopenedposition fridge#1::fridge_door pstn19679=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn19677=1.872)
	...
	(supported braiserbody#1 p40734=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p40733=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705) counter#1::front_left_stove)

	(contained pepper-shaker p40736=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p40735=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
