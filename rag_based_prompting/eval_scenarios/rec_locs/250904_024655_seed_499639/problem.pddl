...
(define
  (problem test_kitchen_chicken_soup_250904_024655_seed_499639)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn14005=0.0)
	(atposition faucet#1::joint_faucet_0 pstn14006=0.0)
	(atposition oven#1::knob_joint_2 pstn14004=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14002=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn14001=1.872)
	(atposition fridge#1::fridge_door pstn14003=1.78)

	(isclosedposition oven#1::knob_joint_2 pstn14004=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14005=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14006=0.0)

	(isopenedposition fridge#1::fridge_door pstn14003=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn14002=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn14001=1.872)

	(position counter#1::chewie_door_left_joint pstn14002=-1.872)
	(position oven#1::knob_joint_2 pstn14004=0.0)
	(position oven#1::knob_joint_3 pstn14005=0.0)
	(position faucet#1::joint_faucet_0 pstn14006=0.0)
	(position fridge#1::fridge_door pstn14003=1.78)
	(position counter#1::chewie_door_right_joint pstn14001=1.872)

	(pose chicken-leg p41598=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p41599=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(pose braiserbody#1 p41597=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p41602=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p41601=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p41601=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p41598=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p41599=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(atpose braiserbody#1 p41597=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p41602=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p41601=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p41602=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p41599=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531) counter#1::front_left_stove)
	(supported braiserbody#1 p41600=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
