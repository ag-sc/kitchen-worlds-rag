...
(define
  (problem test_kitchen_chicken_soup_250901_110543_seed_452363)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn2285=0.0)
	(position oven#1::knob_joint_3 pstn2286=0.0)
	(position counter#1::chewie_door_right_joint pstn2282=1.872)
	(position counter#1::chewie_door_left_joint pstn2283=-1.872)
	(position faucet#1::joint_faucet_0 pstn2287=0.0)
	(position fridge#1::fridge_door pstn2284=1.78)

	(atposition oven#1::knob_joint_3 pstn2286=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2282=1.872)
	(atposition counter#1::chewie_door_left_joint pstn2283=-1.872)
	(atposition fridge#1::fridge_door pstn2284=1.78)
	(atposition oven#1::knob_joint_2 pstn2285=0.0)
	(atposition faucet#1::joint_faucet_0 pstn2287=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn2284=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn2282=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn2283=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn2287=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2286=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2285=0.0)

	(pose chicken-leg p5894=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p5898=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p5893=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p5897=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p5895=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))

	(atpose chicken-leg p5894=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p5893=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p5898=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p5897=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p5895=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))
	...
	(contained pepper-shaker p5898=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p5897=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p5896=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p5895=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252) counter#1::front_left_stove)
