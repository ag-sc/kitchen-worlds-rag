...
(define
  (problem test_kitchen_chicken_soup_250904_045435_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn18186=0.0)
	(position faucet#1::joint_faucet_0 pstn18188=0.0)
	(position oven#1::knob_joint_3 pstn18187=0.0)
	(position counter#1::chewie_door_left_joint pstn18184=-1.872)
	(position fridge#1::fridge_door pstn18185=1.78)
	(position counter#1::chewie_door_right_joint pstn18183=1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn18188=0.0)
	(atposition fridge#1::fridge_door pstn18185=1.78)
	(atposition oven#1::knob_joint_3 pstn18187=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18183=1.872)
	(atposition counter#1::chewie_door_left_joint pstn18184=-1.872)
	(atposition oven#1::knob_joint_2 pstn18186=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn18186=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn18188=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn18187=0.0)

	(pose braiserbody#1 p49493=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p49495=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose salt-shaker p49497=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p49494=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p49498=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p49493=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p49498=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p49495=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(atpose chicken-leg p49494=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p49497=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq128=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn18183=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn18184=-1.872)
	(isopenedposition fridge#1::fridge_door pstn18185=1.78)

	(ataconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq128=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p49498=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p49497=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p49495=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
	(supported braiserbody#1 p49496=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
