...
(define
  (problem test_kitchen_chicken_soup_250904_104835_seed_49167)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn2814=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2816=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2815=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn2811=1.872)
	(position oven#1::knob_joint_3 pstn2815=0.0)
	(position counter#1::chewie_door_left_joint pstn2812=-1.872)
	(position oven#1::knob_joint_2 pstn2814=0.0)
	(position fridge#1::fridge_door pstn2813=1.78)
	(position faucet#1::joint_faucet_0 pstn2816=0.0)

	(atposition counter#1::chewie_door_right_joint pstn2811=1.872)
	(atposition faucet#1::joint_faucet_0 pstn2816=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2812=-1.872)
	(atposition oven#1::knob_joint_3 pstn2815=0.0)
	(atposition oven#1::knob_joint_2 pstn2814=0.0)
	(atposition fridge#1::fridge_door pstn2813=1.78)

	(pose braiserbody#1 p5827=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p5831=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p5832=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p5828=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p5829=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102))

	(atpose chicken-leg p5828=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p5832=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p5831=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p5827=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p5829=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102))

	(isopenedposition counter#1::chewie_door_left_joint pstn2812=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2811=1.872)
	(isopenedposition fridge#1::fridge_door pstn2813=1.78)
	...
	(contained salt-shaker p5831=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p5832=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p5829=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102) counter#1::front_left_stove)
	(supported braiserbody#1 p5830=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
