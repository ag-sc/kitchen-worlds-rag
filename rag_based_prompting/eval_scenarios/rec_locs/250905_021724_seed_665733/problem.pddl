...
(define
  (problem test_kitchen_chicken_soup_250905_021724_seed_665733)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn21661=0.0)
	(atposition fridge#1::fridge_door pstn21659=1.78)
	(atposition counter#1::chewie_door_right_joint pstn21657=1.872)
	(atposition faucet#1::joint_faucet_0 pstn21662=0.0)
	(atposition counter#1::chewie_door_left_joint pstn21658=-1.872)
	(atposition oven#1::knob_joint_2 pstn21660=0.0)
	(position fridge#1::fridge_door pstn21659=1.78)
	(position oven#1::knob_joint_2 pstn21660=0.0)
	(position oven#1::knob_joint_3 pstn21661=0.0)
	(position counter#1::chewie_door_left_joint pstn21658=-1.872)
	(position counter#1::chewie_door_right_joint pstn21657=1.872)
	(position faucet#1::joint_faucet_0 pstn21662=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn21662=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn21661=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21660=0.0)

	(pose chicken-leg p39963=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p39962=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p39964=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(pose salt-shaker p39966=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p39967=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p39963=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p39962=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p39964=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(atpose salt-shaker p39966=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p39967=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn21658=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn21657=1.872)
	(isopenedposition fridge#1::fridge_door pstn21659=1.78)
	...
	(contained pepper-shaker p39967=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p39966=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p39965=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p39964=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418) counter#1::front_left_stove)
