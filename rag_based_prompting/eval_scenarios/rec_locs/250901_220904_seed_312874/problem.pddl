...
(define
  (problem test_kitchen_chicken_soup_250901_220904_seed_312874)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn24712=0.0)
	(position counter#1::chewie_door_left_joint pstn24710=-1.872)
	(position oven#1::knob_joint_3 pstn24713=0.0)
	(position fridge#1::fridge_door pstn24711=1.78)
	(position faucet#1::joint_faucet_0 pstn24714=0.0)
	(position counter#1::chewie_door_right_joint pstn24709=1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn24714=0.0)
	(atposition counter#1::chewie_door_right_joint pstn24709=1.872)
	(atposition counter#1::chewie_door_left_joint pstn24710=-1.872)
	(atposition oven#1::knob_joint_2 pstn24712=0.0)
	(atposition oven#1::knob_joint_3 pstn24713=0.0)
	(atposition fridge#1::fridge_door pstn24711=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn24712=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24714=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24713=0.0)

	(pose chicken-leg p48295=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p48296=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(pose braiserbody#1 p48294=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p48298=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p48299=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p48298=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p48299=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p48295=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p48296=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(atpose braiserbody#1 p48294=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq304=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(isopenedposition counter#1::chewie_door_right_joint pstn24709=1.872)
	(isopenedposition fridge#1::fridge_door pstn24711=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn24710=-1.872)

	(ataconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq304=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p48298=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p48299=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p48296=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441) counter#1::front_left_stove)
	(supported braiserbody#1 p48297=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
