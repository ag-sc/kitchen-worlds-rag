...
(define
  (problem test_kitchen_chicken_soup_250901_233454_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn27600=0.0)
	(position faucet#1::joint_faucet_0 pstn27602=0.0)
	(position counter#1::chewie_door_right_joint pstn27597=1.872)
	(position counter#1::chewie_door_left_joint pstn27598=-1.872)
	(position oven#1::knob_joint_3 pstn27601=0.0)
	(position fridge#1::fridge_door pstn27599=1.78)
	...
	(atposition oven#1::knob_joint_3 pstn27601=0.0)
	(atposition faucet#1::joint_faucet_0 pstn27602=0.0)
	(atposition counter#1::chewie_door_right_joint pstn27597=1.872)
	(atposition counter#1::chewie_door_left_joint pstn27598=-1.872)
	(atposition fridge#1::fridge_door pstn27599=1.78)
	(atposition oven#1::knob_joint_2 pstn27600=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn27601=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn27602=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn27600=0.0)

	(isopenedposition fridge#1::fridge_door pstn27599=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn27597=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn27598=-1.872)

	(pose pepper-shaker p53189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p53184=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p53185=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p53186=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose salt-shaker p53188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq568=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq184=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p53189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p53184=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p53186=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose chicken-leg p53185=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p53188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(ataconf right aq184=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq568=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p53188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p53189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p53187=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p53186=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)
