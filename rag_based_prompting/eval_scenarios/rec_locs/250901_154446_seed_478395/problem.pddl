...
(define
  (problem test_kitchen_chicken_soup_250901_154446_seed_478395)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn12143=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12142=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12144=0.0)

	(isopenedposition fridge#1::fridge_door pstn12141=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn12140=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn12139=1.872)

	(position counter#1::chewie_door_left_joint pstn12140=-1.872)
	(position counter#1::chewie_door_right_joint pstn12139=1.872)
	(position fridge#1::fridge_door pstn12141=1.78)
	(position faucet#1::joint_faucet_0 pstn12144=0.0)
	(position oven#1::knob_joint_3 pstn12143=0.0)
	(position oven#1::knob_joint_2 pstn12142=0.0)

	(atposition counter#1::chewie_door_left_joint pstn12140=-1.872)
	(atposition oven#1::knob_joint_2 pstn12142=0.0)
	(atposition fridge#1::fridge_door pstn12141=1.78)
	(atposition faucet#1::joint_faucet_0 pstn12144=0.0)
	(atposition oven#1::knob_joint_3 pstn12143=0.0)
	(atposition counter#1::chewie_door_right_joint pstn12139=1.872)

	(atpose chicken-leg p27319=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p27322=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p27323=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p27320=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(atpose braiserbody#1 p27318=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p27323=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p27322=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p27320=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(pose chicken-leg p27319=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p27318=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p27322=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p27323=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p27321=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p27320=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304) counter#1::front_left_stove)
