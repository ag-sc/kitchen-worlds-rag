...
(define
  (problem test_kitchen_chicken_soup_250904_110240_seed_72373)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn3464=0.0)
	(position counter#1::chewie_door_right_joint pstn3461=1.872)
	(position faucet#1::joint_faucet_0 pstn3466=0.0)
	(position fridge#1::fridge_door pstn3463=1.78)
	(position counter#1::chewie_door_left_joint pstn3462=-1.872)
	(position oven#1::knob_joint_3 pstn3465=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn3464=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3466=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3465=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn3462=-1.872)
	(atposition oven#1::knob_joint_3 pstn3465=0.0)
	(atposition oven#1::knob_joint_2 pstn3464=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3466=0.0)
	(atposition fridge#1::fridge_door pstn3463=1.78)
	(atposition counter#1::chewie_door_right_joint pstn3461=1.872)

	(atpose chicken-leg p7468=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p7467=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p7471=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p7472=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p7469=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373))
	(pose pepper-shaker p7472=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p7471=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p7468=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p7469=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373))
	(pose braiserbody#1 p7467=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn3461=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3462=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3463=1.78)
	...
	(contained pepper-shaker p7472=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p7471=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p7469=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373) counter#1::front_left_stove)
	(supported braiserbody#1 p7470=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
