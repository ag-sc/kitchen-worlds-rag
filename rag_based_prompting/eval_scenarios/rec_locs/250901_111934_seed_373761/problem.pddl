...
(define
  (problem test_kitchen_chicken_soup_250901_111934_seed_373761)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn2529=0.0)
	(atposition oven#1::knob_joint_3 pstn2528=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2524=1.872)
	(atposition counter#1::chewie_door_left_joint pstn2525=-1.872)
	(atposition fridge#1::fridge_door pstn2526=1.78)
	(atposition oven#1::knob_joint_2 pstn2527=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn2526=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn2524=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn2525=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn2529=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2527=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2528=0.0)

	(position counter#1::chewie_door_right_joint pstn2524=1.872)
	(position counter#1::chewie_door_left_joint pstn2525=-1.872)
	(position oven#1::knob_joint_3 pstn2528=0.0)
	(position faucet#1::joint_faucet_0 pstn2529=0.0)
	(position oven#1::knob_joint_2 pstn2527=0.0)
	(position fridge#1::fridge_door pstn2526=1.78)

	(pose chicken-leg p8238=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p8242=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p8237=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p8239=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))
	(pose salt-shaker p8241=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p8238=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p8241=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p8242=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p8237=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p8239=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))
	...
	(contained salt-shaker p8241=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p8242=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p8239=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998) counter#1::front_left_stove)
	(supported braiserbody#1 p8240=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
