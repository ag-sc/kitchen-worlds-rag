...
(define
  (problem test_kitchen_chicken_soup_250904_071311_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn23329=0.0)
	(atposition oven#1::knob_joint_2 pstn23328=0.0)
	(atposition counter#1::chewie_door_left_joint pstn23326=-1.872)
	(atposition fridge#1::fridge_door pstn23327=1.78)
	(atposition counter#1::chewie_door_right_joint pstn23325=1.872)
	(atposition faucet#1::joint_faucet_0 pstn23330=0.0)

	(position faucet#1::joint_faucet_0 pstn23330=0.0)
	(position fridge#1::fridge_door pstn23327=1.78)
	(position oven#1::knob_joint_3 pstn23329=0.0)
	(position counter#1::chewie_door_left_joint pstn23326=-1.872)
	(position oven#1::knob_joint_2 pstn23328=0.0)
	(position counter#1::chewie_door_right_joint pstn23325=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn23330=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn23329=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn23328=0.0)

	(pose braiserlid#1 p57548=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(pose braiserbody#1 p57546=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p57551=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p57547=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p57550=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p57546=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p57551=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p57547=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p57550=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p57548=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))

	(aconf left aq880=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq576=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn23326=-1.872)
	(isopenedposition fridge#1::fridge_door pstn23327=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn23325=1.872)

	(ataconf right aq576=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq880=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p57550=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p57551=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p57549=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p57548=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
