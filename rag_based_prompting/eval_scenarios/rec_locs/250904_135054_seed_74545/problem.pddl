...
(define
  (problem test_kitchen_chicken_soup_250904_135054_seed_74545)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn2622=0.0)
	(position oven#1::knob_joint_3 pstn2623=0.0)
	(position counter#1::chewie_door_right_joint pstn2619=1.872)
	(position fridge#1::fridge_door pstn2621=1.78)
	(position counter#1::chewie_door_left_joint pstn2620=-1.872)
	(position faucet#1::joint_faucet_0 pstn2624=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn2623=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2624=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2622=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn2621=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2620=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2619=1.872)

	(atposition counter#1::chewie_door_left_joint pstn2620=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn2624=0.0)
	(atposition oven#1::knob_joint_3 pstn2623=0.0)
	(atposition oven#1::knob_joint_2 pstn2622=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2619=1.872)
	(atposition fridge#1::fridge_door pstn2621=1.78)

	(pose salt-shaker p5184=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p5181=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p5180=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p5182=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(pose pepper-shaker p5185=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p5181=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p5180=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p5184=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p5182=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(atpose pepper-shaker p5185=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p5185=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p5184=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p5182=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999) counter#1::front_left_stove)
	(supported braiserbody#1 p5183=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
