...
(define
  (problem test_kitchen_chicken_soup_250901_115650_seed_25295)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn2992=1.78)
	(position counter#1::chewie_door_left_joint pstn2991=-1.872)
	(position oven#1::knob_joint_2 pstn2993=0.0)
	(position faucet#1::joint_faucet_0 pstn2995=0.0)
	(position counter#1::chewie_door_right_joint pstn2990=1.872)
	(position oven#1::knob_joint_3 pstn2994=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn2995=0.0)
	(atposition oven#1::knob_joint_3 pstn2994=0.0)
	(atposition fridge#1::fridge_door pstn2992=1.78)
	(atposition oven#1::knob_joint_2 pstn2993=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2990=1.872)
	(atposition counter#1::chewie_door_left_joint pstn2991=-1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn2992=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2991=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2990=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn2995=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2994=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2993=0.0)

	(atpose salt-shaker p11888=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p11886=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(atpose chicken-leg p11885=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p11884=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p11889=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p11889=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p11885=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p11884=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p11888=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p11886=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	...
	(contained salt-shaker p11888=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p11889=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p11887=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p11886=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662) counter#1::front_left_stove)
