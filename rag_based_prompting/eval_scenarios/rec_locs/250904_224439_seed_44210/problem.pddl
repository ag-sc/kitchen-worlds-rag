...
(define
  (problem test_kitchen_chicken_soup_250904_224439_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn17897=1.78)
	(position oven#1::knob_joint_2 pstn17898=0.0)
	(position counter#1::chewie_door_left_joint pstn17896=-1.872)
	(position counter#1::chewie_door_right_joint pstn17895=1.872)
	(position faucet#1::joint_faucet_0 pstn17900=0.0)
	(position oven#1::knob_joint_3 pstn17899=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn17900=0.0)
	(atposition fridge#1::fridge_door pstn17897=1.78)
	(atposition oven#1::knob_joint_3 pstn17899=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17896=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn17895=1.872)
	(atposition oven#1::knob_joint_2 pstn17898=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn17898=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17900=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17899=0.0)

	(pose braiserbody#1 p27845=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p27847=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(pose salt-shaker p27849=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p27850=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p27846=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p27846=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p27845=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p27847=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(atpose salt-shaker p27849=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p27850=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn17895=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn17896=-1.872)
	(isopenedposition fridge#1::fridge_door pstn17897=1.78)
	...
	(contained salt-shaker p27849=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p27850=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p27847=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
	(supported braiserbody#1 p27848=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
