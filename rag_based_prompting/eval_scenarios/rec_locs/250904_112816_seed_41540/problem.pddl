...
(define
  (problem test_kitchen_chicken_soup_250904_112816_seed_41540)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn4555=0.0)
	(position oven#1::knob_joint_3 pstn4554=0.0)
	(position fridge#1::fridge_door pstn4552=1.78)
	(position counter#1::chewie_door_right_joint pstn4550=1.872)
	(position counter#1::chewie_door_left_joint pstn4551=-1.872)
	(position oven#1::knob_joint_2 pstn4553=0.0)

	(atposition faucet#1::joint_faucet_0 pstn4555=0.0)
	(atposition oven#1::knob_joint_3 pstn4554=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4550=1.872)
	(atposition fridge#1::fridge_door pstn4552=1.78)
	(atposition counter#1::chewie_door_left_joint pstn4551=-1.872)
	(atposition oven#1::knob_joint_2 pstn4553=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn4553=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4554=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4555=0.0)
	...
	(pose salt-shaker p10123=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p10120=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p10121=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(pose pepper-shaker p10124=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p10119=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p10123=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p10124=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p10119=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p10121=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(atpose chicken-leg p10120=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn4550=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn4551=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4552=1.78)
	...
	(contained pepper-shaker p10124=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p10123=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p10121=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584) counter#1::front_left_stove)
	(supported braiserbody#1 p10122=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
