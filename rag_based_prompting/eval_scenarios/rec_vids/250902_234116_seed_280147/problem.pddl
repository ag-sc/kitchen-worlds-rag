...
(define
  (problem test_kitchen_chicken_soup_250902_234116_seed_280147)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn24953=0.0)
	(position counter#1::chewie_door_right_joint pstn24950=1.872)
	(position faucet#1::joint_faucet_0 pstn24955=0.0)
	(position oven#1::knob_joint_3 pstn24954=0.0)
	(position fridge#1::fridge_door pstn24952=1.78)
	(position counter#1::chewie_door_left_joint pstn24951=-1.872)
	...
	(atposition fridge#1::fridge_door pstn24952=1.78)
	(atposition counter#1::chewie_door_right_joint pstn24950=1.872)
	(atposition faucet#1::joint_faucet_0 pstn24955=0.0)
	(atposition oven#1::knob_joint_3 pstn24954=0.0)
	(atposition counter#1::chewie_door_left_joint pstn24951=-1.872)
	(atposition oven#1::knob_joint_2 pstn24953=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn24955=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24954=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24953=0.0)

	(pose braiserbody#1 p57562=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p57566=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p57563=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p57567=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p57564=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))

	(atpose salt-shaker p57566=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p57563=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p57564=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	(atpose pepper-shaker p57567=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p57562=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn24950=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn24951=-1.872)
	(isopenedposition fridge#1::fridge_door pstn24952=1.78)
	...
	(contained salt-shaker p57566=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p57567=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p57565=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p57564=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667) counter#1::front_left_stove)
