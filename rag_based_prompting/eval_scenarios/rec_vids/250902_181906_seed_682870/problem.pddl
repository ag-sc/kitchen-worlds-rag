...
(define
  (problem test_kitchen_chicken_soup_250902_181906_seed_682870)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn17237=0.0)
	(position counter#1::chewie_door_right_joint pstn17234=1.872)
	(position faucet#1::joint_faucet_0 pstn17239=0.0)
	(position fridge#1::fridge_door pstn17236=1.78)
	(position oven#1::knob_joint_3 pstn17238=0.0)
	(position counter#1::chewie_door_left_joint pstn17235=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn17237=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17238=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17239=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn17235=-1.872)
	(atposition oven#1::knob_joint_2 pstn17237=0.0)
	(atposition oven#1::knob_joint_3 pstn17238=0.0)
	(atposition counter#1::chewie_door_right_joint pstn17234=1.872)
	(atposition fridge#1::fridge_door pstn17236=1.78)
	(atposition faucet#1::joint_faucet_0 pstn17239=0.0)

	(pose chicken-leg p38527=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p38531=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p38526=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p38528=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126))
	(pose salt-shaker p38530=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p38530=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p38531=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p38527=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p38528=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126))
	(atpose braiserbody#1 p38526=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq560=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq120=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn17234=1.872)
	(isopenedposition fridge#1::fridge_door pstn17236=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn17235=-1.872)

	(ataconf right aq120=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq560=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p38531=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p38530=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p38529=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p38528=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126) counter#1::front_left_stove)
