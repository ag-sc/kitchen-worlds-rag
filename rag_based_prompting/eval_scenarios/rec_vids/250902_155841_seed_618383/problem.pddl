...
(define
  (problem test_kitchen_chicken_soup_250902_155841_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn13781=1.78)
	(atposition faucet#1::joint_faucet_0 pstn13784=0.0)
	(atposition counter#1::chewie_door_left_joint pstn13780=-1.872)
	(atposition oven#1::knob_joint_2 pstn13782=0.0)
	(atposition oven#1::knob_joint_3 pstn13783=0.0)
	(atposition counter#1::chewie_door_right_joint pstn13779=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn13784=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13783=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn13782=0.0)

	(position counter#1::chewie_door_left_joint pstn13780=-1.872)
	(position faucet#1::joint_faucet_0 pstn13784=0.0)
	(position oven#1::knob_joint_2 pstn13782=0.0)
	(position fridge#1::fridge_door pstn13781=1.78)
	(position counter#1::chewie_door_right_joint pstn13779=1.872)
	(position oven#1::knob_joint_3 pstn13783=0.0)

	(pose chicken-leg p29728=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p29729=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(pose pepper-shaker p29732=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p29727=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p29731=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p29731=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p29729=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(atpose chicken-leg p29728=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p29732=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p29727=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq552=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn13780=-1.872)
	(isopenedposition fridge#1::fridge_door pstn13781=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn13779=1.872)

	(ataconf left aq552=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p29732=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p29731=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p29729=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)
	(supported braiserbody#1 p29730=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
