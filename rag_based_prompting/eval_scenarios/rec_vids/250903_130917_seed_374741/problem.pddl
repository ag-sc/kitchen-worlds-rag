...
(define
  (problem test_kitchen_chicken_soup_250903_130917_seed_374741)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn17986=0.0)
	(position fridge#1::fridge_door pstn17984=1.78)
	(position counter#1::chewie_door_left_joint pstn17983=-1.872)
	(position counter#1::chewie_door_right_joint pstn17982=1.872)
	(position oven#1::knob_joint_2 pstn17985=0.0)
	(position faucet#1::joint_faucet_0 pstn17987=0.0)
	...
	(atposition oven#1::knob_joint_2 pstn17985=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17983=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn17982=1.872)
	(atposition faucet#1::joint_faucet_0 pstn17987=0.0)
	(atposition oven#1::knob_joint_3 pstn17986=0.0)
	(atposition fridge#1::fridge_door pstn17984=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn17985=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17987=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17986=0.0)

	(pose braiserlid#1 p37485=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(pose braiserbody#1 p37483=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p37487=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p37488=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p37484=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p37484=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p37488=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p37483=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p37487=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p37485=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))

	(aconf left aq432=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq760=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn17983=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn17982=1.872)
	(isopenedposition fridge#1::fridge_door pstn17984=1.78)

	(ataconf left aq432=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq760=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p37487=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p37488=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p37486=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p37485=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355) counter#1::front_left_stove)
