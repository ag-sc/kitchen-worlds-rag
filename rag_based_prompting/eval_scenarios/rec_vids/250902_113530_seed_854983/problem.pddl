...
(define
  (problem test_kitchen_chicken_soup_250902_113530_seed_854983)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn6268=1.78)
	(position faucet#1::joint_faucet_0 pstn6271=0.0)
	(position oven#1::knob_joint_3 pstn6270=0.0)
	(position oven#1::knob_joint_2 pstn6269=0.0)
	(position counter#1::chewie_door_left_joint pstn6267=-1.872)
	(position counter#1::chewie_door_right_joint pstn6266=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn6269=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6270=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6271=0.0)

	(isopenedposition fridge#1::fridge_door pstn6268=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6266=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn6267=-1.872)
	...
	(atposition counter#1::chewie_door_left_joint pstn6267=-1.872)
	(atposition oven#1::knob_joint_2 pstn6269=0.0)
	(atposition fridge#1::fridge_door pstn6268=1.78)
	(atposition counter#1::chewie_door_right_joint pstn6266=1.872)
	(atposition faucet#1::joint_faucet_0 pstn6271=0.0)
	(atposition oven#1::knob_joint_3 pstn6270=0.0)

	(atpose braiserbody#1 p10859=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p10860=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p10864=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p10861=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(atpose salt-shaker p10863=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(pose braiserlid#1 p10861=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(pose braiserbody#1 p10859=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p10860=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p10864=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p10863=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p10863=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p10864=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p10862=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p10861=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303) counter#1::front_left_stove)
