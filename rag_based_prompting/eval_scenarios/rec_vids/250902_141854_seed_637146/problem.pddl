...
(define
  (problem test_kitchen_chicken_soup_250902_141854_seed_637146)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn10862=0.0)
	(atposition oven#1::knob_joint_3 pstn10863=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10859=1.872)
	(atposition fridge#1::fridge_door pstn10861=1.78)
	(atposition faucet#1::joint_faucet_0 pstn10864=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10860=-1.872)

	(position faucet#1::joint_faucet_0 pstn10864=0.0)
	(position fridge#1::fridge_door pstn10861=1.78)
	(position oven#1::knob_joint_2 pstn10862=0.0)
	(position counter#1::chewie_door_right_joint pstn10859=1.872)
	(position counter#1::chewie_door_left_joint pstn10860=-1.872)
	(position oven#1::knob_joint_3 pstn10863=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn10862=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10863=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10864=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn10861=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn10859=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn10860=-1.872)

	(pose braiserlid#1 p22650=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(pose braiserbody#1 p22648=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p22649=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p22653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p22652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p22649=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p22653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p22650=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(atpose salt-shaker p22652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p22648=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p22652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p22653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p22651=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p22650=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073) counter#1::front_left_stove)
