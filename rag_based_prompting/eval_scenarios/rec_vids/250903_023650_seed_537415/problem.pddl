...
(define
  (problem test_kitchen_chicken_soup_250903_023650_seed_537415)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn29840=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn29841=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn29842=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn29839=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn29837=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn29838=-1.872)

	(position counter#1::chewie_door_right_joint pstn29837=1.872)
	(position oven#1::knob_joint_2 pstn29840=0.0)
	(position fridge#1::fridge_door pstn29839=1.78)
	(position faucet#1::joint_faucet_0 pstn29842=0.0)
	(position counter#1::chewie_door_left_joint pstn29838=-1.872)
	(position oven#1::knob_joint_3 pstn29841=0.0)

	(atposition counter#1::chewie_door_right_joint pstn29837=1.872)
	(atposition oven#1::knob_joint_2 pstn29840=0.0)
	(atposition faucet#1::joint_faucet_0 pstn29842=0.0)
	(atposition fridge#1::fridge_door pstn29839=1.78)
	(atposition oven#1::knob_joint_3 pstn29841=0.0)
	(atposition counter#1::chewie_door_left_joint pstn29838=-1.872)

	(pose salt-shaker p66123=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p66119=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p66121=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(pose pepper-shaker p66124=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p66120=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p66120=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p66121=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(atpose pepper-shaker p66124=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p66119=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p66123=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p66123=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p66124=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p66121=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718) counter#1::front_left_stove)
	(supported braiserbody#1 p66122=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
