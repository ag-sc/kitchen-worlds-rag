...
(define
  (problem test_kitchen_chicken_soup_250903_230314_seed_316464)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn8125=0.0)
	(position oven#1::knob_joint_2 pstn8124=0.0)
	(position faucet#1::joint_faucet_0 pstn8126=0.0)
	(position counter#1::chewie_door_right_joint pstn8121=1.872)
	(position fridge#1::fridge_door pstn8123=1.78)
	(position counter#1::chewie_door_left_joint pstn8122=-1.872)
	...
	(atposition oven#1::knob_joint_3 pstn8125=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8121=1.872)
	(atposition fridge#1::fridge_door pstn8123=1.78)
	(atposition counter#1::chewie_door_left_joint pstn8122=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn8126=0.0)
	(atposition oven#1::knob_joint_2 pstn8124=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn8125=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8126=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8124=0.0)

	(pose chicken-leg p19455=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p19454=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p19456=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(pose pepper-shaker p19459=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p19458=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn8121=1.872)
	(isopenedposition fridge#1::fridge_door pstn8123=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8122=-1.872)

	(aconf left aq560=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p19459=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p19454=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p19456=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(atpose chicken-leg p19455=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p19458=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(ataconf left aq560=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p19459=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p19458=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p19457=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p19456=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765) counter#1::front_left_stove)
