...
(define
  (problem test_kitchen_chicken_soup_250903_004711_seed_144508)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn26212=1.78)
	(position faucet#1::joint_faucet_0 pstn26215=0.0)
	(position oven#1::knob_joint_3 pstn26214=0.0)
	(position counter#1::chewie_door_left_joint pstn26211=-1.872)
	(position oven#1::knob_joint_2 pstn26213=0.0)
	(position counter#1::chewie_door_right_joint pstn26210=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn26215=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn26214=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn26213=0.0)

	(atposition counter#1::chewie_door_right_joint pstn26210=1.872)
	(atposition counter#1::chewie_door_left_joint pstn26211=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn26215=0.0)
	(atposition fridge#1::fridge_door pstn26212=1.78)
	(atposition oven#1::knob_joint_3 pstn26214=0.0)
	(atposition oven#1::knob_joint_2 pstn26213=0.0)

	(pose salt-shaker p62723=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p62720=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p62721=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189))
	(pose pepper-shaker p62724=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p62719=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p62724=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p62721=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189))
	(atpose salt-shaker p62723=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p62720=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p62719=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn26210=1.872)
	(isopenedposition fridge#1::fridge_door pstn26212=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn26211=-1.872)
	...
	(contained salt-shaker p62723=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p62724=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p62721=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189) counter#1::front_left_stove)
	(supported braiserbody#1 p62722=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
