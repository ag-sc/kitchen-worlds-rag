...
(define
  (problem test_kitchen_chicken_soup_250904_002020_seed_665733)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn10461=0.0)
	(position counter#1::chewie_door_right_joint pstn10458=1.872)
	(position faucet#1::joint_faucet_0 pstn10463=0.0)
	(position oven#1::knob_joint_3 pstn10462=0.0)
	(position fridge#1::fridge_door pstn10460=1.78)
	(position counter#1::chewie_door_left_joint pstn10459=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn10461=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10462=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10463=0.0)

	(isopenedposition fridge#1::fridge_door pstn10460=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn10459=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn10458=1.872)

	(atposition counter#1::chewie_door_right_joint pstn10458=1.872)
	(atposition oven#1::knob_joint_3 pstn10462=0.0)
	(atposition faucet#1::joint_faucet_0 pstn10463=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10459=-1.872)
	(atposition fridge#1::fridge_door pstn10460=1.78)
	(atposition oven#1::knob_joint_2 pstn10461=0.0)

	(pose braiserbody#1 p28184=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p28189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p28186=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(pose salt-shaker p28188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p28185=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose pepper-shaker p28189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p28185=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p28186=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(atpose braiserbody#1 p28184=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p28188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p28188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p28189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p28187=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p28186=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418) counter#1::front_left_stove)
