...
(define
  (problem test_kitchen_chicken_soup_250903_054649_seed_988376)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1904=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1902=1.872)
	(atposition faucet#1::joint_faucet_0 pstn1907=0.0)
	(atposition oven#1::knob_joint_2 pstn1905=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1903=-1.872)
	(atposition oven#1::knob_joint_3 pstn1906=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn1906=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1905=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1907=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn1902=1.872)
	(position faucet#1::joint_faucet_0 pstn1907=0.0)
	(position oven#1::knob_joint_2 pstn1905=0.0)
	(position counter#1::chewie_door_left_joint pstn1903=-1.872)
	(position oven#1::knob_joint_3 pstn1906=0.0)
	(position fridge#1::fridge_door pstn1904=1.78)

	(pose chicken-leg p12576=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p12575=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p12580=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p12577=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(pose salt-shaker p12579=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p12575=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p12579=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p12577=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(atpose pepper-shaker p12580=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p12576=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn1903=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1904=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1902=1.872)
	...
	(contained pepper-shaker p12580=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p12579=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p12578=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p12577=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975) counter#1::front_left_stove)
