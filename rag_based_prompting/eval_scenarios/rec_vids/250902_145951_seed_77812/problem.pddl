...
(define
  (problem test_kitchen_chicken_soup_250902_145951_seed_77812)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn11883=0.0)
	(atposition faucet#1::joint_faucet_0 pstn11885=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11880=1.872)
	(atposition fridge#1::fridge_door pstn11882=1.78)
	(atposition oven#1::knob_joint_3 pstn11884=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11881=-1.872)
	(position fridge#1::fridge_door pstn11882=1.78)
	(position oven#1::knob_joint_2 pstn11883=0.0)
	(position oven#1::knob_joint_3 pstn11884=0.0)
	(position counter#1::chewie_door_left_joint pstn11881=-1.872)
	(position faucet#1::joint_faucet_0 pstn11885=0.0)
	(position counter#1::chewie_door_right_joint pstn11880=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn11883=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11884=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11885=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn11882=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn11881=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn11880=1.872)

	(atpose salt-shaker p25442=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p25440=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(atpose braiserbody#1 p25438=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p25439=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p25443=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p25443=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p25440=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(pose chicken-leg p25439=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p25438=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p25442=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p25442=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p25443=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p25441=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p25440=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125) counter#1::front_left_stove)
