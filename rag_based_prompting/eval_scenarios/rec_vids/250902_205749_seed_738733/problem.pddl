...
(define
  (problem test_kitchen_chicken_soup_250902_205749_seed_738733)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn23296=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn23295=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn23297=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn23292=1.872)
	(position counter#1::chewie_door_left_joint pstn23293=-1.872)
	(position fridge#1::fridge_door pstn23294=1.78)
	(position oven#1::knob_joint_3 pstn23296=0.0)
	(position oven#1::knob_joint_2 pstn23295=0.0)
	(position faucet#1::joint_faucet_0 pstn23297=0.0)

	(atposition counter#1::chewie_door_right_joint pstn23292=1.872)
	(atposition oven#1::knob_joint_3 pstn23296=0.0)
	(atposition oven#1::knob_joint_2 pstn23295=0.0)
	(atposition counter#1::chewie_door_left_joint pstn23293=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn23297=0.0)
	(atposition fridge#1::fridge_door pstn23294=1.78)

	(pose salt-shaker p44356=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p44353=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p44357=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p44354=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	(pose braiserbody#1 p44352=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq784=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq8=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p44357=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p44354=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	(atpose salt-shaker p44356=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p44352=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p44353=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn23292=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn23293=-1.872)
	(isopenedposition fridge#1::fridge_door pstn23294=1.78)

	(ataconf right aq8=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq784=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p44356=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p44357=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p44355=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p44354=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791) counter#1::front_left_stove)
