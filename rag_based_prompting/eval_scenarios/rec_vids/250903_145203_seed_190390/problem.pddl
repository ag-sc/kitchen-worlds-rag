...
(define
  (problem test_kitchen_chicken_soup_250903_145203_seed_190390)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn19274=0.0)
	(position counter#1::chewie_door_left_joint pstn19270=-1.872)
	(position oven#1::knob_joint_2 pstn19272=0.0)
	(position fridge#1::fridge_door pstn19271=1.78)
	(position oven#1::knob_joint_3 pstn19273=0.0)
	(position counter#1::chewie_door_right_joint pstn19269=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn19274=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19273=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19272=0.0)

	(atposition counter#1::chewie_door_left_joint pstn19270=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn19274=0.0)
	(atposition oven#1::knob_joint_2 pstn19272=0.0)
	(atposition oven#1::knob_joint_3 pstn19273=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19269=1.872)
	(atposition fridge#1::fridge_door pstn19271=1.78)

	(pose braiserlid#1 p45401=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(pose pepper-shaker p45404=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p45399=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p45400=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p45403=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p45403=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p45400=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p45404=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p45399=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p45401=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))

	(aconf left aq704=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq232=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn19270=-1.872)
	(isopenedposition fridge#1::fridge_door pstn19271=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn19269=1.872)

	(ataconf left aq704=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq232=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p45403=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p45404=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p45402=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p45401=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928) counter#1::front_left_stove)
