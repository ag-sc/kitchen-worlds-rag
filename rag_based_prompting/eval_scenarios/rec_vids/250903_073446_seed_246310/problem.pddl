...
(define
  (problem test_kitchen_chicken_soup_250903_073446_seed_246310)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn5659=1.78)
	(position faucet#1::joint_faucet_0 pstn5662=0.0)
	(position counter#1::chewie_door_right_joint pstn5657=1.872)
	(position oven#1::knob_joint_3 pstn5661=0.0)
	(position counter#1::chewie_door_left_joint pstn5658=-1.872)
	(position oven#1::knob_joint_2 pstn5660=0.0)

	(atposition fridge#1::fridge_door pstn5659=1.78)
	(atposition counter#1::chewie_door_left_joint pstn5658=-1.872)
	(atposition oven#1::knob_joint_2 pstn5660=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5662=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5657=1.872)
	(atposition oven#1::knob_joint_3 pstn5661=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn5662=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5661=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5660=0.0)

	(atpose braiserbody#1 p18982=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p18983=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p18984=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))
	(atpose pepper-shaker p18987=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p18986=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p18983=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p18986=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p18982=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p18987=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p18984=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))

	(isopenedposition counter#1::chewie_door_right_joint pstn5657=1.872)
	(isopenedposition fridge#1::fridge_door pstn5659=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5658=-1.872)
	...
	(supported braiserbody#1 p18985=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p18984=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612) counter#1::front_left_stove)

	(contained pepper-shaker p18987=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p18986=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
