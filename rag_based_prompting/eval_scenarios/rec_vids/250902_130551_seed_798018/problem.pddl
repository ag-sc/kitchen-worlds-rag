...
(define
  (problem test_kitchen_chicken_soup_250902_130551_seed_798018)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn8841=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8837=-1.872)
	(atposition fridge#1::fridge_door pstn8838=1.78)
	(atposition oven#1::knob_joint_2 pstn8839=0.0)
	(atposition oven#1::knob_joint_3 pstn8840=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8836=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn8841=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8840=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8839=0.0)

	(position counter#1::chewie_door_left_joint pstn8837=-1.872)
	(position faucet#1::joint_faucet_0 pstn8841=0.0)
	(position fridge#1::fridge_door pstn8838=1.78)
	(position oven#1::knob_joint_3 pstn8840=0.0)
	(position counter#1::chewie_door_right_joint pstn8836=1.872)
	(position oven#1::knob_joint_2 pstn8839=0.0)

	(pose salt-shaker p17999=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p17997=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose braiserbody#1 p17995=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p17996=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p18000=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p17995=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p17999=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p17997=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose pepper-shaker p18000=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p17996=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn8837=-1.872)
	(isopenedposition fridge#1::fridge_door pstn8838=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn8836=1.872)
	...
	(contained pepper-shaker p18000=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p17999=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p17998=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p17997=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
