...
(define
  (problem test_kitchen_chicken_soup_250902_171756_seed_354453)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn15378=0.0)
	(position faucet#1::joint_faucet_0 pstn15379=0.0)
	(position counter#1::chewie_door_right_joint pstn15374=1.872)
	(position oven#1::knob_joint_2 pstn15377=0.0)
	(position counter#1::chewie_door_left_joint pstn15375=-1.872)
	(position fridge#1::fridge_door pstn15376=1.78)
	...
	(atposition fridge#1::fridge_door pstn15376=1.78)
	(atposition faucet#1::joint_faucet_0 pstn15379=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15374=1.872)
	(atposition oven#1::knob_joint_3 pstn15378=0.0)
	(atposition oven#1::knob_joint_2 pstn15377=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15375=-1.872)

	(isclosedposition oven#1::knob_joint_3 pstn15378=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15379=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15377=0.0)
	...
	(pose braiserbody#1 p36273=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p36275=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(pose pepper-shaker p36278=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p36274=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p36277=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p36277=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p36278=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p36274=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p36273=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p36275=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))

	(isopenedposition counter#1::chewie_door_right_joint pstn15374=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15375=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15376=1.78)
	...
	(supported braiserbody#1 p36276=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p36275=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309) counter#1::front_left_stove)

	(contained pepper-shaker p36278=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p36277=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
