...
(define
  (problem test_kitchen_chicken_soup_250903_015210_seed_734621)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn28287=0.0)
	(position counter#1::chewie_door_right_joint pstn28282=1.872)
	(position counter#1::chewie_door_left_joint pstn28283=-1.872)
	(position fridge#1::fridge_door pstn28284=1.78)
	(position oven#1::knob_joint_2 pstn28285=0.0)
	(position oven#1::knob_joint_3 pstn28286=0.0)

	(atposition faucet#1::joint_faucet_0 pstn28287=0.0)
	(atposition oven#1::knob_joint_2 pstn28285=0.0)
	(atposition counter#1::chewie_door_left_joint pstn28283=-1.872)
	(atposition oven#1::knob_joint_3 pstn28286=0.0)
	(atposition counter#1::chewie_door_right_joint pstn28282=1.872)
	(atposition fridge#1::fridge_door pstn28284=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn28287=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn28285=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn28286=0.0)

	(pose salt-shaker p65230=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p65231=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p65228=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(pose braiserbody#1 p65226=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p65227=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p65230=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p65228=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(atpose braiserbody#1 p65226=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p65227=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p65231=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn28283=-1.872)
	(isopenedposition fridge#1::fridge_door pstn28284=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn28282=1.872)
	...
	(contained pepper-shaker p65231=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p65230=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p65228=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19) counter#1::front_left_stove)
	(supported braiserbody#1 p65229=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
