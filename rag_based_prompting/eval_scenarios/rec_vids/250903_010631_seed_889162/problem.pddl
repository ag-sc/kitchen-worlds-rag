...
(define
  (problem test_kitchen_chicken_soup_250903_010631_seed_889162)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn27246=0.0)
	(atposition oven#1::knob_joint_3 pstn27245=0.0)
	(atposition oven#1::knob_joint_2 pstn27244=0.0)
	(atposition counter#1::chewie_door_right_joint pstn27241=1.872)
	(atposition counter#1::chewie_door_left_joint pstn27242=-1.872)
	(atposition fridge#1::fridge_door pstn27243=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn27246=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn27245=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn27244=0.0)

	(position counter#1::chewie_door_left_joint pstn27242=-1.872)
	(position oven#1::knob_joint_2 pstn27244=0.0)
	(position faucet#1::joint_faucet_0 pstn27246=0.0)
	(position fridge#1::fridge_door pstn27243=1.78)
	(position oven#1::knob_joint_3 pstn27245=0.0)
	(position counter#1::chewie_door_right_joint pstn27241=1.872)

	(pose chicken-leg p63453=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p63457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p63452=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p63456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p63454=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209))

	(atpose chicken-leg p63453=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p63456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p63454=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209))
	(atpose pepper-shaker p63457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p63452=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn27242=-1.872)
	(isopenedposition fridge#1::fridge_door pstn27243=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn27241=1.872)
	...
	(contained pepper-shaker p63457=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p63456=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p63454=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209) counter#1::front_left_stove)
	(supported braiserbody#1 p63455=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
