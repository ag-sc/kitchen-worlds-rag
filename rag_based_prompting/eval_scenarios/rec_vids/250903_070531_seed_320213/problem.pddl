...
(define
  (problem test_kitchen_chicken_soup_250903_070531_seed_320213)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn5239=0.0)
	(position fridge#1::fridge_door pstn5236=1.78)
	(position oven#1::knob_joint_2 pstn5237=0.0)
	(position oven#1::knob_joint_3 pstn5238=0.0)
	(position counter#1::chewie_door_right_joint pstn5234=1.872)
	(position counter#1::chewie_door_left_joint pstn5235=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn5239=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5237=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5238=0.0)

	(atposition counter#1::chewie_door_right_joint pstn5234=1.872)
	(atposition fridge#1::fridge_door pstn5236=1.78)
	(atposition counter#1::chewie_door_left_joint pstn5235=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn5239=0.0)
	(atposition oven#1::knob_joint_2 pstn5237=0.0)
	(atposition oven#1::knob_joint_3 pstn5238=0.0)

	(pose chicken-leg p16484=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p16485=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(pose braiserbody#1 p16483=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p16488=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p16487=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p16485=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(atpose salt-shaker p16487=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p16484=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p16483=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p16488=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn5234=1.872)
	(isopenedposition fridge#1::fridge_door pstn5236=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5235=-1.872)
	...
	(contained salt-shaker p16487=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p16488=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p16485=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62) counter#1::front_left_stove)
	(supported braiserbody#1 p16486=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
