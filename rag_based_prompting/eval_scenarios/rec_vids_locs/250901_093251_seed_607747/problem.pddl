...
(define
  (problem test_kitchen_chicken_soup_250901_093251_seed_607747)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	...
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098) counter#1::front_left_stove)
