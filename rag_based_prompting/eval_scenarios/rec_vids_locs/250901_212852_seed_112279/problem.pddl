...
(define
  (problem test_kitchen_chicken_soup_250901_212852_seed_112279)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn22938=0.0)
	(position counter#1::chewie_door_right_joint pstn22934=1.872)
	(position fridge#1::fridge_door pstn22936=1.78)
	(position counter#1::chewie_door_left_joint pstn22935=-1.872)
	(position faucet#1::joint_faucet_0 pstn22939=0.0)
	(position oven#1::knob_joint_2 pstn22937=0.0)

	(atposition faucet#1::joint_faucet_0 pstn22939=0.0)
	(atposition fridge#1::fridge_door pstn22936=1.78)
	(atposition oven#1::knob_joint_3 pstn22938=0.0)
	(atposition counter#1::chewie_door_left_joint pstn22935=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn22934=1.872)
	(atposition oven#1::knob_joint_2 pstn22937=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn22937=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn22938=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn22939=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn22936=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn22935=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn22934=1.872)

	(pose pepper-shaker p70218=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p70215=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))
	(pose chicken-leg p70214=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p70217=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p70213=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq576=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq952=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p70218=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p70215=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))
	(atpose braiserbody#1 p70213=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p70217=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p70214=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(ataconf right aq952=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq576=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p70218=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p70217=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p70216=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p70215=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655) counter#1::front_left_stove)
