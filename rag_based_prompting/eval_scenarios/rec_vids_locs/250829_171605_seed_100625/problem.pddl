...
(define
  (problem test_kitchen_chicken_soup_250829_171605_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn4978=0.0)
	(position counter#1::chewie_door_left_joint pstn4975=-1.872)
	(position counter#1::chewie_door_right_joint pstn4974=1.872)
	(position faucet#1::joint_faucet_0 pstn4979=0.0)
	(position fridge#1::fridge_door pstn4976=1.78)
	(position oven#1::knob_joint_2 pstn4977=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn4978=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4977=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4979=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn4975=-1.872)
	(atposition oven#1::knob_joint_3 pstn4978=0.0)
	(atposition oven#1::knob_joint_2 pstn4977=0.0)
	(atposition faucet#1::joint_faucet_0 pstn4979=0.0)
	(atposition fridge#1::fridge_door pstn4976=1.78)
	(atposition counter#1::chewie_door_right_joint pstn4974=1.872)

	(pose braiserlid#1 p13500=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(pose pepper-shaker p13503=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p13502=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p13498=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p13499=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p13500=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(atpose pepper-shaker p13503=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p13498=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p13499=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p13502=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn4974=1.872)
	(isopenedposition fridge#1::fridge_door pstn4976=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn4975=-1.872)
	...
	(contained pepper-shaker p13503=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p13502=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13501=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13500=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
