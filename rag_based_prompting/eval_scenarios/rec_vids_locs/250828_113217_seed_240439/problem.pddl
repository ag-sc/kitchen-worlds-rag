...
(define
  (problem test_kitchen_chicken_soup_250828_113217_seed_240439)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn446=0.0)
	(atposition oven#1::knob_joint_3 pstn447=0.0)
	(atposition counter#1::chewie_door_left_joint pstn444=-1.872)
	(atposition fridge#1::fridge_door pstn445=1.78)
	(atposition counter#1::chewie_door_right_joint pstn443=1.872)
	(atposition faucet#1::joint_faucet_0 pstn448=0.0)
	(position fridge#1::fridge_door pstn445=1.78)
	(position oven#1::knob_joint_2 pstn446=0.0)
	(position oven#1::knob_joint_3 pstn447=0.0)
	(position counter#1::chewie_door_right_joint pstn443=1.872)
	(position faucet#1::joint_faucet_0 pstn448=0.0)
	(position counter#1::chewie_door_left_joint pstn444=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn446=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn447=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn448=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn445=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn444=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn443=1.872)

	(pose salt-shaker p412=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p408=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p413=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p409=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p410=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))

	(atpose braiserlid#1 p410=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))
	(atpose salt-shaker p412=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p408=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p413=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p409=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p412=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p413=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p410=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159) counter#1::front_left_stove)
	(supported braiserbody#1 p411=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
