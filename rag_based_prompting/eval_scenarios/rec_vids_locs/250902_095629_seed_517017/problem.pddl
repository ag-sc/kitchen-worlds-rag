...
(define
  (problem test_kitchen_chicken_soup_250902_095629_seed_517017)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn485=1.78)
	(atposition oven#1::knob_joint_3 pstn487=0.0)
	(atposition faucet#1::joint_faucet_0 pstn488=0.0)
	(atposition counter#1::chewie_door_right_joint pstn483=1.872)
	(atposition oven#1::knob_joint_2 pstn486=0.0)
	(atposition counter#1::chewie_door_left_joint pstn484=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn486=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn487=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn488=0.0)

	(isopenedposition fridge#1::fridge_door pstn485=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn483=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn484=-1.872)
	...
	(position counter#1::chewie_door_left_joint pstn484=-1.872)
	(position counter#1::chewie_door_right_joint pstn483=1.872)
	(position oven#1::knob_joint_2 pstn486=0.0)
	(position oven#1::knob_joint_3 pstn487=0.0)
	(position faucet#1::joint_faucet_0 pstn488=0.0)
	(position fridge#1::fridge_door pstn485=1.78)

	(pose salt-shaker p4421=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4417=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p4419=(0.567, 7.872, 0.712, 0.0, -0.0, 2.522))
	(pose chicken-leg p4418=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p4422=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p4421=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p4417=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p4419=(0.567, 7.872, 0.712, 0.0, -0.0, 2.522))
	(atpose pepper-shaker p4422=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p4418=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p4422=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4421=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p4420=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p4419=(0.567, 7.872, 0.712, 0.0, -0.0, 2.522) counter#1::front_left_stove)
