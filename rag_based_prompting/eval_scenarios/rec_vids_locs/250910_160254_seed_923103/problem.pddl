...
(define
  (problem test_kitchen_chicken_soup_250910_160254_seed_923103)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn15390=0.0)
	(atposition oven#1::knob_joint_2 pstn15388=0.0)
	(atposition oven#1::knob_joint_3 pstn15389=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15386=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn15385=1.872)
	(atposition fridge#1::fridge_door pstn15387=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn15388=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15389=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15390=0.0)

	(position counter#1::chewie_door_left_joint pstn15386=-1.872)
	(position oven#1::knob_joint_2 pstn15388=0.0)
	(position faucet#1::joint_faucet_0 pstn15390=0.0)
	(position fridge#1::fridge_door pstn15387=1.78)
	(position counter#1::chewie_door_right_joint pstn15385=1.872)
	(position oven#1::knob_joint_3 pstn15389=0.0)

	(atpose braiserbody#1 p20428=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p20433=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p20430=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(atpose chicken-leg p20429=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p20432=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p20433=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p20428=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p20430=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(pose salt-shaker p20432=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p20429=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq528=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq752=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn15386=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15387=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn15385=1.872)

	(ataconf right aq752=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq528=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p20432=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p20433=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p20431=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p20430=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097) counter#1::front_left_stove)
