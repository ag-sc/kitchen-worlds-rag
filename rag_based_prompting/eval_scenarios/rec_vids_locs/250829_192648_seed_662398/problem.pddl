...
(define
  (problem test_kitchen_chicken_soup_250829_192648_seed_662398)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn10285=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10281=-1.872)
	(atposition oven#1::knob_joint_3 pstn10284=0.0)
	(atposition fridge#1::fridge_door pstn10282=1.78)
	(atposition counter#1::chewie_door_right_joint pstn10280=1.872)
	(atposition oven#1::knob_joint_2 pstn10283=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn10284=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10283=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10285=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn10280=1.872)
	(position fridge#1::fridge_door pstn10282=1.78)
	(position counter#1::chewie_door_left_joint pstn10281=-1.872)
	(position oven#1::knob_joint_2 pstn10283=0.0)
	(position faucet#1::joint_faucet_0 pstn10285=0.0)
	(position oven#1::knob_joint_3 pstn10284=0.0)

	(pose braiserlid#1 p19765=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(pose braiserbody#1 p19763=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p19767=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p19764=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p19768=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p19765=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(atpose chicken-leg p19764=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p19767=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p19768=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p19763=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn10280=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn10281=-1.872)
	(isopenedposition fridge#1::fridge_door pstn10282=1.78)
	...
	(contained salt-shaker p19767=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p19768=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p19765=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574) counter#1::front_left_stove)
	(supported braiserbody#1 p19766=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
