...
(define
  (problem test_kitchen_chicken_soup_250830_043224_seed_499639)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn22415=0.0)
	(atposition faucet#1::joint_faucet_0 pstn22416=0.0)
	(atposition oven#1::knob_joint_2 pstn22414=0.0)
	(atposition counter#1::chewie_door_right_joint pstn22411=1.872)
	(atposition fridge#1::fridge_door pstn22413=1.78)
	(atposition counter#1::chewie_door_left_joint pstn22412=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn22414=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn22416=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn22415=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn22411=1.872)
	(position faucet#1::joint_faucet_0 pstn22416=0.0)
	(position oven#1::knob_joint_2 pstn22414=0.0)
	(position fridge#1::fridge_door pstn22413=1.78)
	(position counter#1::chewie_door_left_joint pstn22412=-1.872)
	(position oven#1::knob_joint_3 pstn22415=0.0)

	(pose braiserbody#1 p64346=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p64351=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p64348=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(pose chicken-leg p64347=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p64350=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p64347=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p64348=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(atpose braiserbody#1 p64346=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p64350=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p64351=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn22412=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn22411=1.872)
	(isopenedposition fridge#1::fridge_door pstn22413=1.78)
	...
	(contained salt-shaker p64350=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p64351=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p64349=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p64348=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531) counter#1::front_left_stove)
