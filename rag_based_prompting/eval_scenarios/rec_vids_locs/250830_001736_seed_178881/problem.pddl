...
(define
  (problem test_kitchen_chicken_soup_250830_001736_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn16483=1.78)
	(atposition counter#1::chewie_door_right_joint pstn16481=1.872)
	(atposition oven#1::knob_joint_3 pstn16485=0.0)
	(atposition oven#1::knob_joint_2 pstn16484=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16482=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn16486=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn16486=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16485=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16484=0.0)

	(position counter#1::chewie_door_right_joint pstn16481=1.872)
	(position oven#1::knob_joint_3 pstn16485=0.0)
	(position counter#1::chewie_door_left_joint pstn16482=-1.872)
	(position oven#1::knob_joint_2 pstn16484=0.0)
	(position faucet#1::joint_faucet_0 pstn16486=0.0)
	(position fridge#1::fridge_door pstn16483=1.78)

	(pose braiserlid#1 p42579=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose chicken-leg p42578=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p42581=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p42577=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p42582=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p42579=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose braiserbody#1 p42577=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p42581=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p42582=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p42578=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq544=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq208=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn16482=-1.872)
	(isopenedposition fridge#1::fridge_door pstn16483=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16481=1.872)

	(ataconf right aq208=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq544=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p42582=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p42581=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p42580=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p42579=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
