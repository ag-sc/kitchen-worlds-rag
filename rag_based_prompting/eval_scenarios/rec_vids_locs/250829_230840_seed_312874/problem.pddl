...
(define
  (problem test_kitchen_chicken_soup_250829_230840_seed_312874)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn15806=0.0)
	(position fridge#1::fridge_door pstn15805=1.78)
	(position oven#1::knob_joint_3 pstn15807=0.0)
	(position faucet#1::joint_faucet_0 pstn15808=0.0)
	(position counter#1::chewie_door_right_joint pstn15803=1.872)
	(position counter#1::chewie_door_left_joint pstn15804=-1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn15808=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15804=-1.872)
	(atposition oven#1::knob_joint_2 pstn15806=0.0)
	(atposition fridge#1::fridge_door pstn15805=1.78)
	(atposition oven#1::knob_joint_3 pstn15807=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15803=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn15806=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15808=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15807=0.0)
	...
	(pose chicken-leg p36727=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p36726=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p36731=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p36728=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(pose salt-shaker p36730=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p36731=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p36726=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p36730=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p36728=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(atpose chicken-leg p36727=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn15803=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15804=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15805=1.78)
	...
	(contained pepper-shaker p36731=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p36730=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p36729=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p36728=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441) counter#1::front_left_stove)
