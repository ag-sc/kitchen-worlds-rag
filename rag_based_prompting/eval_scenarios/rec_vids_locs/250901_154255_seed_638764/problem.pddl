...
(define
  (problem test_kitchen_chicken_soup_250901_154255_seed_638764)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn11871=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11868=1.872)
	(atposition faucet#1::joint_faucet_0 pstn11873=0.0)
	(atposition oven#1::knob_joint_3 pstn11872=0.0)
	(atposition fridge#1::fridge_door pstn11870=1.78)
	(atposition counter#1::chewie_door_left_joint pstn11869=-1.872)

	(position faucet#1::joint_faucet_0 pstn11873=0.0)
	(position fridge#1::fridge_door pstn11870=1.78)
	(position counter#1::chewie_door_right_joint pstn11868=1.872)
	(position counter#1::chewie_door_left_joint pstn11869=-1.872)
	(position oven#1::knob_joint_2 pstn11871=0.0)
	(position oven#1::knob_joint_3 pstn11872=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn11872=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11873=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11871=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn11870=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11868=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11869=-1.872)

	(pose chicken-leg p41997=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p41998=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827))
	(pose pepper-shaker p42001=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p42000=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p41996=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p42000=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p41996=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p41997=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p41998=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827))
	(atpose pepper-shaker p42001=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p42000=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p42001=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p41998=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827) counter#1::front_left_stove)
	(supported braiserbody#1 p41999=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
