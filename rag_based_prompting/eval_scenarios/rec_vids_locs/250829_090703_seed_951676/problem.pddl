...
(define
  (problem test_kitchen_chicken_soup_250829_090703_seed_951676)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p0=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	...
	(atpose braiserbody#1 p0=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p1=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625) counter#1::front_left_stove)
	(supported braiserbody#1 p3=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
