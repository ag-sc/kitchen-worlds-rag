...
(define
  (problem test_kitchen_chicken_soup_250829_122853_seed_77812)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn430=0.0)
	(atposition oven#1::knob_joint_2 pstn429=0.0)
	(atposition faucet#1::joint_faucet_0 pstn431=0.0)
	(atposition counter#1::chewie_door_left_joint pstn427=-1.872)
	(atposition fridge#1::fridge_door pstn428=1.78)
	(atposition counter#1::chewie_door_right_joint pstn426=1.872)
	...
	(position faucet#1::joint_faucet_0 pstn431=0.0)
	(position fridge#1::fridge_door pstn428=1.78)
	(position counter#1::chewie_door_right_joint pstn426=1.872)
	(position counter#1::chewie_door_left_joint pstn427=-1.872)
	(position oven#1::knob_joint_2 pstn429=0.0)
	(position oven#1::knob_joint_3 pstn430=0.0)

	(isopenedposition fridge#1::fridge_door pstn428=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn427=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn426=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn431=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn429=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn430=0.0)
	...
	(pose braiserlid#1 p2937=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(pose braiserbody#1 p2935=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p2937=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(atpose braiserbody#1 p2935=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p2937=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125) counter#1::front_left_stove)
	(supported braiserbody#1 p2938=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
