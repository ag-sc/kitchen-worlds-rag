...
(define
  (problem test_kitchen_chicken_soup_250828_143556_seed_854983)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(pose braiserbody#1 p0=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303) counter#1::front_left_stove)
