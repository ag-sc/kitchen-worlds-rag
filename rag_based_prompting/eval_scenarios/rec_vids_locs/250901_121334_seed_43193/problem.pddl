...
(define
  (problem test_kitchen_chicken_soup_250901_121334_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn5754=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5752=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5753=0.0)

	(position counter#1::chewie_door_left_joint pstn5750=-1.872)
	(position oven#1::knob_joint_2 pstn5752=0.0)
	(position counter#1::chewie_door_right_joint pstn5749=1.872)
	(position fridge#1::fridge_door pstn5751=1.78)
	(position oven#1::knob_joint_3 pstn5753=0.0)
	(position faucet#1::joint_faucet_0 pstn5754=0.0)

	(atposition counter#1::chewie_door_right_joint pstn5749=1.872)
	(atposition fridge#1::fridge_door pstn5751=1.78)
	(atposition oven#1::knob_joint_3 pstn5753=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5750=-1.872)
	(atposition oven#1::knob_joint_2 pstn5752=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5754=0.0)

	(pose braiserbody#1 p18353=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p18358=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p18357=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p18355=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(pose chicken-leg p18354=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p18355=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(atpose chicken-leg p18354=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p18357=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p18353=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p18358=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn5749=1.872)
	(isopenedposition fridge#1::fridge_door pstn5751=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5750=-1.872)
	...
	(contained salt-shaker p18357=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p18358=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p18356=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p18355=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
