...
(define
  (problem test_kitchen_dishwasher_260325_031629_seed_881038)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn5276=0.0)
	(position counter#1::chewie_door_right_joint pstn5272=0.0)
	(position oven#1::knob_joint_2 pstn5275=0.0)
	(position fridge#1::fridge_door pstn5274=0.0)
	(position faucet#1::joint_faucet_0 pstn5277=0.0)
	(position counter#1::indigo_drawer_top_joint pstn5271=0.0)
	(position counter#1::chewie_door_left_joint pstn5273=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn5277=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5272=0.0)
	(atposition oven#1::knob_joint_2 pstn5275=0.0)
	(atposition fridge#1::fridge_door pstn5274=0.0)
	(atposition oven#1::knob_joint_3 pstn5276=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn5271=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5273=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn5276=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn5272=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5275=0.0)
	(isclosedposition fridge#1::fridge_door pstn5274=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn5271=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn5273=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5277=0.0)
