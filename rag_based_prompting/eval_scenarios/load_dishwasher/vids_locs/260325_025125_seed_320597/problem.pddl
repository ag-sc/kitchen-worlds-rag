...
(define
  (problem test_kitchen_dishwasher_260325_025125_seed_320597)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn3635=0.0)
	(position counter#1::chewie_door_right_joint pstn3632=0.0)
	(position oven#1::knob_joint_3 pstn3636=0.0)
	(position counter#1::chewie_door_left_joint pstn3633=0.0)
	(position faucet#1::joint_faucet_0 pstn3637=0.0)
	(position counter#1::indigo_drawer_top_joint pstn3631=0.0)
	(position fridge#1::fridge_door pstn3634=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn3635=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn3632=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3636=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3637=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn3633=0.0)
	(isclosedposition fridge#1::fridge_door pstn3634=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn3631=0.0)
	...
	(atposition counter#1::indigo_drawer_top_joint pstn3631=0.0)
	(atposition oven#1::knob_joint_2 pstn3635=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3632=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3637=0.0)
	(atposition oven#1::knob_joint_3 pstn3636=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3633=0.0)
	(atposition fridge#1::fridge_door pstn3634=0.0)
