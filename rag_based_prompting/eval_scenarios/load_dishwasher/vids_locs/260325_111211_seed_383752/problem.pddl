...
(define
  (problem test_kitchen_dishwasher_260325_111211_seed_383752)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p0=(0.7, 8.788, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p1=(0.7, 8.788, 0.953, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p1=(0.7, 8.788, 0.953, 0.0, -0.0, 1.571))
	...
	(atpose braiserbody#1 p0=(0.7, 8.788, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p2=(0.7, 8.788, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1=(0.7, 8.788, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
