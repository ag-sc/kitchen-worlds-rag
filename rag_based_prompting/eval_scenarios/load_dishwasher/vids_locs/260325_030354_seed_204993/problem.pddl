...
(define
  (problem test_kitchen_dishwasher_260325_030354_seed_204993)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn4471=0.0)
	(position counter#1::chewie_door_left_joint pstn4470=0.0)
	(position faucet#1::joint_faucet_0 pstn4474=0.0)
	(position counter#1::chewie_door_right_joint pstn4469=0.0)
	(position counter#1::indigo_drawer_top_joint pstn4468=0.0)
	(position oven#1::knob_joint_2 pstn4472=0.0)
	(position oven#1::knob_joint_3 pstn4473=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn4474=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn4468=0.0)
	(atposition fridge#1::fridge_door pstn4471=0.0)
	(atposition oven#1::knob_joint_3 pstn4473=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4469=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4470=0.0)
	(atposition oven#1::knob_joint_2 pstn4472=0.0)

	(isclosedposition fridge#1::fridge_door pstn4471=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn4469=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn4470=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn4468=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4472=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4473=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4474=0.0)
