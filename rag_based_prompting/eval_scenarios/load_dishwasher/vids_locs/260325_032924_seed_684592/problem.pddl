...
(define
  (problem test_kitchen_dishwasher_260325_032924_seed_684592)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn6168=0.0)
	(position fridge#1::fridge_door pstn6167=0.0)
	(position faucet#1::joint_faucet_0 pstn6170=0.0)
	(position oven#1::knob_joint_3 pstn6169=0.0)
	(position counter#1::indigo_drawer_top_joint pstn6164=0.0)
	(position counter#1::chewie_door_right_joint pstn6165=0.0)
	(position counter#1::chewie_door_left_joint pstn6166=0.0)
	...
	(atposition oven#1::knob_joint_3 pstn6169=0.0)
	(atposition oven#1::knob_joint_2 pstn6168=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6166=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn6164=0.0)
	(atposition fridge#1::fridge_door pstn6167=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6170=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6165=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn6168=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn6166=0.0)
	(isclosedposition fridge#1::fridge_door pstn6167=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6169=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6170=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn6164=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn6165=0.0)
