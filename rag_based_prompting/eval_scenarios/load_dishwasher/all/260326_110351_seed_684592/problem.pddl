...
(define
  (problem test_kitchen_dishwasher_260326_110351_seed_684592)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn5175=0.0)
	(position oven#1::knob_joint_2 pstn5176=0.0)
	(position counter#1::chewie_door_left_joint pstn5174=0.0)
	(position faucet#1::joint_faucet_0 pstn5178=0.0)
	(position oven#1::knob_joint_3 pstn5177=0.0)
	(position counter#1::chewie_door_right_joint pstn5173=0.0)
	(position counter#1::indigo_drawer_top_joint pstn5172=0.0)
	...
	(atposition fridge#1::fridge_door pstn5175=0.0)
	(atposition oven#1::knob_joint_2 pstn5176=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5174=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5178=0.0)
	(atposition oven#1::knob_joint_3 pstn5177=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn5172=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5173=0.0)

	(isclosedposition fridge#1::fridge_door pstn5175=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5176=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn5174=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5178=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn5173=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5177=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn5172=0.0)
	...
	(atpose braiserlid#1 p2754=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p2757=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2756=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose counter#1::indigo_drawer_top lp224=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserbody#1 p2753=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p2758=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(pose pepper-shaker p2758=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2754=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571))
	(pose chicken-leg p2756=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p2757=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2753=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp224=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	...
	(startpose counter#1::indigo_drawer_top lp224=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p2758=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p2759=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p2757=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(relpose fork rp223=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p2755=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2754=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp223=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
