...
(define
  (problem test_kitchen_dishwasher_260326_115149_seed_383752)
  (:domain domain)
  ...
  (:init
	...
	(atbconf q936=(2.0, 6.25, 0.2, 3.142))
	...
	(position oven#1::knob_joint_3 pstn1935=0.0)
	(position counter#1::chewie_door_right_joint pstn1931=0.0)
	(position counter#1::indigo_drawer_top_joint pstn1930=0.0)
	(position counter#1::chewie_door_left_joint pstn1932=0.0)
	(position oven#1::knob_joint_2 pstn1934=0.0)
	(position fridge#1::fridge_door pstn1933=0.0)
	(position faucet#1::joint_faucet_0 pstn1936=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn1931=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn1930=0.0)
	(atposition oven#1::knob_joint_3 pstn1935=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1936=0.0)
	(atposition oven#1::knob_joint_2 pstn1934=0.0)
	(atposition fridge#1::fridge_door pstn1933=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1932=0.0)

	(isclosedposition counter#1::indigo_drawer_top_joint pstn1930=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1936=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1934=0.0)
	(isclosedposition fridge#1::fridge_door pstn1933=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn1931=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn1932=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1935=0.0)

	(atpose pepper-shaker p937=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p935=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p932=(0.7, 8.788, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p933=(0.7, 8.788, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p936=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose counter#1::indigo_drawer_top lp68=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(aconf right aq792=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(aconf left aq672=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(ataconf right aq792=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq672=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(pose counter#1::indigo_drawer_top lp68=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserlid#1 p933=(0.7, 8.788, 0.953, 0.0, -0.0, 1.571))
	(pose braiserbody#1 p932=(0.7, 8.788, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p936=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p935=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p937=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(jointaffectlink counter#1::indigo_drawer_top_joint counter#1::indigo_drawer_top)
	(supported braiserlid#1 p933=(0.7, 8.788, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p934=(0.7, 8.788, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp68=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p937=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p938=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p936=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(relpose fork rp68=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(atrelpose fork rp68=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
