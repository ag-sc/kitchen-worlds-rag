...
(define
  (problem test_kitchen_dishwasher_260324_202737_seed_881038)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn21381=0.0)
	(atposition counter#1::chewie_door_right_joint pstn21376=0.0)
	(atposition oven#1::knob_joint_3 pstn21380=0.0)
	(atposition oven#1::knob_joint_2 pstn21379=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn21375=0.0)
	(atposition counter#1::chewie_door_left_joint pstn21377=0.0)
	(atposition fridge#1::fridge_door pstn21378=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn21381=0.0)
	(isclosedposition fridge#1::fridge_door pstn21378=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn21376=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn21377=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn21380=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21379=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn21375=0.0)

	(position counter#1::chewie_door_left_joint pstn21377=0.0)
	(position oven#1::knob_joint_3 pstn21380=0.0)
	(position counter#1::indigo_drawer_top_joint pstn21375=0.0)
	(position fridge#1::fridge_door pstn21378=0.0)
	(position faucet#1::joint_faucet_0 pstn21381=0.0)
	(position oven#1::knob_joint_2 pstn21379=0.0)
	(position counter#1::chewie_door_right_joint pstn21376=0.0)

	(pose braiserlid#1 p7072=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571))
	(pose salt-shaker p7075=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p7074=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose counter#1::indigo_drawer_top lp553=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose pepper-shaker p7076=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p7071=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p7071=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p7072=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571))
	(atpose chicken-leg p7074=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p7076=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p7075=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose counter#1::indigo_drawer_top lp553=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	...
	(startpose counter#1::indigo_drawer_top lp553=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p7077=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p7075=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p7076=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(relpose fork rp551=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p7073=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p7072=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp551=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
