...
(define
  (problem test_kitchen_dishwasher_260324_174701_seed_75471)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn6898=0.0)
	(position fridge#1::fridge_door pstn6897=0.0)
	(position counter#1::chewie_door_left_joint pstn6896=0.0)
	(position oven#1::knob_joint_3 pstn6899=0.0)
	(position counter#1::indigo_drawer_top_joint pstn6894=0.0)
	(position counter#1::chewie_door_right_joint pstn6895=0.0)
	(position faucet#1::joint_faucet_0 pstn6900=0.0)
	...
	(atposition oven#1::knob_joint_3 pstn6899=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6896=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6895=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6900=0.0)
	(atposition oven#1::knob_joint_2 pstn6898=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn6894=0.0)
	(atposition fridge#1::fridge_door pstn6897=0.0)
	...
	(pose salt-shaker p2042=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp185=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserlid#1 p2039=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(pose chicken-leg p2041=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p2043=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2038=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))

	(isclosedposition counter#1::chewie_door_left_joint pstn6896=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6899=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn6894=0.0)
	(isclosedposition fridge#1::fridge_door pstn6897=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6900=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn6895=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6898=0.0)

	(atpose braiserbody#1 p2038=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(atpose counter#1::indigo_drawer_top lp185=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose salt-shaker p2042=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2039=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(atpose chicken-leg p2041=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p2043=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(supported braiserlid#1 p2039=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p2040=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp185=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p2043=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p2044=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p2042=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(relpose fork rp184=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(atrelpose fork rp184=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
