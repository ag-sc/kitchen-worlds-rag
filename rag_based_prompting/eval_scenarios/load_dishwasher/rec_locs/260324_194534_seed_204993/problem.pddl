...
(define
  (problem test_kitchen_dishwasher_260324_194534_seed_204993)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn17750=0.0)
	(position counter#1::indigo_drawer_top_joint pstn17744=0.0)
	(position oven#1::knob_joint_3 pstn17749=0.0)
	(position counter#1::chewie_door_left_joint pstn17746=0.0)
	(position oven#1::knob_joint_2 pstn17748=0.0)
	(position counter#1::chewie_door_right_joint pstn17745=0.0)
	(position fridge#1::fridge_door pstn17747=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn17745=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17746=0.0)
	(atposition oven#1::knob_joint_2 pstn17748=0.0)
	(atposition fridge#1::fridge_door pstn17747=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn17744=0.0)
	(atposition faucet#1::joint_faucet_0 pstn17750=0.0)
	(atposition oven#1::knob_joint_3 pstn17749=0.0)

	(pose chicken-leg p5929=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p5931=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p5927=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571))
	(pose salt-shaker p5930=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp462=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserbody#1 p5926=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571))

	(isclosedposition counter#1::chewie_door_left_joint pstn17746=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17748=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17749=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn17745=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17750=0.0)
	(isclosedposition fridge#1::fridge_door pstn17747=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn17744=0.0)

	(atpose pepper-shaker p5931=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p5927=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p5930=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p5929=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose counter#1::indigo_drawer_top lp462=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserbody#1 p5926=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571))
	...
	(startpose counter#1::indigo_drawer_top lp462=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p5931=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p5930=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p5932=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(relpose fork rp460=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p5928=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p5927=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp460=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
