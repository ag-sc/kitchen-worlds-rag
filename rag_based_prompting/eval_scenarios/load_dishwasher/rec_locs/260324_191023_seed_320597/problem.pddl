...
(define
  (problem test_kitchen_dishwasher_260324_191023_seed_320597)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn14047=0.0)
	(position counter#1::indigo_drawer_top_joint pstn14043=0.0)
	(position fridge#1::fridge_door pstn14046=0.0)
	(position faucet#1::joint_faucet_0 pstn14049=0.0)
	(position oven#1::knob_joint_3 pstn14048=0.0)
	(position counter#1::chewie_door_right_joint pstn14044=0.0)
	(position counter#1::chewie_door_left_joint pstn14045=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn14044=0.0)
	(atposition fridge#1::fridge_door pstn14046=0.0)
	(atposition oven#1::knob_joint_3 pstn14048=0.0)
	(atposition faucet#1::joint_faucet_0 pstn14049=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14045=0.0)
	(atposition oven#1::knob_joint_2 pstn14047=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn14043=0.0)

	(pose braiserbody#1 p4338=(0.7, 8.691, 0.923, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp372=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose chicken-leg p4341=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p4342=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4339=(0.7, 8.691, 0.953, 0.0, -0.0, 1.571))
	(pose pepper-shaker p4343=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p4338=(0.7, 8.691, 0.923, 0.0, -0.0, 1.571))
	(atpose counter#1::indigo_drawer_top lp372=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose salt-shaker p4342=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p4343=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p4339=(0.7, 8.691, 0.953, 0.0, -0.0, 1.571))
	(atpose chicken-leg p4341=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isclosedposition counter#1::indigo_drawer_top_joint pstn14043=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14049=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn14044=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn14045=0.0)
	(isclosedposition fridge#1::fridge_door pstn14046=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14048=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14047=0.0)
	...
	(startpose counter#1::indigo_drawer_top lp372=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained salt-shaker p4342=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p4344=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p4343=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(relpose fork rp370=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p4340=(0.7, 8.691, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p4339=(0.7, 8.691, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp370=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
