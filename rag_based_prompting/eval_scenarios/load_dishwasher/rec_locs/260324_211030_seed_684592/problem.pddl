...
(define
  (problem test_kitchen_dishwasher_260324_211030_seed_684592)
  (:domain domain)
  ...
  (:init
	...
	(atbconf q904=(2.0, 6.25, 0.2, 3.142))
	...
	(atposition oven#1::knob_joint_3 pstn24840=0.0)
	(atposition faucet#1::joint_faucet_0 pstn24841=0.0)
	(atposition counter#1::chewie_door_left_joint pstn24837=0.0)
	(atposition oven#1::knob_joint_2 pstn24839=0.0)
	(atposition counter#1::chewie_door_right_joint pstn24836=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn24835=0.0)
	(atposition fridge#1::fridge_door pstn24838=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn24836=0.0)
	(position counter#1::indigo_drawer_top_joint pstn24835=0.0)
	(position fridge#1::fridge_door pstn24838=0.0)
	(position oven#1::knob_joint_3 pstn24840=0.0)
	(position counter#1::chewie_door_left_joint pstn24837=0.0)
	(position oven#1::knob_joint_2 pstn24839=0.0)
	(position faucet#1::joint_faucet_0 pstn24841=0.0)

	(pose braiserlid#1 p7986=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571))
	(pose salt-shaker p7989=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p7985=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp646=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose chicken-leg p7988=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p7990=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p7986=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p7989=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p7985=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p7988=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p7990=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose counter#1::indigo_drawer_top lp646=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(isclosedposition counter#1::chewie_door_right_joint pstn24836=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn24835=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn24837=0.0)
	(isclosedposition fridge#1::fridge_door pstn24838=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24840=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24839=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24841=0.0)
	...
	(supported braiserlid#1 p7986=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p7987=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp646=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p7990=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p7991=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p7989=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(relpose fork rp644=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(atrelpose fork rp644=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
