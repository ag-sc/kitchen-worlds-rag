...
(define
  (problem test_kitchen_dishwasher_260323_151019_seed_212514)
  (:domain domain)
  ...
  (:init
	...
	(bconf q912=(2.0, 6.25, 0.2, 3.142))

	(atbconf q912=(2.0, 6.25, 0.2, 3.142))
	...
	(position oven#1::knob_joint_3 pstn3893=0.0)
	(position counter#1::indigo_drawer_top_joint pstn3888=0.0)
	(position faucet#1::joint_faucet_0 pstn3894=0.0)
	(position counter#1::chewie_door_left_joint pstn3890=0.0)
	(position oven#1::knob_joint_2 pstn3892=0.0)
	(position fridge#1::fridge_door pstn3891=0.0)
	(position counter#1::chewie_door_right_joint pstn3889=0.0)

	(atposition oven#1::knob_joint_3 pstn3893=0.0)
	(atposition oven#1::knob_joint_2 pstn3892=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3889=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3890=0.0)
	(atposition fridge#1::fridge_door pstn3891=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3894=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn3888=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn3894=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn3890=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3892=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn3888=0.0)
	(isclosedposition fridge#1::fridge_door pstn3891=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn3889=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3893=0.0)
	...
	(ataconf right aq144=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(aconf right aq144=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(aconf left aq824=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(pose counter#1::indigo_drawer_top lp94=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose chicken-leg p1112=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1110=(0.7, 8.855, 0.953, 0.0, -0.0, 1.571))
	(pose salt-shaker p1113=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p1114=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1109=(0.7, 8.855, 0.923, 0.0, -0.0, 1.571))

	(atpose counter#1::indigo_drawer_top lp94=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserlid#1 p1110=(0.7, 8.855, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p1113=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1109=(0.7, 8.855, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p1114=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1112=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(jointaffectlink counter#1::indigo_drawer_top_joint counter#1::indigo_drawer_top)

	(supported braiserlid#1 p1110=(0.7, 8.855, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p1111=(0.7, 8.855, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp94=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(relpose fork rp94=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(contained fork p1115=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p1113=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p1114=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(atrelpose fork rp94=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
