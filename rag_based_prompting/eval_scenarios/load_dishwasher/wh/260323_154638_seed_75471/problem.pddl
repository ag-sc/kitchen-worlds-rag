...
(define
  (problem test_kitchen_dishwasher_260323_154638_seed_75471)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn12484=0.0)
	(position counter#1::indigo_drawer_top_joint pstn12480=0.0)
	(position counter#1::chewie_door_right_joint pstn12481=0.0)
	(position oven#1::knob_joint_3 pstn12485=0.0)
	(position fridge#1::fridge_door pstn12483=0.0)
	(position counter#1::chewie_door_left_joint pstn12482=0.0)
	(position faucet#1::joint_faucet_0 pstn12486=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn12482=0.0)
	(atposition oven#1::knob_joint_3 pstn12485=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn12480=0.0)
	(atposition fridge#1::fridge_door pstn12483=0.0)
	(atposition oven#1::knob_joint_2 pstn12484=0.0)
	(atposition counter#1::chewie_door_right_joint pstn12481=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12486=0.0)

	(atpose chicken-leg p7898=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p7900=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p7895=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p7899=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose counter#1::indigo_drawer_top lp184=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserlid#1 p7896=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(isclosedposition counter#1::chewie_door_left_joint pstn12482=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12484=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn12480=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn12481=0.0)
	(isclosedposition fridge#1::fridge_door pstn12483=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12486=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12485=0.0)
	(pose pepper-shaker p7900=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p7896=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(pose chicken-leg p7898=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p7899=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp184=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserbody#1 p7895=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	...
	(startpose counter#1::indigo_drawer_top lp184=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p7900=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p7899=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p7901=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(relpose fork rp183=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p7897=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p7896=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp183=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
