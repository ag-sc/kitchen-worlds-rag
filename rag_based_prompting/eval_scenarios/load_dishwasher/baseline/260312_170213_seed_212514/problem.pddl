...
(define
  (problem test_kitchen_dishwasher_260312_170213_seed_212514)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p0=(0.7, 8.855, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p4=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p1=(0.7, 8.855, 0.953, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p1=(0.7, 8.855, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p4=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p0=(0.7, 8.855, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p2=(0.7, 8.855, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1=(0.7, 8.855, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
