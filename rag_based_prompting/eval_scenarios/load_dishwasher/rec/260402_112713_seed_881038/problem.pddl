...
(define
  (problem test_kitchen_dishwasher_260402_112713_seed_881038)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p1=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571))
	(pose chicken-leg p3=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p0=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p1=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571))
	(atpose braiserbody#1 p0=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p2=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
