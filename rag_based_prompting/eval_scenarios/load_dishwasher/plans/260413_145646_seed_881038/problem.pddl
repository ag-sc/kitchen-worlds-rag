...
(define
  (problem test_kitchen_dishwasher_260413_145646_seed_881038)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn963=0.0)
	(position faucet#1::joint_faucet_0 pstn966=0.0)
	(position counter#1::chewie_door_right_joint pstn961=0.0)
	(position oven#1::knob_joint_2 pstn964=0.0)
	(position oven#1::knob_joint_3 pstn965=0.0)
	(position counter#1::indigo_drawer_top_joint pstn960=0.0)
	(position counter#1::chewie_door_left_joint pstn962=0.0)

	(atposition faucet#1::joint_faucet_0 pstn966=0.0)
	(atposition counter#1::chewie_door_right_joint pstn961=0.0)
	(atposition oven#1::knob_joint_2 pstn964=0.0)
	(atposition oven#1::knob_joint_3 pstn965=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn960=0.0)
	(atposition counter#1::chewie_door_left_joint pstn962=0.0)
	(atposition fridge#1::fridge_door pstn963=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn966=0.0)
	(isclosedposition fridge#1::fridge_door pstn963=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn964=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn965=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn960=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn962=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn961=0.0)

	(pose chicken-leg p497=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p495=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571))
	(pose braiserbody#1 p494=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp33=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose pepper-shaker p499=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p498=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p495=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571))
	(atpose braiserbody#1 p494=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p499=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p497=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose counter#1::indigo_drawer_top lp33=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose salt-shaker p498=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(supported braiserlid#1 p495=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p496=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp33=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p500=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p499=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p498=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
