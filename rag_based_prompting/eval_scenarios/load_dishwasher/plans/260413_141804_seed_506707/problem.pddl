...
(define
  (problem test_kitchen_dishwasher_260413_141804_seed_506707)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1039=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1038=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1037=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1042=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn1036=0.0)
	(atposition oven#1::knob_joint_3 pstn1041=0.0)
	(atposition oven#1::knob_joint_2 pstn1040=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn1038=0.0)
	(position counter#1::chewie_door_right_joint pstn1037=0.0)
	(position fridge#1::fridge_door pstn1039=0.0)
	(position faucet#1::joint_faucet_0 pstn1042=0.0)
	(position oven#1::knob_joint_2 pstn1040=0.0)
	(position counter#1::indigo_drawer_top_joint pstn1036=0.0)
	(position oven#1::knob_joint_3 pstn1041=0.0)

	(pose salt-shaker p459=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p458=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose counter#1::indigo_drawer_top lp35=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserbody#1 p455=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p456=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(pose pepper-shaker p460=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p456=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p460=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose counter#1::indigo_drawer_top lp35=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserbody#1 p455=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p459=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p458=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isclosedposition counter#1::chewie_door_left_joint pstn1038=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn1037=0.0)
	(isclosedposition fridge#1::fridge_door pstn1039=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1042=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1041=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn1036=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1040=0.0)
	...
	(supported braiserlid#1 p456=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p457=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp35=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained salt-shaker p459=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p461=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p460=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
