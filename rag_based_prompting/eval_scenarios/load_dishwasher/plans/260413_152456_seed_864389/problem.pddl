...
(define
  (problem test_kitchen_dishwasher_260413_152456_seed_864389)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn1174=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1170=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1171=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn1169=0.0)
	(atposition oven#1::knob_joint_2 pstn1173=0.0)
	(atposition fridge#1::fridge_door pstn1172=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1175=0.0)
	...
	(position faucet#1::joint_faucet_0 pstn1175=0.0)
	(position oven#1::knob_joint_3 pstn1174=0.0)
	(position counter#1::chewie_door_left_joint pstn1171=0.0)
	(position fridge#1::fridge_door pstn1172=0.0)
	(position counter#1::chewie_door_right_joint pstn1170=0.0)
	(position counter#1::indigo_drawer_top_joint pstn1169=0.0)
	(position oven#1::knob_joint_2 pstn1173=0.0)

	(isclosedposition fridge#1::fridge_door pstn1172=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn1171=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1173=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1174=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1175=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn1170=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn1169=0.0)
	...
	(pose salt-shaker p564=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp40=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserlid#1 p561=(0.7, 8.896, 0.953, 0.0, -0.0, 1.571))
	(pose braiserbody#1 p560=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p563=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p565=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p565=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p563=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose counter#1::indigo_drawer_top lp40=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserlid#1 p561=(0.7, 8.896, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p564=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p560=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	...
	(startpose counter#1::indigo_drawer_top lp40=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p566=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p565=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p564=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(relpose fork rp40=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p562=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p561=(0.7, 8.896, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp40=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
