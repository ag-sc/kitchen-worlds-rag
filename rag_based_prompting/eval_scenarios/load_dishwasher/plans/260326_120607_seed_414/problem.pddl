...
(define
  (problem test_kitchen_dishwasher_260326_120607_seed_414)
  (:domain domain)
  ...
  (:init
	...
	(atpose braiserlid#1 p1537=(0.7, 8.816, 0.953, 0.0, -0.0, 1.571))
	(atpose counter#1::indigo_drawer_top lp102=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserbody#1 p1536=(0.7, 8.816, 0.923, 0.0, -0.0, 1.571))
	...
	(pose braiserbody#1 p1536=(0.7, 8.816, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p1540=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p1537=(0.7, 8.816, 0.953, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p1538=(0.7, 8.816, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1537=(0.7, 8.816, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
