...
(define
  (problem test_kitchen_dishwasher_260413_130848_seed_414)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p1=(0.7, 8.816, 0.953, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p1=(0.7, 8.816, 0.953, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p1=(0.7, 8.816, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p2=(0.7, 8.816, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
