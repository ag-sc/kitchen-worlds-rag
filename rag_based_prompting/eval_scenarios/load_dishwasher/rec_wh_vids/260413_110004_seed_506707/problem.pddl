...
(define
  (problem test_kitchen_dishwasher_260413_110004_seed_506707)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn6090=0.0)
	(position oven#1::knob_joint_3 pstn6092=0.0)
	(position oven#1::knob_joint_2 pstn6091=0.0)
	(position faucet#1::joint_faucet_0 pstn6093=0.0)
	(position counter#1::indigo_drawer_top_joint pstn6087=0.0)
	(position counter#1::chewie_door_left_joint pstn6089=0.0)
	(position counter#1::chewie_door_right_joint pstn6088=0.0)

	(atposition oven#1::knob_joint_2 pstn6091=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6093=0.0)
	(atposition oven#1::knob_joint_3 pstn6092=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6089=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn6087=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6088=0.0)
	(atposition fridge#1::fridge_door pstn6090=0.0)
	...
	(atpose braiserlid#1 p4487=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(atpose chicken-leg p4489=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p4491=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose counter#1::indigo_drawer_top lp116=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose salt-shaker p4490=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p4486=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))

	(isclosedposition counter#1::chewie_door_right_joint pstn6088=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6091=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6093=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6092=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn6089=0.0)
	(isclosedposition fridge#1::fridge_door pstn6090=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn6087=0.0)
	(pose pepper-shaker p4491=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp116=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose chicken-leg p4489=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p4490=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4487=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(pose braiserbody#1 p4486=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	...
	(startpose counter#1::indigo_drawer_top lp116=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p4491=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p4492=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p4490=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(relpose fork rp116=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p4488=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p4487=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp116=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
