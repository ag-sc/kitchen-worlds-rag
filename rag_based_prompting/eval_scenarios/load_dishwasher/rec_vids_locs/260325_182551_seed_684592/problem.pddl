...
(define
  (problem test_kitchen_dishwasher_260325_182551_seed_684592)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn7822=0.0)
	(position counter#1::indigo_drawer_top_joint pstn7819=0.0)
	(position oven#1::knob_joint_3 pstn7824=0.0)
	(position counter#1::chewie_door_left_joint pstn7821=0.0)
	(position oven#1::knob_joint_2 pstn7823=0.0)
	(position faucet#1::joint_faucet_0 pstn7825=0.0)
	(position counter#1::chewie_door_right_joint pstn7820=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn7825=0.0)
	(isclosedposition fridge#1::fridge_door pstn7822=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn7820=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn7821=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn7819=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7824=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7823=0.0)

	(atposition counter#1::indigo_drawer_top_joint pstn7819=0.0)
	(atposition oven#1::knob_joint_3 pstn7824=0.0)
	(atposition oven#1::knob_joint_2 pstn7823=0.0)
	(atposition fridge#1::fridge_door pstn7822=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7820=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7821=0.0)
	(atposition faucet#1::joint_faucet_0 pstn7825=0.0)
