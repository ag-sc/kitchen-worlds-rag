...
(define
  (problem test_kitchen_dishwasher_260325_175320_seed_204993)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn6525=0.0)
	(position fridge#1::fridge_door pstn6524=0.0)
	(position counter#1::indigo_drawer_top_joint pstn6521=0.0)
	(position oven#1::knob_joint_3 pstn6526=0.0)
	(position counter#1::chewie_door_left_joint pstn6523=0.0)
	(position counter#1::chewie_door_right_joint pstn6522=0.0)
	(position faucet#1::joint_faucet_0 pstn6527=0.0)
	...
	(isclosedposition fridge#1::fridge_door pstn6524=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6526=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6525=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn6523=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn6522=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn6521=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6527=0.0)
	...
	(atposition counter#1::indigo_drawer_top_joint pstn6521=0.0)
	(atposition fridge#1::fridge_door pstn6524=0.0)
	(atposition oven#1::knob_joint_3 pstn6526=0.0)
	(atposition oven#1::knob_joint_2 pstn6525=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6523=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6527=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6522=0.0)
