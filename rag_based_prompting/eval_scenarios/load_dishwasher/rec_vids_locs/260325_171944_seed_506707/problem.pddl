...
(define
  (problem test_kitchen_dishwasher_260325_171944_seed_506707)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn4687=0.0)
	(position fridge#1::fridge_door pstn4684=0.0)
	(position oven#1::knob_joint_2 pstn4685=0.0)
	(position counter#1::chewie_door_left_joint pstn4683=0.0)
	(position counter#1::chewie_door_right_joint pstn4682=0.0)
	(position counter#1::indigo_drawer_top_joint pstn4681=0.0)
	(position oven#1::knob_joint_3 pstn4686=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn4682=0.0)
	(atposition oven#1::knob_joint_3 pstn4686=0.0)
	(atposition fridge#1::fridge_door pstn4684=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn4681=0.0)
	(atposition oven#1::knob_joint_2 pstn4685=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4683=0.0)
	(atposition faucet#1::joint_faucet_0 pstn4687=0.0)
	...
	(isclosedposition counter#1::indigo_drawer_top_joint pstn4681=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4686=0.0)
	(isclosedposition fridge#1::fridge_door pstn4684=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4687=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4685=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn4683=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn4682=0.0)
