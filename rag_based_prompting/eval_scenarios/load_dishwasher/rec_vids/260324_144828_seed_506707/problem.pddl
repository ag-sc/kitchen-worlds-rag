...
(define
  (problem test_kitchen_dishwasher_260324_144828_seed_506707)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn4682=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn4679=0.0)
	(atposition faucet#1::joint_faucet_0 pstn4685=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4681=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4680=0.0)
	(atposition oven#1::knob_joint_2 pstn4683=0.0)
	(atposition oven#1::knob_joint_3 pstn4684=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn4685=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn4680=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4683=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4684=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn4681=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn4679=0.0)
	(isclosedposition fridge#1::fridge_door pstn4682=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn4680=0.0)
	(position oven#1::knob_joint_2 pstn4683=0.0)
	(position oven#1::knob_joint_3 pstn4684=0.0)
	(position fridge#1::fridge_door pstn4682=0.0)
	(position counter#1::chewie_door_left_joint pstn4681=0.0)
	(position counter#1::indigo_drawer_top_joint pstn4679=0.0)
	(position faucet#1::joint_faucet_0 pstn4685=0.0)

	(pose braiserbody#1 p2321=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2322=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(pose salt-shaker p2325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p2326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp169=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose chicken-leg p2324=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserbody#1 p2321=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(atpose counter#1::indigo_drawer_top lp169=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose pepper-shaker p2326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2324=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p2322=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p2325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(startpose counter#1::indigo_drawer_top lp169=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p2326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p2327=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(relpose fork rp169=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p2323=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2322=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp169=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
