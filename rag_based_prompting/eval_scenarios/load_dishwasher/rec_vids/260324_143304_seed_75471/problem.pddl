...
(define
  (problem test_kitchen_dishwasher_260324_143304_seed_75471)
  (:domain domain)
  ...
  (:init
	...
	(bconf q440=(2.0, 6.25, 0.2, 3.142))

	(atbconf q440=(2.0, 6.25, 0.2, 3.142))
	...
	(position oven#1::knob_joint_2 pstn3836=0.0)
	(position counter#1::indigo_drawer_top_joint pstn3832=0.0)
	(position counter#1::chewie_door_right_joint pstn3833=0.0)
	(position fridge#1::fridge_door pstn3835=0.0)
	(position faucet#1::joint_faucet_0 pstn3838=0.0)
	(position oven#1::knob_joint_3 pstn3837=0.0)
	(position counter#1::chewie_door_left_joint pstn3834=0.0)

	(atposition faucet#1::joint_faucet_0 pstn3838=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn3832=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3834=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3833=0.0)
	(atposition oven#1::knob_joint_2 pstn3836=0.0)
	(atposition fridge#1::fridge_door pstn3835=0.0)
	(atposition oven#1::knob_joint_3 pstn3837=0.0)
	...
	(pose braiserlid#1 p1961=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(pose chicken-leg p1963=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p1960=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp135=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose pepper-shaker p1965=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p1964=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p1964=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1963=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p1961=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p1965=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1960=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(atpose counter#1::indigo_drawer_top lp135=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(isclosedposition counter#1::chewie_door_right_joint pstn3833=0.0)
	(isclosedposition fridge#1::fridge_door pstn3835=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3837=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3838=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn3834=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3836=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn3832=0.0)

	(aconf left aq912=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq896=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(ataconf left aq912=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	...
	(startpose counter#1::indigo_drawer_top lp135=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p1966=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p1964=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p1965=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(relpose fork rp135=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p1962=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1961=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp135=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
