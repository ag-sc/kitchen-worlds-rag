...
(define
  (problem test_kitchen_dishwasher_260323_174247_seed_75471)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition fridge#1::fridge_door pstn1967=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1969=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn1966=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn1965=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn1964=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1970=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1968=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn1966=0.0)
	(position oven#1::knob_joint_2 pstn1968=0.0)
	(position faucet#1::joint_faucet_0 pstn1970=0.0)
	(position counter#1::chewie_door_right_joint pstn1965=0.0)
	(position fridge#1::fridge_door pstn1967=0.0)
	(position counter#1::indigo_drawer_top_joint pstn1964=0.0)
	(position oven#1::knob_joint_3 pstn1969=0.0)

	(atposition counter#1::chewie_door_left_joint pstn1966=0.0)
	(atposition oven#1::knob_joint_2 pstn1968=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1970=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1965=0.0)
	(atposition fridge#1::fridge_door pstn1967=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn1964=0.0)
	(atposition oven#1::knob_joint_3 pstn1969=0.0)

	(pose chicken-leg p883=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p884=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p880=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp66=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose pepper-shaker p885=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p881=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))

	(atpose chicken-leg p883=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p884=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p885=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p880=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p881=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	...
	(contained fork p886=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p884=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p885=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(relpose fork rp66=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p882=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p881=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
