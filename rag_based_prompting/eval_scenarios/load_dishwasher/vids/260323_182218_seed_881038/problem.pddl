...
(define
  (problem test_kitchen_dishwasher_260323_182218_seed_881038)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn2658=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2653=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2654=0.0)
	(atposition oven#1::knob_joint_3 pstn2657=0.0)
	(atposition fridge#1::fridge_door pstn2655=0.0)
	(atposition oven#1::knob_joint_2 pstn2656=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn2652=0.0)

	(isclosedposition fridge#1::fridge_door pstn2655=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn2652=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2658=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2656=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn2653=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn2654=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2657=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn2653=0.0)
	(position faucet#1::joint_faucet_0 pstn2658=0.0)
	(position fridge#1::fridge_door pstn2655=0.0)
	(position counter#1::chewie_door_left_joint pstn2654=0.0)
	(position oven#1::knob_joint_2 pstn2656=0.0)
	(position oven#1::knob_joint_3 pstn2657=0.0)
	(position counter#1::indigo_drawer_top_joint pstn2652=0.0)

	(pose chicken-leg p2221=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose counter#1::indigo_drawer_top lp66=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose pepper-shaker p2223=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2218=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2219=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571))
	(pose salt-shaker p2222=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p2219=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571))
	(atpose chicken-leg p2221=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p2222=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose counter#1::indigo_drawer_top lp66=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose pepper-shaker p2223=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2218=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p2219=(0.7, 8.872, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p2220=(0.7, 8.872, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp66=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained salt-shaker p2222=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p2224=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p2223=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(relpose fork rp65=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(atrelpose fork rp65=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
