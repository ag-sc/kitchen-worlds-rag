...
(define
  (problem test_kitchen_dishwasher_260323_200900_seed_684592)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn8212=0.0)
	(position counter#1::chewie_door_left_joint pstn8209=0.0)
	(position fridge#1::fridge_door pstn8210=0.0)
	(position oven#1::knob_joint_2 pstn8211=0.0)
	(position counter#1::indigo_drawer_top_joint pstn8207=0.0)
	(position faucet#1::joint_faucet_0 pstn8213=0.0)
	(position counter#1::chewie_door_right_joint pstn8208=0.0)

	(atposition oven#1::knob_joint_2 pstn8211=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8208=0.0)
	(atposition oven#1::knob_joint_3 pstn8212=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8213=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8209=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn8207=0.0)
	(atposition fridge#1::fridge_door pstn8210=0.0)
	...
	(pose braiserbody#1 p4242=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p4246=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4243=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp304=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose chicken-leg p4245=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p4247=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isclosedposition counter#1::chewie_door_right_joint pstn8208=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn8209=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8212=0.0)
	(isclosedposition fridge#1::fridge_door pstn8210=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8211=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn8207=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8213=0.0)
	...
	(atpose counter#1::indigo_drawer_top lp304=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserbody#1 p4242=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p4246=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p4243=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p4247=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p4245=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(jointaffectlink counter#1::indigo_drawer_top_joint counter#1::indigo_drawer_top)

	(startpose counter#1::indigo_drawer_top lp304=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p4248=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p4247=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4246=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(relpose fork rp304=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p4244=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p4243=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp304=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
