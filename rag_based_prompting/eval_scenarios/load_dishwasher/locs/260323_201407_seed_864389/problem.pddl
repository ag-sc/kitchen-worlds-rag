...
(define
  (problem test_kitchen_dishwasher_260323_201407_seed_864389)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p1=(0.7, 8.896, 0.953, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p1=(0.7, 8.896, 0.953, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p2=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1=(0.7, 8.896, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
