...
(define
  (problem test_kitchen_dishwasher_260323_194736_seed_204993)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn6478=0.0)
	(position faucet#1::joint_faucet_0 pstn6481=0.0)
	(position counter#1::chewie_door_right_joint pstn6476=0.0)
	(position oven#1::knob_joint_3 pstn6480=0.0)
	(position counter#1::chewie_door_left_joint pstn6477=0.0)
	(position counter#1::indigo_drawer_top_joint pstn6475=0.0)
	(position oven#1::knob_joint_2 pstn6479=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn6481=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6476=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn6475=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6477=0.0)
	(atposition oven#1::knob_joint_2 pstn6479=0.0)
	(atposition oven#1::knob_joint_3 pstn6480=0.0)
	(atposition fridge#1::fridge_door pstn6478=0.0)
	...
	(pose chicken-leg p3417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p3419=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3414=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp236=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserlid#1 p3415=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571))
	(pose salt-shaker p3418=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p3415=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571))
	(atpose chicken-leg p3417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose counter#1::indigo_drawer_top lp236=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose pepper-shaker p3419=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p3418=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p3414=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571))

	(isclosedposition counter#1::indigo_drawer_top_joint pstn6475=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6479=0.0)
	(isclosedposition fridge#1::fridge_door pstn6478=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6481=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6480=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn6476=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn6477=0.0)

	(ataconf left aq672=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq864=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(aconf right aq864=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	...
	(startpose counter#1::indigo_drawer_top lp236=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p3420=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p3419=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3418=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(relpose fork rp236=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p3416=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3415=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp236=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
