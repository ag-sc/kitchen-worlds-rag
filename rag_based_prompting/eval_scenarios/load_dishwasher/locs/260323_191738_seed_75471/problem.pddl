...
(define
  (problem test_kitchen_dishwasher_260323_191738_seed_75471)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn3713=0.0)
	(position fridge#1::fridge_door pstn3712=0.0)
	(position counter#1::chewie_door_left_joint pstn3711=0.0)
	(position counter#1::indigo_drawer_top_joint pstn3709=0.0)
	(position oven#1::knob_joint_3 pstn3714=0.0)
	(position faucet#1::joint_faucet_0 pstn3715=0.0)
	(position counter#1::chewie_door_right_joint pstn3710=0.0)

	(atposition oven#1::knob_joint_3 pstn3714=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3710=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn3709=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3715=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3711=0.0)
	(atposition oven#1::knob_joint_2 pstn3713=0.0)
	(atposition fridge#1::fridge_door pstn3712=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn3714=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn3710=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn3709=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3713=0.0)
	(isclosedposition fridge#1::fridge_door pstn3712=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3715=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn3711=0.0)
	...
	(pose pepper-shaker p1958=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p1957=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1953=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p1956=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1954=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp134=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	...
	(atpose counter#1::indigo_drawer_top lp134=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserbody#1 p1953=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p1958=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1956=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p1954=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p1957=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(jointaffectlink counter#1::indigo_drawer_top_joint counter#1::indigo_drawer_top)

	(supported braiserlid#1 p1954=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p1955=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp134=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p1958=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1957=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p1959=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(relpose fork rp134=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(atrelpose fork rp134=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
