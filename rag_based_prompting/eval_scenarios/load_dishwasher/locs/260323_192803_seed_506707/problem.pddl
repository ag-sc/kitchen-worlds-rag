...
(define
  (problem test_kitchen_dishwasher_260323_192803_seed_506707)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn4560=0.0)
	(atposition oven#1::knob_joint_3 pstn4561=0.0)
	(atposition fridge#1::fridge_door pstn4559=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn4556=0.0)
	(atposition faucet#1::joint_faucet_0 pstn4562=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4557=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4558=0.0)
	...
	(position counter#1::indigo_drawer_top_joint pstn4556=0.0)
	(position counter#1::chewie_door_right_joint pstn4557=0.0)
	(position counter#1::chewie_door_left_joint pstn4558=0.0)
	(position oven#1::knob_joint_2 pstn4560=0.0)
	(position fridge#1::fridge_door pstn4559=0.0)
	(position oven#1::knob_joint_3 pstn4561=0.0)
	(position faucet#1::joint_faucet_0 pstn4562=0.0)

	(pose salt-shaker p2318=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2314=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp168=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose pepper-shaker p2319=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p2317=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p2315=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))

	(isclosedposition counter#1::indigo_drawer_top_joint pstn4556=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn4557=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn4558=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4560=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4561=0.0)
	(isclosedposition fridge#1::fridge_door pstn4559=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4562=0.0)
	...
	(atpose counter#1::indigo_drawer_top lp168=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose salt-shaker p2318=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2314=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p2315=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(atpose chicken-leg p2317=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(startpose counter#1::indigo_drawer_top lp168=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p2320=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	...
	(relpose fork rp168=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p2316=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2315=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp168=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
