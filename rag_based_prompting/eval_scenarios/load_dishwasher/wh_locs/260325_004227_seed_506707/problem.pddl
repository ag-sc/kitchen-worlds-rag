...
(define
  (problem test_kitchen_dishwasher_260325_004227_seed_506707)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn2772=0.0)
	(position faucet#1::joint_faucet_0 pstn2774=0.0)
	(position oven#1::knob_joint_3 pstn2773=0.0)
	(position counter#1::indigo_drawer_top_joint pstn2768=0.0)
	(position fridge#1::fridge_door pstn2771=0.0)
	(position counter#1::chewie_door_right_joint pstn2769=0.0)
	(position counter#1::chewie_door_left_joint pstn2770=0.0)

	(atposition oven#1::knob_joint_2 pstn2772=0.0)
	(atposition oven#1::knob_joint_3 pstn2773=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn2768=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2769=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2770=0.0)
	(atposition fridge#1::fridge_door pstn2771=0.0)
	(atposition faucet#1::joint_faucet_0 pstn2774=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn2772=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2774=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2773=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn2768=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn2769=0.0)
	(isclosedposition fridge#1::fridge_door pstn2771=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn2770=0.0)
	...
	(pose chicken-leg p1184=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p1185=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp99=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserbody#1 p1181=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p1182=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(pose pepper-shaker p1186=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(ataconf left aq712=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(aconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(aconf left aq712=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(atpose counter#1::indigo_drawer_top lp99=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserbody#1 p1181=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p1182=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p1186=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1184=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p1185=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(jointaffectlink counter#1::indigo_drawer_top_joint counter#1::indigo_drawer_top)

	(supported braiserlid#1 p1182=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p1183=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp99=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained salt-shaker p1185=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p1187=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p1186=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
