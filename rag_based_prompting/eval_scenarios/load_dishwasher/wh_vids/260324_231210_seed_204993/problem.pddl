...
(define
  (problem test_kitchen_dishwasher_260324_231210_seed_204993)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn3245=0.0)
	(position counter#1::chewie_door_right_joint pstn3243=0.0)
	(position faucet#1::joint_faucet_0 pstn3248=0.0)
	(position oven#1::knob_joint_3 pstn3247=0.0)
	(position oven#1::knob_joint_2 pstn3246=0.0)
	(position counter#1::indigo_drawer_top_joint pstn3242=0.0)
	(position counter#1::chewie_door_left_joint pstn3244=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn3248=0.0)
	(atposition oven#1::knob_joint_2 pstn3246=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3243=0.0)
	(atposition oven#1::knob_joint_3 pstn3247=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3244=0.0)
	(atposition fridge#1::fridge_door pstn3245=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn3242=0.0)
	...
	(pose chicken-leg p1359=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p1361=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p1357=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571))
	(pose braiserbody#1 p1356=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p1360=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp131=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(isclosedposition counter#1::indigo_drawer_top_joint pstn3242=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn3244=0.0)
	(isclosedposition fridge#1::fridge_door pstn3245=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3247=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn3243=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3248=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3246=0.0)
	...
	(atpose salt-shaker p1360=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1359=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p1361=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1356=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p1357=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571))
	(jointaffectlink counter#1::indigo_drawer_top_joint counter#1::indigo_drawer_top)

	(supported braiserlid#1 p1357=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p1358=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp131=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p1362=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p1360=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p1361=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
