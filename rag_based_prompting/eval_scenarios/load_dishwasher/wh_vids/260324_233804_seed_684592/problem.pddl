...
(define
  (problem test_kitchen_dishwasher_260324_233804_seed_684592)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn4490=0.0)
	(atposition fridge#1::fridge_door pstn4487=0.0)
	(atposition oven#1::knob_joint_2 pstn4488=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn4484=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4485=0.0)
	(atposition oven#1::knob_joint_3 pstn4489=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4486=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn4488=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn4486=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4489=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn4484=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn4485=0.0)
	(isclosedposition fridge#1::fridge_door pstn4487=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4490=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn4486=0.0)
	(position counter#1::indigo_drawer_top_joint pstn4484=0.0)
	(position fridge#1::fridge_door pstn4487=0.0)
	(position counter#1::chewie_door_right_joint pstn4485=0.0)
	(position oven#1::knob_joint_3 pstn4489=0.0)
	(position faucet#1::joint_faucet_0 pstn4490=0.0)
	(position oven#1::knob_joint_2 pstn4488=0.0)

	(pose chicken-leg p2127=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p2129=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2124=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2125=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571))
	(pose counter#1::indigo_drawer_top lp193=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose salt-shaker p2128=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p2127=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p2128=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2124=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571))
	(atpose counter#1::indigo_drawer_top lp193=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose pepper-shaker p2129=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2125=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571))
	...
	(startpose counter#1::indigo_drawer_top lp193=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained fork p2130=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained salt-shaker p2128=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2129=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(relpose fork rp193=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p2126=(0.7, 8.741, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2125=(0.7, 8.741, 0.953, 0.0, -0.0, 1.571) braiserbody#1)

	(atrelpose fork rp193=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
