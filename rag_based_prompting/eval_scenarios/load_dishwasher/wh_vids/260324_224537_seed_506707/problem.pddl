...
(define
  (problem test_kitchen_dishwasher_260324_224537_seed_506707)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1665=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn1662=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1663=0.0)
	(atposition oven#1::knob_joint_3 pstn1667=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1664=0.0)
	(atposition oven#1::knob_joint_2 pstn1666=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1668=0.0)

	(position faucet#1::joint_faucet_0 pstn1668=0.0)
	(position counter#1::indigo_drawer_top_joint pstn1662=0.0)
	(position fridge#1::fridge_door pstn1665=0.0)
	(position oven#1::knob_joint_3 pstn1667=0.0)
	(position counter#1::chewie_door_right_joint pstn1663=0.0)
	(position counter#1::chewie_door_left_joint pstn1664=0.0)
	(position oven#1::knob_joint_2 pstn1666=0.0)
	...
	(isclosedposition counter#1::indigo_drawer_top_joint pstn1662=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1668=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1667=0.0)
	(isclosedposition fridge#1::fridge_door pstn1665=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn1663=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn1664=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1666=0.0)
