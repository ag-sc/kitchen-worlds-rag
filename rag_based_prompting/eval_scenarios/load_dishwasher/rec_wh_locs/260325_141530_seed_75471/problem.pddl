...
(define
  (problem test_kitchen_dishwasher_260325_141530_seed_75471)
  (:domain domain)
  ...
  (:init
	...
	(bconf q392=(2.0, 6.25, 0.2, 3.142))

	(atbconf q392=(2.0, 6.25, 0.2, 3.142))
	...
	(position fridge#1::fridge_door pstn3836=0.0)
	(position counter#1::chewie_door_left_joint pstn3835=0.0)
	(position counter#1::chewie_door_right_joint pstn3834=0.0)
	(position oven#1::knob_joint_3 pstn3838=0.0)
	(position faucet#1::joint_faucet_0 pstn3839=0.0)
	(position counter#1::indigo_drawer_top_joint pstn3833=0.0)
	(position oven#1::knob_joint_2 pstn3837=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn3839=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn3835=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3838=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3837=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn3834=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn3833=0.0)
	(isclosedposition fridge#1::fridge_door pstn3836=0.0)

	(atposition counter#1::chewie_door_left_joint pstn3835=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3834=0.0)
	(atposition oven#1::knob_joint_3 pstn3838=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn3833=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3839=0.0)
	(atposition fridge#1::fridge_door pstn3836=0.0)
	(atposition oven#1::knob_joint_2 pstn3837=0.0)
