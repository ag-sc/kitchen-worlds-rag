...
(define
  (problem test_kitchen_dishwasher_260325_151002_seed_204993)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn6526=0.0)
	(position oven#1::knob_joint_3 pstn6525=0.0)
	(position oven#1::knob_joint_2 pstn6524=0.0)
	(position counter#1::chewie_door_left_joint pstn6522=0.0)
	(position counter#1::chewie_door_right_joint pstn6521=0.0)
	(position fridge#1::fridge_door pstn6523=0.0)
	(position counter#1::indigo_drawer_top_joint pstn6520=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn6525=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn6521=0.0)
	(isclosedposition fridge#1::fridge_door pstn6523=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn6522=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6526=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6524=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn6520=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn6521=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6522=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn6520=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6526=0.0)
	(atposition oven#1::knob_joint_3 pstn6525=0.0)
	(atposition fridge#1::fridge_door pstn6523=0.0)
	(atposition oven#1::knob_joint_2 pstn6524=0.0)

	(pose braiserbody#1 p3200=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p3205=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p3204=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p3203=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose counter#1::indigo_drawer_top lp237=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserlid#1 p3201=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p3200=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p3204=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p3203=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose counter#1::indigo_drawer_top lp237=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserlid#1 p3201=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p3205=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained fork p3206=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p3205=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3204=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(relpose fork rp237=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(supported braiserbody#1 p3202=(0.7, 8.985, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3201=(0.7, 8.985, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
