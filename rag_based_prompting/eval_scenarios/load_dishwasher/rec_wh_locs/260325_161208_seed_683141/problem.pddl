...
(define
  (problem test_kitchen_dishwasher_260325_161208_seed_683141)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn1090=0.0)
	(atposition oven#1::knob_joint_2 pstn1088=0.0)
	(atposition oven#1::knob_joint_3 pstn1089=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn1084=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1085=0.0)
	(atposition fridge#1::fridge_door pstn1087=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1086=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn1089=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn1085=0.0)
	(isclosedposition fridge#1::fridge_door pstn1087=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1090=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn1086=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn1084=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1088=0.0)
	...
	(position counter#1::indigo_drawer_top_joint pstn1084=0.0)
	(position faucet#1::joint_faucet_0 pstn1090=0.0)
	(position fridge#1::fridge_door pstn1087=0.0)
	(position oven#1::knob_joint_3 pstn1089=0.0)
	(position counter#1::chewie_door_left_joint pstn1086=0.0)
	(position oven#1::knob_joint_2 pstn1088=0.0)
	(position counter#1::chewie_door_right_joint pstn1085=0.0)

	(pose braiserlid#1 p589=(0.7, 8.941, 0.953, 0.0, -0.0, 1.571))
	(pose braiserbody#1 p588=(0.7, 8.941, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p592=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp34=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose pepper-shaker p593=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p591=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserbody#1 p588=(0.7, 8.941, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p593=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p592=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p591=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p589=(0.7, 8.941, 0.953, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p589=(0.7, 8.941, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
	(supported braiserbody#1 p590=(0.7, 8.941, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)

	(startpose counter#1::indigo_drawer_top lp34=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))

	(contained pepper-shaker p593=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p592=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p594=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
