...
(define
  (problem test_kitchen_dishwasher_260323_213105_seed_506707)
  (:domain domain)
  ...
  (:init
	...
	(atpose braiserbody#1 p0=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571))
	(atpose counter#1::indigo_drawer_top lp0=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(atpose braiserlid#1 p1=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p2=(0.7, 8.897, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1=(0.7, 8.897, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
