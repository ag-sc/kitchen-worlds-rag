...
(define
  (problem test_kitchen_dishwasher_260331_144504_seed_75471)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn2268=0.0)
	(position oven#1::knob_joint_3 pstn2269=0.0)
	(position fridge#1::fridge_door pstn2267=0.0)
	(position counter#1::indigo_drawer_top_joint pstn2264=0.0)
	(position counter#1::chewie_door_right_joint pstn2265=0.0)
	(position faucet#1::joint_faucet_0 pstn2270=0.0)
	(position counter#1::chewie_door_left_joint pstn2266=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn2269=0.0)
	(isclosedposition fridge#1::fridge_door pstn2267=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2268=0.0)
	(isclosedposition counter#1::chewie_door_right_joint pstn2265=0.0)
	(isclosedposition counter#1::indigo_drawer_top_joint pstn2264=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2270=0.0)
	(isclosedposition counter#1::chewie_door_left_joint pstn2266=0.0)

	(atposition counter#1::chewie_door_left_joint pstn2266=0.0)
	(atposition faucet#1::joint_faucet_0 pstn2270=0.0)
	(atposition oven#1::knob_joint_2 pstn2268=0.0)
	(atposition fridge#1::fridge_door pstn2267=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2265=0.0)
	(atposition counter#1::indigo_drawer_top_joint pstn2264=0.0)
	(atposition oven#1::knob_joint_3 pstn2269=0.0)

	(atpose braiserbody#1 p1176=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p1179=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p1181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p1177=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	(atpose salt-shaker p1180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose counter#1::indigo_drawer_top lp79=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose pepper-shaker p1181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p1180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose counter#1::indigo_drawer_top lp79=(0.594, 8.843, 0.722, 0.0, -0.0, 0.0))
	(pose braiserbody#1 p1176=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p1179=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1177=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p1180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained fork p1182=(0.735, 8.831, 0.689, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)
	(contained pepper-shaker p1181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(relpose fork rp79=(0.141, -0.012, -0.033, 0.0, -0.0, 2.447) counter#1::indigo_drawer_top)

	(supported braiserbody#1 p1178=(0.7, 8.919, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1177=(0.7, 8.919, 0.953, 0.0, -0.0, 1.571) braiserbody#1)
