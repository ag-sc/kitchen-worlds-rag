...
(define
  (problem test_kitchen_chicken_soup_250909_165339_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn1994=0.0)
	(position faucet#1::joint_faucet_0 pstn1996=0.0)
	(position fridge#1::fridge_door pstn1993=1.78)
	(position oven#1::knob_joint_3 pstn1995=0.0)
	(position counter#1::chewie_door_right_joint pstn1991=1.872)
	(position counter#1::chewie_door_left_joint pstn1992=-1.872)
	...
	(atposition fridge#1::fridge_door pstn1993=1.78)
	(atposition oven#1::knob_joint_2 pstn1994=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1996=0.0)
	(atposition oven#1::knob_joint_3 pstn1995=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1991=1.872)
	(atposition counter#1::chewie_door_left_joint pstn1992=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn1994=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1995=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1996=0.0)
	...
	(pose braiserlid#1 p1245=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(pose chicken-leg p1244=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p1243=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p1248=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p1247=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p1248=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1243=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p1244=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p1247=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p1245=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(isopenedposition counter#1::chewie_door_left_joint pstn1992=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1993=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1991=1.872)
	...
	(contained salt-shaker p1247=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p1248=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p1246=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1245=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
