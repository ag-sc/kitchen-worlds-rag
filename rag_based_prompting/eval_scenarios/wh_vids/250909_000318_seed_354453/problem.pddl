...
(define
  (problem test_kitchen_chicken_soup_250909_000318_seed_354453)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn24306=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24307=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24305=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn24304=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn24302=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn24303=-1.872)
	...
	(position counter#1::chewie_door_right_joint pstn24302=1.872)
	(position fridge#1::fridge_door pstn24304=1.78)
	(position counter#1::chewie_door_left_joint pstn24303=-1.872)
	(position oven#1::knob_joint_2 pstn24305=0.0)
	(position oven#1::knob_joint_3 pstn24306=0.0)
	(position faucet#1::joint_faucet_0 pstn24307=0.0)

	(atposition counter#1::chewie_door_right_joint pstn24302=1.872)
	(atposition counter#1::chewie_door_left_joint pstn24303=-1.872)
	(atposition fridge#1::fridge_door pstn24304=1.78)
	(atposition oven#1::knob_joint_2 pstn24305=0.0)
	(atposition oven#1::knob_joint_3 pstn24306=0.0)
	(atposition faucet#1::joint_faucet_0 pstn24307=0.0)
	(pose braiserbody#1 p52102=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p52107=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p52104=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(pose salt-shaker p52106=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p52103=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p52106=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p52103=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p52102=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p52107=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p52104=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	...
	(contained salt-shaker p52106=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p52107=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p52104=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309) counter#1::front_left_stove)
	(supported braiserbody#1 p52105=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
