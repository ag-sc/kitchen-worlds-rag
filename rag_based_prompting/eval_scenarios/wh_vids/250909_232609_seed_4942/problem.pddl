...
(define
  (problem test_kitchen_chicken_soup_250909_232609_seed_4942)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p3047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(pose salt-shaker p3049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p3050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3045=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p3046=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p3047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(atpose pepper-shaker p3050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p3045=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p3046=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p3049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p3049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p3047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391) counter#1::front_left_stove)
	(supported braiserbody#1 p3048=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
