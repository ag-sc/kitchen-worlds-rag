...
(define
  (problem test_kitchen_chicken_soup_250909_002914_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn24564=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24563=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24562=0.0)

	(position counter#1::chewie_door_left_joint pstn24560=-1.872)
	(position counter#1::chewie_door_right_joint pstn24559=1.872)
	(position faucet#1::joint_faucet_0 pstn24564=0.0)
	(position oven#1::knob_joint_2 pstn24562=0.0)
	(position fridge#1::fridge_door pstn24561=1.78)
	(position oven#1::knob_joint_3 pstn24563=0.0)

	(atposition counter#1::chewie_door_right_joint pstn24559=1.872)
	(atposition faucet#1::joint_faucet_0 pstn24564=0.0)
	(atposition oven#1::knob_joint_3 pstn24563=0.0)
	(atposition oven#1::knob_joint_2 pstn24562=0.0)
	(atposition fridge#1::fridge_door pstn24561=1.78)
	(atposition counter#1::chewie_door_left_joint pstn24560=-1.872)

	(pose chicken-leg p54124=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p54125=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(pose braiserbody#1 p54123=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p54128=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p54127=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p54124=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p54125=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(atpose braiserbody#1 p54123=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p54128=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p54127=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq560=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq136=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn24560=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn24559=1.872)
	(isopenedposition fridge#1::fridge_door pstn24561=1.78)

	(ataconf left aq560=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq136=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p54128=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p54127=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p54126=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p54125=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
