...
(define
  (problem test_kitchen_chicken_soup_250908_164437_seed_411808)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn10847=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10844=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn10848=0.0)
	(atposition fridge#1::fridge_door pstn10845=1.78)
	(atposition counter#1::chewie_door_right_joint pstn10843=1.872)
	(atposition oven#1::knob_joint_2 pstn10846=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn10848=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10846=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10847=0.0)

	(position counter#1::chewie_door_right_joint pstn10843=1.872)
	(position counter#1::chewie_door_left_joint pstn10844=-1.872)
	(position oven#1::knob_joint_2 pstn10846=0.0)
	(position oven#1::knob_joint_3 pstn10847=0.0)
	(position faucet#1::joint_faucet_0 pstn10848=0.0)
	(position fridge#1::fridge_door pstn10845=1.78)

	(pose chicken-leg p23028=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p23031=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p23029=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(pose braiserbody#1 p23027=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p23032=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p23027=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p23028=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p23031=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p23029=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(atpose pepper-shaker p23032=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn10844=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn10843=1.872)
	(isopenedposition fridge#1::fridge_door pstn10845=1.78)
	...
	(contained pepper-shaker p23032=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23031=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p23029=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148) counter#1::front_left_stove)
	(supported braiserbody#1 p23030=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
