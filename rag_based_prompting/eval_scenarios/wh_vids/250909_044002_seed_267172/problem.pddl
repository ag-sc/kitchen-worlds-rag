...
(define
  (problem test_kitchen_chicken_soup_250909_044002_seed_267172)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p0=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	...
	(atpose braiserbody#1 p0=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p5=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	...
	(supported braiserbody#1 p3=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75) counter#1::front_left_stove)
