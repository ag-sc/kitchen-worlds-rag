...
(define
  (problem test_kitchen_chicken_soup_250909_062521_seed_313992)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn3074=0.0)
	(position fridge#1::fridge_door pstn3071=1.78)
	(position counter#1::chewie_door_right_joint pstn3069=1.872)
	(position oven#1::knob_joint_2 pstn3072=0.0)
	(position counter#1::chewie_door_left_joint pstn3070=-1.872)
	(position oven#1::knob_joint_3 pstn3073=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn3074=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3072=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3073=0.0)

	(atposition counter#1::chewie_door_left_joint pstn3070=-1.872)
	(atposition fridge#1::fridge_door pstn3071=1.78)
	(atposition oven#1::knob_joint_2 pstn3072=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3074=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3069=1.872)
	(atposition oven#1::knob_joint_3 pstn3073=0.0)

	(pose chicken-leg p4924=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p4927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p4928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4923=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p4925=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))

	(atpose pepper-shaker p4928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p4925=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))
	(atpose chicken-leg p4924=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p4927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p4923=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn3070=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3071=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn3069=1.872)
	...
	(contained pepper-shaker p4928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4925=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903) counter#1::front_left_stove)
	(supported braiserbody#1 p4926=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
