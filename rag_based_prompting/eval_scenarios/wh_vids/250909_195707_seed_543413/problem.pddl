...
(define
  (problem test_kitchen_chicken_soup_250909_195707_seed_543413)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn8475=0.0)
	(position counter#1::chewie_door_left_joint pstn8471=-1.872)
	(position oven#1::knob_joint_3 pstn8474=0.0)
	(position fridge#1::fridge_door pstn8472=1.78)
	(position oven#1::knob_joint_2 pstn8473=0.0)
	(position counter#1::chewie_door_right_joint pstn8470=1.872)

	(atposition faucet#1::joint_faucet_0 pstn8475=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8471=-1.872)
	(atposition fridge#1::fridge_door pstn8472=1.78)
	(atposition oven#1::knob_joint_2 pstn8473=0.0)
	(atposition oven#1::knob_joint_3 pstn8474=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8470=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn8473=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8475=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8474=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn8472=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8471=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn8470=1.872)

	(atpose braiserbody#1 p10613=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p10617=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p10614=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p10618=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p10615=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(pose pepper-shaker p10618=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p10614=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p10613=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p10615=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(pose salt-shaker p10617=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p10617=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p10618=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p10616=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p10615=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92) counter#1::front_left_stove)
