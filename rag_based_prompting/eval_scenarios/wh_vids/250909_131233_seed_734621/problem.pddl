...
(define
  (problem test_kitchen_chicken_soup_250909_131233_seed_734621)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn12635=0.0)
	(position fridge#1::fridge_door pstn12633=1.78)
	(position counter#1::chewie_door_right_joint pstn12631=1.872)
	(position faucet#1::joint_faucet_0 pstn12636=0.0)
	(position counter#1::chewie_door_left_joint pstn12632=-1.872)
	(position oven#1::knob_joint_2 pstn12634=0.0)

	(atposition oven#1::knob_joint_3 pstn12635=0.0)
	(atposition oven#1::knob_joint_2 pstn12634=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12636=0.0)
	(atposition counter#1::chewie_door_left_joint pstn12632=-1.872)
	(atposition fridge#1::fridge_door pstn12633=1.78)
	(atposition counter#1::chewie_door_right_joint pstn12631=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn12634=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12635=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12636=0.0)

	(isopenedposition fridge#1::fridge_door pstn12633=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12631=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn12632=-1.872)

	(pose braiserlid#1 p26641=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(pose braiserbody#1 p26639=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p26643=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p26644=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p26640=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p26640=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p26641=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(atpose salt-shaker p26643=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p26644=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p26639=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p26643=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p26644=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p26642=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p26641=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19) counter#1::front_left_stove)
