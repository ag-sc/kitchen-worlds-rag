...
(define
  (problem test_kitchen_chicken_soup_250909_204520_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn10760=0.0)
	(position counter#1::chewie_door_right_joint pstn10756=1.872)
	(position counter#1::chewie_door_left_joint pstn10757=-1.872)
	(position oven#1::knob_joint_2 pstn10759=0.0)
	(position faucet#1::joint_faucet_0 pstn10761=0.0)
	(position fridge#1::fridge_door pstn10758=1.78)
	...
	(atposition fridge#1::fridge_door pstn10758=1.78)
	(atposition counter#1::chewie_door_left_joint pstn10757=-1.872)
	(atposition oven#1::knob_joint_2 pstn10759=0.0)
	(atposition faucet#1::joint_faucet_0 pstn10761=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10756=1.872)
	(atposition oven#1::knob_joint_3 pstn10760=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn10759=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10760=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10761=0.0)

	(isopenedposition fridge#1::fridge_door pstn10758=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn10757=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn10756=1.872)

	(pose braiserbody#1 p11914=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p11918=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p11916=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(pose pepper-shaker p11919=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p11915=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p11916=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(atpose chicken-leg p11915=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p11919=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p11914=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p11918=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p11919=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p11918=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p11916=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
	(supported braiserbody#1 p11917=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
