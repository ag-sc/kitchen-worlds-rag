...
(define
  (problem test_kitchen_chicken_soup_250909_015725_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn26978=0.0)
	(atposition oven#1::knob_joint_2 pstn26977=0.0)
	(atposition counter#1::chewie_door_right_joint pstn26974=1.872)
	(atposition counter#1::chewie_door_left_joint pstn26975=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn26979=0.0)
	(atposition fridge#1::fridge_door pstn26976=1.78)

	(position faucet#1::joint_faucet_0 pstn26979=0.0)
	(position fridge#1::fridge_door pstn26976=1.78)
	(position oven#1::knob_joint_3 pstn26978=0.0)
	(position counter#1::chewie_door_right_joint pstn26974=1.872)
	(position oven#1::knob_joint_2 pstn26977=0.0)
	(position counter#1::chewie_door_left_joint pstn26975=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn26979=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn26977=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn26978=0.0)

	(pose braiserbody#1 p63078=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p63082=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p63079=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p63080=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(pose pepper-shaker p63083=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p63078=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p63082=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p63079=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p63080=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(atpose pepper-shaker p63083=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq520=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq848=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn26974=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn26975=-1.872)
	(isopenedposition fridge#1::fridge_door pstn26976=1.78)

	(ataconf left aq520=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq848=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p63083=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p63082=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p63081=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p63080=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
