...
(define
  (problem test_kitchen_chicken_soup_250829_021227_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p34203=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p34207=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p34204=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p34208=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p34205=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))

	(aconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq96=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(atpose pepper-shaker p34208=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p34203=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p34204=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p34207=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p34205=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))

	(ataconf right aq96=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p34208=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p34207=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p34205=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
	(supported braiserbody#1 p34206=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
