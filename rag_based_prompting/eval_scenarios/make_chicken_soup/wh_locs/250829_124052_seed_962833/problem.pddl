...
(define
  (problem test_kitchen_chicken_soup_250829_124052_seed_962833)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(pose salt-shaker p370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p366=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(atpose braiserbody#1 p366=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928) counter#1::front_left_stove)
	(supported braiserbody#1 p369=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
