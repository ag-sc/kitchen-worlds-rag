...
(define
  (problem test_kitchen_chicken_soup_250828_141246_seed_411808)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn479=0.0)
	(position counter#1::chewie_door_left_joint pstn476=-1.872)
	(position oven#1::knob_joint_2 pstn478=0.0)
	(position faucet#1::joint_faucet_0 pstn480=0.0)
	(position fridge#1::fridge_door pstn477=1.78)
	(position counter#1::chewie_door_right_joint pstn475=1.872)

	(atposition oven#1::knob_joint_3 pstn479=0.0)
	(atposition counter#1::chewie_door_left_joint pstn476=-1.872)
	(atposition oven#1::knob_joint_2 pstn478=0.0)
	(atposition faucet#1::joint_faucet_0 pstn480=0.0)
	(atposition fridge#1::fridge_door pstn477=1.78)
	(atposition counter#1::chewie_door_right_joint pstn475=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn478=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn480=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn479=0.0)
	...
	(pose braiserlid#1 p425=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(pose pepper-shaker p428=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p427=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p423=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p424=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p425=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(atpose pepper-shaker p428=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p424=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p427=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p423=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn475=1.872)
	(isopenedposition fridge#1::fridge_door pstn477=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn476=-1.872)
	...
	(contained pepper-shaker p428=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p427=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p425=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148) counter#1::front_left_stove)
	(supported braiserbody#1 p426=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
