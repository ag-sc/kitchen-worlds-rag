...
(define
  (problem test_kitchen_chicken_soup_250828_120800_seed_373761)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn488=1.78)
	(position counter#1::chewie_door_left_joint pstn487=-1.872)
	(position oven#1::knob_joint_2 pstn489=0.0)
	(position counter#1::chewie_door_right_joint pstn486=1.872)
	(position oven#1::knob_joint_3 pstn490=0.0)
	(position faucet#1::joint_faucet_0 pstn491=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn491=0.0)
	(atposition oven#1::knob_joint_3 pstn490=0.0)
	(atposition counter#1::chewie_door_left_joint pstn487=-1.872)
	(atposition oven#1::knob_joint_2 pstn489=0.0)
	(atposition fridge#1::fridge_door pstn488=1.78)
	(atposition counter#1::chewie_door_right_joint pstn486=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn490=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn491=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn489=0.0)

	(isopenedposition fridge#1::fridge_door pstn488=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn487=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn486=1.872)

	(pose braiserbody#1 p1209=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p1213=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p1210=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p1214=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p1211=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))

	(atpose pepper-shaker p1214=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p1211=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))
	(atpose braiserbody#1 p1209=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p1213=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1210=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p1214=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1213=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p1211=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998) counter#1::front_left_stove)
	(supported braiserbody#1 p1212=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
