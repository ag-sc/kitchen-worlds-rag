...
(define
  (problem test_kitchen_chicken_soup_250829_135243_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p366=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	...
	(atpose braiserbody#1 p366=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p371=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	...
	(supported braiserbody#1 p369=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
