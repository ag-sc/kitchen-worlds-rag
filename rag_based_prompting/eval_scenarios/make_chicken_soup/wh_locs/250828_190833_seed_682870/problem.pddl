...
(define
  (problem test_kitchen_chicken_soup_250828_190833_seed_682870)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126))
	(pose braiserbody#1 p0=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p1=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserbody#1 p0=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p5=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126) counter#1::front_left_stove)
	(supported braiserbody#1 p3=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
