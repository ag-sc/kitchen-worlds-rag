...
(define
  (problem test_kitchen_chicken_soup_250829_060428_seed_374741)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn14614=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14612=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14613=0.0)

	(position counter#1::chewie_door_right_joint pstn14609=1.872)
	(position oven#1::knob_joint_2 pstn14612=0.0)
	(position counter#1::chewie_door_left_joint pstn14610=-1.872)
	(position fridge#1::fridge_door pstn14611=1.78)
	(position oven#1::knob_joint_3 pstn14613=0.0)
	(position faucet#1::joint_faucet_0 pstn14614=0.0)

	(atposition counter#1::chewie_door_right_joint pstn14609=1.872)
	(atposition counter#1::chewie_door_left_joint pstn14610=-1.872)
	(atposition oven#1::knob_joint_2 pstn14612=0.0)
	(atposition faucet#1::joint_faucet_0 pstn14614=0.0)
	(atposition fridge#1::fridge_door pstn14611=1.78)
	(atposition oven#1::knob_joint_3 pstn14613=0.0)

	(pose braiserlid#1 p50923=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(pose pepper-shaker p50926=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p50925=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p50922=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p50921=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p50926=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p50921=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p50923=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(atpose salt-shaker p50925=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p50922=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn14609=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn14610=-1.872)
	(isopenedposition fridge#1::fridge_door pstn14611=1.78)
	...
	(contained pepper-shaker p50926=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p50925=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p50923=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355) counter#1::front_left_stove)
	(supported braiserbody#1 p50924=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
