...
(define
  (problem test_kitchen_chicken_soup_250828_172620_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn2537=0.0)
	(atposition oven#1::knob_joint_2 pstn2535=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2532=1.872)
	(atposition fridge#1::fridge_door pstn2534=1.78)
	(atposition counter#1::chewie_door_left_joint pstn2533=-1.872)
	(atposition oven#1::knob_joint_3 pstn2536=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn2536=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2535=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2537=0.0)

	(position counter#1::chewie_door_right_joint pstn2532=1.872)
	(position fridge#1::fridge_door pstn2534=1.78)
	(position counter#1::chewie_door_left_joint pstn2533=-1.872)
	(position faucet#1::joint_faucet_0 pstn2537=0.0)
	(position oven#1::knob_joint_3 pstn2536=0.0)
	(position oven#1::knob_joint_2 pstn2535=0.0)

	(atpose braiserbody#1 p4567=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p4571=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p4568=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p4569=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(atpose pepper-shaker p4572=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p4568=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p4571=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4569=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(pose pepper-shaker p4572=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4567=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn2532=1.872)
	(isopenedposition fridge#1::fridge_door pstn2534=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2533=-1.872)
	...
	(contained pepper-shaker p4572=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4571=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4569=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)
	(supported braiserbody#1 p4570=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
