...
(define
  (problem test_kitchen_chicken_soup_250828_211126_seed_313992)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn3186=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3181=1.872)
	(atposition oven#1::knob_joint_2 pstn3184=0.0)
	(atposition oven#1::knob_joint_3 pstn3185=0.0)
	(atposition fridge#1::fridge_door pstn3183=1.78)
	(atposition counter#1::chewie_door_left_joint pstn3182=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn3186=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3184=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3185=0.0)

	(position counter#1::chewie_door_left_joint pstn3182=-1.872)
	(position counter#1::chewie_door_right_joint pstn3181=1.872)
	(position oven#1::knob_joint_2 pstn3184=0.0)
	(position oven#1::knob_joint_3 pstn3185=0.0)
	(position faucet#1::joint_faucet_0 pstn3186=0.0)
	(position fridge#1::fridge_door pstn3183=1.78)

	(pose braiserbody#1 p9684=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p9686=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))
	(pose pepper-shaker p9689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p9688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p9685=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p9685=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p9688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p9689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p9684=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p9686=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))

	(isopenedposition counter#1::chewie_door_right_joint pstn3181=1.872)
	(isopenedposition fridge#1::fridge_door pstn3183=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn3182=-1.872)
	...
	(contained salt-shaker p9688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p9689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p9686=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903) counter#1::front_left_stove)
	(supported braiserbody#1 p9687=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
