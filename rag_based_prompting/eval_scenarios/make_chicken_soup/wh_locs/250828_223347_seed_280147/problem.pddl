...
(define
  (problem test_kitchen_chicken_soup_250828_223347_seed_280147)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn5776=0.0)
	(position counter#1::chewie_door_right_joint pstn5771=1.872)
	(position fridge#1::fridge_door pstn5773=1.78)
	(position oven#1::knob_joint_2 pstn5774=0.0)
	(position oven#1::knob_joint_3 pstn5775=0.0)
	(position counter#1::chewie_door_left_joint pstn5772=-1.872)

	(atposition faucet#1::joint_faucet_0 pstn5776=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5771=1.872)
	(atposition counter#1::chewie_door_left_joint pstn5772=-1.872)
	(atposition fridge#1::fridge_door pstn5773=1.78)
	(atposition oven#1::knob_joint_2 pstn5774=0.0)
	(atposition oven#1::knob_joint_3 pstn5775=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn5774=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5776=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5775=0.0)
	...
	(pose braiserlid#1 p14884=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	(pose braiserbody#1 p14882=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p14887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p14883=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p14886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p14886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14882=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p14887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p14883=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p14884=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))

	(isopenedposition counter#1::chewie_door_right_joint pstn5771=1.872)
	(isopenedposition fridge#1::fridge_door pstn5773=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5772=-1.872)
	...
	(contained salt-shaker p14886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14884=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667) counter#1::front_left_stove)
	(supported braiserbody#1 p14885=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
