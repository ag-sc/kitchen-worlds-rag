...
(define
  (problem test_kitchen_chicken_soup_250828_202118_seed_662398)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn1275=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1274=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1276=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn1271=1.872)
	(position oven#1::knob_joint_2 pstn1274=0.0)
	(position counter#1::chewie_door_left_joint pstn1272=-1.872)
	(position faucet#1::joint_faucet_0 pstn1276=0.0)
	(position fridge#1::fridge_door pstn1273=1.78)
	(position oven#1::knob_joint_3 pstn1275=0.0)

	(atposition counter#1::chewie_door_right_joint pstn1271=1.872)
	(atposition oven#1::knob_joint_2 pstn1274=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1272=-1.872)
	(atposition fridge#1::fridge_door pstn1273=1.78)
	(atposition faucet#1::joint_faucet_0 pstn1276=0.0)
	(atposition oven#1::knob_joint_3 pstn1275=0.0)

	(pose salt-shaker p7799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p7797=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(pose pepper-shaker p7800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p7796=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p7795=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p7796=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p7795=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p7799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p7800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p7797=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))

	(isopenedposition counter#1::chewie_door_right_joint pstn1271=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1272=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1273=1.78)
	...
	(contained pepper-shaker p7800=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p7799=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p7797=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574) counter#1::front_left_stove)
	(supported braiserbody#1 p7798=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
