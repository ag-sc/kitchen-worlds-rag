...
(define
  (problem test_kitchen_chicken_soup_250828_224839_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn6260=0.0)
	(position oven#1::knob_joint_2 pstn6259=0.0)
	(position counter#1::chewie_door_right_joint pstn6256=1.872)
	(position counter#1::chewie_door_left_joint pstn6257=-1.872)
	(position fridge#1::fridge_door pstn6258=1.78)
	(position faucet#1::joint_faucet_0 pstn6261=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn6261=0.0)
	(atposition oven#1::knob_joint_2 pstn6259=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6257=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn6256=1.872)
	(atposition oven#1::knob_joint_3 pstn6260=0.0)
	(atposition fridge#1::fridge_door pstn6258=1.78)

	(isclosedposition oven#1::knob_joint_3 pstn6260=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6261=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6259=0.0)
	...
	(pose chicken-leg p15231=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p15235=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p15234=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p15232=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose braiserbody#1 p15230=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p15232=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose chicken-leg p15231=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p15235=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p15234=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p15230=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn6257=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn6256=1.872)
	(isopenedposition fridge#1::fridge_door pstn6258=1.78)
	...
	(contained salt-shaker p15234=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p15235=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p15232=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)
	(supported braiserbody#1 p15233=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
