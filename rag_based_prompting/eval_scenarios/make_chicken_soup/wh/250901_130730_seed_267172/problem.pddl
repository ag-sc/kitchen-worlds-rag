...
(define
  (problem test_kitchen_chicken_soup_250901_130730_seed_267172)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn241=0.0)
	(atposition oven#1::knob_joint_2 pstn239=0.0)
	(atposition oven#1::knob_joint_3 pstn240=0.0)
	(atposition fridge#1::fridge_door pstn238=1.78)
	(atposition counter#1::chewie_door_right_joint pstn236=1.872)
	(atposition counter#1::chewie_door_left_joint pstn237=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn241=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn239=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn240=0.0)

	(position counter#1::chewie_door_right_joint pstn236=1.872)
	(position oven#1::knob_joint_3 pstn240=0.0)
	(position fridge#1::fridge_door pstn238=1.78)
	(position counter#1::chewie_door_left_joint pstn237=-1.872)
	(position faucet#1::joint_faucet_0 pstn241=0.0)
	(position oven#1::knob_joint_2 pstn239=0.0)

	(pose chicken-leg p1316=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1317=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	(pose salt-shaker p1319=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1315=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p1320=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p1319=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1315=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p1320=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p1317=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	(atpose chicken-leg p1316=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn237=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn236=1.872)
	(isopenedposition fridge#1::fridge_door pstn238=1.78)
	...
	(contained pepper-shaker p1320=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1319=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p1318=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1317=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75) counter#1::front_left_stove)
