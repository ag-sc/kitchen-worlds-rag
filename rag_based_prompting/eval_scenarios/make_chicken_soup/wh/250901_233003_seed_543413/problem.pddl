...
(define
  (problem test_kitchen_chicken_soup_250901_233003_seed_543413)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn2641=0.0)
	(position counter#1::chewie_door_left_joint pstn2638=-1.872)
	(position oven#1::knob_joint_2 pstn2640=0.0)
	(position fridge#1::fridge_door pstn2639=1.78)
	(position counter#1::chewie_door_right_joint pstn2637=1.872)
	(position faucet#1::joint_faucet_0 pstn2642=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn2642=0.0)
	(atposition oven#1::knob_joint_3 pstn2641=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2638=-1.872)
	(atposition oven#1::knob_joint_2 pstn2640=0.0)
	(atposition fridge#1::fridge_door pstn2639=1.78)
	(atposition counter#1::chewie_door_right_joint pstn2637=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn2642=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2640=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2641=0.0)

	(pose chicken-leg p6048=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p6047=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p6051=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p6052=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p6049=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))

	(atpose chicken-leg p6048=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p6047=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p6049=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	...
	(isopenedposition counter#1::chewie_door_right_joint pstn2637=1.872)
	(isopenedposition fridge#1::fridge_door pstn2639=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2638=-1.872)
	...
	(supported braiserbody#1 p6050=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p6049=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92) counter#1::front_left_stove)
