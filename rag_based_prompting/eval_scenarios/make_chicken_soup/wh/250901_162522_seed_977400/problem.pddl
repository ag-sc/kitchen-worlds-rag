...
(define
  (problem test_kitchen_chicken_soup_250901_162522_seed_977400)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn6307=1.78)
	(atposition counter#1::chewie_door_left_joint pstn6306=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn6305=1.872)
	(atposition faucet#1::joint_faucet_0 pstn6310=0.0)
	(atposition oven#1::knob_joint_2 pstn6308=0.0)
	(atposition oven#1::knob_joint_3 pstn6309=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn6307=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn6306=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn6305=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn6310=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6308=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6309=0.0)

	(position counter#1::chewie_door_left_joint pstn6306=-1.872)
	(position faucet#1::joint_faucet_0 pstn6310=0.0)
	(position counter#1::chewie_door_right_joint pstn6305=1.872)
	(position oven#1::knob_joint_2 pstn6308=0.0)
	(position oven#1::knob_joint_3 pstn6309=0.0)
	(position fridge#1::fridge_door pstn6307=1.78)

	(pose braiserbody#1 p17456=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p17458=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(pose salt-shaker p17460=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p17457=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p17461=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p17461=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p17458=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(atpose salt-shaker p17460=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p17456=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p17457=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p17460=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p17461=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p17459=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p17458=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695) counter#1::front_left_stove)
