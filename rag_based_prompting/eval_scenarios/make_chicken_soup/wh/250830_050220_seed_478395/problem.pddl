...
(define
  (problem test_kitchen_chicken_soup_250830_050220_seed_478395)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn32027=1.78)
	(atposition counter#1::chewie_door_left_joint pstn32026=-1.872)
	(atposition oven#1::knob_joint_2 pstn32028=0.0)
	(atposition faucet#1::joint_faucet_0 pstn32030=0.0)
	(atposition oven#1::knob_joint_3 pstn32029=0.0)
	(atposition counter#1::chewie_door_right_joint pstn32025=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn32030=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn32029=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn32028=0.0)

	(position counter#1::chewie_door_right_joint pstn32025=1.872)
	(position faucet#1::joint_faucet_0 pstn32030=0.0)
	(position fridge#1::fridge_door pstn32027=1.78)
	(position counter#1::chewie_door_left_joint pstn32026=-1.872)
	(position oven#1::knob_joint_3 pstn32029=0.0)
	(position oven#1::knob_joint_2 pstn32028=0.0)

	(pose pepper-shaker p66014=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p66009=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p66011=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(pose salt-shaker p66013=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p66010=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p66011=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(atpose chicken-leg p66010=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p66013=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p66014=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p66009=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn32026=-1.872)
	(isopenedposition fridge#1::fridge_door pstn32027=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn32025=1.872)
	...
	(contained salt-shaker p66013=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p66014=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p66012=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p66011=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304) counter#1::front_left_stove)
