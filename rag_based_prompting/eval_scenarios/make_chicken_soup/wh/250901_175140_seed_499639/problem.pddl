...
(define
  (problem test_kitchen_chicken_soup_250901_175140_seed_499639)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn8968=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8969=0.0)
	(atposition fridge#1::fridge_door pstn8966=1.78)
	(atposition counter#1::chewie_door_right_joint pstn8964=1.872)
	(atposition counter#1::chewie_door_left_joint pstn8965=-1.872)
	(atposition oven#1::knob_joint_2 pstn8967=0.0)
	(position fridge#1::fridge_door pstn8966=1.78)
	(position counter#1::chewie_door_left_joint pstn8965=-1.872)
	(position counter#1::chewie_door_right_joint pstn8964=1.872)
	(position oven#1::knob_joint_2 pstn8967=0.0)
	(position oven#1::knob_joint_3 pstn8968=0.0)
	(position faucet#1::joint_faucet_0 pstn8969=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn8967=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8968=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8969=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn8966=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn8964=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn8965=-1.872)

	(pose salt-shaker p25559=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p25557=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(pose chicken-leg p25556=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p25560=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p25555=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p25556=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p25560=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p25557=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(atpose braiserbody#1 p25555=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p25559=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p25560=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p25559=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p25558=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p25557=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531) counter#1::front_left_stove)
