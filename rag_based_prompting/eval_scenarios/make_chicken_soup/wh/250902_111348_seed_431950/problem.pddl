...
(define
  (problem test_kitchen_chicken_soup_250902_111348_seed_431950)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1913=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1911=1.872)
	(atposition counter#1::chewie_door_left_joint pstn1912=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn1916=0.0)
	(atposition oven#1::knob_joint_3 pstn1915=0.0)
	(atposition oven#1::knob_joint_2 pstn1914=0.0)
	(position faucet#1::joint_faucet_0 pstn1916=0.0)
	(position oven#1::knob_joint_3 pstn1915=0.0)
	(position oven#1::knob_joint_2 pstn1914=0.0)
	(position fridge#1::fridge_door pstn1913=1.78)
	(position counter#1::chewie_door_right_joint pstn1911=1.872)
	(position counter#1::chewie_door_left_joint pstn1912=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn1914=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1916=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1915=0.0)

	(isopenedposition fridge#1::fridge_door pstn1913=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1911=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1912=-1.872)

	(pose salt-shaker p16755=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p16752=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p16751=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p16756=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p16753=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))

	(atpose chicken-leg p16752=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p16751=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p16756=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p16755=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p16753=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	...
	(supported braiserbody#1 p16754=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p16753=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642) counter#1::front_left_stove)
