...
(define
  (problem test_kitchen_chicken_soup_250902_002251_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(pose salt-shaker p4=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p0=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p1=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	...
	(atpose braiserbody#1 p0=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
	(supported braiserbody#1 p3=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
