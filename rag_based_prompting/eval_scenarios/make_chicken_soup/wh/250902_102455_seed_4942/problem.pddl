...
(define
  (problem test_kitchen_chicken_soup_250902_102455_seed_4942)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1256=1.78)
	(atposition oven#1::knob_joint_3 pstn1258=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1259=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1255=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1254=1.872)
	(atposition oven#1::knob_joint_2 pstn1257=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn1258=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1259=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1257=0.0)

	(position counter#1::chewie_door_left_joint pstn1255=-1.872)
	(position counter#1::chewie_door_right_joint pstn1254=1.872)
	(position oven#1::knob_joint_2 pstn1257=0.0)
	(position fridge#1::fridge_door pstn1256=1.78)
	(position oven#1::knob_joint_3 pstn1258=0.0)
	(position faucet#1::joint_faucet_0 pstn1259=0.0)

	(pose chicken-leg p11138=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p11141=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p11142=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p11139=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(pose braiserbody#1 p11137=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p11138=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p11137=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p11141=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p11142=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p11139=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))

	(isopenedposition counter#1::chewie_door_right_joint pstn1254=1.872)
	(isopenedposition fridge#1::fridge_door pstn1256=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1255=-1.872)
	...
	(contained salt-shaker p11141=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p11142=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p11139=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391) counter#1::front_left_stove)
	(supported braiserbody#1 p11140=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
