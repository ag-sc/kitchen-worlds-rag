...
(define
  (problem test_kitchen_chicken_soup_250829_184533_seed_923103)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn10737=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10735=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10736=0.0)

	(position counter#1::chewie_door_right_joint pstn10732=1.872)
	(position fridge#1::fridge_door pstn10734=1.78)
	(position oven#1::knob_joint_3 pstn10736=0.0)
	(position faucet#1::joint_faucet_0 pstn10737=0.0)
	(position oven#1::knob_joint_2 pstn10735=0.0)
	(position counter#1::chewie_door_left_joint pstn10733=-1.872)

	(atposition counter#1::chewie_door_right_joint pstn10732=1.872)
	(atposition oven#1::knob_joint_3 pstn10736=0.0)
	(atposition oven#1::knob_joint_2 pstn10735=0.0)
	(atposition faucet#1::joint_faucet_0 pstn10737=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10733=-1.872)
	(atposition fridge#1::fridge_door pstn10734=1.78)

	(pose chicken-leg p21231=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p21230=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p21232=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(pose pepper-shaker p21235=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p21234=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p21230=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p21231=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p21235=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p21232=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(atpose salt-shaker p21234=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq32=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq240=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(isopenedposition counter#1::chewie_door_right_joint pstn10732=1.872)
	(isopenedposition fridge#1::fridge_door pstn10734=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn10733=-1.872)

	(ataconf left aq32=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq240=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p21235=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p21234=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p21233=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p21232=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097) counter#1::front_left_stove)
