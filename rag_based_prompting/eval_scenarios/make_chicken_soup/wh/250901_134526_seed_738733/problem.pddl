...
(define
  (problem test_kitchen_chicken_soup_250901_134526_seed_738733)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn1447=0.0)
	(position fridge#1::fridge_door pstn1444=1.78)
	(position oven#1::knob_joint_2 pstn1445=0.0)
	(position counter#1::chewie_door_left_joint pstn1443=-1.872)
	(position oven#1::knob_joint_3 pstn1446=0.0)
	(position counter#1::chewie_door_right_joint pstn1442=1.872)

	(atposition faucet#1::joint_faucet_0 pstn1447=0.0)
	(atposition fridge#1::fridge_door pstn1444=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1442=1.872)
	(atposition counter#1::chewie_door_left_joint pstn1443=-1.872)
	(atposition oven#1::knob_joint_3 pstn1446=0.0)
	(atposition oven#1::knob_joint_2 pstn1445=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn1446=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1445=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1447=0.0)
	...
	(pose salt-shaker p4218=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4214=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p4215=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p4219=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4216=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))

	(atpose pepper-shaker p4219=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p4218=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p4215=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p4216=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	(atpose braiserbody#1 p4214=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn1442=1.872)
	(isopenedposition fridge#1::fridge_door pstn1444=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1443=-1.872)
	...
	(contained salt-shaker p4218=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p4219=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p4217=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p4216=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791) counter#1::front_left_stove)
