...
(define
  (problem test_kitchen_chicken_soup_250901_204124_seed_988376)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn3466=0.0)
	(position oven#1::knob_joint_2 pstn3465=0.0)
	(position fridge#1::fridge_door pstn3464=1.78)
	(position faucet#1::joint_faucet_0 pstn3467=0.0)
	(position counter#1::chewie_door_left_joint pstn3463=-1.872)
	(position counter#1::chewie_door_right_joint pstn3462=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn3466=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3465=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3467=0.0)

	(isopenedposition fridge#1::fridge_door pstn3464=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn3462=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3463=-1.872)

	(atposition counter#1::chewie_door_right_joint pstn3462=1.872)
	(atposition fridge#1::fridge_door pstn3464=1.78)
	(atposition counter#1::chewie_door_left_joint pstn3463=-1.872)
	(atposition oven#1::knob_joint_3 pstn3466=0.0)
	(atposition oven#1::knob_joint_2 pstn3465=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3467=0.0)

	(pose salt-shaker p20363=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p20361=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(pose pepper-shaker p20364=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p20359=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p20360=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p20361=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(atpose chicken-leg p20360=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p20363=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p20364=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p20359=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p20363=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p20364=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p20361=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975) counter#1::front_left_stove)
	(supported braiserbody#1 p20362=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
