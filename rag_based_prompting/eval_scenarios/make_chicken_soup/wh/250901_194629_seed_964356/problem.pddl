...
(define
  (problem test_kitchen_chicken_soup_250901_194629_seed_964356)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1599=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1597=1.872)
	(atposition oven#1::knob_joint_2 pstn1600=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1602=0.0)
	(atposition oven#1::knob_joint_3 pstn1601=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1598=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn1602=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1601=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1600=0.0)

	(position counter#1::chewie_door_right_joint pstn1597=1.872)
	(position faucet#1::joint_faucet_0 pstn1602=0.0)
	(position oven#1::knob_joint_3 pstn1601=0.0)
	(position fridge#1::fridge_door pstn1599=1.78)
	(position counter#1::chewie_door_left_joint pstn1598=-1.872)
	(position oven#1::knob_joint_2 pstn1600=0.0)

	(pose braiserlid#1 p14173=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318))
	(pose salt-shaker p14175=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p14176=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p14171=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p14172=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p14173=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318))
	(atpose chicken-leg p14172=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p14175=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p14176=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14171=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn1598=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1599=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1597=1.872)
	...
	(contained salt-shaker p14175=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14176=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14173=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318) counter#1::front_left_stove)
	(supported braiserbody#1 p14174=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
