...
(define
  (problem test_kitchen_chicken_soup_250901_105551_seed_567288)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn5128=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5130=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5125=1.872)
	(atposition fridge#1::fridge_door pstn5127=1.78)
	(atposition counter#1::chewie_door_left_joint pstn5126=-1.872)
	(atposition oven#1::knob_joint_3 pstn5129=0.0)
	...
	(position fridge#1::fridge_door pstn5127=1.78)
	(position oven#1::knob_joint_3 pstn5129=0.0)
	(position counter#1::chewie_door_left_joint pstn5126=-1.872)
	(position counter#1::chewie_door_right_joint pstn5125=1.872)
	(position faucet#1::joint_faucet_0 pstn5130=0.0)
	(position oven#1::knob_joint_2 pstn5128=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn5129=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5130=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5128=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn5127=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5125=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5126=-1.872)

	(pose braiserbody#1 p6423=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p6425=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(pose salt-shaker p6427=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p6424=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p6428=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p6423=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p6428=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p6425=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(atpose chicken-leg p6424=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p6427=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p6428=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p6427=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p6426=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p6425=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683) counter#1::front_left_stove)
