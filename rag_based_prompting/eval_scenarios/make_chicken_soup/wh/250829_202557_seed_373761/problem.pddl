...
(define
  (problem test_kitchen_chicken_soup_250829_202557_seed_373761)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn14775=0.0)
	(atposition oven#1::knob_joint_2 pstn14774=0.0)
	(atposition counter#1::chewie_door_right_joint pstn14771=1.872)
	(atposition fridge#1::fridge_door pstn14773=1.78)
	(atposition faucet#1::joint_faucet_0 pstn14776=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14772=-1.872)
	(position fridge#1::fridge_door pstn14773=1.78)
	(position counter#1::chewie_door_left_joint pstn14772=-1.872)
	(position oven#1::knob_joint_3 pstn14775=0.0)
	(position counter#1::chewie_door_right_joint pstn14771=1.872)
	(position oven#1::knob_joint_2 pstn14774=0.0)
	(position faucet#1::joint_faucet_0 pstn14776=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn14775=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14774=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14776=0.0)
	...
	(pose salt-shaker p28746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p28747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p28743=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p28742=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p28744=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))

	(aconf left aq552=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq584=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p28747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p28746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p28743=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p28742=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p28744=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))
	(isopenedposition counter#1::chewie_door_right_joint pstn14771=1.872)
	(isopenedposition fridge#1::fridge_door pstn14773=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn14772=-1.872)

	(ataconf left aq552=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq584=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p28746=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p28747=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p28744=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998) counter#1::front_left_stove)
	(supported braiserbody#1 p28745=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
