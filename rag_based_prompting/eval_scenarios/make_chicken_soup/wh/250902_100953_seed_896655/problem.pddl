...
(define
  (problem test_kitchen_chicken_soup_250902_100953_seed_896655)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn1046=0.0)
	(atposition oven#1::knob_joint_3 pstn1045=0.0)
	(atposition fridge#1::fridge_door pstn1043=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1041=1.872)
	(atposition oven#1::knob_joint_2 pstn1044=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1042=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn1044=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1046=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1045=0.0)

	(position counter#1::chewie_door_left_joint pstn1042=-1.872)
	(position faucet#1::joint_faucet_0 pstn1046=0.0)
	(position oven#1::knob_joint_3 pstn1045=0.0)
	(position fridge#1::fridge_door pstn1043=1.78)
	(position counter#1::chewie_door_right_joint pstn1041=1.872)
	(position oven#1::knob_joint_2 pstn1044=0.0)

	(pose braiserlid#1 p9160=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(pose salt-shaker p9162=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p9159=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p9163=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p9158=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p9162=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p9159=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p9163=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p9158=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p9160=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))

	(aconf left aq88=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn1041=1.872)
	(isopenedposition fridge#1::fridge_door pstn1043=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1042=-1.872)

	(ataconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq88=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p9163=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p9162=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p9161=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p9160=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987) counter#1::front_left_stove)
