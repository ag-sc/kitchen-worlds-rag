...
(define
  (problem test_kitchen_chicken_soup_250902_142305_seed_844870)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn7050=0.0)
	(atposition oven#1::knob_joint_2 pstn7049=0.0)
	(atposition faucet#1::joint_faucet_0 pstn7051=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7046=1.872)
	(atposition fridge#1::fridge_door pstn7048=1.78)
	(atposition counter#1::chewie_door_left_joint pstn7047=-1.872)

	(position faucet#1::joint_faucet_0 pstn7051=0.0)
	(position counter#1::chewie_door_right_joint pstn7046=1.872)
	(position fridge#1::fridge_door pstn7048=1.78)
	(position counter#1::chewie_door_left_joint pstn7047=-1.872)
	(position oven#1::knob_joint_3 pstn7050=0.0)
	(position oven#1::knob_joint_2 pstn7049=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn7049=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn7051=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7050=0.0)

	(pose braiserlid#1 p31718=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683))
	(pose chicken-leg p31717=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p31721=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p31720=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p31716=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p31717=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p31721=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p31720=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p31716=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p31718=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683))

	(isopenedposition counter#1::chewie_door_right_joint pstn7046=1.872)
	(isopenedposition fridge#1::fridge_door pstn7048=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn7047=-1.872)
	...
	(contained pepper-shaker p31721=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p31720=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p31718=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683) counter#1::front_left_stove)
	(supported braiserbody#1 p31719=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
