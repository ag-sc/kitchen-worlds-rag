...
(define
  (problem test_kitchen_chicken_soup_250901_115040_seed_817039)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn6758=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6759=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6760=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn6757=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn6756=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn6755=1.872)

	(position counter#1::chewie_door_left_joint pstn6756=-1.872)
	(position oven#1::knob_joint_2 pstn6758=0.0)
	(position fridge#1::fridge_door pstn6757=1.78)
	(position counter#1::chewie_door_right_joint pstn6755=1.872)
	(position oven#1::knob_joint_3 pstn6759=0.0)
	(position faucet#1::joint_faucet_0 pstn6760=0.0)

	(atposition counter#1::chewie_door_right_joint pstn6755=1.872)
	(atposition oven#1::knob_joint_3 pstn6759=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6756=-1.872)
	(atposition fridge#1::fridge_door pstn6757=1.78)
	(atposition faucet#1::joint_faucet_0 pstn6760=0.0)
	(atposition oven#1::knob_joint_2 pstn6758=0.0)

	(pose salt-shaker p15866=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p15867=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p15862=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p15864=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose chicken-leg p15863=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p15866=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p15862=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p15864=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose pepper-shaker p15867=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p15863=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p15867=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p15866=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p15864=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
	(supported braiserbody#1 p15865=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
