...
(define
  (problem test_kitchen_chicken_soup_250901_122704_seed_981849)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn9113=1.78)
	(position counter#1::chewie_door_left_joint pstn9112=-1.872)
	(position oven#1::knob_joint_2 pstn9114=0.0)
	(position faucet#1::joint_faucet_0 pstn9116=0.0)
	(position counter#1::chewie_door_right_joint pstn9111=1.872)
	(position oven#1::knob_joint_3 pstn9115=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn9116=0.0)
	(atposition oven#1::knob_joint_3 pstn9115=0.0)
	(atposition fridge#1::fridge_door pstn9113=1.78)
	(atposition counter#1::chewie_door_right_joint pstn9111=1.872)
	(atposition counter#1::chewie_door_left_joint pstn9112=-1.872)
	(atposition oven#1::knob_joint_2 pstn9114=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn9116=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9114=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9115=0.0)

	(pose pepper-shaker p19339=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p19334=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p19336=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(pose salt-shaker p19338=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p19335=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn9111=1.872)
	(isopenedposition fridge#1::fridge_door pstn9113=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn9112=-1.872)

	(aconf left aq864=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq880=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p19339=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p19338=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p19336=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(atpose chicken-leg p19335=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p19334=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(ataconf left aq864=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq880=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p19338=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p19339=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p19337=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p19336=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705) counter#1::front_left_stove)
