...
(define
  (problem test_kitchen_chicken_soup_250901_113225_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn5624=0.0)
	(position oven#1::knob_joint_3 pstn5625=0.0)
	(position faucet#1::joint_faucet_0 pstn5626=0.0)
	(position fridge#1::fridge_door pstn5623=1.78)
	(position counter#1::chewie_door_left_joint pstn5622=-1.872)
	(position counter#1::chewie_door_right_joint pstn5621=1.872)
	...
	(atposition fridge#1::fridge_door pstn5623=1.78)
	(atposition faucet#1::joint_faucet_0 pstn5626=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5622=-1.872)
	(atposition oven#1::knob_joint_2 pstn5624=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5621=1.872)
	(atposition oven#1::knob_joint_3 pstn5625=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn5624=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5625=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5626=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn5623=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5621=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5622=-1.872)

	(atpose salt-shaker p12794=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p12791=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p12792=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(atpose braiserbody#1 p12790=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p12795=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p12795=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p12794=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p12792=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(pose chicken-leg p12791=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p12790=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p12794=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12795=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p12792=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
	(supported braiserbody#1 p12793=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
