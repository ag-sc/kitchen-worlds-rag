...
(define
  (problem test_kitchen_chicken_soup_250902_090524_seed_643547)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn211=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn210=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn212=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn208=-1.872)
	(position counter#1::chewie_door_right_joint pstn207=1.872)
	(position oven#1::knob_joint_3 pstn211=0.0)
	(position oven#1::knob_joint_2 pstn210=0.0)
	(position fridge#1::fridge_door pstn209=1.78)
	(position faucet#1::joint_faucet_0 pstn212=0.0)

	(atposition counter#1::chewie_door_right_joint pstn207=1.872)
	(atposition oven#1::knob_joint_3 pstn211=0.0)
	(atposition oven#1::knob_joint_2 pstn210=0.0)
	(atposition fridge#1::fridge_door pstn209=1.78)
	(atposition faucet#1::joint_faucet_0 pstn212=0.0)
	(atposition counter#1::chewie_door_left_joint pstn208=-1.872)

	(pose salt-shaker p2318=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p2319=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2314=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p2315=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p2316=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))

	(isopenedposition counter#1::chewie_door_left_joint pstn208=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn207=1.872)
	(isopenedposition fridge#1::fridge_door pstn209=1.78)

	(atpose pepper-shaker p2319=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2314=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p2316=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(atpose chicken-leg p2315=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p2318=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p2318=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2319=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p2316=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313) counter#1::front_left_stove)
	(supported braiserbody#1 p2317=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
