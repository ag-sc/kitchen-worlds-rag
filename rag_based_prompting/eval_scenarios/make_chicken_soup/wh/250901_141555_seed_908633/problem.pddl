...
(define
  (problem test_kitchen_chicken_soup_250901_141555_seed_908633)
  (:domain domain)
  ...
  (:init
	...
	(isopenedposition fridge#1::fridge_door pstn2704=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2703=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2702=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn2707=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2705=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2706=0.0)

	(position counter#1::chewie_door_left_joint pstn2703=-1.872)
	(position faucet#1::joint_faucet_0 pstn2707=0.0)
	(position counter#1::chewie_door_right_joint pstn2702=1.872)
	(position oven#1::knob_joint_3 pstn2706=0.0)
	(position oven#1::knob_joint_2 pstn2705=0.0)
	(position fridge#1::fridge_door pstn2704=1.78)

	(atposition counter#1::chewie_door_left_joint pstn2703=-1.872)
	(atposition fridge#1::fridge_door pstn2704=1.78)
	(atposition faucet#1::joint_faucet_0 pstn2707=0.0)
	(atposition oven#1::knob_joint_3 pstn2706=0.0)
	(atposition oven#1::knob_joint_2 pstn2705=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2702=1.872)

	(pose braiserbody#1 p7242=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p7243=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p7244=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944))
	(pose pepper-shaker p7247=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p7246=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p7244=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944))
	(atpose salt-shaker p7246=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p7247=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p7243=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p7242=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p7246=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p7247=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p7245=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p7244=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944) counter#1::front_left_stove)
