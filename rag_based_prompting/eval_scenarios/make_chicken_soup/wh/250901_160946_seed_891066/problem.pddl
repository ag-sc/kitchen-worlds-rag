...
(define
  (problem test_kitchen_chicken_soup_250901_160946_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn5321=1.78)
	(position oven#1::knob_joint_3 pstn5323=0.0)
	(position counter#1::chewie_door_right_joint pstn5319=1.872)
	(position counter#1::chewie_door_left_joint pstn5320=-1.872)
	(position faucet#1::joint_faucet_0 pstn5324=0.0)
	(position oven#1::knob_joint_2 pstn5322=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn5323=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5324=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5322=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn5321=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5319=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5320=-1.872)

	(atposition counter#1::chewie_door_right_joint pstn5319=1.872)
	(atposition oven#1::knob_joint_2 pstn5322=0.0)
	(atposition fridge#1::fridge_door pstn5321=1.78)
	(atposition oven#1::knob_joint_3 pstn5323=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5320=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn5324=0.0)

	(pose salt-shaker p16542=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p16538=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p16540=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose chicken-leg p16539=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p16543=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p16539=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p16542=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p16543=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p16540=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose braiserbody#1 p16538=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p16541=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p16540=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)

	(contained pepper-shaker p16543=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p16542=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
