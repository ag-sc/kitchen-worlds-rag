...
(define
  (problem test_kitchen_chicken_soup_250901_165944_seed_889162)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn8273=0.0)
	(atposition oven#1::knob_joint_3 pstn8272=0.0)
	(atposition fridge#1::fridge_door pstn8270=1.78)
	(atposition oven#1::knob_joint_2 pstn8271=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8268=1.872)
	(atposition counter#1::chewie_door_left_joint pstn8269=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn8271=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8273=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8272=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn8269=-1.872)
	(position fridge#1::fridge_door pstn8270=1.78)
	(position counter#1::chewie_door_right_joint pstn8268=1.872)
	(position oven#1::knob_joint_2 pstn8271=0.0)
	(position faucet#1::joint_faucet_0 pstn8273=0.0)
	(position oven#1::knob_joint_3 pstn8272=0.0)

	(pose braiserlid#1 p20616=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209))
	(pose pepper-shaker p20619=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p20618=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p20614=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p20615=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p20615=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p20616=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209))
	(atpose braiserbody#1 p20614=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p20618=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p20619=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn8268=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn8269=-1.872)
	(isopenedposition fridge#1::fridge_door pstn8270=1.78)
	...
	(contained pepper-shaker p20619=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p20618=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p20616=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209) counter#1::front_left_stove)
	(supported braiserbody#1 p20617=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
