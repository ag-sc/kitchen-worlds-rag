...
(define
  (problem test_kitchen_chicken_soup_250901_092812_seed_989544)
  (:domain domain)
  ...
  (:init
	...
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
