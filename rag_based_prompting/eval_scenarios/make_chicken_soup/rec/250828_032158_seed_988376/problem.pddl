...
(define
  (problem test_kitchen_chicken_soup_250828_032158_seed_988376)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn35031=0.0)
	(position counter#1::chewie_door_left_joint pstn35028=-1.872)
	(position counter#1::chewie_door_right_joint pstn35027=1.872)
	(position oven#1::knob_joint_2 pstn35030=0.0)
	(position faucet#1::joint_faucet_0 pstn35032=0.0)
	(position fridge#1::fridge_door pstn35029=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn35031=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn35032=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn35030=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn35028=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn35027=1.872)
	(atposition oven#1::knob_joint_2 pstn35030=0.0)
	(atposition oven#1::knob_joint_3 pstn35031=0.0)
	(atposition faucet#1::joint_faucet_0 pstn35032=0.0)
	(atposition fridge#1::fridge_door pstn35029=1.78)

	(pose salt-shaker p97801=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p97797=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p97798=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p97802=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p97799=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))

	(atpose chicken-leg p97798=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p97802=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p97797=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p97799=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(atpose salt-shaker p97801=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq160=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn35028=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn35027=1.872)
	(isopenedposition fridge#1::fridge_door pstn35029=1.78)

	(ataconf right aq160=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p97802=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p97801=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p97799=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975) counter#1::front_left_stove)
	(supported braiserbody#1 p97800=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
