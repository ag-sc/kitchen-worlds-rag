...
(define
  (problem test_kitchen_chicken_soup_250827_165522_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn17862=0.0)
	(position fridge#1::fridge_door pstn17860=1.78)
	(position counter#1::chewie_door_left_joint pstn17859=-1.872)
	(position oven#1::knob_joint_2 pstn17861=0.0)
	(position faucet#1::joint_faucet_0 pstn17863=0.0)
	(position counter#1::chewie_door_right_joint pstn17858=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn17860=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn17858=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn17859=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn17863=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17862=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17861=0.0)

	(atposition counter#1::chewie_door_right_joint pstn17858=1.872)
	(atposition faucet#1::joint_faucet_0 pstn17863=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17859=-1.872)
	(atposition oven#1::knob_joint_2 pstn17861=0.0)
	(atposition oven#1::knob_joint_3 pstn17862=0.0)
	(atposition fridge#1::fridge_door pstn17860=1.78)

	(pose chicken-leg p42909=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p42910=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose pepper-shaker p42913=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p42912=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p42908=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq888=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq80=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p42913=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p42910=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose braiserbody#1 p42908=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p42912=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p42909=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(ataconf right aq80=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq888=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p42913=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p42912=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p42911=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p42910=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
