...
(define
  (problem test_kitchen_chicken_soup_250826_182006_seed_318962)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn6581=0.0)
	(position oven#1::knob_joint_3 pstn6582=0.0)
	(position faucet#1::joint_faucet_0 pstn6583=0.0)
	(position counter#1::chewie_door_left_joint pstn6579=-1.872)
	(position fridge#1::fridge_door pstn6580=1.78)
	(position counter#1::chewie_door_right_joint pstn6578=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn6581=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6582=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6583=0.0)

	(atposition counter#1::chewie_door_left_joint pstn6579=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn6578=1.872)
	(atposition oven#1::knob_joint_2 pstn6581=0.0)
	(atposition oven#1::knob_joint_3 pstn6582=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6583=0.0)
	(atposition fridge#1::fridge_door pstn6580=1.78)

	(atpose salt-shaker p9372=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p9373=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p9370=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79))
	(atpose braiserbody#1 p9368=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p9369=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p9373=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p9370=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79))
	(pose salt-shaker p9372=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p9368=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p9369=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn6579=-1.872)
	(isopenedposition fridge#1::fridge_door pstn6580=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6578=1.872)
	...
	(contained pepper-shaker p9373=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p9372=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p9371=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p9370=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79) counter#1::front_left_stove)
