...
(define
  (problem test_kitchen_chicken_soup_250910_104648_seed_112279)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn1281=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1283=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1282=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn1278=1.872)
	(position counter#1::chewie_door_left_joint pstn1279=-1.872)
	(position oven#1::knob_joint_3 pstn1282=0.0)
	(position fridge#1::fridge_door pstn1280=1.78)
	(position faucet#1::joint_faucet_0 pstn1283=0.0)
	(position oven#1::knob_joint_2 pstn1281=0.0)

	(atposition counter#1::chewie_door_left_joint pstn1279=-1.872)
	(atposition oven#1::knob_joint_2 pstn1281=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1278=1.872)
	(atposition fridge#1::fridge_door pstn1280=1.78)
	(atposition faucet#1::joint_faucet_0 pstn1283=0.0)
	(atposition oven#1::knob_joint_3 pstn1282=0.0)

	(pose braiserbody#1 p658=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p662=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p663=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p659=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p660=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))

	(atpose pepper-shaker p663=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p659=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p660=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))
	(atpose salt-shaker p662=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p658=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn1278=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1279=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1280=1.78)
	...
	(contained salt-shaker p662=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p663=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p660=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655) counter#1::front_left_stove)
	(supported braiserbody#1 p661=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
