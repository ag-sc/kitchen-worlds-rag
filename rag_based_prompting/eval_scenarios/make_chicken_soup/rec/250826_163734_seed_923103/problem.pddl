...
(define
  (problem test_kitchen_chicken_soup_250826_163734_seed_923103)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p1465=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p1462=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1463=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(pose pepper-shaker p1466=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1461=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p1463=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(atpose pepper-shaker p1466=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1462=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p1465=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1461=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p1465=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p1466=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p1463=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097) counter#1::front_left_stove)
	(supported braiserbody#1 p1464=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
