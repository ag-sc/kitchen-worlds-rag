...
(define
  (problem test_kitchen_chicken_soup_250828_020743_seed_178186)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn33303=0.0)
	(atposition faucet#1::joint_faucet_0 pstn33304=0.0)
	(atposition counter#1::chewie_door_right_joint pstn33299=1.872)
	(atposition oven#1::knob_joint_2 pstn33302=0.0)
	(atposition counter#1::chewie_door_left_joint pstn33300=-1.872)
	(atposition fridge#1::fridge_door pstn33301=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn33302=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn33304=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn33303=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn33301=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn33299=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn33300=-1.872)

	(position counter#1::chewie_door_right_joint pstn33299=1.872)
	(position oven#1::knob_joint_2 pstn33302=0.0)
	(position counter#1::chewie_door_left_joint pstn33300=-1.872)
	(position faucet#1::joint_faucet_0 pstn33304=0.0)
	(position fridge#1::fridge_door pstn33301=1.78)
	(position oven#1::knob_joint_3 pstn33303=0.0)

	(pose braiserlid#1 p91272=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	(pose salt-shaker p91274=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p91275=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p91271=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p91270=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p91270=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p91271=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p91274=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p91275=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p91272=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	...
	(contained pepper-shaker p91275=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p91274=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p91272=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036) counter#1::front_left_stove)
	(supported braiserbody#1 p91273=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
