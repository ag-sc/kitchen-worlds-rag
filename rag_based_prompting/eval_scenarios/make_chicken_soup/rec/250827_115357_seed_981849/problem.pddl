...
(define
  (problem test_kitchen_chicken_soup_250827_115357_seed_981849)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn5946=1.78)
	(position counter#1::chewie_door_right_joint pstn5944=1.872)
	(position faucet#1::joint_faucet_0 pstn5949=0.0)
	(position oven#1::knob_joint_3 pstn5948=0.0)
	(position oven#1::knob_joint_2 pstn5947=0.0)
	(position counter#1::chewie_door_left_joint pstn5945=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn5947=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5949=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5948=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn5944=1.872)
	(atposition faucet#1::joint_faucet_0 pstn5949=0.0)
	(atposition oven#1::knob_joint_3 pstn5948=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5945=-1.872)
	(atposition oven#1::knob_joint_2 pstn5947=0.0)
	(atposition fridge#1::fridge_door pstn5946=1.78)

	(pose salt-shaker p12474=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p12471=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p12472=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(pose pepper-shaker p12475=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p12470=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p12472=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(atpose pepper-shaker p12475=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p12471=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p12470=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p12474=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn5944=1.872)
	(isopenedposition fridge#1::fridge_door pstn5946=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5945=-1.872)
	...
	(contained salt-shaker p12474=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12475=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p12472=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705) counter#1::front_left_stove)
	(supported braiserbody#1 p12473=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
