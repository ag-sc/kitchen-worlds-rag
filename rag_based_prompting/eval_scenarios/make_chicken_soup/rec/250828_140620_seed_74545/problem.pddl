...
(define
  (problem test_kitchen_chicken_soup_250828_140620_seed_74545)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn479=0.0)
	(position counter#1::chewie_door_left_joint pstn477=-1.872)
	(position counter#1::chewie_door_right_joint pstn476=1.872)
	(position faucet#1::joint_faucet_0 pstn481=0.0)
	(position oven#1::knob_joint_3 pstn480=0.0)
	(position fridge#1::fridge_door pstn478=1.78)
	...
	(atposition fridge#1::fridge_door pstn478=1.78)
	(atposition faucet#1::joint_faucet_0 pstn481=0.0)
	(atposition oven#1::knob_joint_3 pstn480=0.0)
	(atposition counter#1::chewie_door_left_joint pstn477=-1.872)
	(atposition oven#1::knob_joint_2 pstn479=0.0)
	(atposition counter#1::chewie_door_right_joint pstn476=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn479=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn481=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn480=0.0)

	(isopenedposition fridge#1::fridge_door pstn478=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn477=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn476=1.872)
	...
	(pose braiserlid#1 p2106=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(pose braiserbody#1 p2104=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p2109=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p2108=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p2105=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p2106=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(atpose pepper-shaker p2109=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2105=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p2104=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p2108=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p2109=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2108=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2107=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2106=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999) counter#1::front_left_stove)
