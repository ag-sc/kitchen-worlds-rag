...
(define
  (problem test_kitchen_chicken_soup_250828_060424_seed_708959)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn40119=1.78)
	(position faucet#1::joint_faucet_0 pstn40122=0.0)
	(position counter#1::chewie_door_left_joint pstn40118=-1.872)
	(position counter#1::chewie_door_right_joint pstn40117=1.872)
	(position oven#1::knob_joint_3 pstn40121=0.0)
	(position oven#1::knob_joint_2 pstn40120=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn40120=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn40122=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn40121=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn40118=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn40117=1.872)
	(atposition faucet#1::joint_faucet_0 pstn40122=0.0)
	(atposition oven#1::knob_joint_2 pstn40120=0.0)
	(atposition oven#1::knob_joint_3 pstn40121=0.0)
	(atposition fridge#1::fridge_door pstn40119=1.78)

	(atpose chicken-leg p106742=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p106743=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(atpose salt-shaker p106745=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p106741=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p106746=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p106746=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p106743=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(pose chicken-leg p106742=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p106741=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p106745=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn40118=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn40117=1.872)
	(isopenedposition fridge#1::fridge_door pstn40119=1.78)
	...
	(supported braiserbody#1 p106744=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p106743=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278) counter#1::front_left_stove)

	(contained pepper-shaker p106746=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p106745=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
