...
(define
  (problem test_kitchen_chicken_soup_250827_112417_seed_239530)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn5073=1.78)
	(atposition counter#1::chewie_door_left_joint pstn5072=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn5076=0.0)
	(atposition oven#1::knob_joint_2 pstn5074=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5071=1.872)
	(atposition oven#1::knob_joint_3 pstn5075=0.0)
	(position faucet#1::joint_faucet_0 pstn5076=0.0)
	(position fridge#1::fridge_door pstn5073=1.78)
	(position oven#1::knob_joint_2 pstn5074=0.0)
	(position counter#1::chewie_door_right_joint pstn5071=1.872)
	(position counter#1::chewie_door_left_joint pstn5072=-1.872)
	(position oven#1::knob_joint_3 pstn5075=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn5073=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5071=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5072=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn5076=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5074=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5075=0.0)
	...
	(pose braiserbody#1 p10049=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p10051=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))

	(atpose chicken-leg p10050=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p10049=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p10053=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p10054=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p10051=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	...
	(supported braiserbody#1 p10052=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p10051=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285) counter#1::front_left_stove)
