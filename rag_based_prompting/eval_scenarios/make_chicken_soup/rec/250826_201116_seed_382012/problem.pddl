...
(define
  (problem test_kitchen_chicken_soup_250826_201116_seed_382012)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn11713=0.0)
	(position counter#1::chewie_door_right_joint pstn11710=1.872)
	(position fridge#1::fridge_door pstn11712=1.78)
	(position oven#1::knob_joint_3 pstn11714=0.0)
	(position faucet#1::joint_faucet_0 pstn11715=0.0)
	(position counter#1::chewie_door_left_joint pstn11711=-1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn11715=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11710=1.872)
	(atposition oven#1::knob_joint_2 pstn11713=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11711=-1.872)
	(atposition fridge#1::fridge_door pstn11712=1.78)
	(atposition oven#1::knob_joint_3 pstn11714=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn11714=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11715=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11713=0.0)

	(pose chicken-leg p13917=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p13920=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p13916=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p13921=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p13918=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))

	(atpose pepper-shaker p13921=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p13918=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(atpose salt-shaker p13920=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p13917=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p13916=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn11711=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn11710=1.872)
	(isopenedposition fridge#1::fridge_door pstn11712=1.78)
	...
	(contained salt-shaker p13920=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p13921=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13919=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13918=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928) counter#1::front_left_stove)
