...
(define
  (problem test_kitchen_chicken_soup_250828_001141_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn30685=0.0)
	(atposition counter#1::chewie_door_right_joint pstn30680=1.872)
	(atposition oven#1::knob_joint_2 pstn30683=0.0)
	(atposition counter#1::chewie_door_left_joint pstn30681=-1.872)
	(atposition fridge#1::fridge_door pstn30682=1.78)
	(atposition oven#1::knob_joint_3 pstn30684=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn30685=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn30684=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn30683=0.0)

	(position counter#1::chewie_door_right_joint pstn30680=1.872)
	(position oven#1::knob_joint_3 pstn30684=0.0)
	(position fridge#1::fridge_door pstn30682=1.78)
	(position oven#1::knob_joint_2 pstn30683=0.0)
	(position counter#1::chewie_door_left_joint pstn30681=-1.872)
	(position faucet#1::joint_faucet_0 pstn30685=0.0)

	(atpose chicken-leg p82584=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p82583=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p82588=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p82585=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(atpose salt-shaker p82587=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p82588=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p82584=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p82583=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p82585=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose salt-shaker p82587=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn30681=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn30680=1.872)
	(isopenedposition fridge#1::fridge_door pstn30682=1.78)
	...
	(contained salt-shaker p82587=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p82588=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p82586=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p82585=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
