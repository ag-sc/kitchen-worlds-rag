...
(define
  (problem test_kitchen_chicken_soup_250826_160751_seed_240439)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn971=0.0)
	(position counter#1::chewie_door_right_joint pstn968=1.872)
	(position fridge#1::fridge_door pstn970=1.78)
	(position counter#1::chewie_door_left_joint pstn969=-1.872)
	(position oven#1::knob_joint_3 pstn972=0.0)
	(position faucet#1::joint_faucet_0 pstn973=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn973=0.0)
	(atposition oven#1::knob_joint_2 pstn971=0.0)
	(atposition fridge#1::fridge_door pstn970=1.78)
	(atposition oven#1::knob_joint_3 pstn972=0.0)
	(atposition counter#1::chewie_door_right_joint pstn968=1.872)
	(atposition counter#1::chewie_door_left_joint pstn969=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn971=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn972=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn973=0.0)
	...
	(pose pepper-shaker p592=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p591=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p589=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))
	(pose chicken-leg p588=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p587=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p589=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))
	(atpose chicken-leg p588=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p592=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p591=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p587=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn969=-1.872)
	(isopenedposition fridge#1::fridge_door pstn970=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn968=1.872)
	...
	(contained pepper-shaker p592=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p591=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p589=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159) counter#1::front_left_stove)
	(supported braiserbody#1 p590=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
