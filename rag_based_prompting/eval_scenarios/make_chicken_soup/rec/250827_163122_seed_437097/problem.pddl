...
(define
  (problem test_kitchen_chicken_soup_250827_163122_seed_437097)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn17026=0.0)
	(atposition fridge#1::fridge_door pstn17023=1.78)
	(atposition oven#1::knob_joint_2 pstn17024=0.0)
	(atposition oven#1::knob_joint_3 pstn17025=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17022=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn17021=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn17025=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17024=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17026=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn17021=1.872)
	(position oven#1::knob_joint_3 pstn17025=0.0)
	(position fridge#1::fridge_door pstn17023=1.78)
	(position counter#1::chewie_door_left_joint pstn17022=-1.872)
	(position faucet#1::joint_faucet_0 pstn17026=0.0)
	(position oven#1::knob_joint_2 pstn17024=0.0)

	(pose salt-shaker p40755=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p40752=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p40751=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p40756=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p40753=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))

	(atpose pepper-shaker p40756=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p40753=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(atpose chicken-leg p40752=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p40755=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p40751=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn17021=1.872)
	(isopenedposition fridge#1::fridge_door pstn17023=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn17022=-1.872)
	...
	(contained salt-shaker p40755=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p40756=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p40754=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p40753=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96) counter#1::front_left_stove)
