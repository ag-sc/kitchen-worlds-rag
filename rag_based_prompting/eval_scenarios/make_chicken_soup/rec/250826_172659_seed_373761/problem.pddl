...
(define
  (problem test_kitchen_chicken_soup_250826_172659_seed_373761)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p4839=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4835=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p4836=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p4840=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4837=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))

	(atpose braiserbody#1 p4835=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p4836=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p4837=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))
	(atpose pepper-shaker p4840=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p4839=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p4839=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p4840=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4837=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998) counter#1::front_left_stove)
	(supported braiserbody#1 p4838=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
