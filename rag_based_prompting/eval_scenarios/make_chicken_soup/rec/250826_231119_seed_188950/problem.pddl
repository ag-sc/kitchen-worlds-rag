...
(define
  (problem test_kitchen_chicken_soup_250826_231119_seed_188950)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn18866=0.0)
	(atposition counter#1::chewie_door_left_joint pstn18863=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn18862=1.872)
	(atposition oven#1::knob_joint_2 pstn18865=0.0)
	(atposition faucet#1::joint_faucet_0 pstn18867=0.0)
	(atposition fridge#1::fridge_door pstn18864=1.78)

	(position faucet#1::joint_faucet_0 pstn18867=0.0)
	(position oven#1::knob_joint_2 pstn18865=0.0)
	(position counter#1::chewie_door_right_joint pstn18862=1.872)
	(position fridge#1::fridge_door pstn18864=1.78)
	(position oven#1::knob_joint_3 pstn18866=0.0)
	(position counter#1::chewie_door_left_joint pstn18863=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn18867=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18865=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn18866=0.0)

	(pose salt-shaker p21820=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p21817=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p21816=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p21821=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p21818=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))

	(aconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq208=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p21821=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p21818=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	(atpose salt-shaker p21820=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p21816=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p21817=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn18862=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn18863=-1.872)
	(isopenedposition fridge#1::fridge_door pstn18864=1.78)

	(ataconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq208=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p21820=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p21821=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p21819=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p21818=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735) counter#1::front_left_stove)
