...
(define
  (problem test_kitchen_chicken_soup_250829_153732_seed_709159)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn4370=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4371=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4369=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn4368=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4366=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn4367=-1.872)

	(position counter#1::chewie_door_left_joint pstn4367=-1.872)
	(position counter#1::chewie_door_right_joint pstn4366=1.872)
	(position oven#1::knob_joint_3 pstn4370=0.0)
	(position faucet#1::joint_faucet_0 pstn4371=0.0)
	(position fridge#1::fridge_door pstn4368=1.78)
	(position oven#1::knob_joint_2 pstn4369=0.0)

	(atposition counter#1::chewie_door_left_joint pstn4367=-1.872)
	(atposition oven#1::knob_joint_3 pstn4370=0.0)
	(atposition faucet#1::joint_faucet_0 pstn4371=0.0)
	(atposition fridge#1::fridge_door pstn4368=1.78)
	(atposition oven#1::knob_joint_2 pstn4369=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4366=1.872)

	(atpose chicken-leg p11064=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p11067=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p11063=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p11068=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p11065=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(pose pepper-shaker p11068=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p11064=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p11063=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p11065=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(pose salt-shaker p11067=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p11068=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p11067=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p11065=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44) counter#1::front_left_stove)
	(supported braiserbody#1 p11066=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
