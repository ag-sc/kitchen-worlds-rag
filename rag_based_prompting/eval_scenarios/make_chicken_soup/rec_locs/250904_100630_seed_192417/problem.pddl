...
(define
  (problem test_kitchen_chicken_soup_250904_100630_seed_192417)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn1071=1.78)
	(position oven#1::knob_joint_3 pstn1073=0.0)
	(position counter#1::chewie_door_left_joint pstn1070=-1.872)
	(position counter#1::chewie_door_right_joint pstn1069=1.872)
	(position oven#1::knob_joint_2 pstn1072=0.0)
	(position faucet#1::joint_faucet_0 pstn1074=0.0)

	(atposition fridge#1::fridge_door pstn1071=1.78)
	(atposition faucet#1::joint_faucet_0 pstn1074=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1070=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1069=1.872)
	(atposition oven#1::knob_joint_3 pstn1073=0.0)
	(atposition oven#1::knob_joint_2 pstn1072=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn1073=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1072=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1074=0.0)
	...
	(pose salt-shaker p2817=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p2814=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p2818=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2813=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2815=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539))

	(atpose chicken-leg p2814=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p2817=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2813=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p2815=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539))
	(atpose pepper-shaker p2818=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn1070=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1071=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1069=1.872)
	...
	(contained salt-shaker p2817=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2818=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p2815=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539) counter#1::front_left_stove)
	(supported braiserbody#1 p2816=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
