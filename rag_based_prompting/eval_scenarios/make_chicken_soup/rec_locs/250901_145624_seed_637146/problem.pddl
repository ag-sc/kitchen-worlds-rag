...
(define
  (problem test_kitchen_chicken_soup_250901_145624_seed_637146)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn9557=1.78)
	(atposition oven#1::knob_joint_3 pstn9559=0.0)
	(atposition oven#1::knob_joint_2 pstn9558=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9556=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn9560=0.0)
	(atposition counter#1::chewie_door_right_joint pstn9555=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn9560=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9559=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9558=0.0)

	(position counter#1::chewie_door_left_joint pstn9556=-1.872)
	(position oven#1::knob_joint_2 pstn9558=0.0)
	(position faucet#1::joint_faucet_0 pstn9560=0.0)
	(position counter#1::chewie_door_right_joint pstn9555=1.872)
	(position fridge#1::fridge_door pstn9557=1.78)
	(position oven#1::knob_joint_3 pstn9559=0.0)

	(pose chicken-leg p24768=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p24771=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p24769=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(pose pepper-shaker p24772=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p24767=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p24767=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p24771=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p24768=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p24772=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p24769=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))

	(isopenedposition counter#1::chewie_door_left_joint pstn9556=-1.872)
	(isopenedposition fridge#1::fridge_door pstn9557=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn9555=1.872)
	...
	(contained salt-shaker p24771=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p24772=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p24770=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p24769=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073) counter#1::front_left_stove)
