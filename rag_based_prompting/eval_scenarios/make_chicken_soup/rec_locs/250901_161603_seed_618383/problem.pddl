...
(define
  (problem test_kitchen_chicken_soup_250901_161603_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn13154=0.0)
	(position counter#1::chewie_door_right_joint pstn13150=1.872)
	(position faucet#1::joint_faucet_0 pstn13155=0.0)
	(position fridge#1::fridge_door pstn13152=1.78)
	(position counter#1::chewie_door_left_joint pstn13151=-1.872)
	(position oven#1::knob_joint_2 pstn13153=0.0)
	...
	(atposition oven#1::knob_joint_2 pstn13153=0.0)
	(atposition counter#1::chewie_door_left_joint pstn13151=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn13150=1.872)
	(atposition oven#1::knob_joint_3 pstn13154=0.0)
	(atposition faucet#1::joint_faucet_0 pstn13155=0.0)
	(atposition fridge#1::fridge_door pstn13152=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn13154=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn13153=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13155=0.0)

	(isopenedposition fridge#1::fridge_door pstn13152=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn13150=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn13151=-1.872)

	(pose braiserbody#1 p29131=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p29135=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p29132=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p29136=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p29133=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))

	(atpose braiserlid#1 p29133=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(atpose braiserbody#1 p29131=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p29132=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p29136=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p29135=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p29136=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p29135=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p29133=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)
	(supported braiserbody#1 p29134=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
