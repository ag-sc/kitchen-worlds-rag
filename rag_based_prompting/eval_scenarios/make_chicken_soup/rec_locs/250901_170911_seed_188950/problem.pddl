...
(define
  (problem test_kitchen_chicken_soup_250901_170911_seed_188950)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn14601=0.0)
	(atposition fridge#1::fridge_door pstn14600=1.78)
	(atposition faucet#1::joint_faucet_0 pstn14603=0.0)
	(atposition counter#1::chewie_door_right_joint pstn14598=1.872)
	(atposition oven#1::knob_joint_3 pstn14602=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14599=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn14603=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14602=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14601=0.0)

	(position counter#1::chewie_door_right_joint pstn14598=1.872)
	(position fridge#1::fridge_door pstn14600=1.78)
	(position faucet#1::joint_faucet_0 pstn14603=0.0)
	(position oven#1::knob_joint_3 pstn14602=0.0)
	(position counter#1::chewie_door_left_joint pstn14599=-1.872)
	(position oven#1::knob_joint_2 pstn14601=0.0)

	(pose salt-shaker p33378=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p33375=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p33374=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p33376=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	(pose pepper-shaker p33379=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p33376=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	(atpose chicken-leg p33375=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p33379=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p33374=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p33378=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn14598=1.872)
	(isopenedposition fridge#1::fridge_door pstn14600=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn14599=-1.872)
	...
	(contained salt-shaker p33378=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p33379=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p33377=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p33376=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735) counter#1::front_left_stove)
