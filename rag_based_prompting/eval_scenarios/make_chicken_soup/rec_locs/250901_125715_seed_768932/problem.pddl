...
(define
  (problem test_kitchen_chicken_soup_250901_125715_seed_768932)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn5542=1.78)
	(position oven#1::knob_joint_2 pstn5543=0.0)
	(position faucet#1::joint_faucet_0 pstn5545=0.0)
	(position counter#1::chewie_door_left_joint pstn5541=-1.872)
	(position oven#1::knob_joint_3 pstn5544=0.0)
	(position counter#1::chewie_door_right_joint pstn5540=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn5545=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5544=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5543=0.0)

	(atposition counter#1::chewie_door_right_joint pstn5540=1.872)
	(atposition counter#1::chewie_door_left_joint pstn5541=-1.872)
	(atposition oven#1::knob_joint_2 pstn5543=0.0)
	(atposition oven#1::knob_joint_3 pstn5544=0.0)
	(atposition fridge#1::fridge_door pstn5542=1.78)
	(atposition faucet#1::joint_faucet_0 pstn5545=0.0)

	(pose braiserbody#1 p16877=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p16878=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p16879=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))
	(pose salt-shaker p16881=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p16882=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p16877=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p16881=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p16882=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p16878=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p16879=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))

	(isopenedposition counter#1::chewie_door_right_joint pstn5540=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5541=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5542=1.78)
	...
	(contained pepper-shaker p16882=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p16881=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p16880=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p16879=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469) counter#1::front_left_stove)
