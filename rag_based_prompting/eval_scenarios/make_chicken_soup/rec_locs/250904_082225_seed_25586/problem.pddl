...
(define
  (problem test_kitchen_chicken_soup_250904_082225_seed_25586)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn24841=0.0)
	(position counter#1::chewie_door_right_joint pstn24837=1.872)
	(position faucet#1::joint_faucet_0 pstn24842=0.0)
	(position oven#1::knob_joint_2 pstn24840=0.0)
	(position counter#1::chewie_door_left_joint pstn24838=-1.872)
	(position fridge#1::fridge_door pstn24839=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn24841=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24842=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24840=0.0)

	(atposition counter#1::chewie_door_left_joint pstn24838=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn24842=0.0)
	(atposition counter#1::chewie_door_right_joint pstn24837=1.872)
	(atposition fridge#1::fridge_door pstn24839=1.78)
	(atposition oven#1::knob_joint_2 pstn24840=0.0)
	(atposition oven#1::knob_joint_3 pstn24841=0.0)

	(pose chicken-leg p62641=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p62644=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p62645=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p62640=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p62642=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))

	(atpose braiserbody#1 p62640=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p62642=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(atpose pepper-shaker p62645=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p62641=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p62644=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq552=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq744=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn24838=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn24837=1.872)
	(isopenedposition fridge#1::fridge_door pstn24839=1.78)

	(ataconf right aq744=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq552=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p62645=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p62644=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p62642=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973) counter#1::front_left_stove)
	(supported braiserbody#1 p62643=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
