...
(define
  (problem test_kitchen_chicken_soup_250901_172604_seed_354453)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn15248=0.0)
	(position counter#1::chewie_door_left_joint pstn15245=-1.872)
	(position faucet#1::joint_faucet_0 pstn15249=0.0)
	(position oven#1::knob_joint_2 pstn15247=0.0)
	(position fridge#1::fridge_door pstn15246=1.78)
	(position counter#1::chewie_door_right_joint pstn15244=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn15247=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15248=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15249=0.0)

	(atposition counter#1::chewie_door_right_joint pstn15244=1.872)
	(atposition oven#1::knob_joint_3 pstn15248=0.0)
	(atposition faucet#1::joint_faucet_0 pstn15249=0.0)
	(atposition oven#1::knob_joint_2 pstn15247=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15245=-1.872)
	(atposition fridge#1::fridge_door pstn15246=1.78)

	(atpose chicken-leg p33828=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p33829=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(atpose pepper-shaker p33832=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p33827=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p33831=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p33832=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p33827=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p33831=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p33828=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p33829=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))

	(isopenedposition counter#1::chewie_door_right_joint pstn15244=1.872)
	(isopenedposition fridge#1::fridge_door pstn15246=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn15245=-1.872)
	...
	(contained salt-shaker p33831=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p33832=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p33830=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p33829=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309) counter#1::front_left_stove)
