...
(define
  (problem test_kitchen_chicken_soup_250901_180346_seed_567288)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn17035=0.0)
	(atposition oven#1::knob_joint_3 pstn17034=0.0)
	(atposition oven#1::knob_joint_2 pstn17033=0.0)
	(atposition counter#1::chewie_door_right_joint pstn17030=1.872)
	(atposition counter#1::chewie_door_left_joint pstn17031=-1.872)
	(atposition fridge#1::fridge_door pstn17032=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn17035=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17033=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17034=0.0)

	(position counter#1::chewie_door_right_joint pstn17030=1.872)
	(position oven#1::knob_joint_2 pstn17033=0.0)
	(position counter#1::chewie_door_left_joint pstn17031=-1.872)
	(position faucet#1::joint_faucet_0 pstn17035=0.0)
	(position fridge#1::fridge_door pstn17032=1.78)
	(position oven#1::knob_joint_3 pstn17034=0.0)

	(pose pepper-shaker p35870=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p35866=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p35869=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p35865=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p35867=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))

	(atpose braiserlid#1 p35867=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(atpose pepper-shaker p35870=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p35869=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p35866=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p35865=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq432=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq280=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn17030=1.872)
	(isopenedposition fridge#1::fridge_door pstn17032=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn17031=-1.872)

	(ataconf left aq432=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq280=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p35869=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p35870=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p35867=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683) counter#1::front_left_stove)
	(supported braiserbody#1 p35868=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
