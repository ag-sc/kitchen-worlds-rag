...
(define
  (problem test_kitchen_chicken_soup_250901_222918_seed_437097)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn25598=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn25599=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn25597=0.0)

	(isopenedposition fridge#1::fridge_door pstn25596=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn25595=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn25594=1.872)

	(position counter#1::chewie_door_left_joint pstn25595=-1.872)
	(position oven#1::knob_joint_2 pstn25597=0.0)
	(position fridge#1::fridge_door pstn25596=1.78)
	(position oven#1::knob_joint_3 pstn25598=0.0)
	(position counter#1::chewie_door_right_joint pstn25594=1.872)
	(position faucet#1::joint_faucet_0 pstn25599=0.0)

	(atposition counter#1::chewie_door_left_joint pstn25595=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn25599=0.0)
	(atposition oven#1::knob_joint_2 pstn25597=0.0)
	(atposition fridge#1::fridge_door pstn25596=1.78)
	(atposition oven#1::knob_joint_3 pstn25598=0.0)
	(atposition counter#1::chewie_door_right_joint pstn25594=1.872)

	(pose salt-shaker p48840=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p48836=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p48841=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p48838=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(pose chicken-leg p48837=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserbody#1 p48836=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p48840=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p48841=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p48838=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(atpose chicken-leg p48837=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p48840=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p48841=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p48838=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96) counter#1::front_left_stove)
	(supported braiserbody#1 p48839=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
