...
(define
  (problem test_kitchen_chicken_soup_250901_202854_seed_454237)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn21022=0.0)
	(atposition counter#1::chewie_door_left_joint pstn21020=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn21019=1.872)
	(atposition oven#1::knob_joint_3 pstn21023=0.0)
	(atposition fridge#1::fridge_door pstn21021=1.78)
	(atposition faucet#1::joint_faucet_0 pstn21024=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn21023=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21022=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21024=0.0)

	(isopenedposition fridge#1::fridge_door pstn21021=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn21019=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn21020=-1.872)

	(position counter#1::chewie_door_left_joint pstn21020=-1.872)
	(position counter#1::chewie_door_right_joint pstn21019=1.872)
	(position fridge#1::fridge_door pstn21021=1.78)
	(position oven#1::knob_joint_3 pstn21023=0.0)
	(position faucet#1::joint_faucet_0 pstn21024=0.0)
	(position oven#1::knob_joint_2 pstn21022=0.0)

	(pose braiserlid#1 p43924=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129))
	(pose pepper-shaker p43927=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p43922=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p43923=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p43926=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p43927=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p43924=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129))
	(atpose braiserbody#1 p43922=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p43923=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p43926=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p43926=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p43927=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p43925=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p43924=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129) counter#1::front_left_stove)
