...
(define
  (problem test_kitchen_chicken_soup_250904_130337_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn795=0.0)
	(position oven#1::knob_joint_3 pstn796=0.0)
	(position counter#1::chewie_door_left_joint pstn793=-1.872)
	(position faucet#1::joint_faucet_0 pstn797=0.0)
	(position counter#1::chewie_door_right_joint pstn792=1.872)
	(position fridge#1::fridge_door pstn794=1.78)
	...
	(atposition oven#1::knob_joint_3 pstn796=0.0)
	(atposition faucet#1::joint_faucet_0 pstn797=0.0)
	(atposition fridge#1::fridge_door pstn794=1.78)
	(atposition counter#1::chewie_door_right_joint pstn792=1.872)
	(atposition oven#1::knob_joint_2 pstn795=0.0)
	(atposition counter#1::chewie_door_left_joint pstn793=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn797=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn796=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn795=0.0)

	(pose chicken-leg p4635=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p4638=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4636=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(pose pepper-shaker p4639=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4634=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn793=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn792=1.872)
	(isopenedposition fridge#1::fridge_door pstn794=1.78)

	(atpose pepper-shaker p4639=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p4638=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p4636=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(atpose braiserbody#1 p4634=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p4635=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p4639=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4638=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p4637=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p4636=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
