...
(define
  (problem test_kitchen_chicken_soup_250901_122629_seed_854983)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn4723=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4719=-1.872)
	(atposition fridge#1::fridge_door pstn4720=1.78)
	(atposition oven#1::knob_joint_3 pstn4722=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4718=1.872)
	(atposition oven#1::knob_joint_2 pstn4721=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn4723=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4722=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4721=0.0)

	(position counter#1::chewie_door_left_joint pstn4719=-1.872)
	(position fridge#1::fridge_door pstn4720=1.78)
	(position oven#1::knob_joint_3 pstn4722=0.0)
	(position counter#1::chewie_door_right_joint pstn4718=1.872)
	(position oven#1::knob_joint_2 pstn4721=0.0)
	(position faucet#1::joint_faucet_0 pstn4723=0.0)

	(atpose braiserbody#1 p13018=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p13023=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p13020=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(atpose chicken-leg p13019=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p13022=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(pose pepper-shaker p13023=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p13020=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(pose braiserbody#1 p13018=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p13019=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p13022=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn4719=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4720=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4718=1.872)
	...
	(supported braiserbody#1 p13021=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13020=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303) counter#1::front_left_stove)

	(contained pepper-shaker p13023=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p13022=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
