...
(define
  (problem test_kitchen_chicken_soup_250901_133643_seed_951676)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn6529=0.0)
	(position counter#1::chewie_door_left_joint pstn6527=-1.872)
	(position fridge#1::fridge_door pstn6528=1.78)
	(position oven#1::knob_joint_3 pstn6530=0.0)
	(position faucet#1::joint_faucet_0 pstn6531=0.0)
	(position counter#1::chewie_door_right_joint pstn6526=1.872)

	(atposition oven#1::knob_joint_3 pstn6530=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6526=1.872)
	(atposition oven#1::knob_joint_2 pstn6529=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6531=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6527=-1.872)
	(atposition fridge#1::fridge_door pstn6528=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn6529=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6530=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6531=0.0)
	...
	(pose braiserbody#1 p19626=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p19627=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p19630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p19628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(pose pepper-shaker p19631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p19628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(atpose braiserbody#1 p19626=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p19630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p19627=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p19631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn6526=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn6527=-1.872)
	(isopenedposition fridge#1::fridge_door pstn6528=1.78)
	...
	(contained salt-shaker p19630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p19631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p19628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625) counter#1::front_left_stove)
	(supported braiserbody#1 p19629=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
