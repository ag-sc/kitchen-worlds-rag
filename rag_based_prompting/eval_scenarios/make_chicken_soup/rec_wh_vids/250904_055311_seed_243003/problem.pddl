...
(define
  (problem test_kitchen_chicken_soup_250904_055311_seed_243003)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn21482=0.0)
	(position counter#1::chewie_door_left_joint pstn21479=-1.872)
	(position fridge#1::fridge_door pstn21480=1.78)
	(position counter#1::chewie_door_right_joint pstn21478=1.872)
	(position faucet#1::joint_faucet_0 pstn21483=0.0)
	(position oven#1::knob_joint_2 pstn21481=0.0)

	(atposition oven#1::knob_joint_2 pstn21481=0.0)
	(atposition counter#1::chewie_door_right_joint pstn21478=1.872)
	(atposition counter#1::chewie_door_left_joint pstn21479=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn21483=0.0)
	(atposition oven#1::knob_joint_3 pstn21482=0.0)
	(atposition fridge#1::fridge_door pstn21480=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn21482=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21481=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21483=0.0)

	(isopenedposition fridge#1::fridge_door pstn21480=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn21478=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn21479=-1.872)

	(pose pepper-shaker p43946=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p43941=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p43945=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p43942=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p43943=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))

	(atpose pepper-shaker p43946=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p43945=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p43943=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(atpose braiserbody#1 p43941=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p43942=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p43945=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p43946=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p43943=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274) counter#1::front_left_stove)
	(supported braiserbody#1 p43944=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
