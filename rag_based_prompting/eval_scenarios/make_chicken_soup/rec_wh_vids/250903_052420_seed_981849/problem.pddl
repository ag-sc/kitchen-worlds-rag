...
(define
  (problem test_kitchen_chicken_soup_250903_052420_seed_981849)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn15175=0.0)
	(position oven#1::knob_joint_3 pstn15174=0.0)
	(position oven#1::knob_joint_2 pstn15173=0.0)
	(position counter#1::chewie_door_left_joint pstn15171=-1.872)
	(position counter#1::chewie_door_right_joint pstn15170=1.872)
	(position fridge#1::fridge_door pstn15172=1.78)

	(isclosedposition oven#1::knob_joint_3 pstn15174=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15173=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15175=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn15171=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn15170=1.872)
	(atposition faucet#1::joint_faucet_0 pstn15175=0.0)
	(atposition fridge#1::fridge_door pstn15172=1.78)
	(atposition oven#1::knob_joint_3 pstn15174=0.0)
	(atposition oven#1::knob_joint_2 pstn15173=0.0)

	(pose braiserlid#1 p27849=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(pose chicken-leg p27848=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p27847=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p27852=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p27851=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq832=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq304=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p27852=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p27851=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p27849=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(atpose braiserbody#1 p27847=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p27848=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn15170=1.872)
	(isopenedposition fridge#1::fridge_door pstn15172=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn15171=-1.872)

	(ataconf left aq832=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq304=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(supported braiserbody#1 p27850=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p27849=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705) counter#1::front_left_stove)

	(contained pepper-shaker p27852=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p27851=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
