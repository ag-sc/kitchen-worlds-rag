...
(define
  (problem test_kitchen_chicken_soup_250903_184558_seed_944370)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn3003=0.0)
	(position counter#1::chewie_door_left_joint pstn3000=-1.872)
	(position fridge#1::fridge_door pstn3001=1.78)
	(position faucet#1::joint_faucet_0 pstn3004=0.0)
	(position oven#1::knob_joint_2 pstn3002=0.0)
	(position counter#1::chewie_door_right_joint pstn2999=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn3003=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3002=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3004=0.0)

	(isopenedposition fridge#1::fridge_door pstn3001=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn2999=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3000=-1.872)

	(atposition counter#1::chewie_door_right_joint pstn2999=1.872)
	(atposition oven#1::knob_joint_2 pstn3002=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3004=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3000=-1.872)
	(atposition fridge#1::fridge_door pstn3001=1.78)
	(atposition oven#1::knob_joint_3 pstn3003=0.0)

	(pose chicken-leg p8095=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p8096=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(pose salt-shaker p8098=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p8099=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p8094=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p8095=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p8096=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(atpose braiserbody#1 p8094=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p8098=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p8099=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p8099=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p8098=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p8097=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p8096=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823) counter#1::front_left_stove)
