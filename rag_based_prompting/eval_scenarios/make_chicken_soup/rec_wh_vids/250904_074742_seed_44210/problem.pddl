...
(define
  (problem test_kitchen_chicken_soup_250904_074742_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn24580=1.78)
	(position counter#1::chewie_door_right_joint pstn24578=1.872)
	(position oven#1::knob_joint_2 pstn24581=0.0)
	(position counter#1::chewie_door_left_joint pstn24579=-1.872)
	(position oven#1::knob_joint_3 pstn24582=0.0)
	(position faucet#1::joint_faucet_0 pstn24583=0.0)
	...
	(atposition fridge#1::fridge_door pstn24580=1.78)
	(atposition faucet#1::joint_faucet_0 pstn24583=0.0)
	(atposition counter#1::chewie_door_right_joint pstn24578=1.872)
	(atposition counter#1::chewie_door_left_joint pstn24579=-1.872)
	(atposition oven#1::knob_joint_2 pstn24581=0.0)
	(atposition oven#1::knob_joint_3 pstn24582=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn24581=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24583=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24582=0.0)

	(pose chicken-leg p49043=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p49046=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p49044=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(pose pepper-shaker p49047=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p49042=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p49042=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p49046=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p49044=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(atpose chicken-leg p49043=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p49047=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq200=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn24579=-1.872)
	(isopenedposition fridge#1::fridge_door pstn24580=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn24578=1.872)

	(ataconf right aq200=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p49046=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p49047=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p49044=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
	(supported braiserbody#1 p49045=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
