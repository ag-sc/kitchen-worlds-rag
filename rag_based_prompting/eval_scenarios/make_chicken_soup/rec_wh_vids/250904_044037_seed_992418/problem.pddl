...
(define
  (problem test_kitchen_chicken_soup_250904_044037_seed_992418)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn18746=0.0)
	(atposition oven#1::knob_joint_3 pstn18747=0.0)
	(atposition fridge#1::fridge_door pstn18745=1.78)
	(atposition faucet#1::joint_faucet_0 pstn18748=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18743=1.872)
	(atposition counter#1::chewie_door_left_joint pstn18744=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn18746=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn18748=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn18747=0.0)

	(position counter#1::chewie_door_right_joint pstn18743=1.872)
	(position fridge#1::fridge_door pstn18745=1.78)
	(position oven#1::knob_joint_2 pstn18746=0.0)
	(position counter#1::chewie_door_left_joint pstn18744=-1.872)
	(position oven#1::knob_joint_3 pstn18747=0.0)
	(position faucet#1::joint_faucet_0 pstn18748=0.0)

	(pose braiserlid#1 p41430=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(pose chicken-leg p41429=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p41432=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p41433=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p41428=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p41430=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(atpose chicken-leg p41429=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p41432=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p41433=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p41428=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn18744=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn18743=1.872)
	(isopenedposition fridge#1::fridge_door pstn18745=1.78)
	...
	(contained pepper-shaker p41433=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p41432=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p41431=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p41430=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554) counter#1::front_left_stove)
