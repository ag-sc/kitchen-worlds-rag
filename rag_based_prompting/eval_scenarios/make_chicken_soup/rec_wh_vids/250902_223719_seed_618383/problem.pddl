...
(define
  (problem test_kitchen_chicken_soup_250902_223719_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn24390=0.0)
	(position faucet#1::joint_faucet_0 pstn24391=0.0)
	(position fridge#1::fridge_door pstn24388=1.78)
	(position counter#1::chewie_door_right_joint pstn24386=1.872)
	(position counter#1::chewie_door_left_joint pstn24387=-1.872)
	(position oven#1::knob_joint_2 pstn24389=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn24389=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24390=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24391=0.0)

	(isopenedposition fridge#1::fridge_door pstn24388=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn24386=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn24387=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn24387=-1.872)
	(atposition oven#1::knob_joint_2 pstn24389=0.0)
	(atposition oven#1::knob_joint_3 pstn24390=0.0)
	(atposition faucet#1::joint_faucet_0 pstn24391=0.0)
	(atposition fridge#1::fridge_door pstn24388=1.78)
	(atposition counter#1::chewie_door_right_joint pstn24386=1.872)

	(atpose braiserbody#1 p48459=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p48460=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p48463=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p48464=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p48461=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))

	(pose pepper-shaker p48464=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p48459=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p48463=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p48460=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p48461=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	...
	(contained salt-shaker p48463=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p48464=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p48462=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p48461=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)
