...
(define
  (problem test_kitchen_chicken_soup_250902_151408_seed_951676)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn11655=0.0)
	(atposition faucet#1::joint_faucet_0 pstn11657=0.0)
	(atposition fridge#1::fridge_door pstn11654=1.78)
	(atposition counter#1::chewie_door_left_joint pstn11653=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn11652=1.872)
	(atposition oven#1::knob_joint_3 pstn11656=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn11655=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11656=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11657=0.0)

	(position counter#1::chewie_door_right_joint pstn11652=1.872)
	(position oven#1::knob_joint_2 pstn11655=0.0)
	(position oven#1::knob_joint_3 pstn11656=0.0)
	(position faucet#1::joint_faucet_0 pstn11657=0.0)
	(position fridge#1::fridge_door pstn11654=1.78)
	(position counter#1::chewie_door_left_joint pstn11653=-1.872)

	(pose pepper-shaker p21785=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p21781=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p21782=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(pose salt-shaker p21784=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p21780=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p21782=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(atpose salt-shaker p21784=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p21785=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p21781=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p21780=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq368=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq432=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn11652=1.872)
	(isopenedposition fridge#1::fridge_door pstn11654=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn11653=-1.872)

	(ataconf right aq432=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq368=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p21785=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p21784=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p21783=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p21782=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625) counter#1::front_left_stove)
