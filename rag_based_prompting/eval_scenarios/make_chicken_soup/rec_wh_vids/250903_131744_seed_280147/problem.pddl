...
(define
  (problem test_kitchen_chicken_soup_250903_131744_seed_280147)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn33021=1.78)
	(position counter#1::chewie_door_left_joint pstn33020=-1.872)
	(position oven#1::knob_joint_3 pstn33023=0.0)
	(position counter#1::chewie_door_right_joint pstn33019=1.872)
	(position faucet#1::joint_faucet_0 pstn33024=0.0)
	(position oven#1::knob_joint_2 pstn33022=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn33023=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn33024=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn33022=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn33019=1.872)
	(atposition oven#1::knob_joint_2 pstn33022=0.0)
	(atposition fridge#1::fridge_door pstn33021=1.78)
	(atposition counter#1::chewie_door_left_joint pstn33020=-1.872)
	(atposition oven#1::knob_joint_3 pstn33023=0.0)
	(atposition faucet#1::joint_faucet_0 pstn33024=0.0)

	(pose salt-shaker p57919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p57917=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	(pose braiserbody#1 p57915=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p57916=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p57920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p57915=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p57916=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p57919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p57920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p57917=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))

	(aconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq368=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn33019=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn33020=-1.872)
	(isopenedposition fridge#1::fridge_door pstn33021=1.78)

	(ataconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq368=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p57919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p57920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p57917=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667) counter#1::front_left_stove)
	(supported braiserbody#1 p57918=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
