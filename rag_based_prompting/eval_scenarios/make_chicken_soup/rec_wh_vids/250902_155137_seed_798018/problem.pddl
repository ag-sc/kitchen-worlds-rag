...
(define
  (problem test_kitchen_chicken_soup_250902_155137_seed_798018)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn13215=0.0)
	(position faucet#1::joint_faucet_0 pstn13216=0.0)
	(position counter#1::chewie_door_right_joint pstn13211=1.872)
	(position oven#1::knob_joint_2 pstn13214=0.0)
	(position counter#1::chewie_door_left_joint pstn13212=-1.872)
	(position fridge#1::fridge_door pstn13213=1.78)

	(atposition oven#1::knob_joint_3 pstn13215=0.0)
	(atposition counter#1::chewie_door_right_joint pstn13211=1.872)
	(atposition faucet#1::joint_faucet_0 pstn13216=0.0)
	(atposition oven#1::knob_joint_2 pstn13214=0.0)
	(atposition fridge#1::fridge_door pstn13213=1.78)
	(atposition counter#1::chewie_door_left_joint pstn13212=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn13214=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13215=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13216=0.0)

	(pose chicken-leg p23392=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p23391=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p23396=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p23393=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose salt-shaker p23395=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p23395=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p23392=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p23396=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p23391=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p23393=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))

	(aconf left aq288=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn13212=-1.872)
	(isopenedposition fridge#1::fridge_door pstn13213=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn13211=1.872)

	(ataconf left aq288=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq704=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p23396=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23395=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p23393=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
	(supported braiserbody#1 p23394=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
