...
(define
  (problem test_kitchen_chicken_soup_250903_210835_seed_320213)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn7086=0.0)
	(atposition fridge#1::fridge_door pstn7084=1.78)
	(atposition counter#1::chewie_door_right_joint pstn7082=1.872)
	(atposition faucet#1::joint_faucet_0 pstn7087=0.0)
	(atposition oven#1::knob_joint_2 pstn7085=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7083=-1.872)
	(position fridge#1::fridge_door pstn7084=1.78)
	(position oven#1::knob_joint_2 pstn7085=0.0)
	(position counter#1::chewie_door_left_joint pstn7083=-1.872)
	(position oven#1::knob_joint_3 pstn7086=0.0)
	(position counter#1::chewie_door_right_joint pstn7082=1.872)
	(position faucet#1::joint_faucet_0 pstn7087=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn7087=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7086=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7085=0.0)

	(atpose chicken-leg p15693=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p15696=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p15697=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p15694=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(atpose braiserbody#1 p15692=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p15697=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p15692=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p15694=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(pose chicken-leg p15693=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p15696=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq840=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn7083=-1.872)
	(isopenedposition fridge#1::fridge_door pstn7084=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn7082=1.872)

	(ataconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq840=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p15696=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p15697=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p15694=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62) counter#1::front_left_stove)
	(supported braiserbody#1 p15695=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
