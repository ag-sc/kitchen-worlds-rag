...
(define
  (problem test_kitchen_chicken_soup_250903_204140_seed_25586)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn6838=0.0)
	(position fridge#1::fridge_door pstn6836=1.78)
	(position oven#1::knob_joint_2 pstn6837=0.0)
	(position counter#1::chewie_door_left_joint pstn6835=-1.872)
	(position faucet#1::joint_faucet_0 pstn6839=0.0)
	(position counter#1::chewie_door_right_joint pstn6834=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn6838=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6837=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6839=0.0)

	(atposition counter#1::chewie_door_left_joint pstn6835=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn6839=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6834=1.872)
	(atposition fridge#1::fridge_door pstn6836=1.78)
	(atposition oven#1::knob_joint_3 pstn6838=0.0)
	(atposition oven#1::knob_joint_2 pstn6837=0.0)

	(pose chicken-leg p14366=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p14369=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p14365=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p14367=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(pose pepper-shaker p14370=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p14369=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14365=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p14367=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(atpose chicken-leg p14366=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p14370=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn6835=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn6834=1.872)
	(isopenedposition fridge#1::fridge_door pstn6836=1.78)
	...
	(contained salt-shaker p14369=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14370=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p14368=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p14367=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973) counter#1::front_left_stove)
