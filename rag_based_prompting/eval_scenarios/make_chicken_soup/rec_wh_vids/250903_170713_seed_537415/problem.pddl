...
(define
  (problem test_kitchen_chicken_soup_250903_170713_seed_537415)
  (:domain domain)
  ...
  (:init
	...
	(isopenedposition fridge#1::fridge_door pstn250=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn249=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn248=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn253=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn252=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn251=0.0)

	(position counter#1::chewie_door_left_joint pstn249=-1.872)
	(position oven#1::knob_joint_3 pstn252=0.0)
	(position counter#1::chewie_door_right_joint pstn248=1.872)
	(position faucet#1::joint_faucet_0 pstn253=0.0)
	(position fridge#1::fridge_door pstn250=1.78)
	(position oven#1::knob_joint_2 pstn251=0.0)

	(atposition counter#1::chewie_door_left_joint pstn249=-1.872)
	(atposition oven#1::knob_joint_2 pstn251=0.0)
	(atposition oven#1::knob_joint_3 pstn252=0.0)
	(atposition counter#1::chewie_door_right_joint pstn248=1.872)
	(atposition faucet#1::joint_faucet_0 pstn253=0.0)
	(atposition fridge#1::fridge_door pstn250=1.78)

	(pose chicken-leg p2351=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p2355=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2352=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(pose braiserbody#1 p2350=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p2354=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p2350=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p2354=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p2355=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2352=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(atpose chicken-leg p2351=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p2355=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2354=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2353=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2352=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718) counter#1::front_left_stove)
