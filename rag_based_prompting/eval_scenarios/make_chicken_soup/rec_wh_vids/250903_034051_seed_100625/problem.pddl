...
(define
  (problem test_kitchen_chicken_soup_250903_034051_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn11729=0.0)
	(position counter#1::chewie_door_right_joint pstn11725=1.872)
	(position counter#1::chewie_door_left_joint pstn11726=-1.872)
	(position faucet#1::joint_faucet_0 pstn11730=0.0)
	(position fridge#1::fridge_door pstn11727=1.78)
	(position oven#1::knob_joint_2 pstn11728=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn11728=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11730=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11729=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn11726=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn11730=0.0)
	(atposition oven#1::knob_joint_2 pstn11728=0.0)
	(atposition oven#1::knob_joint_3 pstn11729=0.0)
	(atposition fridge#1::fridge_door pstn11727=1.78)
	(atposition counter#1::chewie_door_right_joint pstn11725=1.872)
	...
	(pose braiserbody#1 p20003=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p20005=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))

	(atpose braiserlid#1 p20005=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	...
	(atpose braiserbody#1 p20003=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq600=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq608=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn11725=1.872)
	(isopenedposition fridge#1::fridge_door pstn11727=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn11726=-1.872)
	...
	(supported braiserlid#1 p20005=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
	(supported braiserbody#1 p20006=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
