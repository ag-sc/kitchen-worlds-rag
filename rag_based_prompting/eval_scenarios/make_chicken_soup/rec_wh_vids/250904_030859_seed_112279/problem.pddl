...
(define
  (problem test_kitchen_chicken_soup_250904_030859_seed_112279)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn14896=0.0)
	(position faucet#1::joint_faucet_0 pstn14897=0.0)
	(position counter#1::chewie_door_left_joint pstn14893=-1.872)
	(position oven#1::knob_joint_2 pstn14895=0.0)
	(position counter#1::chewie_door_right_joint pstn14892=1.872)
	(position fridge#1::fridge_door pstn14894=1.78)
	...
	(atposition fridge#1::fridge_door pstn14894=1.78)
	(atposition oven#1::knob_joint_2 pstn14895=0.0)
	(atposition counter#1::chewie_door_right_joint pstn14892=1.872)
	(atposition oven#1::knob_joint_3 pstn14896=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14893=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn14897=0.0)

	(isclosedposition faucet#1::joint_faucet_0 pstn14897=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14896=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14895=0.0)

	(pose salt-shaker p37366=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p37363=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p37362=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p37364=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))
	(pose pepper-shaker p37367=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p37366=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p37363=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p37362=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p37364=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))
	(atpose pepper-shaker p37367=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq48=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq184=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(isopenedposition counter#1::chewie_door_left_joint pstn14893=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn14892=1.872)
	(isopenedposition fridge#1::fridge_door pstn14894=1.78)

	(ataconf left aq48=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq184=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p37366=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p37367=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p37364=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655) counter#1::front_left_stove)
	(supported braiserbody#1 p37365=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
