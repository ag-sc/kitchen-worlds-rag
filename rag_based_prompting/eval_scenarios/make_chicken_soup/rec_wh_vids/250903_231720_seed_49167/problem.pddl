...
(define
  (problem test_kitchen_chicken_soup_250903_231720_seed_49167)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn9084=0.0)
	(position faucet#1::joint_faucet_0 pstn9086=0.0)
	(position counter#1::chewie_door_left_joint pstn9082=-1.872)
	(position counter#1::chewie_door_right_joint pstn9081=1.872)
	(position fridge#1::fridge_door pstn9083=1.78)
	(position oven#1::knob_joint_3 pstn9085=0.0)

	(atposition oven#1::knob_joint_3 pstn9085=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9082=-1.872)
	(atposition oven#1::knob_joint_2 pstn9084=0.0)
	(atposition counter#1::chewie_door_right_joint pstn9081=1.872)
	(atposition fridge#1::fridge_door pstn9083=1.78)
	(atposition faucet#1::joint_faucet_0 pstn9086=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn9085=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9086=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9084=0.0)

	(isopenedposition fridge#1::fridge_door pstn9083=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn9082=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn9081=1.872)

	(pose chicken-leg p25567=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p25571=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p25566=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p25570=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p25568=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102))

	(atpose chicken-leg p25567=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p25566=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p25571=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p25570=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p25568=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102))
	...
	(contained salt-shaker p25570=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p25571=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p25568=(0.567, 7.872, 0.712, 0.0, -0.0, 3.102) counter#1::front_left_stove)
	(supported braiserbody#1 p25569=(0.7, 8.746, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
