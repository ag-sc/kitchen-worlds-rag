...
(define
  (problem test_kitchen_chicken_soup_250902_225328_seed_354453)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn22300=0.0)
	(atposition fridge#1::fridge_door pstn22298=1.78)
	(atposition faucet#1::joint_faucet_0 pstn22301=0.0)
	(atposition counter#1::chewie_door_right_joint pstn22296=1.872)
	(atposition oven#1::knob_joint_2 pstn22299=0.0)
	(atposition counter#1::chewie_door_left_joint pstn22297=-1.872)

	(position faucet#1::joint_faucet_0 pstn22301=0.0)
	(position counter#1::chewie_door_right_joint pstn22296=1.872)
	(position oven#1::knob_joint_2 pstn22299=0.0)
	(position counter#1::chewie_door_left_joint pstn22297=-1.872)
	(position oven#1::knob_joint_3 pstn22300=0.0)
	(position fridge#1::fridge_door pstn22298=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn22301=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn22299=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn22300=0.0)

	(pose braiserbody#1 p65518=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p65519=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p65522=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p65523=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p65520=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))

	(atpose salt-shaker p65522=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p65518=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p65519=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p65520=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(atpose pepper-shaker p65523=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn22296=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn22297=-1.872)
	(isopenedposition fridge#1::fridge_door pstn22298=1.78)
	...
	(supported braiserbody#1 p65521=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p65520=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309) counter#1::front_left_stove)

	(contained pepper-shaker p65523=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p65522=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
