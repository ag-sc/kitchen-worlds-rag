...
(define
  (problem test_kitchen_chicken_soup_250902_153629_seed_923103)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn10320=0.0)
	(position counter#1::chewie_door_right_joint pstn10317=1.872)
	(position counter#1::chewie_door_left_joint pstn10318=-1.872)
	(position fridge#1::fridge_door pstn10319=1.78)
	(position faucet#1::joint_faucet_0 pstn10322=0.0)
	(position oven#1::knob_joint_3 pstn10321=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn10321=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10322=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10320=0.0)

	(atposition counter#1::chewie_door_left_joint pstn10318=-1.872)
	(atposition fridge#1::fridge_door pstn10319=1.78)
	(atposition faucet#1::joint_faucet_0 pstn10322=0.0)
	(atposition oven#1::knob_joint_3 pstn10321=0.0)
	(atposition oven#1::knob_joint_2 pstn10320=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10317=1.872)

	(pose chicken-leg p35304=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p35305=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(pose salt-shaker p35307=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p35303=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p35308=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p35307=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p35304=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p35303=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p35308=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p35305=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))

	(isopenedposition counter#1::chewie_door_right_joint pstn10317=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn10318=-1.872)
	(isopenedposition fridge#1::fridge_door pstn10319=1.78)
	...
	(contained salt-shaker p35307=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p35308=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p35305=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097) counter#1::front_left_stove)
	(supported braiserbody#1 p35306=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
