...
(define
  (problem test_kitchen_chicken_soup_250903_194829_seed_41540)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn2038=1.78)
	(atposition faucet#1::joint_faucet_0 pstn2041=0.0)
	(atposition oven#1::knob_joint_3 pstn2040=0.0)
	(atposition oven#1::knob_joint_2 pstn2039=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2036=1.872)
	(atposition counter#1::chewie_door_left_joint pstn2037=-1.872)
	(position faucet#1::joint_faucet_0 pstn2041=0.0)
	(position oven#1::knob_joint_3 pstn2040=0.0)
	(position counter#1::chewie_door_right_joint pstn2036=1.872)
	(position counter#1::chewie_door_left_joint pstn2037=-1.872)
	(position oven#1::knob_joint_2 pstn2039=0.0)
	(position fridge#1::fridge_door pstn2038=1.78)

	(isclosedposition faucet#1::joint_faucet_0 pstn2041=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2040=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2039=0.0)

	(pose salt-shaker p5472=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p5469=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p5470=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(pose braiserbody#1 p5468=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5473=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p5470=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(atpose braiserbody#1 p5468=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p5472=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p5473=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p5469=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn2037=-1.872)
	(isopenedposition fridge#1::fridge_door pstn2038=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn2036=1.872)
	...
	(contained salt-shaker p5472=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p5473=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p5470=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584) counter#1::front_left_stove)
	(supported braiserbody#1 p5471=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
