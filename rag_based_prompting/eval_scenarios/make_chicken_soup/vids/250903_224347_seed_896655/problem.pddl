...
(define
  (problem test_kitchen_chicken_soup_250903_224347_seed_896655)
  (:domain domain)
  ...
  (:init
	...
	(isopenedposition fridge#1::fridge_door pstn6577=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6575=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn6576=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn6580=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6579=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6578=0.0)

	(position counter#1::chewie_door_left_joint pstn6576=-1.872)
	(position faucet#1::joint_faucet_0 pstn6580=0.0)
	(position counter#1::chewie_door_right_joint pstn6575=1.872)
	(position fridge#1::fridge_door pstn6577=1.78)
	(position oven#1::knob_joint_3 pstn6579=0.0)
	(position oven#1::knob_joint_2 pstn6578=0.0)

	(atposition counter#1::chewie_door_left_joint pstn6576=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn6580=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6575=1.872)
	(atposition fridge#1::fridge_door pstn6577=1.78)
	(atposition oven#1::knob_joint_3 pstn6579=0.0)
	(atposition oven#1::knob_joint_2 pstn6578=0.0)

	(pose chicken-leg p26996=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p26997=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(pose salt-shaker p26999=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p26995=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p27000=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p26995=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p26996=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p26999=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p26997=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(atpose pepper-shaker p27000=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p26999=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p27000=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p26997=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987) counter#1::front_left_stove)
	(supported braiserbody#1 p26998=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
