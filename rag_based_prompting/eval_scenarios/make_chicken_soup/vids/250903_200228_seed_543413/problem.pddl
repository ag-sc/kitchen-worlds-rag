...
(define
  (problem test_kitchen_chicken_soup_250903_200228_seed_543413)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn2832=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2831=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2833=0.0)

	(position counter#1::chewie_door_left_joint pstn2829=-1.872)
	(position oven#1::knob_joint_3 pstn2832=0.0)
	(position oven#1::knob_joint_2 pstn2831=0.0)
	(position counter#1::chewie_door_right_joint pstn2828=1.872)
	(position fridge#1::fridge_door pstn2830=1.78)
	(position faucet#1::joint_faucet_0 pstn2833=0.0)

	(atposition counter#1::chewie_door_left_joint pstn2829=-1.872)
	(atposition oven#1::knob_joint_3 pstn2832=0.0)
	(atposition oven#1::knob_joint_2 pstn2831=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2828=1.872)
	(atposition fridge#1::fridge_door pstn2830=1.78)
	(atposition faucet#1::joint_faucet_0 pstn2833=0.0)

	(pose salt-shaker p7719=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p7715=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p7716=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p7717=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(pose pepper-shaker p7720=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p7719=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p7716=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p7720=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p7717=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(atpose braiserbody#1 p7715=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn2829=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2828=1.872)
	(isopenedposition fridge#1::fridge_door pstn2830=1.78)
	...
	(contained salt-shaker p7719=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p7720=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p7717=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92) counter#1::front_left_stove)
	(supported braiserbody#1 p7718=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
