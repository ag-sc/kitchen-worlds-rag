...
(define
  (problem test_kitchen_chicken_soup_250903_065835_seed_734621)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn30111=0.0)
	(position fridge#1::fridge_door pstn30110=1.78)
	(position counter#1::chewie_door_left_joint pstn30109=-1.872)
	(position counter#1::chewie_door_right_joint pstn30108=1.872)
	(position faucet#1::joint_faucet_0 pstn30113=0.0)
	(position oven#1::knob_joint_3 pstn30112=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn30113=0.0)
	(atposition oven#1::knob_joint_3 pstn30112=0.0)
	(atposition oven#1::knob_joint_2 pstn30111=0.0)
	(atposition fridge#1::fridge_door pstn30110=1.78)
	(atposition counter#1::chewie_door_left_joint pstn30109=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn30108=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn30113=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn30112=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn30111=0.0)

	(pose chicken-leg p104600=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p104601=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(pose braiserbody#1 p104599=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p104604=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p104603=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn30108=1.872)
	(isopenedposition fridge#1::fridge_door pstn30110=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn30109=-1.872)

	(atpose pepper-shaker p104604=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p104603=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p104601=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(atpose braiserbody#1 p104599=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p104600=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p104603=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p104604=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p104602=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p104601=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19) counter#1::front_left_stove)
