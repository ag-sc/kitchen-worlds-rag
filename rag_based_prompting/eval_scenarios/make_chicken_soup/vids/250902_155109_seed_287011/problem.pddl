...
(define
  (problem test_kitchen_chicken_soup_250902_155109_seed_287011)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn11095=0.0)
	(atposition faucet#1::joint_faucet_0 pstn11097=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11092=1.872)
	(atposition fridge#1::fridge_door pstn11094=1.78)
	(atposition oven#1::knob_joint_3 pstn11096=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11093=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn11097=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11095=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11096=0.0)

	(position counter#1::chewie_door_left_joint pstn11093=-1.872)
	(position oven#1::knob_joint_2 pstn11095=0.0)
	(position faucet#1::joint_faucet_0 pstn11097=0.0)
	(position counter#1::chewie_door_right_joint pstn11092=1.872)
	(position fridge#1::fridge_door pstn11094=1.78)
	(position oven#1::knob_joint_3 pstn11096=0.0)

	(pose braiserlid#1 p35671=(0.567, 7.872, 0.712, 0.0, -0.0, 0.508))
	(pose pepper-shaker p35674=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p35673=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p35670=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p35669=(0.7, 8.866, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p35671=(0.567, 7.872, 0.712, 0.0, -0.0, 0.508))
	(atpose braiserbody#1 p35669=(0.7, 8.866, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p35674=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p35673=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p35670=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn11093=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn11092=1.872)
	(isopenedposition fridge#1::fridge_door pstn11094=1.78)
	...
	(contained pepper-shaker p35674=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p35673=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p35672=(0.7, 8.866, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p35671=(0.567, 7.872, 0.712, 0.0, -0.0, 0.508) counter#1::front_left_stove)
