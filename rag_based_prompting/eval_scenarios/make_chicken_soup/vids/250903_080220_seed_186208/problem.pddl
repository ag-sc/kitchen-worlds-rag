...
(define
  (problem test_kitchen_chicken_soup_250903_080220_seed_186208)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn32365=0.0)
	(atposition counter#1::chewie_door_left_joint pstn32362=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn32366=0.0)
	(atposition oven#1::knob_joint_2 pstn32364=0.0)
	(atposition fridge#1::fridge_door pstn32363=1.78)
	(atposition counter#1::chewie_door_right_joint pstn32361=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn32364=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn32365=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn32366=0.0)

	(position counter#1::chewie_door_right_joint pstn32361=1.872)
	(position oven#1::knob_joint_3 pstn32365=0.0)
	(position counter#1::chewie_door_left_joint pstn32362=-1.872)
	(position faucet#1::joint_faucet_0 pstn32366=0.0)
	(position oven#1::knob_joint_2 pstn32364=0.0)
	(position fridge#1::fridge_door pstn32363=1.78)

	(pose braiserlid#1 p105768=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167))
	(pose chicken-leg p105767=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p105770=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p105771=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p105766=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p105767=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p105770=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p105771=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p105766=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p105768=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167))

	(aconf left aq768=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq624=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn32361=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn32362=-1.872)
	(isopenedposition fridge#1::fridge_door pstn32363=1.78)

	(ataconf left aq768=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq624=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p105771=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p105770=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p105768=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167) counter#1::front_left_stove)
	(supported braiserbody#1 p105769=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
