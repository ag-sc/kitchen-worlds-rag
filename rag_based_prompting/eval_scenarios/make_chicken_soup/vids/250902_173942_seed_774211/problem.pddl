...
(define
  (problem test_kitchen_chicken_soup_250902_173942_seed_774211)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn14242=0.0)
	(atposition faucet#1::joint_faucet_0 pstn14244=0.0)
	(atposition counter#1::chewie_door_right_joint pstn14239=1.872)
	(atposition oven#1::knob_joint_3 pstn14243=0.0)
	(atposition fridge#1::fridge_door pstn14241=1.78)
	(atposition counter#1::chewie_door_left_joint pstn14240=-1.872)
	(position fridge#1::fridge_door pstn14241=1.78)
	(position counter#1::chewie_door_left_joint pstn14240=-1.872)
	(position oven#1::knob_joint_2 pstn14242=0.0)
	(position faucet#1::joint_faucet_0 pstn14244=0.0)
	(position counter#1::chewie_door_right_joint pstn14239=1.872)
	(position oven#1::knob_joint_3 pstn14243=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn14243=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14242=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14244=0.0)

	(isopenedposition fridge#1::fridge_door pstn14241=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn14240=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn14239=1.872)

	(pose salt-shaker p46889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p46886=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p46885=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p46887=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(pose pepper-shaker p46890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p46889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p46885=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p46886=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p46887=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(atpose pepper-shaker p46890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p46889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p46890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p46887=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682) counter#1::front_left_stove)
	(supported braiserbody#1 p46888=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
