...
(define
  (problem test_kitchen_chicken_soup_250903_233700_seed_431950)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn10048=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10044=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn10043=1.872)
	(atposition fridge#1::fridge_door pstn10045=1.78)
	(atposition oven#1::knob_joint_2 pstn10046=0.0)
	(atposition oven#1::knob_joint_3 pstn10047=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn10047=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10046=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10048=0.0)

	(position counter#1::chewie_door_left_joint pstn10044=-1.872)
	(position counter#1::chewie_door_right_joint pstn10043=1.872)
	(position fridge#1::fridge_door pstn10045=1.78)
	(position oven#1::knob_joint_2 pstn10046=0.0)
	(position oven#1::knob_joint_3 pstn10047=0.0)
	(position faucet#1::joint_faucet_0 pstn10048=0.0)

	(pose braiserbody#1 p30337=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p30339=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(pose chicken-leg p30338=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p30342=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p30341=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p30337=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p30338=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p30342=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p30341=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p30339=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))

	(isopenedposition counter#1::chewie_door_right_joint pstn10043=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn10044=-1.872)
	(isopenedposition fridge#1::fridge_door pstn10045=1.78)
	...
	(contained pepper-shaker p30342=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p30341=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p30339=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642) counter#1::front_left_stove)
	(supported braiserbody#1 p30340=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
