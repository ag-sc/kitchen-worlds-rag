...
(define
  (problem test_kitchen_chicken_soup_250903_094749_seed_178186)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn35038=0.0)
	(atposition counter#1::chewie_door_right_joint pstn35034=1.872)
	(atposition oven#1::knob_joint_2 pstn35037=0.0)
	(atposition fridge#1::fridge_door pstn35036=1.78)
	(atposition counter#1::chewie_door_left_joint pstn35035=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn35039=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn35038=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn35039=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn35037=0.0)

	(isopenedposition fridge#1::fridge_door pstn35036=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn35035=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn35034=1.872)

	(position counter#1::chewie_door_right_joint pstn35034=1.872)
	(position oven#1::knob_joint_2 pstn35037=0.0)
	(position fridge#1::fridge_door pstn35036=1.78)
	(position counter#1::chewie_door_left_joint pstn35035=-1.872)
	(position faucet#1::joint_faucet_0 pstn35039=0.0)
	(position oven#1::knob_joint_3 pstn35038=0.0)

	(pose pepper-shaker p111968=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p111965=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	(pose salt-shaker p111967=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p111964=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p111963=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p111965=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	(atpose salt-shaker p111967=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p111968=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p111964=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p111963=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p111967=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p111968=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p111965=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036) counter#1::front_left_stove)
	(supported braiserbody#1 p111966=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
