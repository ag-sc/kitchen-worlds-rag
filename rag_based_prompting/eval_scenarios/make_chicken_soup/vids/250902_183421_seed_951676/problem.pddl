...
(define
  (problem test_kitchen_chicken_soup_250902_183421_seed_951676)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn15436=1.78)
	(position counter#1::chewie_door_left_joint pstn15435=-1.872)
	(position oven#1::knob_joint_3 pstn15438=0.0)
	(position oven#1::knob_joint_2 pstn15437=0.0)
	(position counter#1::chewie_door_right_joint pstn15434=1.872)
	(position faucet#1::joint_faucet_0 pstn15439=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15438=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15437=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15439=0.0)

	(atposition counter#1::chewie_door_right_joint pstn15434=1.872)
	(atposition faucet#1::joint_faucet_0 pstn15439=0.0)
	(atposition fridge#1::fridge_door pstn15436=1.78)
	(atposition counter#1::chewie_door_left_joint pstn15435=-1.872)
	(atposition oven#1::knob_joint_3 pstn15438=0.0)
	(atposition oven#1::knob_joint_2 pstn15437=0.0)

	(pose salt-shaker p49843=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p49840=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p49844=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p49841=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(pose braiserbody#1 p49839=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p49840=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p49844=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p49841=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(atpose braiserbody#1 p49839=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p49843=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq152=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq992=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn15434=1.872)
	(isopenedposition fridge#1::fridge_door pstn15436=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn15435=-1.872)

	(ataconf left aq152=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq992=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p49843=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p49844=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p49842=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p49841=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625) counter#1::front_left_stove)
