...
(define
  (problem test_kitchen_chicken_soup_250902_185136_seed_798018)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn15676=0.0)
	(position fridge#1::fridge_door pstn15673=1.78)
	(position counter#1::chewie_door_right_joint pstn15671=1.872)
	(position counter#1::chewie_door_left_joint pstn15672=-1.872)
	(position oven#1::knob_joint_2 pstn15674=0.0)
	(position oven#1::knob_joint_3 pstn15675=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15675=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15676=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15674=0.0)

	(isopenedposition fridge#1::fridge_door pstn15673=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn15671=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15672=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn15672=-1.872)
	(atposition oven#1::knob_joint_2 pstn15674=0.0)
	(atposition oven#1::knob_joint_3 pstn15675=0.0)
	(atposition faucet#1::joint_faucet_0 pstn15676=0.0)
	(atposition fridge#1::fridge_door pstn15673=1.78)
	(atposition counter#1::chewie_door_right_joint pstn15671=1.872)

	(pose braiserbody#1 p51842=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p51843=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p51844=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose pepper-shaker p51847=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p51846=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p51844=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose chicken-leg p51843=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p51847=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p51846=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p51842=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p51846=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p51847=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p51845=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p51844=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
