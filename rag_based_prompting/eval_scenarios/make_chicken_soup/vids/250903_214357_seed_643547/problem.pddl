...
(define
  (problem test_kitchen_chicken_soup_250903_214357_seed_643547)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn5056=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5057=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5055=0.0)

	(position counter#1::chewie_door_left_joint pstn5053=-1.872)
	(position fridge#1::fridge_door pstn5054=1.78)
	(position oven#1::knob_joint_3 pstn5056=0.0)
	(position counter#1::chewie_door_right_joint pstn5052=1.872)
	(position oven#1::knob_joint_2 pstn5055=0.0)
	(position faucet#1::joint_faucet_0 pstn5057=0.0)

	(atposition counter#1::chewie_door_left_joint pstn5053=-1.872)
	(atposition fridge#1::fridge_door pstn5054=1.78)
	(atposition oven#1::knob_joint_3 pstn5056=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5052=1.872)
	(atposition oven#1::knob_joint_2 pstn5055=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5057=0.0)

	(pose salt-shaker p19546=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p19543=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p19544=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(pose pepper-shaker p19547=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p19542=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p19542=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p19543=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p19544=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(atpose salt-shaker p19546=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p19547=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn5053=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn5052=1.872)
	(isopenedposition fridge#1::fridge_door pstn5054=1.78)
	...
	(contained salt-shaker p19546=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p19547=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p19544=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313) counter#1::front_left_stove)
	(supported braiserbody#1 p19545=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
