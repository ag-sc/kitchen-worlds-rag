...
(define
  (problem test_kitchen_chicken_soup_250903_064309_seed_236356)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn29905=0.0)
	(position faucet#1::joint_faucet_0 pstn29906=0.0)
	(position fridge#1::fridge_door pstn29903=1.78)
	(position oven#1::knob_joint_2 pstn29904=0.0)
	(position counter#1::chewie_door_right_joint pstn29901=1.872)
	(position counter#1::chewie_door_left_joint pstn29902=-1.872)
	...
	(atposition fridge#1::fridge_door pstn29903=1.78)
	(atposition oven#1::knob_joint_2 pstn29904=0.0)
	(atposition counter#1::chewie_door_right_joint pstn29901=1.872)
	(atposition counter#1::chewie_door_left_joint pstn29902=-1.872)
	(atposition oven#1::knob_joint_3 pstn29905=0.0)
	(atposition faucet#1::joint_faucet_0 pstn29906=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn29903=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn29901=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn29902=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn29906=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn29904=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn29905=0.0)

	(pose braiserlid#1 p103310=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))
	(pose chicken-leg p103309=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p103308=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p103313=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p103312=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p103309=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p103308=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p103313=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p103312=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p103310=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))
	...
	(contained pepper-shaker p103313=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p103312=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p103311=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p103310=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647) counter#1::front_left_stove)
