...
(define
  (problem test_kitchen_chicken_soup_250902_212140_seed_344159)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn19590=0.0)
	(atposition faucet#1::joint_faucet_0 pstn19592=0.0)
	(atposition counter#1::chewie_door_left_joint pstn19588=-1.872)
	(atposition fridge#1::fridge_door pstn19589=1.78)
	(atposition oven#1::knob_joint_3 pstn19591=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19587=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn19590=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19591=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19592=0.0)

	(position counter#1::chewie_door_left_joint pstn19588=-1.872)
	(position fridge#1::fridge_door pstn19589=1.78)
	(position oven#1::knob_joint_3 pstn19591=0.0)
	(position counter#1::chewie_door_right_joint pstn19587=1.872)
	(position oven#1::knob_joint_2 pstn19590=0.0)
	(position faucet#1::joint_faucet_0 pstn19592=0.0)

	(pose braiserbody#1 p60318=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p60319=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p60320=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(pose pepper-shaker p60323=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p60322=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p60319=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p60320=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(atpose pepper-shaker p60323=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p60322=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p60318=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq432=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq672=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn19588=-1.872)
	(isopenedposition fridge#1::fridge_door pstn19589=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn19587=1.872)

	(ataconf left aq432=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq672=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(supported braiserbody#1 p60321=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p60320=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934) counter#1::front_left_stove)

	(contained pepper-shaker p60323=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p60322=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
