...
(define
  (problem test_kitchen_chicken_soup_250903_035411_seed_312874)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn27686=0.0)
	(atposition counter#1::chewie_door_left_joint pstn27684=-1.872)
	(atposition oven#1::knob_joint_3 pstn27687=0.0)
	(atposition counter#1::chewie_door_right_joint pstn27683=1.872)
	(atposition faucet#1::joint_faucet_0 pstn27688=0.0)
	(atposition fridge#1::fridge_door pstn27685=1.78)

	(position faucet#1::joint_faucet_0 pstn27688=0.0)
	(position fridge#1::fridge_door pstn27685=1.78)
	(position oven#1::knob_joint_2 pstn27686=0.0)
	(position counter#1::chewie_door_left_joint pstn27684=-1.872)
	(position oven#1::knob_joint_3 pstn27687=0.0)
	(position counter#1::chewie_door_right_joint pstn27683=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn27687=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn27686=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn27688=0.0)

	(isopenedposition fridge#1::fridge_door pstn27685=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn27684=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn27683=1.872)

	(pose salt-shaker p89420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p89418=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(pose chicken-leg p89417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p89416=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p89421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p89417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p89416=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p89421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p89420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p89418=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	...
	(contained pepper-shaker p89421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p89420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p89418=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441) counter#1::front_left_stove)
	(supported braiserbody#1 p89419=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
