...
(define
  (problem test_kitchen_chicken_soup_250903_043357_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn28656=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn28658=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn28657=0.0)

	(isopenedposition fridge#1::fridge_door pstn28655=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn28654=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn28653=1.872)

	(position counter#1::chewie_door_right_joint pstn28653=1.872)
	(position oven#1::knob_joint_3 pstn28657=0.0)
	(position faucet#1::joint_faucet_0 pstn28658=0.0)
	(position fridge#1::fridge_door pstn28655=1.78)
	(position counter#1::chewie_door_left_joint pstn28654=-1.872)
	(position oven#1::knob_joint_2 pstn28656=0.0)

	(atposition counter#1::chewie_door_left_joint pstn28654=-1.872)
	(atposition oven#1::knob_joint_2 pstn28656=0.0)
	(atposition counter#1::chewie_door_right_joint pstn28653=1.872)
	(atposition oven#1::knob_joint_3 pstn28657=0.0)
	(atposition faucet#1::joint_faucet_0 pstn28658=0.0)
	(atposition fridge#1::fridge_door pstn28655=1.78)

	(pose braiserbody#1 p92177=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p92179=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose chicken-leg p92178=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p92182=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p92181=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p92177=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p92179=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose chicken-leg p92178=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p92181=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p92182=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p92182=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p92181=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p92179=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
	(supported braiserbody#1 p92180=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
