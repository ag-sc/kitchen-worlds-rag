...
(define
  (problem test_kitchen_chicken_soup_250902_160458_seed_452363)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn11308=0.0)
	(position counter#1::chewie_door_right_joint pstn11305=1.872)
	(position faucet#1::joint_faucet_0 pstn11310=0.0)
	(position oven#1::knob_joint_3 pstn11309=0.0)
	(position fridge#1::fridge_door pstn11307=1.78)
	(position counter#1::chewie_door_left_joint pstn11306=-1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn11310=0.0)
	(atposition oven#1::knob_joint_3 pstn11309=0.0)
	(atposition fridge#1::fridge_door pstn11307=1.78)
	(atposition counter#1::chewie_door_left_joint pstn11306=-1.872)
	(atposition oven#1::knob_joint_2 pstn11308=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11305=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn11308=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11310=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11309=0.0)

	(pose braiserbody#1 p37648=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p37650=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))
	(pose pepper-shaker p37653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p37649=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p37652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p37650=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))
	(atpose pepper-shaker p37653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p37652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p37649=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p37648=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn11305=1.872)
	(isopenedposition fridge#1::fridge_door pstn11307=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn11306=-1.872)
	...
	(contained pepper-shaker p37653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p37652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p37651=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p37650=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252) counter#1::front_left_stove)
