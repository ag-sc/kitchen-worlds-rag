...
(define
  (problem test_kitchen_chicken_soup_250903_011004_seed_981849)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn24904=0.0)
	(atposition fridge#1::fridge_door pstn24901=1.78)
	(atposition oven#1::knob_joint_3 pstn24903=0.0)
	(atposition counter#1::chewie_door_right_joint pstn24899=1.872)
	(atposition oven#1::knob_joint_2 pstn24902=0.0)
	(atposition counter#1::chewie_door_left_joint pstn24900=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn24903=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24904=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24902=0.0)

	(position counter#1::chewie_door_right_joint pstn24899=1.872)
	(position oven#1::knob_joint_2 pstn24902=0.0)
	(position counter#1::chewie_door_left_joint pstn24900=-1.872)
	(position faucet#1::joint_faucet_0 pstn24904=0.0)
	(position fridge#1::fridge_door pstn24901=1.78)
	(position oven#1::knob_joint_3 pstn24903=0.0)

	(pose braiserlid#1 p76104=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(pose pepper-shaker p76107=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p76106=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p76103=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p76102=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p76106=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p76107=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p76103=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p76102=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p76104=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))

	(isopenedposition counter#1::chewie_door_left_joint pstn24900=-1.872)
	(isopenedposition fridge#1::fridge_door pstn24901=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn24899=1.872)
	...
	(contained salt-shaker p76106=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p76107=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p76104=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705) counter#1::front_left_stove)
	(supported braiserbody#1 p76105=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
