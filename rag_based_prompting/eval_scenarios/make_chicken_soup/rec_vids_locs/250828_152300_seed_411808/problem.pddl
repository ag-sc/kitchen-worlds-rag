...
(define
  (problem test_kitchen_chicken_soup_250828_152300_seed_411808)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn426=0.0)
	(position counter#1::chewie_door_left_joint pstn424=-1.872)
	(position counter#1::chewie_door_right_joint pstn423=1.872)
	(position oven#1::knob_joint_3 pstn427=0.0)
	(position fridge#1::fridge_door pstn425=1.78)
	(position faucet#1::joint_faucet_0 pstn428=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn428=0.0)
	(atposition oven#1::knob_joint_3 pstn427=0.0)
	(atposition counter#1::chewie_door_right_joint pstn423=1.872)
	(atposition fridge#1::fridge_door pstn425=1.78)
	(atposition oven#1::knob_joint_2 pstn426=0.0)
	(atposition counter#1::chewie_door_left_joint pstn424=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn426=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn428=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn427=0.0)
	...
	(pose braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(pose braiserbody#1 p366=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p367=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148))
	(atpose salt-shaker p370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p366=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p367=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p371=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn424=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn423=1.872)
	(isopenedposition fridge#1::fridge_door pstn425=1.78)
	...
	(supported braiserbody#1 p369=(0.7, 8.847, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p368=(0.567, 7.872, 0.712, 0.0, -0.0, 0.148) counter#1::front_left_stove)
