...
(define
  (problem test_kitchen_chicken_soup_250829_161118_seed_567288)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn3456=1.78)
	(atposition faucet#1::joint_faucet_0 pstn3459=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3455=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn3454=1.872)
	(atposition oven#1::knob_joint_2 pstn3457=0.0)
	(atposition oven#1::knob_joint_3 pstn3458=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn3456=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn3454=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3455=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn3459=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3457=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3458=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn3454=1.872)
	(position counter#1::chewie_door_left_joint pstn3455=-1.872)
	(position oven#1::knob_joint_3 pstn3458=0.0)
	(position oven#1::knob_joint_2 pstn3457=0.0)
	(position fridge#1::fridge_door pstn3456=1.78)
	(position faucet#1::joint_faucet_0 pstn3459=0.0)

	(pose braiserlid#1 p9576=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(pose salt-shaker p9578=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p9575=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p9579=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p9574=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p9579=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p9575=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p9574=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p9576=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(atpose salt-shaker p9578=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p9579=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p9578=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p9576=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683) counter#1::front_left_stove)
	(supported braiserbody#1 p9577=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
