...
(define
  (problem test_kitchen_chicken_soup_250829_144137_seed_188950)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn1395=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1394=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1396=0.0)

	(isopenedposition fridge#1::fridge_door pstn1393=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1392=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1391=1.872)
	...
	(position counter#1::chewie_door_right_joint pstn1391=1.872)
	(position oven#1::knob_joint_3 pstn1395=0.0)
	(position fridge#1::fridge_door pstn1393=1.78)
	(position faucet#1::joint_faucet_0 pstn1396=0.0)
	(position oven#1::knob_joint_2 pstn1394=0.0)
	(position counter#1::chewie_door_left_joint pstn1392=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn1392=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1391=1.872)
	(atposition oven#1::knob_joint_3 pstn1395=0.0)
	(atposition oven#1::knob_joint_2 pstn1394=0.0)
	(atposition fridge#1::fridge_door pstn1393=1.78)
	(atposition faucet#1::joint_faucet_0 pstn1396=0.0)

	(pose chicken-leg p1541=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1542=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	(pose pepper-shaker p1545=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1540=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p1544=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p1545=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1540=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p1542=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	(atpose salt-shaker p1544=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1541=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p1545=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1544=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p1543=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1542=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735) counter#1::front_left_stove)
