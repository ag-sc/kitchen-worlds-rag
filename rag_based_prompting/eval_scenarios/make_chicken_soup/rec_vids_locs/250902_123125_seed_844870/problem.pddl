...
(define
  (problem test_kitchen_chicken_soup_250902_123125_seed_844870)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn3237=0.0)
	(position counter#1::chewie_door_left_joint pstn3234=-1.872)
	(position counter#1::chewie_door_right_joint pstn3233=1.872)
	(position faucet#1::joint_faucet_0 pstn3238=0.0)
	(position oven#1::knob_joint_2 pstn3236=0.0)
	(position fridge#1::fridge_door pstn3235=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn3237=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3238=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3236=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn3234=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn3233=1.872)
	(atposition oven#1::knob_joint_3 pstn3237=0.0)
	(atposition oven#1::knob_joint_2 pstn3236=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3238=0.0)
	(atposition fridge#1::fridge_door pstn3235=1.78)

	(pose pepper-shaker p18243=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p18242=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p18240=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683))
	(pose braiserbody#1 p18238=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p18239=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p18240=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683))
	(atpose salt-shaker p18242=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p18238=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p18239=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p18243=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn3233=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3234=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3235=1.78)
	...
	(contained salt-shaker p18242=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p18243=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p18241=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p18240=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683) counter#1::front_left_stove)
