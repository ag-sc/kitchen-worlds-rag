...
(define
  (problem test_kitchen_chicken_soup_250830_011406_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn17151=0.0)
	(atposition oven#1::knob_joint_2 pstn17150=0.0)
	(atposition fridge#1::fridge_door pstn17149=1.78)
	(atposition counter#1::chewie_door_right_joint pstn17147=1.872)
	(atposition counter#1::chewie_door_left_joint pstn17148=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn17152=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn17151=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17152=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17150=0.0)

	(isopenedposition fridge#1::fridge_door pstn17149=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn17147=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn17148=-1.872)
	...
	(position counter#1::chewie_door_right_joint pstn17147=1.872)
	(position fridge#1::fridge_door pstn17149=1.78)
	(position counter#1::chewie_door_left_joint pstn17148=-1.872)
	(position faucet#1::joint_faucet_0 pstn17152=0.0)
	(position oven#1::knob_joint_3 pstn17151=0.0)
	(position oven#1::knob_joint_2 pstn17150=0.0)

	(atpose salt-shaker p48420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p48416=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p48421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p48418=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose chicken-leg p48417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p48421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p48420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p48418=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose braiserbody#1 p48416=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p48417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(supported braiserbody#1 p48419=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p48418=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)

	(contained pepper-shaker p48421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p48420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
