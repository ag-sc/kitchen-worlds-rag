...
(define
  (problem test_kitchen_chicken_soup_250901_095938_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn443=1.78)
	(atposition faucet#1::joint_faucet_0 pstn446=0.0)
	(atposition counter#1::chewie_door_left_joint pstn442=-1.872)
	(atposition oven#1::knob_joint_2 pstn444=0.0)
	(atposition oven#1::knob_joint_3 pstn445=0.0)
	(atposition counter#1::chewie_door_right_joint pstn441=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn443=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn442=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn441=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn446=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn445=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn444=0.0)

	(position counter#1::chewie_door_left_joint pstn442=-1.872)
	(position oven#1::knob_joint_3 pstn445=0.0)
	(position counter#1::chewie_door_right_joint pstn441=1.872)
	(position oven#1::knob_joint_2 pstn444=0.0)
	(position faucet#1::joint_faucet_0 pstn446=0.0)
	(position fridge#1::fridge_door pstn443=1.78)

	(pose braiserlid#1 p3633=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose pepper-shaker p3636=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3631=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p3632=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p3635=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p3631=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p3632=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p3633=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(atpose pepper-shaker p3636=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p3635=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p3635=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3636=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p3634=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3633=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
