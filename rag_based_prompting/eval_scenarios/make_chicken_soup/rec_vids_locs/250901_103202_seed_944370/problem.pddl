...
(define
  (problem test_kitchen_chicken_soup_250901_103202_seed_944370)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn915=0.0)
	(position counter#1::chewie_door_left_joint pstn913=-1.872)
	(position faucet#1::joint_faucet_0 pstn917=0.0)
	(position counter#1::chewie_door_right_joint pstn912=1.872)
	(position oven#1::knob_joint_3 pstn916=0.0)
	(position fridge#1::fridge_door pstn914=1.78)

	(atposition oven#1::knob_joint_3 pstn916=0.0)
	(atposition counter#1::chewie_door_right_joint pstn912=1.872)
	(atposition oven#1::knob_joint_2 pstn915=0.0)
	(atposition counter#1::chewie_door_left_joint pstn913=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn917=0.0)
	(atposition fridge#1::fridge_door pstn914=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn917=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn916=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn915=0.0)

	(pose braiserbody#1 p8222=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p8224=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(pose pepper-shaker p8227=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p8226=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p8223=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p8224=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(atpose salt-shaker p8226=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p8223=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p8222=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p8227=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn912=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn913=-1.872)
	(isopenedposition fridge#1::fridge_door pstn914=1.78)
	...
	(contained salt-shaker p8226=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p8227=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p8224=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823) counter#1::front_left_stove)
	(supported braiserbody#1 p8225=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
