...
(define
  (problem test_kitchen_chicken_soup_250829_132916_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1617=1.78)
	(atposition counter#1::chewie_door_left_joint pstn1616=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1615=1.872)
	(atposition oven#1::knob_joint_2 pstn1618=0.0)
	(atposition oven#1::knob_joint_3 pstn1619=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1620=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn1619=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1618=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1620=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn1616=-1.872)
	(position oven#1::knob_joint_2 pstn1618=0.0)
	(position oven#1::knob_joint_3 pstn1619=0.0)
	(position faucet#1::joint_faucet_0 pstn1620=0.0)
	(position counter#1::chewie_door_right_joint pstn1615=1.872)
	(position fridge#1::fridge_door pstn1617=1.78)

	(atpose braiserbody#1 p7929=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p7931=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(atpose pepper-shaker p7934=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p7933=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p7930=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p7933=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p7934=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p7930=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p7929=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p7931=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))

	(isopenedposition counter#1::chewie_door_right_joint pstn1615=1.872)
	(isopenedposition fridge#1::fridge_door pstn1617=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1616=-1.872)
	...
	(contained salt-shaker p7933=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p7934=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p7932=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p7931=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)
