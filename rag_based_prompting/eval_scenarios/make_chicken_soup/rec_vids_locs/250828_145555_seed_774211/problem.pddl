...
(define
  (problem test_kitchen_chicken_soup_250828_145555_seed_774211)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn275=1.78)
	(position oven#1::knob_joint_2 pstn276=0.0)
	(position faucet#1::joint_faucet_0 pstn278=0.0)
	(position oven#1::knob_joint_3 pstn277=0.0)
	(position counter#1::chewie_door_left_joint pstn274=-1.872)
	(position counter#1::chewie_door_right_joint pstn273=1.872)
	...
	(atposition fridge#1::fridge_door pstn275=1.78)
	(atposition counter#1::chewie_door_right_joint pstn273=1.872)
	(atposition counter#1::chewie_door_left_joint pstn274=-1.872)
	(atposition oven#1::knob_joint_2 pstn276=0.0)
	(atposition oven#1::knob_joint_3 pstn277=0.0)
	(atposition faucet#1::joint_faucet_0 pstn278=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn276=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn278=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn277=0.0)
	...
	(pose braiserlid#1 p2382=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(pose braiserbody#1 p2380=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p2385=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p2381=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p2384=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p2382=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(atpose chicken-leg p2381=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p2384=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2380=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p2385=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_left_joint pstn274=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn273=1.872)
	(isopenedposition fridge#1::fridge_door pstn275=1.78)
	...
	(contained salt-shaker p2384=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2385=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2383=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2382=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682) counter#1::front_left_stove)
