...
(define
  (problem test_kitchen_chicken_soup_250901_193358_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn19006=0.0)
	(position faucet#1::joint_faucet_0 pstn19008=0.0)
	(position oven#1::knob_joint_3 pstn19007=0.0)
	(position fridge#1::fridge_door pstn19005=1.78)
	(position counter#1::chewie_door_right_joint pstn19003=1.872)
	(position counter#1::chewie_door_left_joint pstn19004=-1.872)

	(atposition fridge#1::fridge_door pstn19005=1.78)
	(atposition oven#1::knob_joint_3 pstn19007=0.0)
	(atposition counter#1::chewie_door_left_joint pstn19004=-1.872)
	(atposition oven#1::knob_joint_2 pstn19006=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19003=1.872)
	(atposition faucet#1::joint_faucet_0 pstn19008=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn19005=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn19004=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn19003=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn19008=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19006=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19007=0.0)

	(pose braiserbody#1 p60283=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p60288=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p60285=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(pose chicken-leg p60284=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p60287=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p60285=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(atpose salt-shaker p60287=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p60284=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p60283=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p60288=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p60287=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p60288=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p60286=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p60285=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
