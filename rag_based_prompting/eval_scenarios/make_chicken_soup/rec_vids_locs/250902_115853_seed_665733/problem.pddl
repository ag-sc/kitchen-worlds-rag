...
(define
  (problem test_kitchen_chicken_soup_250902_115853_seed_665733)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn2635=0.0)
	(position counter#1::chewie_door_left_joint pstn2632=-1.872)
	(position faucet#1::joint_faucet_0 pstn2636=0.0)
	(position fridge#1::fridge_door pstn2633=1.78)
	(position counter#1::chewie_door_right_joint pstn2631=1.872)
	(position oven#1::knob_joint_2 pstn2634=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn2635=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2634=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2636=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn2631=1.872)
	(atposition oven#1::knob_joint_2 pstn2634=0.0)
	(atposition oven#1::knob_joint_3 pstn2635=0.0)
	(atposition fridge#1::fridge_door pstn2633=1.78)
	(atposition counter#1::chewie_door_left_joint pstn2632=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn2636=0.0)

	(pose salt-shaker p15670=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p15666=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p15667=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p15668=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(pose pepper-shaker p15671=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p15666=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p15668=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(atpose pepper-shaker p15671=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p15667=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p15670=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn2631=1.872)
	(isopenedposition fridge#1::fridge_door pstn2633=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2632=-1.872)
	...
	(contained salt-shaker p15670=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p15671=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p15668=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418) counter#1::front_left_stove)
	(supported braiserbody#1 p15669=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
