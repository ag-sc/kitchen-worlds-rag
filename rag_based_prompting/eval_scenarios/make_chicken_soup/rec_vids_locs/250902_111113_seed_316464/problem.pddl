...
(define
  (problem test_kitchen_chicken_soup_250902_111113_seed_316464)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn1868=0.0)
	(atposition fridge#1::fridge_door pstn1866=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1864=1.872)
	(atposition faucet#1::joint_faucet_0 pstn1869=0.0)
	(atposition oven#1::knob_joint_2 pstn1867=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1865=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn1869=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1867=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1868=0.0)

	(position counter#1::chewie_door_right_joint pstn1864=1.872)
	(position counter#1::chewie_door_left_joint pstn1865=-1.872)
	(position oven#1::knob_joint_2 pstn1867=0.0)
	(position faucet#1::joint_faucet_0 pstn1869=0.0)
	(position fridge#1::fridge_door pstn1866=1.78)
	(position oven#1::knob_joint_3 pstn1868=0.0)

	(pose chicken-leg p10823=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p10827=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p10826=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p10824=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(pose braiserbody#1 p10822=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p10824=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(atpose braiserbody#1 p10822=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p10827=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p10826=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p10823=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn1864=1.872)
	(isopenedposition fridge#1::fridge_door pstn1866=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1865=-1.872)
	...
	(contained pepper-shaker p10827=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p10826=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p10824=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765) counter#1::front_left_stove)
	(supported braiserbody#1 p10825=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
