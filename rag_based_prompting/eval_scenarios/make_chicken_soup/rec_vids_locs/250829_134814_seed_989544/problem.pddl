...
(define
  (problem test_kitchen_chicken_soup_250829_134814_seed_989544)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn1826=0.0)
	(position fridge#1::fridge_door pstn1824=1.78)
	(position faucet#1::joint_faucet_0 pstn1827=0.0)
	(position counter#1::chewie_door_left_joint pstn1823=-1.872)
	(position oven#1::knob_joint_2 pstn1825=0.0)
	(position counter#1::chewie_door_right_joint pstn1822=1.872)

	(atposition oven#1::knob_joint_3 pstn1826=0.0)
	(atposition fridge#1::fridge_door pstn1824=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1822=1.872)
	(atposition faucet#1::joint_faucet_0 pstn1827=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1823=-1.872)
	(atposition oven#1::knob_joint_2 pstn1825=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn1827=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1825=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1826=0.0)
	...
	(pose chicken-leg p9872=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p9871=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p9876=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p9873=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose salt-shaker p9875=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p9873=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose pepper-shaker p9876=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p9872=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p9875=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p9871=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn1822=1.872)
	(isopenedposition fridge#1::fridge_door pstn1824=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1823=-1.872)
	...
	(supported braiserbody#1 p9874=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p9873=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)

	(contained pepper-shaker p9876=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p9875=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
