...
(define
  (problem test_kitchen_chicken_soup_250902_104243_seed_962833)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn971=0.0)
	(atposition oven#1::knob_joint_2 pstn969=0.0)
	(atposition counter#1::chewie_door_left_joint pstn967=-1.872)
	(atposition fridge#1::fridge_door pstn968=1.78)
	(atposition counter#1::chewie_door_right_joint pstn966=1.872)
	(atposition oven#1::knob_joint_3 pstn970=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn970=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn969=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn971=0.0)

	(isopenedposition fridge#1::fridge_door pstn968=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn966=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn967=-1.872)
	...
	(position counter#1::chewie_door_left_joint pstn967=-1.872)
	(position counter#1::chewie_door_right_joint pstn966=1.872)
	(position oven#1::knob_joint_3 pstn970=0.0)
	(position fridge#1::fridge_door pstn968=1.78)
	(position oven#1::knob_joint_2 pstn969=0.0)
	(position faucet#1::joint_faucet_0 pstn971=0.0)

	(atpose braiserbody#1 p10198=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p10200=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(atpose salt-shaker p10202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p10199=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p10203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p10203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p10198=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p10200=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(pose salt-shaker p10202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p10199=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p10203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p10202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p10201=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p10200=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928) counter#1::front_left_stove)
