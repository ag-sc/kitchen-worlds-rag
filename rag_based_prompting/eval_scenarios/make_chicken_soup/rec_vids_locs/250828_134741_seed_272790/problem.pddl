...
(define
  (problem test_kitchen_chicken_soup_250828_134741_seed_272790)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn911=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn913=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn912=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn909=-1.872)
	(position oven#1::knob_joint_2 pstn911=0.0)
	(position counter#1::chewie_door_right_joint pstn908=1.872)
	(position fridge#1::fridge_door pstn910=1.78)
	(position faucet#1::joint_faucet_0 pstn913=0.0)
	(position oven#1::knob_joint_3 pstn912=0.0)

	(atposition counter#1::chewie_door_left_joint pstn909=-1.872)
	(atposition oven#1::knob_joint_2 pstn911=0.0)
	(atposition counter#1::chewie_door_right_joint pstn908=1.872)
	(atposition faucet#1::joint_faucet_0 pstn913=0.0)
	(atposition oven#1::knob_joint_3 pstn912=0.0)
	(atposition fridge#1::fridge_door pstn910=1.78)

	(pose pepper-shaker p2961=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p2960=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2956=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p2957=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p2958=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))

	(atpose braiserlid#1 p2958=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(atpose pepper-shaker p2961=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p2960=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2956=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p2957=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn908=1.872)
	(isopenedposition fridge#1::fridge_door pstn910=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn909=-1.872)
	...
	(contained salt-shaker p2960=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2961=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2959=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2958=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401) counter#1::front_left_stove)
