...
(define
  (problem test_kitchen_chicken_soup_250901_172840_seed_41540)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn15441=0.0)
	(position fridge#1::fridge_door pstn15439=1.78)
	(position faucet#1::joint_faucet_0 pstn15442=0.0)
	(position counter#1::chewie_door_left_joint pstn15438=-1.872)
	(position counter#1::chewie_door_right_joint pstn15437=1.872)
	(position oven#1::knob_joint_2 pstn15440=0.0)

	(atposition oven#1::knob_joint_2 pstn15440=0.0)
	(atposition faucet#1::joint_faucet_0 pstn15442=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15437=1.872)
	(atposition oven#1::knob_joint_3 pstn15441=0.0)
	(atposition fridge#1::fridge_door pstn15439=1.78)
	(atposition counter#1::chewie_door_left_joint pstn15438=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15441=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15440=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15442=0.0)
	...
	(pose braiserbody#1 p49997=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p49998=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p50001=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p49999=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(pose pepper-shaker p50002=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p49998=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p50001=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p49999=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(atpose pepper-shaker p50002=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p49997=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn15437=1.872)
	(isopenedposition fridge#1::fridge_door pstn15439=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn15438=-1.872)
	...
	(contained salt-shaker p50001=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p50002=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p50000=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p49999=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584) counter#1::front_left_stove)
