...
(define
  (problem test_kitchen_chicken_soup_250902_112518_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn2019=1.78)
	(atposition counter#1::chewie_door_left_joint pstn2018=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn2022=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2017=1.872)
	(atposition oven#1::knob_joint_3 pstn2021=0.0)
	(atposition oven#1::knob_joint_2 pstn2020=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn2021=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2020=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2022=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn2018=-1.872)
	(position oven#1::knob_joint_3 pstn2021=0.0)
	(position faucet#1::joint_faucet_0 pstn2022=0.0)
	(position counter#1::chewie_door_right_joint pstn2017=1.872)
	(position fridge#1::fridge_door pstn2019=1.78)
	(position oven#1::knob_joint_2 pstn2020=0.0)

	(pose salt-shaker p13086=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p13083=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p13087=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p13084=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(pose braiserbody#1 p13082=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p13083=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p13087=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p13084=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(atpose braiserbody#1 p13082=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p13086=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn2018=-1.872)
	(isopenedposition fridge#1::fridge_door pstn2019=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn2017=1.872)
	...
	(contained salt-shaker p13086=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p13087=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13085=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13084=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
