...
(define
  (problem test_kitchen_chicken_soup_250902_101101_seed_823374)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn651=0.0)
	(atposition faucet#1::joint_faucet_0 pstn653=0.0)
	(atposition counter#1::chewie_door_right_joint pstn648=1.872)
	(atposition counter#1::chewie_door_left_joint pstn649=-1.872)
	(atposition oven#1::knob_joint_3 pstn652=0.0)
	(atposition fridge#1::fridge_door pstn650=1.78)
	...
	(position faucet#1::joint_faucet_0 pstn653=0.0)
	(position counter#1::chewie_door_right_joint pstn648=1.872)
	(position oven#1::knob_joint_2 pstn651=0.0)
	(position oven#1::knob_joint_3 pstn652=0.0)
	(position counter#1::chewie_door_left_joint pstn649=-1.872)
	(position fridge#1::fridge_door pstn650=1.78)

	(isclosedposition oven#1::knob_joint_2 pstn651=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn653=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn652=0.0)
	...
	(atpose braiserbody#1 p5666=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p5668=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(atpose salt-shaker p5670=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p5671=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p5667=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p5671=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p5667=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p5668=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(pose salt-shaker p5670=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p5666=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn649=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn648=1.872)
	(isopenedposition fridge#1::fridge_door pstn650=1.78)
	...
	(contained salt-shaker p5670=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p5671=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p5669=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p5668=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762) counter#1::front_left_stove)
