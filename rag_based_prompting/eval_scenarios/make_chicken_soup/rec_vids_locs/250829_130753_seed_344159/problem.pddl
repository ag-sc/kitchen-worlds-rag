...
(define
  (problem test_kitchen_chicken_soup_250829_130753_seed_344159)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn1411=0.0)
	(position fridge#1::fridge_door pstn1410=1.78)
	(position faucet#1::joint_faucet_0 pstn1413=0.0)
	(position oven#1::knob_joint_3 pstn1412=0.0)
	(position counter#1::chewie_door_right_joint pstn1408=1.872)
	(position counter#1::chewie_door_left_joint pstn1409=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn1411=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1412=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1413=0.0)

	(isopenedposition fridge#1::fridge_door pstn1410=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1409=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1408=1.872)
	...
	(atposition counter#1::chewie_door_left_joint pstn1409=-1.872)
	(atposition oven#1::knob_joint_2 pstn1411=0.0)
	(atposition fridge#1::fridge_door pstn1410=1.78)
	(atposition faucet#1::joint_faucet_0 pstn1413=0.0)
	(atposition oven#1::knob_joint_3 pstn1412=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1408=1.872)

	(atpose salt-shaker p6642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p6639=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p6643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p6638=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p6640=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(pose pepper-shaker p6643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p6638=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p6640=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(pose salt-shaker p6642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p6639=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p6642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p6643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p6640=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934) counter#1::front_left_stove)
	(supported braiserbody#1 p6641=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
