...
(define
  (problem test_kitchen_chicken_soup_250829_205358_seed_738733)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn11302=0.0)
	(atposition oven#1::knob_joint_3 pstn11301=0.0)
	(atposition fridge#1::fridge_door pstn11299=1.78)
	(atposition counter#1::chewie_door_left_joint pstn11298=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn11297=1.872)
	(atposition oven#1::knob_joint_2 pstn11300=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn11301=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11302=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11300=0.0)

	(isopenedposition fridge#1::fridge_door pstn11299=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn11298=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn11297=1.872)
	...
	(position counter#1::chewie_door_left_joint pstn11298=-1.872)
	(position counter#1::chewie_door_right_joint pstn11297=1.872)
	(position fridge#1::fridge_door pstn11299=1.78)
	(position oven#1::knob_joint_2 pstn11300=0.0)
	(position faucet#1::joint_faucet_0 pstn11302=0.0)
	(position oven#1::knob_joint_3 pstn11301=0.0)

	(pose braiserbody#1 p27750=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p27754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p27751=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p27752=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	(pose pepper-shaker p27755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p27751=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p27754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p27750=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p27755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p27752=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	...
	(contained pepper-shaker p27755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p27754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p27753=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p27752=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791) counter#1::front_left_stove)
