...
(define
  (problem test_kitchen_chicken_soup_250901_124202_seed_988376)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn6211=0.0)
	(position counter#1::chewie_door_left_joint pstn6209=-1.872)
	(position oven#1::knob_joint_3 pstn6212=0.0)
	(position faucet#1::joint_faucet_0 pstn6213=0.0)
	(position counter#1::chewie_door_right_joint pstn6208=1.872)
	(position fridge#1::fridge_door pstn6210=1.78)
	...
	(atposition fridge#1::fridge_door pstn6210=1.78)
	(atposition counter#1::chewie_door_right_joint pstn6208=1.872)
	(atposition faucet#1::joint_faucet_0 pstn6213=0.0)
	(atposition oven#1::knob_joint_2 pstn6211=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6209=-1.872)
	(atposition oven#1::knob_joint_3 pstn6212=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn6212=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6213=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6211=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn6210=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6208=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn6209=-1.872)
	...
	(pose salt-shaker p20582=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p20579=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p20580=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(pose braiserbody#1 p20578=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p20583=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p20578=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p20580=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(atpose pepper-shaker p20583=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p20579=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p20582=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p20583=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p20582=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p20580=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975) counter#1::front_left_stove)
	(supported braiserbody#1 p20581=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
