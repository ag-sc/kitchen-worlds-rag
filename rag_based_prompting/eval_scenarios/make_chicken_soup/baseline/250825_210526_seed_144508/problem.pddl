...
(define
  (problem test_kitchen_chicken_soup_250825_210526_seed_144508)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn16931=0.0)
	(position counter#1::chewie_door_right_joint pstn16927=1.872)
	(position fridge#1::fridge_door pstn16929=1.78)
	(position oven#1::knob_joint_2 pstn16930=0.0)
	(position counter#1::chewie_door_left_joint pstn16928=-1.872)
	(position faucet#1::joint_faucet_0 pstn16932=0.0)
	...
	(atposition oven#1::knob_joint_2 pstn16930=0.0)
	(atposition oven#1::knob_joint_3 pstn16931=0.0)
	(atposition counter#1::chewie_door_right_joint pstn16927=1.872)
	(atposition counter#1::chewie_door_left_joint pstn16928=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn16932=0.0)
	(atposition fridge#1::fridge_door pstn16929=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn16930=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16932=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16931=0.0)

	(pose chicken-leg p56496=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p56500=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p56497=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189))
	(pose salt-shaker p56499=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p56495=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p56496=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p56500=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p56497=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189))
	(atpose salt-shaker p56499=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p56495=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq944=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq152=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn16928=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16927=1.872)
	(isopenedposition fridge#1::fridge_door pstn16929=1.78)

	(ataconf left aq944=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq152=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p56499=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p56500=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p56497=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189) counter#1::front_left_stove)
	(supported braiserbody#1 p56498=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
