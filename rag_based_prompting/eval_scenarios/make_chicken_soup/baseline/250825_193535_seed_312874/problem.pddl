...
(define
  (problem test_kitchen_chicken_soup_250825_193535_seed_312874)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p48406=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p48410=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p48408=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(pose pepper-shaker p48411=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p48407=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p48407=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p48406=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p48410=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p48408=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(atpose pepper-shaker p48411=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p48410=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p48411=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p48409=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p48408=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441) counter#1::front_left_stove)
