...
(define
  (problem test_kitchen_chicken_soup_250826_060342_seed_992418)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn27607=0.0)
	(position oven#1::knob_joint_3 pstn27608=0.0)
	(position faucet#1::joint_faucet_0 pstn27609=0.0)
	(position counter#1::chewie_door_left_joint pstn27605=-1.872)
	(position fridge#1::fridge_door pstn27606=1.78)
	(position counter#1::chewie_door_right_joint pstn27604=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn27607=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn27608=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn27609=0.0)

	(atposition counter#1::chewie_door_left_joint pstn27605=-1.872)
	(atposition oven#1::knob_joint_2 pstn27607=0.0)
	(atposition faucet#1::joint_faucet_0 pstn27609=0.0)
	(atposition fridge#1::fridge_door pstn27606=1.78)
	(atposition oven#1::knob_joint_3 pstn27608=0.0)
	(atposition counter#1::chewie_door_right_joint pstn27604=1.872)

	(pose braiserbody#1 p100045=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p100050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p100047=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(pose chicken-leg p100046=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p100049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p100046=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p100045=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p100050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p100047=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(atpose salt-shaker p100049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn27605=-1.872)
	(isopenedposition fridge#1::fridge_door pstn27606=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn27604=1.872)
	...
	(contained salt-shaker p100049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p100050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p100048=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p100047=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554) counter#1::front_left_stove)
