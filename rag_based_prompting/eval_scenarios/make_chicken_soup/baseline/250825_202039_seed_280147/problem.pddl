...
(define
  (problem test_kitchen_chicken_soup_250825_202039_seed_280147)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn16352=0.0)
	(atposition counter#1::chewie_door_right_joint pstn16348=1.872)
	(atposition fridge#1::fridge_door pstn16350=1.78)
	(atposition counter#1::chewie_door_left_joint pstn16349=-1.872)
	(atposition oven#1::knob_joint_2 pstn16351=0.0)
	(atposition faucet#1::joint_faucet_0 pstn16353=0.0)
	(position fridge#1::fridge_door pstn16350=1.78)
	(position counter#1::chewie_door_left_joint pstn16349=-1.872)
	(position faucet#1::joint_faucet_0 pstn16353=0.0)
	(position oven#1::knob_joint_2 pstn16351=0.0)
	(position oven#1::knob_joint_3 pstn16352=0.0)
	(position counter#1::chewie_door_right_joint pstn16348=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn16351=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16353=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16352=0.0)

	(pose pepper-shaker p51646=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p51641=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p51642=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p51643=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	(pose salt-shaker p51645=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p51646=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p51642=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p51641=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p51643=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667))
	(atpose salt-shaker p51645=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn16348=1.872)
	(isopenedposition fridge#1::fridge_door pstn16350=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn16349=-1.872)
	...
	(contained pepper-shaker p51646=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p51645=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p51644=(0.7, 8.829, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p51643=(0.567, 7.872, 0.712, 0.0, -0.0, 2.667) counter#1::front_left_stove)
