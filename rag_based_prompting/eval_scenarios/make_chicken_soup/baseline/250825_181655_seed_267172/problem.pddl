...
(define
  (problem test_kitchen_chicken_soup_250825_181655_seed_267172)
  (:domain domain)
  ...
  (:init
	...
	(isopenedposition fridge#1::fridge_door pstn13181=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn13180=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn13179=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn13184=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13183=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn13182=0.0)

	(position counter#1::chewie_door_left_joint pstn13180=-1.872)
	(position faucet#1::joint_faucet_0 pstn13184=0.0)
	(position fridge#1::fridge_door pstn13181=1.78)
	(position oven#1::knob_joint_2 pstn13182=0.0)
	(position oven#1::knob_joint_3 pstn13183=0.0)
	(position counter#1::chewie_door_right_joint pstn13179=1.872)

	(atposition counter#1::chewie_door_right_joint pstn13179=1.872)
	(atposition faucet#1::joint_faucet_0 pstn13184=0.0)
	(atposition oven#1::knob_joint_3 pstn13183=0.0)
	(atposition oven#1::knob_joint_2 pstn13182=0.0)
	(atposition fridge#1::fridge_door pstn13181=1.78)
	(atposition counter#1::chewie_door_left_joint pstn13180=-1.872)

	(atpose braiserlid#1 p43366=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	(atpose chicken-leg p43365=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p43369=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p43368=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p43364=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p43369=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p43368=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p43364=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p43366=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	(pose chicken-leg p43365=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p43368=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p43369=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p43366=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75) counter#1::front_left_stove)
	(supported braiserbody#1 p43367=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
