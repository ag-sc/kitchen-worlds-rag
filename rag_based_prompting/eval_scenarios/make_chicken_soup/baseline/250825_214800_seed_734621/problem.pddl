...
(define
  (problem test_kitchen_chicken_soup_250825_214800_seed_734621)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn18076=1.78)
	(position counter#1::chewie_door_left_joint pstn18075=-1.872)
	(position faucet#1::joint_faucet_0 pstn18079=0.0)
	(position counter#1::chewie_door_right_joint pstn18074=1.872)
	(position oven#1::knob_joint_2 pstn18077=0.0)
	(position oven#1::knob_joint_3 pstn18078=0.0)

	(atposition faucet#1::joint_faucet_0 pstn18079=0.0)
	(atposition oven#1::knob_joint_3 pstn18078=0.0)
	(atposition fridge#1::fridge_door pstn18076=1.78)
	(atposition counter#1::chewie_door_left_joint pstn18075=-1.872)
	(atposition oven#1::knob_joint_2 pstn18077=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18074=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn18076=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn18075=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn18074=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn18079=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18077=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn18078=0.0)

	(pose chicken-leg p59531=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p59532=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(pose braiserbody#1 p59530=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p59534=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p59535=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p59530=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p59534=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p59535=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p59531=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p59532=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	...
	(contained pepper-shaker p59535=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p59534=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p59532=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19) counter#1::front_left_stove)
	(supported braiserbody#1 p59533=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
