...
(define
  (problem test_kitchen_chicken_soup_250825_141433_seed_637146)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn6517=1.78)
	(position oven#1::knob_joint_2 pstn6518=0.0)
	(position counter#1::chewie_door_right_joint pstn6515=1.872)
	(position faucet#1::joint_faucet_0 pstn6520=0.0)
	(position counter#1::chewie_door_left_joint pstn6516=-1.872)
	(position oven#1::knob_joint_3 pstn6519=0.0)

	(atposition faucet#1::joint_faucet_0 pstn6520=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6516=-1.872)
	(atposition fridge#1::fridge_door pstn6517=1.78)
	(atposition oven#1::knob_joint_2 pstn6518=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6515=1.872)
	(atposition oven#1::knob_joint_3 pstn6519=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn6518=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6520=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6519=0.0)

	(isopenedposition fridge#1::fridge_door pstn6517=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6515=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn6516=-1.872)

	(pose braiserbody#1 p21721=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p21723=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(pose salt-shaker p21725=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p21722=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p21726=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p21726=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p21721=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p21722=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p21725=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p21723=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	...
	(contained pepper-shaker p21726=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p21725=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p21723=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073) counter#1::front_left_stove)
	(supported braiserbody#1 p21724=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
