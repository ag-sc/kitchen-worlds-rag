...
(define
  (problem test_kitchen_chicken_soup_250825_162304_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn10467=1.78)
	(atposition counter#1::chewie_door_right_joint pstn10465=1.872)
	(atposition oven#1::knob_joint_2 pstn10468=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10466=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn10470=0.0)
	(atposition oven#1::knob_joint_3 pstn10469=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn10470=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10468=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10469=0.0)

	(position counter#1::chewie_door_left_joint pstn10466=-1.872)
	(position counter#1::chewie_door_right_joint pstn10465=1.872)
	(position faucet#1::joint_faucet_0 pstn10470=0.0)
	(position oven#1::knob_joint_2 pstn10468=0.0)
	(position oven#1::knob_joint_3 pstn10469=0.0)
	(position fridge#1::fridge_door pstn10467=1.78)

	(pose braiserlid#1 p33151=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(pose pepper-shaker p33154=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p33149=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p33150=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p33153=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p33150=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p33151=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(atpose braiserbody#1 p33149=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p33154=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p33153=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn10466=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn10465=1.872)
	(isopenedposition fridge#1::fridge_door pstn10467=1.78)
	...
	(contained salt-shaker p33153=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p33154=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p33151=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
	(supported braiserbody#1 p33152=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
