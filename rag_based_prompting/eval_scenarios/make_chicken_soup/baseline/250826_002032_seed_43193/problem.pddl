...
(define
  (problem test_kitchen_chicken_soup_250826_002032_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn20707=1.78)
	(position oven#1::knob_joint_3 pstn20709=0.0)
	(position faucet#1::joint_faucet_0 pstn20710=0.0)
	(position oven#1::knob_joint_2 pstn20708=0.0)
	(position counter#1::chewie_door_left_joint pstn20706=-1.872)
	(position counter#1::chewie_door_right_joint pstn20705=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn20709=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn20710=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20708=0.0)

	(atposition counter#1::chewie_door_right_joint pstn20705=1.872)
	(atposition fridge#1::fridge_door pstn20707=1.78)
	(atposition oven#1::knob_joint_3 pstn20709=0.0)
	(atposition counter#1::chewie_door_left_joint pstn20706=-1.872)
	(atposition oven#1::knob_joint_2 pstn20708=0.0)
	(atposition faucet#1::joint_faucet_0 pstn20710=0.0)

	(pose salt-shaker p71002=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p71000=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(pose braiserbody#1 p70998=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p71003=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p70999=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose pepper-shaker p71003=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p70999=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p70998=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p71002=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p71000=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(isopenedposition counter#1::chewie_door_right_joint pstn20705=1.872)
	(isopenedposition fridge#1::fridge_door pstn20707=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn20706=-1.872)
	...
	(contained salt-shaker p71002=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p71003=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p71000=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
	(supported braiserbody#1 p71001=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
