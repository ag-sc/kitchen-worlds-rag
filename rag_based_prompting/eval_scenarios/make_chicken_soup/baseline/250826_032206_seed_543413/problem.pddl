...
(define
  (problem test_kitchen_chicken_soup_250826_032206_seed_543413)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn24553=0.0)
	(position oven#1::knob_joint_3 pstn24552=0.0)
	(position fridge#1::fridge_door pstn24550=1.78)
	(position counter#1::chewie_door_left_joint pstn24549=-1.872)
	(position oven#1::knob_joint_2 pstn24551=0.0)
	(position counter#1::chewie_door_right_joint pstn24548=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn24553=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24552=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24551=0.0)

	(atposition counter#1::chewie_door_left_joint pstn24549=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn24548=1.872)
	(atposition oven#1::knob_joint_3 pstn24552=0.0)
	(atposition fridge#1::fridge_door pstn24550=1.78)
	(atposition faucet#1::joint_faucet_0 pstn24553=0.0)
	(atposition oven#1::knob_joint_2 pstn24551=0.0)

	(pose pepper-shaker p82761=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p82760=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p82757=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p82758=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(pose braiserbody#1 p82756=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p82761=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p82760=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p82757=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p82758=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(atpose braiserbody#1 p82756=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn24548=1.872)
	(isopenedposition fridge#1::fridge_door pstn24550=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn24549=-1.872)
	...
	(contained salt-shaker p82760=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p82761=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p82758=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92) counter#1::front_left_stove)
	(supported braiserbody#1 p82759=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
