...
(define
  (problem test_kitchen_chicken_soup_250825_121856_seed_854983)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn3913=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3912=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3911=0.0)

	(position counter#1::chewie_door_right_joint pstn3908=1.872)
	(position counter#1::chewie_door_left_joint pstn3909=-1.872)
	(position oven#1::knob_joint_3 pstn3912=0.0)
	(position faucet#1::joint_faucet_0 pstn3913=0.0)
	(position fridge#1::fridge_door pstn3910=1.78)
	(position oven#1::knob_joint_2 pstn3911=0.0)

	(atposition counter#1::chewie_door_right_joint pstn3908=1.872)
	(atposition fridge#1::fridge_door pstn3910=1.78)
	(atposition counter#1::chewie_door_left_joint pstn3909=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn3913=0.0)
	(atposition oven#1::knob_joint_3 pstn3912=0.0)
	(atposition oven#1::knob_joint_2 pstn3911=0.0)

	(pose chicken-leg p8620=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p8623=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p8619=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p8624=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p8621=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))

	(atpose pepper-shaker p8624=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p8620=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p8621=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(atpose salt-shaker p8623=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p8619=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn3909=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3910=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn3908=1.872)
	...
	(contained salt-shaker p8623=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p8624=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p8621=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303) counter#1::front_left_stove)
	(supported braiserbody#1 p8622=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
