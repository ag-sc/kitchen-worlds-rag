...
(define
  (problem test_kitchen_chicken_soup_250825_200656_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn16162=0.0)
	(position faucet#1::joint_faucet_0 pstn16164=0.0)
	(position fridge#1::fridge_door pstn16161=1.78)
	(position counter#1::chewie_door_left_joint pstn16160=-1.872)
	(position oven#1::knob_joint_3 pstn16163=0.0)
	(position counter#1::chewie_door_right_joint pstn16159=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn16162=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16164=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16163=0.0)

	(atposition counter#1::chewie_door_left_joint pstn16160=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn16164=0.0)
	(atposition oven#1::knob_joint_3 pstn16163=0.0)
	(atposition oven#1::knob_joint_2 pstn16162=0.0)
	(atposition fridge#1::fridge_door pstn16161=1.78)
	(atposition counter#1::chewie_door_right_joint pstn16159=1.872)

	(pose chicken-leg p50369=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p50372=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p50368=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p50373=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p50370=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(atpose chicken-leg p50369=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p50372=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p50368=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p50373=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p50370=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(isopenedposition counter#1::chewie_door_left_joint pstn16160=-1.872)
	(isopenedposition fridge#1::fridge_door pstn16161=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16159=1.872)
	...
	(contained salt-shaker p50372=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p50373=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p50371=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p50370=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
