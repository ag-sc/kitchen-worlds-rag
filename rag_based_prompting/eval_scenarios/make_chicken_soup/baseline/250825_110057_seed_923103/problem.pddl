...
(define
  (problem test_kitchen_chicken_soup_250825_110057_seed_923103)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn1133=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1129=1.872)
	(atposition faucet#1::joint_faucet_0 pstn1134=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1130=-1.872)
	(atposition oven#1::knob_joint_2 pstn1132=0.0)
	(atposition fridge#1::fridge_door pstn1131=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn1134=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1132=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1133=0.0)

	(position counter#1::chewie_door_right_joint pstn1129=1.872)
	(position fridge#1::fridge_door pstn1131=1.78)
	(position oven#1::knob_joint_2 pstn1132=0.0)
	(position oven#1::knob_joint_3 pstn1133=0.0)
	(position counter#1::chewie_door_left_joint pstn1130=-1.872)
	(position faucet#1::joint_faucet_0 pstn1134=0.0)

	(pose chicken-leg p2126=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p2125=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p2129=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p2130=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2127=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))

	(atpose braiserbody#1 p2125=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p2129=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2126=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p2130=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2127=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))

	(isopenedposition counter#1::chewie_door_left_joint pstn1130=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1131=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1129=1.872)
	...
	(contained pepper-shaker p2130=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2129=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2128=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2127=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097) counter#1::front_left_stove)
