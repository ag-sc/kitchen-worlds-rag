...
(define
  (problem test_kitchen_chicken_soup_250826_094442_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p111919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p111916=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p111917=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(pose pepper-shaker p111920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p111915=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p111915=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p111916=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p111920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p111919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p111917=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	...
	(contained salt-shaker p111919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p111920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p111917=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
	(supported braiserbody#1 p111918=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
