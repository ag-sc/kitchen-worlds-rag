...
(define
  (problem test_kitchen_chicken_soup_250826_035640_seed_374741)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn25220=0.0)
	(atposition faucet#1::joint_faucet_0 pstn25221=0.0)
	(atposition counter#1::chewie_door_left_joint pstn25217=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn25216=1.872)
	(atposition oven#1::knob_joint_2 pstn25219=0.0)
	(atposition fridge#1::fridge_door pstn25218=1.78)
	...
	(isopenedposition fridge#1::fridge_door pstn25218=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn25217=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn25216=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn25221=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn25219=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn25220=0.0)

	(position counter#1::chewie_door_left_joint pstn25217=-1.872)
	(position fridge#1::fridge_door pstn25218=1.78)
	(position counter#1::chewie_door_right_joint pstn25216=1.872)
	(position oven#1::knob_joint_3 pstn25220=0.0)
	(position faucet#1::joint_faucet_0 pstn25221=0.0)
	(position oven#1::knob_joint_2 pstn25219=0.0)

	(pose salt-shaker p86452=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p86453=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p86448=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p86449=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p86450=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))

	(atpose chicken-leg p86449=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p86450=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(atpose salt-shaker p86452=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p86453=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p86448=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p86453=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p86452=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p86450=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355) counter#1::front_left_stove)
	(supported braiserbody#1 p86451=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
