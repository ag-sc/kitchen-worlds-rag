...
(define
  (problem test_kitchen_chicken_soup_250904_195942_seed_267172)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn14047=0.0)
	(position fridge#1::fridge_door pstn14044=1.78)
	(position oven#1::knob_joint_2 pstn14045=0.0)
	(position oven#1::knob_joint_3 pstn14046=0.0)
	(position counter#1::chewie_door_right_joint pstn14042=1.872)
	(position counter#1::chewie_door_left_joint pstn14043=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn14045=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14046=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14047=0.0)

	(isopenedposition fridge#1::fridge_door pstn14044=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn14043=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn14042=1.872)

	(atposition counter#1::chewie_door_left_joint pstn14043=-1.872)
	(atposition oven#1::knob_joint_3 pstn14046=0.0)
	(atposition counter#1::chewie_door_right_joint pstn14042=1.872)
	(atposition fridge#1::fridge_door pstn14044=1.78)
	(atposition oven#1::knob_joint_2 pstn14045=0.0)
	(atposition faucet#1::joint_faucet_0 pstn14047=0.0)

	(pose salt-shaker p33455=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p33451=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p33456=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p33452=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p33453=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))

	(atpose chicken-leg p33452=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p33455=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p33456=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p33453=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	(atpose braiserbody#1 p33451=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p33455=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p33456=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p33454=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p33453=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75) counter#1::front_left_stove)
