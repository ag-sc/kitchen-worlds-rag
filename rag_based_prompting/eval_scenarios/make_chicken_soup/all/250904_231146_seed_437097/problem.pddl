...
(define
  (problem test_kitchen_chicken_soup_250904_231146_seed_437097)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn16075=0.0)
	(position fridge#1::fridge_door pstn16073=1.78)
	(position counter#1::chewie_door_left_joint pstn16072=-1.872)
	(position counter#1::chewie_door_right_joint pstn16071=1.872)
	(position oven#1::knob_joint_2 pstn16074=0.0)
	(position faucet#1::joint_faucet_0 pstn16076=0.0)
	...
	(atposition fridge#1::fridge_door pstn16073=1.78)
	(atposition counter#1::chewie_door_right_joint pstn16071=1.872)
	(atposition counter#1::chewie_door_left_joint pstn16072=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn16076=0.0)
	(atposition oven#1::knob_joint_2 pstn16074=0.0)
	(atposition oven#1::knob_joint_3 pstn16075=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn16074=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16075=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16076=0.0)

	(isopenedposition fridge#1::fridge_door pstn16073=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16071=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn16072=-1.872)

	(pose braiserlid#1 p44863=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(pose salt-shaker p44865=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p44861=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p44862=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p44866=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p44863=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(atpose pepper-shaker p44866=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p44865=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p44861=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p44862=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p44866=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p44865=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p44864=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p44863=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96) counter#1::front_left_stove)
