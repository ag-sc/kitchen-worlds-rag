...
(define
  (problem test_kitchen_chicken_soup_250904_152356_seed_398825)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn8395=0.0)
	(position counter#1::chewie_door_left_joint pstn8392=-1.872)
	(position counter#1::chewie_door_right_joint pstn8391=1.872)
	(position faucet#1::joint_faucet_0 pstn8396=0.0)
	(position fridge#1::fridge_door pstn8393=1.78)
	(position oven#1::knob_joint_2 pstn8394=0.0)
	...
	(atposition fridge#1::fridge_door pstn8393=1.78)
	(atposition oven#1::knob_joint_2 pstn8394=0.0)
	(atposition oven#1::knob_joint_3 pstn8395=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8391=1.872)
	(atposition faucet#1::joint_faucet_0 pstn8396=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8392=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn8395=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8394=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8396=0.0)

	(atpose braiserbody#1 p20478=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p20479=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p20482=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p20480=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854))
	(atpose pepper-shaker p20483=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p20483=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p20482=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p20480=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854))
	(pose braiserbody#1 p20478=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p20479=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn8391=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn8392=-1.872)
	(isopenedposition fridge#1::fridge_door pstn8393=1.78)
	...
	(contained salt-shaker p20482=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p20483=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p20481=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p20480=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854) counter#1::front_left_stove)
