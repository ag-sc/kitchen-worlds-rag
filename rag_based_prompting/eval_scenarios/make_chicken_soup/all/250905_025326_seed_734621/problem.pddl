...
(define
  (problem test_kitchen_chicken_soup_250905_025326_seed_734621)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn19151=0.0)
	(atposition counter#1::chewie_door_left_joint pstn19149=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn19148=1.872)
	(atposition fridge#1::fridge_door pstn19150=1.78)
	(atposition faucet#1::joint_faucet_0 pstn19153=0.0)
	(atposition oven#1::knob_joint_3 pstn19152=0.0)

	(position faucet#1::joint_faucet_0 pstn19153=0.0)
	(position oven#1::knob_joint_3 pstn19152=0.0)
	(position counter#1::chewie_door_left_joint pstn19149=-1.872)
	(position fridge#1::fridge_door pstn19150=1.78)
	(position oven#1::knob_joint_2 pstn19151=0.0)
	(position counter#1::chewie_door_right_joint pstn19148=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn19151=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19153=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19152=0.0)

	(pose braiserlid#1 p56450=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(pose salt-shaker p56452=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p56448=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p56449=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p56453=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p56450=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(atpose salt-shaker p56452=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p56448=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p56449=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p56453=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq824=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq504=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn19148=1.872)
	(isopenedposition fridge#1::fridge_door pstn19150=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn19149=-1.872)

	(ataconf left aq824=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq504=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p56452=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p56453=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p56451=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p56450=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19) counter#1::front_left_stove)
