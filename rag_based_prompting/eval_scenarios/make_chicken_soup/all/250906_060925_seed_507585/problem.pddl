...
(define
  (problem test_kitchen_chicken_soup_250906_060925_seed_507585)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn26762=0.0)
	(position counter#1::chewie_door_right_joint pstn26758=1.872)
	(position faucet#1::joint_faucet_0 pstn26763=0.0)
	(position counter#1::chewie_door_left_joint pstn26759=-1.872)
	(position fridge#1::fridge_door pstn26760=1.78)
	(position oven#1::knob_joint_2 pstn26761=0.0)

	(atposition fridge#1::fridge_door pstn26760=1.78)
	(atposition oven#1::knob_joint_2 pstn26761=0.0)
	(atposition oven#1::knob_joint_3 pstn26762=0.0)
	(atposition counter#1::chewie_door_right_joint pstn26758=1.872)
	(atposition faucet#1::joint_faucet_0 pstn26763=0.0)
	(atposition counter#1::chewie_door_left_joint pstn26759=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn26761=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn26762=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn26763=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn26760=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn26758=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn26759=-1.872)

	(pose salt-shaker p49124=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p49125=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p49122=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(pose chicken-leg p49121=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p49120=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p49122=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(atpose pepper-shaker p49125=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p49124=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p49121=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p49120=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p49124=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p49125=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p49123=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p49122=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39) counter#1::front_left_stove)
