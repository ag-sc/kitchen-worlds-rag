...
(define
  (problem test_kitchen_chicken_soup_250905_054042_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn21277=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21278=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21276=0.0)

	(position counter#1::chewie_door_right_joint pstn21273=1.872)
	(position counter#1::chewie_door_left_joint pstn21274=-1.872)
	(position oven#1::knob_joint_2 pstn21276=0.0)
	(position fridge#1::fridge_door pstn21275=1.78)
	(position oven#1::knob_joint_3 pstn21277=0.0)
	(position faucet#1::joint_faucet_0 pstn21278=0.0)

	(atposition counter#1::chewie_door_right_joint pstn21273=1.872)
	(atposition counter#1::chewie_door_left_joint pstn21274=-1.872)
	(atposition oven#1::knob_joint_3 pstn21277=0.0)
	(atposition faucet#1::joint_faucet_0 pstn21278=0.0)
	(atposition oven#1::knob_joint_2 pstn21276=0.0)
	(atposition fridge#1::fridge_door pstn21275=1.78)

	(pose salt-shaker p62067=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p62063=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p62068=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p62065=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose chicken-leg p62064=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p62064=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p62067=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p62063=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p62065=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(atpose pepper-shaker p62068=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq560=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq184=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn21274=-1.872)
	(isopenedposition fridge#1::fridge_door pstn21275=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn21273=1.872)

	(ataconf left aq560=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq184=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p62068=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p62067=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p62066=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p62065=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
