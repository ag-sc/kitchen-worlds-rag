...
(define
  (problem test_kitchen_chicken_soup_250905_171405_seed_149466)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn13408=0.0)
	(position counter#1::chewie_door_left_joint pstn13404=-1.872)
	(position fridge#1::fridge_door pstn13405=1.78)
	(position oven#1::knob_joint_3 pstn13407=0.0)
	(position counter#1::chewie_door_right_joint pstn13403=1.872)
	(position oven#1::knob_joint_2 pstn13406=0.0)

	(atposition faucet#1::joint_faucet_0 pstn13408=0.0)
	(atposition counter#1::chewie_door_left_joint pstn13404=-1.872)
	(atposition oven#1::knob_joint_3 pstn13407=0.0)
	(atposition counter#1::chewie_door_right_joint pstn13403=1.872)
	(atposition fridge#1::fridge_door pstn13405=1.78)
	(atposition oven#1::knob_joint_2 pstn13406=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn13406=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13408=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13407=0.0)
	...
	(pose braiserlid#1 p23344=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(pose braiserbody#1 p23342=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p23346=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p23347=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p23343=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p23346=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p23344=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(atpose pepper-shaker p23347=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p23343=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p23342=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn13403=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn13404=-1.872)
	(isopenedposition fridge#1::fridge_door pstn13405=1.78)
	...
	(contained pepper-shaker p23347=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23346=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p23344=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9) counter#1::front_left_stove)
	(supported braiserbody#1 p23345=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
