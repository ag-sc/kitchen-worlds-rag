...
(define
  (problem test_kitchen_chicken_soup_250904_144007_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn7961=1.78)
	(atposition faucet#1::joint_faucet_0 pstn7964=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7959=1.872)
	(atposition oven#1::knob_joint_2 pstn7962=0.0)
	(atposition oven#1::knob_joint_3 pstn7963=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7960=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn7963=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn7964=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7962=0.0)

	(position counter#1::chewie_door_left_joint pstn7960=-1.872)
	(position fridge#1::fridge_door pstn7961=1.78)
	(position oven#1::knob_joint_2 pstn7962=0.0)
	(position oven#1::knob_joint_3 pstn7963=0.0)
	(position faucet#1::joint_faucet_0 pstn7964=0.0)
	(position counter#1::chewie_door_right_joint pstn7959=1.872)

	(pose salt-shaker p16518=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p16516=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(pose chicken-leg p16515=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p16519=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p16514=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn7960=-1.872)
	(isopenedposition fridge#1::fridge_door pstn7961=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn7959=1.872)

	(aconf left aq512=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq56=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p16519=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p16514=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p16518=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p16516=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(atpose chicken-leg p16515=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(ataconf right aq56=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq512=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(supported braiserbody#1 p16517=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p16516=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)

	(contained pepper-shaker p16519=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p16518=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
