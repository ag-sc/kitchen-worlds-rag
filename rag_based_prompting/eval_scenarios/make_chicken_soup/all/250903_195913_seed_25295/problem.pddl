...
(define
  (problem test_kitchen_chicken_soup_250903_195913_seed_25295)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn16277=0.0)
	(position oven#1::knob_joint_3 pstn16278=0.0)
	(position fridge#1::fridge_door pstn16276=1.78)
	(position faucet#1::joint_faucet_0 pstn16279=0.0)
	(position counter#1::chewie_door_left_joint pstn16275=-1.872)
	(position counter#1::chewie_door_right_joint pstn16274=1.872)
	...
	(atposition fridge#1::fridge_door pstn16276=1.78)
	(atposition oven#1::knob_joint_2 pstn16277=0.0)
	(atposition oven#1::knob_joint_3 pstn16278=0.0)
	(atposition faucet#1::joint_faucet_0 pstn16279=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16275=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn16274=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn16278=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16279=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16277=0.0)
	...
	(pose braiserbody#1 p33858=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p33863=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p33862=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p33859=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p33860=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))

	(atpose braiserbody#1 p33858=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p33863=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p33859=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p33862=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p33860=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))

	(isopenedposition counter#1::chewie_door_right_joint pstn16274=1.872)
	(isopenedposition fridge#1::fridge_door pstn16276=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn16275=-1.872)
	...
	(contained salt-shaker p33862=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p33863=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p33860=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662) counter#1::front_left_stove)
	(supported braiserbody#1 p33861=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
