...
(define
  (problem test_kitchen_chicken_soup_250904_114617_seed_382012)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn3174=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3171=1.872)
	(atposition faucet#1::joint_faucet_0 pstn3176=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3172=-1.872)
	(atposition oven#1::knob_joint_3 pstn3175=0.0)
	(atposition fridge#1::fridge_door pstn3173=1.78)
	...
	(position fridge#1::fridge_door pstn3173=1.78)
	(position oven#1::knob_joint_3 pstn3175=0.0)
	(position oven#1::knob_joint_2 pstn3174=0.0)
	(position counter#1::chewie_door_right_joint pstn3171=1.872)
	(position counter#1::chewie_door_left_joint pstn3172=-1.872)
	(position faucet#1::joint_faucet_0 pstn3176=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn3174=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3176=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3175=0.0)

	(atpose salt-shaker p9570=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p9567=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p9568=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(atpose braiserbody#1 p9566=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p9571=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p9571=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p9567=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p9568=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(pose braiserbody#1 p9566=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p9570=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn3171=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3172=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3173=1.78)
	...
	(contained pepper-shaker p9571=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p9570=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p9569=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p9568=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928) counter#1::front_left_stove)
