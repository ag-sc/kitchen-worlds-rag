...
(define
  (problem test_kitchen_chicken_soup_250906_102314_seed_195627)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p8680=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268))
	(pose chicken-leg p8679=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p8682=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p8678=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p8683=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p8678=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p8679=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p8682=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p8680=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268))
	(atpose pepper-shaker p8683=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p8683=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p8682=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p8680=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268) counter#1::front_left_stove)
	(supported braiserbody#1 p8681=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
