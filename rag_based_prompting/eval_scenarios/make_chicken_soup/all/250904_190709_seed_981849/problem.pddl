...
(define
  (problem test_kitchen_chicken_soup_250904_190709_seed_981849)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn12523=0.0)
	(position faucet#1::joint_faucet_0 pstn12525=0.0)
	(position counter#1::chewie_door_left_joint pstn12521=-1.872)
	(position fridge#1::fridge_door pstn12522=1.78)
	(position counter#1::chewie_door_right_joint pstn12520=1.872)
	(position oven#1::knob_joint_3 pstn12524=0.0)
	...
	(atposition oven#1::knob_joint_2 pstn12523=0.0)
	(atposition fridge#1::fridge_door pstn12522=1.78)
	(atposition counter#1::chewie_door_right_joint pstn12520=1.872)
	(atposition counter#1::chewie_door_left_joint pstn12521=-1.872)
	(atposition oven#1::knob_joint_3 pstn12524=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12525=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn12524=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12525=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12523=0.0)

	(pose braiserlid#1 p32640=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(pose braiserbody#1 p32638=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p32642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p32639=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p32643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p32643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p32640=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(atpose braiserbody#1 p32638=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p32642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p32639=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_left_joint pstn12521=-1.872)
	(isopenedposition fridge#1::fridge_door pstn12522=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12520=1.872)
	...
	(contained salt-shaker p32642=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p32643=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p32640=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705) counter#1::front_left_stove)
	(supported braiserbody#1 p32641=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
