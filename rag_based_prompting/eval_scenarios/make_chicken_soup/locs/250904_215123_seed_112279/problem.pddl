...
(define
  (problem test_kitchen_chicken_soup_250904_215123_seed_112279)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn16463=0.0)
	(atposition fridge#1::fridge_door pstn16460=1.78)
	(atposition oven#1::knob_joint_2 pstn16461=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16459=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn16458=1.872)
	(atposition oven#1::knob_joint_3 pstn16462=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn16460=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16458=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn16459=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn16463=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16461=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16462=0.0)

	(position counter#1::chewie_door_left_joint pstn16459=-1.872)
	(position counter#1::chewie_door_right_joint pstn16458=1.872)
	(position fridge#1::fridge_door pstn16460=1.78)
	(position faucet#1::joint_faucet_0 pstn16463=0.0)
	(position oven#1::knob_joint_2 pstn16461=0.0)
	(position oven#1::knob_joint_3 pstn16462=0.0)

	(pose chicken-leg p59647=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p59651=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p59646=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p59648=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))
	(pose salt-shaker p59650=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p59651=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p59648=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))
	(atpose braiserbody#1 p59646=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p59650=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p59647=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p59651=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p59650=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p59648=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655) counter#1::front_left_stove)
	(supported braiserbody#1 p59649=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
