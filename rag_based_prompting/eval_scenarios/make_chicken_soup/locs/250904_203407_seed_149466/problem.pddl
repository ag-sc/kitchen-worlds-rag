...
(define
  (problem test_kitchen_chicken_soup_250904_203407_seed_149466)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn14677=0.0)
	(atposition counter#1::chewie_door_right_joint pstn14673=1.872)
	(atposition oven#1::knob_joint_2 pstn14676=0.0)
	(atposition fridge#1::fridge_door pstn14675=1.78)
	(atposition faucet#1::joint_faucet_0 pstn14678=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14674=-1.872)

	(position faucet#1::joint_faucet_0 pstn14678=0.0)
	(position fridge#1::fridge_door pstn14675=1.78)
	(position oven#1::knob_joint_2 pstn14676=0.0)
	(position oven#1::knob_joint_3 pstn14677=0.0)
	(position counter#1::chewie_door_left_joint pstn14674=-1.872)
	(position counter#1::chewie_door_right_joint pstn14673=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn14676=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14677=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14678=0.0)

	(isopenedposition fridge#1::fridge_door pstn14675=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn14673=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn14674=-1.872)

	(pose braiserbody#1 p54860=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p54861=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p54864=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p54862=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(pose pepper-shaker p54865=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p54861=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p54864=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p54865=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p54862=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(atpose braiserbody#1 p54860=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p54864=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p54865=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p54862=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9) counter#1::front_left_stove)
	(supported braiserbody#1 p54863=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
