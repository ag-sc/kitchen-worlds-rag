...
(define
  (problem test_kitchen_chicken_soup_250904_233408_seed_4942)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn18210=1.78)
	(atposition counter#1::chewie_door_right_joint pstn18208=1.872)
	(atposition counter#1::chewie_door_left_joint pstn18209=-1.872)
	(atposition oven#1::knob_joint_3 pstn18212=0.0)
	(atposition faucet#1::joint_faucet_0 pstn18213=0.0)
	(atposition oven#1::knob_joint_2 pstn18211=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn18213=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18211=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn18212=0.0)

	(position counter#1::chewie_door_left_joint pstn18209=-1.872)
	(position fridge#1::fridge_door pstn18210=1.78)
	(position faucet#1::joint_faucet_0 pstn18213=0.0)
	(position counter#1::chewie_door_right_joint pstn18208=1.872)
	(position oven#1::knob_joint_2 pstn18211=0.0)
	(position oven#1::knob_joint_3 pstn18212=0.0)

	(pose salt-shaker p65462=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p65463=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p65459=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p65460=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(pose braiserbody#1 p65458=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq0=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq64=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose salt-shaker p65462=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p65463=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p65460=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(atpose chicken-leg p65459=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p65458=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(ataconf left aq0=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq64=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn18208=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn18209=-1.872)
	(isopenedposition fridge#1::fridge_door pstn18210=1.78)

	(contained pepper-shaker p65463=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p65462=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p65460=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391) counter#1::front_left_stove)
	(supported braiserbody#1 p65461=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
