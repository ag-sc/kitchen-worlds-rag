...
(define
  (problem test_kitchen_chicken_soup_250904_210344_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn15333=0.0)
	(position oven#1::knob_joint_2 pstn15332=0.0)
	(position fridge#1::fridge_door pstn15331=1.78)
	(position counter#1::chewie_door_left_joint pstn15330=-1.872)
	(position faucet#1::joint_faucet_0 pstn15334=0.0)
	(position counter#1::chewie_door_right_joint pstn15329=1.872)

	(atposition faucet#1::joint_faucet_0 pstn15334=0.0)
	(atposition fridge#1::fridge_door pstn15331=1.78)
	(atposition oven#1::knob_joint_2 pstn15332=0.0)
	(atposition oven#1::knob_joint_3 pstn15333=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15329=1.872)
	(atposition counter#1::chewie_door_left_joint pstn15330=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15333=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15334=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15332=0.0)

	(pose salt-shaker p56560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p56556=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p56557=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p56561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p56558=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))

	(atpose chicken-leg p56557=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p56561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p56556=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p56560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p56558=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))

	(isopenedposition counter#1::chewie_door_right_joint pstn15329=1.872)
	(isopenedposition fridge#1::fridge_door pstn15331=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn15330=-1.872)
	...
	(contained pepper-shaker p56561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p56560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p56558=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
	(supported braiserbody#1 p56559=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
