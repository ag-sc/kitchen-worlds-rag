...
(define
  (problem test_kitchen_chicken_soup_250904_123606_seed_452553)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn5337=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5339=0.0)
	(atposition oven#1::knob_joint_3 pstn5338=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5334=1.872)
	(atposition counter#1::chewie_door_left_joint pstn5335=-1.872)
	(atposition fridge#1::fridge_door pstn5336=1.78)
	(position fridge#1::fridge_door pstn5336=1.78)
	(position oven#1::knob_joint_3 pstn5338=0.0)
	(position faucet#1::joint_faucet_0 pstn5339=0.0)
	(position oven#1::knob_joint_2 pstn5337=0.0)
	(position counter#1::chewie_door_right_joint pstn5334=1.872)
	(position counter#1::chewie_door_left_joint pstn5335=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn5339=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5337=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5338=0.0)

	(pose chicken-leg p14916=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p14920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p14917=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(pose braiserbody#1 p14915=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p14919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p14917=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(atpose braiserbody#1 p14915=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p14919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p14916=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p14920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_left_joint pstn5335=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5336=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5334=1.872)
	...
	(contained salt-shaker p14919=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14920=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p14918=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p14917=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452) counter#1::front_left_stove)
