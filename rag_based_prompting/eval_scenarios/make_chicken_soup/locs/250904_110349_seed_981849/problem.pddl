...
(define
  (problem test_kitchen_chicken_soup_250904_110349_seed_981849)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p6276=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(pose chicken-leg p6275=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p6274=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p6278=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p6279=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p6275=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p6274=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p6278=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p6279=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p6276=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	...
	(contained pepper-shaker p6279=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p6278=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p6276=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705) counter#1::front_left_stove)
	(supported braiserbody#1 p6277=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
