...
(define
  (problem test_kitchen_chicken_soup_250904_103643_seed_817039)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p5578=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5583=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p5579=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p5580=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose salt-shaker p5582=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p5583=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p5579=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p5578=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p5580=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose salt-shaker p5582=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p5582=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p5583=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p5581=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p5580=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
