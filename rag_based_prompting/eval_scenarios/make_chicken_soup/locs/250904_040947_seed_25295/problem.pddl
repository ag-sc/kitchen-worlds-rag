...
(define
  (problem test_kitchen_chicken_soup_250904_040947_seed_25295)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn8213=1.78)
	(position counter#1::chewie_door_right_joint pstn8211=1.872)
	(position faucet#1::joint_faucet_0 pstn8216=0.0)
	(position oven#1::knob_joint_2 pstn8214=0.0)
	(position counter#1::chewie_door_left_joint pstn8212=-1.872)
	(position oven#1::knob_joint_3 pstn8215=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn8214=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8215=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8216=0.0)

	(isopenedposition fridge#1::fridge_door pstn8213=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn8211=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn8212=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn8212=-1.872)
	(atposition fridge#1::fridge_door pstn8213=1.78)
	(atposition oven#1::knob_joint_3 pstn8215=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8216=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8211=1.872)
	(atposition oven#1::knob_joint_2 pstn8214=0.0)

	(pose chicken-leg p27111=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p27115=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p27114=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p27112=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(pose braiserbody#1 p27110=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p27114=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p27111=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p27112=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(atpose braiserbody#1 p27110=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p27115=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p27114=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p27115=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p27112=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662) counter#1::front_left_stove)
	(supported braiserbody#1 p27113=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
