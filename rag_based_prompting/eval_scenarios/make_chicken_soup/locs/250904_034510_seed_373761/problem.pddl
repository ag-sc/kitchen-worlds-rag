...
(define
  (problem test_kitchen_chicken_soup_250904_034510_seed_373761)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn7743=0.0)
	(position counter#1::chewie_door_right_joint pstn7739=1.872)
	(position counter#1::chewie_door_left_joint pstn7740=-1.872)
	(position oven#1::knob_joint_2 pstn7742=0.0)
	(position faucet#1::joint_faucet_0 pstn7744=0.0)
	(position fridge#1::fridge_door pstn7741=1.78)
	...
	(isopenedposition fridge#1::fridge_door pstn7741=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn7739=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn7740=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn7744=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7742=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7743=0.0)

	(atposition counter#1::chewie_door_left_joint pstn7740=-1.872)
	(atposition oven#1::knob_joint_2 pstn7742=0.0)
	(atposition fridge#1::fridge_door pstn7741=1.78)
	(atposition oven#1::knob_joint_3 pstn7743=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7739=1.872)
	(atposition faucet#1::joint_faucet_0 pstn7744=0.0)

	(pose chicken-leg p24481=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p24482=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))
	(pose pepper-shaker p24485=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p24484=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p24480=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq616=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq248=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p24485=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p24484=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p24480=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p24481=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p24482=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998))

	(ataconf left aq616=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq248=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p24485=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p24484=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p24483=(0.7, 8.889, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p24482=(0.567, 7.872, 0.712, 0.0, -0.0, 0.998) counter#1::front_left_stove)
