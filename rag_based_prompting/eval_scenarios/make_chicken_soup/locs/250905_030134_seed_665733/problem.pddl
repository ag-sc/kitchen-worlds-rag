...
(define
  (problem test_kitchen_chicken_soup_250905_030134_seed_665733)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn1636=0.0)
	(position oven#1::knob_joint_2 pstn1635=0.0)
	(position counter#1::chewie_door_right_joint pstn1632=1.872)
	(position faucet#1::joint_faucet_0 pstn1637=0.0)
	(position fridge#1::fridge_door pstn1634=1.78)
	(position counter#1::chewie_door_left_joint pstn1633=-1.872)
	...
	(atposition oven#1::knob_joint_2 pstn1635=0.0)
	(atposition fridge#1::fridge_door pstn1634=1.78)
	(atposition counter#1::chewie_door_left_joint pstn1633=-1.872)
	(atposition oven#1::knob_joint_3 pstn1636=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1637=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1632=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn1637=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1635=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1636=0.0)

	(pose braiserlid#1 p2741=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(pose braiserbody#1 p2739=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p2744=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p2743=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p2740=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p2743=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2741=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(atpose chicken-leg p2740=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p2739=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p2744=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn1633=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1632=1.872)
	(isopenedposition fridge#1::fridge_door pstn1634=1.78)
	...
	(contained salt-shaker p2743=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2744=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2742=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2741=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418) counter#1::front_left_stove)
