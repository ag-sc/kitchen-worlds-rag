...
(define
  (problem test_kitchen_chicken_soup_250904_235212_seed_243003)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn18695=1.78)
	(position faucet#1::joint_faucet_0 pstn18698=0.0)
	(position counter#1::chewie_door_right_joint pstn18693=1.872)
	(position counter#1::chewie_door_left_joint pstn18694=-1.872)
	(position oven#1::knob_joint_3 pstn18697=0.0)
	(position oven#1::knob_joint_2 pstn18696=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn18697=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18696=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn18698=0.0)

	(atposition counter#1::chewie_door_left_joint pstn18694=-1.872)
	(atposition oven#1::knob_joint_2 pstn18696=0.0)
	(atposition oven#1::knob_joint_3 pstn18697=0.0)
	(atposition faucet#1::joint_faucet_0 pstn18698=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18693=1.872)
	(atposition fridge#1::fridge_door pstn18695=1.78)

	(pose chicken-leg p65807=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p65810=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p65806=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p65808=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(pose pepper-shaker p65811=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p65810=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p65807=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p65808=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(atpose braiserbody#1 p65806=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p65811=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq816=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn18694=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn18693=1.872)
	(isopenedposition fridge#1::fridge_door pstn18695=1.78)

	(ataconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq816=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p65810=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p65811=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p65808=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274) counter#1::front_left_stove)
	(supported braiserbody#1 p65809=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
