...
(define
  (problem test_kitchen_chicken_soup_250905_022005_seed_316464)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p348=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p350=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))

	(atpose chicken-leg p349=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p353=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p348=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p350=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	...
	(supported braiserlid#1 p350=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765) counter#1::front_left_stove)
	(supported braiserbody#1 p351=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
