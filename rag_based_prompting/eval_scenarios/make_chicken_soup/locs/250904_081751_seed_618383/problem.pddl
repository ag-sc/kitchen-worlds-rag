...
(define
  (problem test_kitchen_chicken_soup_250904_081751_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn17905=1.78)
	(position counter#1::chewie_door_left_joint pstn17904=-1.872)
	(position counter#1::chewie_door_right_joint pstn17903=1.872)
	(position oven#1::knob_joint_3 pstn17907=0.0)
	(position oven#1::knob_joint_2 pstn17906=0.0)
	(position faucet#1::joint_faucet_0 pstn17908=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn17907=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17906=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17908=0.0)

	(isopenedposition fridge#1::fridge_door pstn17905=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn17904=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn17903=1.872)

	(atposition counter#1::chewie_door_left_joint pstn17904=-1.872)
	(atposition oven#1::knob_joint_2 pstn17906=0.0)
	(atposition oven#1::knob_joint_3 pstn17907=0.0)
	(atposition faucet#1::joint_faucet_0 pstn17908=0.0)
	(atposition fridge#1::fridge_door pstn17905=1.78)
	(atposition counter#1::chewie_door_right_joint pstn17903=1.872)

	(pose salt-shaker p47332=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p47329=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p47328=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p47330=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(pose pepper-shaker p47333=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p47329=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p47328=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p47332=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p47330=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(atpose pepper-shaker p47333=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(supported braiserbody#1 p47331=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p47330=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)

	(contained pepper-shaker p47333=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p47332=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
