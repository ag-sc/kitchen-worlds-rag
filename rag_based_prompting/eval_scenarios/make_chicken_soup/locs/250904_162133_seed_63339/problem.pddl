...
(define
  (problem test_kitchen_chicken_soup_250904_162133_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn9633=1.78)
	(atposition oven#1::knob_joint_2 pstn9634=0.0)
	(atposition counter#1::chewie_door_right_joint pstn9631=1.872)
	(atposition oven#1::knob_joint_3 pstn9635=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9632=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn9636=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn9634=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9636=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9635=0.0)

	(position counter#1::chewie_door_right_joint pstn9631=1.872)
	(position counter#1::chewie_door_left_joint pstn9632=-1.872)
	(position fridge#1::fridge_door pstn9633=1.78)
	(position oven#1::knob_joint_3 pstn9635=0.0)
	(position faucet#1::joint_faucet_0 pstn9636=0.0)
	(position oven#1::knob_joint_2 pstn9634=0.0)

	(pose chicken-leg p36917=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p36916=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p36921=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p36918=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose salt-shaker p36920=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p36916=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p36917=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p36921=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p36920=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p36918=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))

	(isopenedposition counter#1::chewie_door_right_joint pstn9631=1.872)
	(isopenedposition fridge#1::fridge_door pstn9633=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn9632=-1.872)
	...
	(contained pepper-shaker p36921=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p36920=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p36918=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
	(supported braiserbody#1 p36919=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
