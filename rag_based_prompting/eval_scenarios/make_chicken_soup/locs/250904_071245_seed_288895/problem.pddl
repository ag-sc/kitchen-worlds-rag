...
(define
  (problem test_kitchen_chicken_soup_250904_071245_seed_288895)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn15479=0.0)
	(atposition fridge#1::fridge_door pstn15478=1.78)
	(atposition counter#1::chewie_door_left_joint pstn15477=-1.872)
	(atposition oven#1::knob_joint_3 pstn15480=0.0)
	(atposition faucet#1::joint_faucet_0 pstn15481=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15476=1.872)
	(position fridge#1::fridge_door pstn15478=1.78)
	(position counter#1::chewie_door_right_joint pstn15476=1.872)
	(position oven#1::knob_joint_2 pstn15479=0.0)
	(position counter#1::chewie_door_left_joint pstn15477=-1.872)
	(position oven#1::knob_joint_3 pstn15480=0.0)
	(position faucet#1::joint_faucet_0 pstn15481=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15480=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15481=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15479=0.0)

	(pose braiserbody#1 p41432=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p41437=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p41436=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p41433=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p41434=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))

	(ataconf left aq0=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p41437=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p41436=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p41434=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(atpose chicken-leg p41433=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p41432=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn15477=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15478=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn15476=1.872)

	(aconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(aconf left aq0=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p41437=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p41436=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p41434=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247) counter#1::front_left_stove)
	(supported braiserbody#1 p41435=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
