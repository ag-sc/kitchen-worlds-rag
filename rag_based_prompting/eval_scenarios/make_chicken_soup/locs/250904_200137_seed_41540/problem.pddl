...
(define
  (problem test_kitchen_chicken_soup_250904_200137_seed_41540)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn13718=0.0)
	(atposition faucet#1::joint_faucet_0 pstn13720=0.0)
	(atposition counter#1::chewie_door_left_joint pstn13716=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn13715=1.872)
	(atposition oven#1::knob_joint_3 pstn13719=0.0)
	(atposition fridge#1::fridge_door pstn13717=1.78)
	(position fridge#1::fridge_door pstn13717=1.78)
	(position oven#1::knob_joint_2 pstn13718=0.0)
	(position oven#1::knob_joint_3 pstn13719=0.0)
	(position faucet#1::joint_faucet_0 pstn13720=0.0)
	(position counter#1::chewie_door_left_joint pstn13716=-1.872)
	(position counter#1::chewie_door_right_joint pstn13715=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn13718=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13720=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13719=0.0)

	(pose braiserlid#1 p53124=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(pose pepper-shaker p53127=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p53122=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p53126=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p53123=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p53124=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(atpose pepper-shaker p53127=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p53123=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p53122=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p53126=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn13716=-1.872)
	(isopenedposition fridge#1::fridge_door pstn13717=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn13715=1.872)
	...
	(contained pepper-shaker p53127=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p53126=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p53124=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584) counter#1::front_left_stove)
	(supported braiserbody#1 p53125=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
