...
(define
  (problem test_kitchen_chicken_soup_250903_122443_seed_149466)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn16055=0.0)
	(position fridge#1::fridge_door pstn16053=1.78)
	(position oven#1::knob_joint_2 pstn16054=0.0)
	(position counter#1::chewie_door_left_joint pstn16052=-1.872)
	(position faucet#1::joint_faucet_0 pstn16056=0.0)
	(position counter#1::chewie_door_right_joint pstn16051=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn16056=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16054=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16055=0.0)

	(atposition counter#1::chewie_door_right_joint pstn16051=1.872)
	(atposition fridge#1::fridge_door pstn16053=1.78)
	(atposition oven#1::knob_joint_3 pstn16055=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16052=-1.872)
	(atposition oven#1::knob_joint_2 pstn16054=0.0)
	(atposition faucet#1::joint_faucet_0 pstn16056=0.0)

	(pose braiserbody#1 p36882=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p36883=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p36886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p36887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p36884=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))

	(aconf left aq88=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq896=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(atpose pepper-shaker p36887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p36884=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(atpose chicken-leg p36883=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p36886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p36882=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn16051=1.872)
	(isopenedposition fridge#1::fridge_door pstn16053=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn16052=-1.872)

	(ataconf left aq88=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq896=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p36887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p36886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p36884=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9) counter#1::front_left_stove)
	(supported braiserbody#1 p36885=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
