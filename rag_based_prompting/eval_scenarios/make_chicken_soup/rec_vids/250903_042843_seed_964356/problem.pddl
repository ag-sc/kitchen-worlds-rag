...
(define
  (problem test_kitchen_chicken_soup_250903_042843_seed_964356)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn434=0.0)
	(position oven#1::knob_joint_3 pstn433=0.0)
	(position fridge#1::fridge_door pstn431=1.78)
	(position oven#1::knob_joint_2 pstn432=0.0)
	(position counter#1::chewie_door_left_joint pstn430=-1.872)
	(position counter#1::chewie_door_right_joint pstn429=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn431=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn429=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn430=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn434=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn433=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn432=0.0)

	(atposition counter#1::chewie_door_left_joint pstn430=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn429=1.872)
	(atposition faucet#1::joint_faucet_0 pstn434=0.0)
	(atposition oven#1::knob_joint_3 pstn433=0.0)
	(atposition fridge#1::fridge_door pstn431=1.78)
	(atposition oven#1::knob_joint_2 pstn432=0.0)

	(pose salt-shaker p3530=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p3528=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318))
	(pose chicken-leg p3527=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p3531=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3526=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p3527=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p3526=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p3528=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318))
	(atpose salt-shaker p3530=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p3531=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p3531=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3530=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p3528=(0.567, 7.872, 0.712, 0.0, -0.0, 1.318) counter#1::front_left_stove)
	(supported braiserbody#1 p3529=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
