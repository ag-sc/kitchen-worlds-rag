...
(define
  (problem test_kitchen_chicken_soup_250902_100421_seed_452363)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn2539=1.78)
	(position oven#1::knob_joint_3 pstn2541=0.0)
	(position oven#1::knob_joint_2 pstn2540=0.0)
	(position faucet#1::joint_faucet_0 pstn2542=0.0)
	(position counter#1::chewie_door_left_joint pstn2538=-1.872)
	(position counter#1::chewie_door_right_joint pstn2537=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn2541=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2542=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2540=0.0)

	(isopenedposition fridge#1::fridge_door pstn2539=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2538=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2537=1.872)
	...
	(atposition counter#1::chewie_door_left_joint pstn2538=-1.872)
	(atposition oven#1::knob_joint_3 pstn2541=0.0)
	(atposition faucet#1::joint_faucet_0 pstn2542=0.0)
	(atposition oven#1::knob_joint_2 pstn2540=0.0)
	(atposition fridge#1::fridge_door pstn2539=1.78)
	(atposition counter#1::chewie_door_right_joint pstn2537=1.872)

	(pose chicken-leg p5100=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p5099=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5104=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p5103=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p5101=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))

	(atpose braiserbody#1 p5099=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p5104=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p5100=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p5101=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))
	(atpose salt-shaker p5103=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p5103=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p5104=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p5101=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252) counter#1::front_left_stove)
	(supported braiserbody#1 p5102=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
