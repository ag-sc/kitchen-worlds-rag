...
(define
  (problem test_kitchen_chicken_soup_250903_051733_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p9053=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p9051=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(pose braiserbody#1 p9049=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p9054=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p9050=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p9051=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(atpose salt-shaker p9053=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p9054=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p9049=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p9050=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p9053=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p9054=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p9051=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
	(supported braiserbody#1 p9052=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
