...
(define
  (problem test_kitchen_chicken_soup_250904_011507_seed_844870)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn12827=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12825=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12826=0.0)

	(position counter#1::chewie_door_left_joint pstn12823=-1.872)
	(position fridge#1::fridge_door pstn12824=1.78)
	(position faucet#1::joint_faucet_0 pstn12827=0.0)
	(position counter#1::chewie_door_right_joint pstn12822=1.872)
	(position oven#1::knob_joint_2 pstn12825=0.0)
	(position oven#1::knob_joint_3 pstn12826=0.0)

	(atposition counter#1::chewie_door_left_joint pstn12823=-1.872)
	(atposition fridge#1::fridge_door pstn12824=1.78)
	(atposition counter#1::chewie_door_right_joint pstn12822=1.872)
	(atposition faucet#1::joint_faucet_0 pstn12827=0.0)
	(atposition oven#1::knob_joint_3 pstn12826=0.0)
	(atposition oven#1::knob_joint_2 pstn12825=0.0)

	(pose braiserbody#1 p33138=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p33142=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p33139=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p33140=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683))
	(pose pepper-shaker p33143=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq952=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq336=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p33143=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p33139=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p33138=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p33142=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p33140=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683))
	(isopenedposition counter#1::chewie_door_left_joint pstn12823=-1.872)
	(isopenedposition fridge#1::fridge_door pstn12824=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12822=1.872)

	(ataconf right aq336=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq952=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p33142=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p33143=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p33140=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683) counter#1::front_left_stove)
	(supported braiserbody#1 p33141=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
