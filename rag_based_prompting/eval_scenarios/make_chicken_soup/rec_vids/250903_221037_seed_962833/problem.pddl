...
(define
  (problem test_kitchen_chicken_soup_250903_221037_seed_962833)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn5478=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5476=-1.872)
	(atposition fridge#1::fridge_door pstn5477=1.78)
	(atposition counter#1::chewie_door_right_joint pstn5475=1.872)
	(atposition faucet#1::joint_faucet_0 pstn5480=0.0)
	(atposition oven#1::knob_joint_3 pstn5479=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn5478=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5480=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5479=0.0)

	(position counter#1::chewie_door_right_joint pstn5475=1.872)
	(position oven#1::knob_joint_2 pstn5478=0.0)
	(position faucet#1::joint_faucet_0 pstn5480=0.0)
	(position oven#1::knob_joint_3 pstn5479=0.0)
	(position fridge#1::fridge_door pstn5477=1.78)
	(position counter#1::chewie_door_left_joint pstn5476=-1.872)

	(pose braiserbody#1 p14068=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p14072=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p14069=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p14073=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p14070=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))

	(isopenedposition counter#1::chewie_door_right_joint pstn5475=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5476=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5477=1.78)

	(atpose pepper-shaker p14073=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p14072=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p14070=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(atpose braiserbody#1 p14068=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p14069=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p14073=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p14072=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14070=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928) counter#1::front_left_stove)
	(supported braiserbody#1 p14071=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
