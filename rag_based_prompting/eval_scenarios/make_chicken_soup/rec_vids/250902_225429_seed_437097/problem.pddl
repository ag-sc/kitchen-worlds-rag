...
(define
  (problem test_kitchen_chicken_soup_250902_225429_seed_437097)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn24482=0.0)
	(atposition counter#1::chewie_door_right_joint pstn24478=1.872)
	(atposition fridge#1::fridge_door pstn24480=1.78)
	(atposition oven#1::knob_joint_2 pstn24481=0.0)
	(atposition faucet#1::joint_faucet_0 pstn24483=0.0)
	(atposition counter#1::chewie_door_left_joint pstn24479=-1.872)
	(position fridge#1::fridge_door pstn24480=1.78)
	(position counter#1::chewie_door_right_joint pstn24478=1.872)
	(position oven#1::knob_joint_3 pstn24482=0.0)
	(position oven#1::knob_joint_2 pstn24481=0.0)
	(position counter#1::chewie_door_left_joint pstn24479=-1.872)
	(position faucet#1::joint_faucet_0 pstn24483=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn24482=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24481=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24483=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn24480=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn24478=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn24479=-1.872)

	(pose braiserlid#1 p52950=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(pose pepper-shaker p52953=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p52949=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p52948=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p52952=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p52950=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(atpose pepper-shaker p52953=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p52948=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p52949=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p52952=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p52953=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p52952=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p52951=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p52950=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96) counter#1::front_left_stove)
