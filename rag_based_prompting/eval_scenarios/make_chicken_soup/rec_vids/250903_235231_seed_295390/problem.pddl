...
(define
  (problem test_kitchen_chicken_soup_250903_235231_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn10069=0.0)
	(position counter#1::chewie_door_left_joint pstn10066=-1.872)
	(position faucet#1::joint_faucet_0 pstn10070=0.0)
	(position fridge#1::fridge_door pstn10067=1.78)
	(position oven#1::knob_joint_2 pstn10068=0.0)
	(position counter#1::chewie_door_right_joint pstn10065=1.872)
	...
	(atposition oven#1::knob_joint_3 pstn10069=0.0)
	(atposition fridge#1::fridge_door pstn10067=1.78)
	(atposition faucet#1::joint_faucet_0 pstn10070=0.0)
	(atposition oven#1::knob_joint_2 pstn10068=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10065=1.872)
	(atposition counter#1::chewie_door_left_joint pstn10066=-1.872)

	(isclosedposition oven#1::knob_joint_3 pstn10069=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10070=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10068=0.0)

	(pose braiserlid#1 p25686=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(pose pepper-shaker p25689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p25688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p25685=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p25684=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p25688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p25689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p25685=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p25686=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(atpose braiserbody#1 p25684=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq520=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq96=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn10065=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn10066=-1.872)
	(isopenedposition fridge#1::fridge_door pstn10067=1.78)

	(ataconf left aq520=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq96=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p25688=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p25689=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p25686=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
	(supported braiserbody#1 p25687=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
