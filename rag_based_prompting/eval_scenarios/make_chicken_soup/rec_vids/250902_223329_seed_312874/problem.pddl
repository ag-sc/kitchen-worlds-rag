...
(define
  (problem test_kitchen_chicken_soup_250902_223329_seed_312874)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn24246=0.0)
	(position fridge#1::fridge_door pstn24244=1.78)
	(position oven#1::knob_joint_2 pstn24245=0.0)
	(position faucet#1::joint_faucet_0 pstn24247=0.0)
	(position counter#1::chewie_door_left_joint pstn24243=-1.872)
	(position counter#1::chewie_door_right_joint pstn24242=1.872)
	...
	(atposition oven#1::knob_joint_3 pstn24246=0.0)
	(atposition counter#1::chewie_door_left_joint pstn24243=-1.872)
	(atposition oven#1::knob_joint_2 pstn24245=0.0)
	(atposition faucet#1::joint_faucet_0 pstn24247=0.0)
	(atposition fridge#1::fridge_door pstn24244=1.78)
	(atposition counter#1::chewie_door_right_joint pstn24242=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn24245=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24247=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24246=0.0)
	...
	(pose pepper-shaker p51638=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p51635=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(pose chicken-leg p51634=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p51633=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p51637=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq704=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq536=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p51638=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p51635=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(atpose braiserbody#1 p51633=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p51634=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p51637=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn24242=1.872)
	(isopenedposition fridge#1::fridge_door pstn24244=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn24243=-1.872)

	(ataconf left aq704=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq536=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p51638=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p51637=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p51636=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p51635=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441) counter#1::front_left_stove)
