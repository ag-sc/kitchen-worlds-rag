...
(define
  (problem test_kitchen_chicken_soup_250902_120841_seed_768932)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn8130=1.78)
	(atposition oven#1::knob_joint_2 pstn8131=0.0)
	(atposition oven#1::knob_joint_3 pstn8132=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8133=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8128=1.872)
	(atposition counter#1::chewie_door_left_joint pstn8129=-1.872)

	(isopenedposition fridge#1::fridge_door pstn8130=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8129=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn8128=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn8133=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8131=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8132=0.0)

	(position counter#1::chewie_door_right_joint pstn8128=1.872)
	(position oven#1::knob_joint_3 pstn8132=0.0)
	(position faucet#1::joint_faucet_0 pstn8133=0.0)
	(position oven#1::knob_joint_2 pstn8131=0.0)
	(position fridge#1::fridge_door pstn8130=1.78)
	(position counter#1::chewie_door_left_joint pstn8129=-1.872)

	(pose braiserbody#1 p12004=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p12008=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p12005=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p12006=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))
	(pose pepper-shaker p12009=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p12004=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p12006=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))
	(atpose pepper-shaker p12009=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p12005=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p12008=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p12008=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12009=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p12007=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p12006=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469) counter#1::front_left_stove)
