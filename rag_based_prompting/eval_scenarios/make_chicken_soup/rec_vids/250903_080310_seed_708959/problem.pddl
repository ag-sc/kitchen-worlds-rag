...
(define
  (problem test_kitchen_chicken_soup_250903_080310_seed_708959)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn6307=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6303=-1.872)
	(atposition oven#1::knob_joint_3 pstn6306=0.0)
	(atposition fridge#1::fridge_door pstn6304=1.78)
	(atposition counter#1::chewie_door_right_joint pstn6302=1.872)
	(atposition oven#1::knob_joint_2 pstn6305=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn6307=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6305=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6306=0.0)

	(position counter#1::chewie_door_right_joint pstn6302=1.872)
	(position oven#1::knob_joint_2 pstn6305=0.0)
	(position faucet#1::joint_faucet_0 pstn6307=0.0)
	(position fridge#1::fridge_door pstn6304=1.78)
	(position counter#1::chewie_door_left_joint pstn6303=-1.872)
	(position oven#1::knob_joint_3 pstn6306=0.0)

	(pose salt-shaker p22581=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p22578=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p22579=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(pose braiserbody#1 p22577=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p22582=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn6302=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn6303=-1.872)
	(isopenedposition fridge#1::fridge_door pstn6304=1.78)

	(atpose pepper-shaker p22582=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p22577=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p22579=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(atpose salt-shaker p22581=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p22578=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p22582=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p22581=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p22579=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278) counter#1::front_left_stove)
	(supported braiserbody#1 p22580=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
