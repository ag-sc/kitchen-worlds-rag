...
(define
  (problem test_kitchen_chicken_soup_250903_062713_seed_25586)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn3835=1.78)
	(atposition faucet#1::joint_faucet_0 pstn3838=0.0)
	(atposition oven#1::knob_joint_3 pstn3837=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3834=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn3833=1.872)

	(position faucet#1::joint_faucet_0 pstn3838=0.0)
	(position oven#1::knob_joint_3 pstn3837=0.0)
	(position counter#1::chewie_door_left_joint pstn3834=-1.872)
	(position counter#1::chewie_door_right_joint pstn3833=1.872)
	(position fridge#1::fridge_door pstn3835=1.78)
	...
	(pose braiserlid#1 p13178=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(pose pepper-shaker p13181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p13180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p13177=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p13176=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p13180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p13177=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p13176=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p13181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p13178=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))

	(isopenedposition counter#1::chewie_door_left_joint pstn3834=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn3833=1.872)
	(isopenedposition fridge#1::fridge_door pstn3835=1.78)
	...
	(contained pepper-shaker p13181=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p13180=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13179=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13178=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973) counter#1::front_left_stove)
