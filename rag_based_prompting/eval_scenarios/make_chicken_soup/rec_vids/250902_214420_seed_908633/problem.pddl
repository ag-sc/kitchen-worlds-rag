...
(define
  (problem test_kitchen_chicken_soup_250902_214420_seed_908633)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn23768=0.0)
	(position counter#1::chewie_door_right_joint pstn23764=1.872)
	(position oven#1::knob_joint_2 pstn23767=0.0)
	(position faucet#1::joint_faucet_0 pstn23769=0.0)
	(position fridge#1::fridge_door pstn23766=1.78)
	(position counter#1::chewie_door_left_joint pstn23765=-1.872)
	...
	(atposition fridge#1::fridge_door pstn23766=1.78)
	(atposition counter#1::chewie_door_right_joint pstn23764=1.872)
	(atposition oven#1::knob_joint_2 pstn23767=0.0)
	(atposition counter#1::chewie_door_left_joint pstn23765=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn23769=0.0)
	(atposition oven#1::knob_joint_3 pstn23768=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn23767=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn23769=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn23768=0.0)
	...
	(atpose salt-shaker p48009=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p48010=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p48005=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p48007=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944))
	(atpose chicken-leg p48006=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p48010=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p48005=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p48006=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p48007=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944))
	(pose salt-shaker p48009=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq232=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq608=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn23764=1.872)
	(isopenedposition fridge#1::fridge_door pstn23766=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn23765=-1.872)

	(ataconf right aq608=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq232=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p48010=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p48009=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p48007=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944) counter#1::front_left_stove)
	(supported braiserbody#1 p48008=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
