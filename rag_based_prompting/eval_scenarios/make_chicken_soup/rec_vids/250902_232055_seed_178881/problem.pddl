...
(define
  (problem test_kitchen_chicken_soup_250902_232055_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn24712=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn24713=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24711=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn24709=-1.872)
	(position counter#1::chewie_door_right_joint pstn24708=1.872)
	(position faucet#1::joint_faucet_0 pstn24713=0.0)
	(position oven#1::knob_joint_3 pstn24712=0.0)
	(position fridge#1::fridge_door pstn24710=1.78)
	(position oven#1::knob_joint_2 pstn24711=0.0)

	(atposition counter#1::chewie_door_right_joint pstn24708=1.872)
	(atposition counter#1::chewie_door_left_joint pstn24709=-1.872)
	(atposition oven#1::knob_joint_3 pstn24712=0.0)
	(atposition faucet#1::joint_faucet_0 pstn24713=0.0)
	(atposition oven#1::knob_joint_2 pstn24711=0.0)
	(atposition fridge#1::fridge_door pstn24710=1.78)

	(pose chicken-leg p55250=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p55249=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p55253=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p55254=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p55251=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(atpose braiserbody#1 p55249=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p55250=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p55253=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p55254=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p55251=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(aconf left aq144=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq232=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn24708=1.872)
	(isopenedposition fridge#1::fridge_door pstn24710=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn24709=-1.872)

	(ataconf right aq232=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq144=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p55254=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p55253=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p55252=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p55251=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
