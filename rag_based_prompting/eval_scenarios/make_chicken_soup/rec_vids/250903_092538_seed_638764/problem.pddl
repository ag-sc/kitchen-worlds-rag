...
(define
  (problem test_kitchen_chicken_soup_250903_092538_seed_638764)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn10179=0.0)
	(atposition oven#1::knob_joint_3 pstn10180=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10176=1.872)
	(atposition counter#1::chewie_door_left_joint pstn10177=-1.872)
	(atposition fridge#1::fridge_door pstn10178=1.78)
	(atposition faucet#1::joint_faucet_0 pstn10181=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn10181=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10179=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10180=0.0)

	(position counter#1::chewie_door_right_joint pstn10176=1.872)
	(position oven#1::knob_joint_2 pstn10179=0.0)
	(position counter#1::chewie_door_left_joint pstn10177=-1.872)
	(position fridge#1::fridge_door pstn10178=1.78)
	(position faucet#1::joint_faucet_0 pstn10181=0.0)
	(position oven#1::knob_joint_3 pstn10180=0.0)

	(pose braiserbody#1 p25804=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p25805=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p25808=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p25809=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p25806=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827))

	(atpose salt-shaker p25808=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p25809=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p25804=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p25806=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827))
	(atpose chicken-leg p25805=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq848=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq288=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn10177=-1.872)
	(isopenedposition fridge#1::fridge_door pstn10178=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn10176=1.872)

	(ataconf left aq848=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq288=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p25809=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p25808=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p25806=(0.567, 7.872, 0.712, 0.0, -0.0, 0.827) counter#1::front_left_stove)
	(supported braiserbody#1 p25807=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
