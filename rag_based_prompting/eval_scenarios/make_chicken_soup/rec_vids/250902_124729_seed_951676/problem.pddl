...
(define
  (problem test_kitchen_chicken_soup_250902_124729_seed_951676)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn8605=0.0)
	(atposition fridge#1::fridge_door pstn8602=1.78)
	(atposition counter#1::chewie_door_left_joint pstn8601=-1.872)
	(atposition oven#1::knob_joint_3 pstn8604=0.0)
	(atposition oven#1::knob_joint_2 pstn8603=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8600=1.872)

	(isopenedposition fridge#1::fridge_door pstn8602=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8601=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn8600=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn8605=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8604=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8603=0.0)

	(position counter#1::chewie_door_left_joint pstn8601=-1.872)
	(position faucet#1::joint_faucet_0 pstn8605=0.0)
	(position oven#1::knob_joint_2 pstn8603=0.0)
	(position oven#1::knob_joint_3 pstn8604=0.0)
	(position counter#1::chewie_door_right_joint pstn8600=1.872)
	(position fridge#1::fridge_door pstn8602=1.78)

	(pose salt-shaker p15661=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p15658=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p15657=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p15659=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(pose pepper-shaker p15662=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p15657=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p15661=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p15658=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p15659=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625))
	(atpose pepper-shaker p15662=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p15662=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p15661=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p15659=(0.567, 7.872, 0.712, 0.0, -0.0, 1.625) counter#1::front_left_stove)
	(supported braiserbody#1 p15660=(0.7, 8.783, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
