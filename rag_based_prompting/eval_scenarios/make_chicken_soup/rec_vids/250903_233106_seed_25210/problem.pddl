...
(define
  (problem test_kitchen_chicken_soup_250903_233106_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn9464=1.78)
	(position counter#1::chewie_door_left_joint pstn9463=-1.872)
	(position oven#1::knob_joint_3 pstn9466=0.0)
	(position faucet#1::joint_faucet_0 pstn9467=0.0)
	(position counter#1::chewie_door_right_joint pstn9462=1.872)
	(position oven#1::knob_joint_2 pstn9465=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn9465=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9466=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9467=0.0)

	(atposition counter#1::chewie_door_left_joint pstn9463=-1.872)
	(atposition fridge#1::fridge_door pstn9464=1.78)
	(atposition oven#1::knob_joint_3 pstn9466=0.0)
	(atposition counter#1::chewie_door_right_joint pstn9462=1.872)
	(atposition oven#1::knob_joint_2 pstn9465=0.0)
	(atposition faucet#1::joint_faucet_0 pstn9467=0.0)

	(pose braiserbody#1 p22038=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p22040=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(pose salt-shaker p22042=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p22039=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p22043=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p22042=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p22039=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p22038=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p22043=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p22040=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))

	(isopenedposition counter#1::chewie_door_right_joint pstn9462=1.872)
	(isopenedposition fridge#1::fridge_door pstn9464=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn9463=-1.872)
	...
	(contained pepper-shaker p22043=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p22042=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p22041=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p22040=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
