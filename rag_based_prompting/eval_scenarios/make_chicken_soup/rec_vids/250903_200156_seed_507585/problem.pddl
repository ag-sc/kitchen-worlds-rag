...
(define
  (problem test_kitchen_chicken_soup_250903_200156_seed_507585)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn1442=1.78)
	(position oven#1::knob_joint_3 pstn1444=0.0)
	(position counter#1::chewie_door_left_joint pstn1441=-1.872)
	(position oven#1::knob_joint_2 pstn1443=0.0)
	(position counter#1::chewie_door_right_joint pstn1440=1.872)
	(position faucet#1::joint_faucet_0 pstn1445=0.0)

	(atposition faucet#1::joint_faucet_0 pstn1445=0.0)
	(atposition oven#1::knob_joint_3 pstn1444=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1441=-1.872)
	(atposition oven#1::knob_joint_2 pstn1443=0.0)
	(atposition fridge#1::fridge_door pstn1442=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1440=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn1444=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1445=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1443=0.0)

	(isopenedposition fridge#1::fridge_door pstn1442=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1440=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1441=-1.872)

	(pose braiserbody#1 p4531=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p4533=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(pose chicken-leg p4532=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p4535=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p4536=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p4533=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(atpose salt-shaker p4535=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p4532=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p4531=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p4536=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p4535=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p4536=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4533=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39) counter#1::front_left_stove)
	(supported braiserbody#1 p4534=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
