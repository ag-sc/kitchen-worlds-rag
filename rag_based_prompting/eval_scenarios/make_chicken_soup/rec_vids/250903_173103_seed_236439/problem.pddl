...
(define
  (problem test_kitchen_chicken_soup_250903_173103_seed_236439)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn24958=0.0)
	(atposition fridge#1::fridge_door pstn24957=1.78)
	(atposition faucet#1::joint_faucet_0 pstn24960=0.0)
	(atposition counter#1::chewie_door_left_joint pstn24956=-1.872)
	(atposition oven#1::knob_joint_3 pstn24959=0.0)
	(atposition counter#1::chewie_door_right_joint pstn24955=1.872)

	(position faucet#1::joint_faucet_0 pstn24960=0.0)
	(position counter#1::chewie_door_left_joint pstn24956=-1.872)
	(position oven#1::knob_joint_3 pstn24959=0.0)
	(position counter#1::chewie_door_right_joint pstn24955=1.872)
	(position fridge#1::fridge_door pstn24957=1.78)
	(position oven#1::knob_joint_2 pstn24958=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn24960=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24959=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24958=0.0)

	(pose pepper-shaker p57278=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p57277=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p57273=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p57275=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024))
	(pose chicken-leg p57274=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq920=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq824=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p57278=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p57274=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p57275=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024))
	(atpose braiserbody#1 p57273=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p57277=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_left_joint pstn24956=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn24955=1.872)
	(isopenedposition fridge#1::fridge_door pstn24957=1.78)

	(ataconf left aq920=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq824=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p57278=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p57277=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p57275=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024) counter#1::front_left_stove)
	(supported braiserbody#1 p57276=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
