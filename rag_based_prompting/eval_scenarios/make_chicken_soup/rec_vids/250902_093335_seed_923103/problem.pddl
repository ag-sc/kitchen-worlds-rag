...
(define
  (problem test_kitchen_chicken_soup_250902_093335_seed_923103)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn1391=0.0)
	(position fridge#1::fridge_door pstn1388=1.78)
	(position oven#1::knob_joint_2 pstn1389=0.0)
	(position counter#1::chewie_door_right_joint pstn1386=1.872)
	(position oven#1::knob_joint_3 pstn1390=0.0)
	(position counter#1::chewie_door_left_joint pstn1387=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn1389=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1390=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1391=0.0)

	(isopenedposition fridge#1::fridge_door pstn1388=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1387=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1386=1.872)
	...
	(atposition counter#1::chewie_door_left_joint pstn1387=-1.872)
	(atposition fridge#1::fridge_door pstn1388=1.78)
	(atposition oven#1::knob_joint_3 pstn1390=0.0)
	(atposition oven#1::knob_joint_2 pstn1389=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1391=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1386=1.872)

	(pose braiserlid#1 p3230=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(pose salt-shaker p3232=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3228=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p3233=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p3229=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p3230=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(atpose braiserbody#1 p3228=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p3229=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p3232=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p3233=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p3232=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3233=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p3230=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097) counter#1::front_left_stove)
	(supported braiserbody#1 p3231=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
