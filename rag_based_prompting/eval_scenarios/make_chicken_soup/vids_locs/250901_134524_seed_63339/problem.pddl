...
(define
  (problem test_kitchen_chicken_soup_250901_134524_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn7211=0.0)
	(position oven#1::knob_joint_2 pstn7210=0.0)
	(position counter#1::chewie_door_left_joint pstn7208=-1.872)
	(position counter#1::chewie_door_right_joint pstn7207=1.872)
	(position fridge#1::fridge_door pstn7209=1.78)
	(position faucet#1::joint_faucet_0 pstn7212=0.0)

	(atposition oven#1::knob_joint_2 pstn7210=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7207=1.872)
	(atposition fridge#1::fridge_door pstn7209=1.78)
	(atposition faucet#1::joint_faucet_0 pstn7212=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7208=-1.872)
	(atposition oven#1::knob_joint_3 pstn7211=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn7212=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7210=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7211=0.0)

	(pose chicken-leg p23803=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p23804=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose salt-shaker p23806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p23802=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p23807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p23806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p23804=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(atpose pepper-shaker p23807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p23802=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p23803=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq64=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq200=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn7207=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn7208=-1.872)
	(isopenedposition fridge#1::fridge_door pstn7209=1.78)

	(ataconf left aq64=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq200=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p23807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p23804=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
	(supported braiserbody#1 p23805=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
