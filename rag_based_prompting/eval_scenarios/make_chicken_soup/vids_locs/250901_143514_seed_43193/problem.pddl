...
(define
  (problem test_kitchen_chicken_soup_250901_143514_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn8837=0.0)
	(position fridge#1::fridge_door pstn8835=1.78)
	(position counter#1::chewie_door_left_joint pstn8834=-1.872)
	(position faucet#1::joint_faucet_0 pstn8838=0.0)
	(position counter#1::chewie_door_right_joint pstn8833=1.872)
	(position oven#1::knob_joint_2 pstn8836=0.0)

	(atposition oven#1::knob_joint_3 pstn8837=0.0)
	(atposition fridge#1::fridge_door pstn8835=1.78)
	(atposition counter#1::chewie_door_left_joint pstn8834=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn8838=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8833=1.872)
	(atposition oven#1::knob_joint_2 pstn8836=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn8837=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8838=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8836=0.0)
	...
	(pose chicken-leg p26536=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p26539=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p26535=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p26537=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(pose pepper-shaker p26540=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p26539=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p26537=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(atpose chicken-leg p26536=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p26540=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p26535=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn8833=1.872)
	(isopenedposition fridge#1::fridge_door pstn8835=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8834=-1.872)
	...
	(contained salt-shaker p26539=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p26540=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p26538=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p26537=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
