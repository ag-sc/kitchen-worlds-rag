...
(define
  (problem test_kitchen_chicken_soup_250901_202421_seed_243003)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn16030=0.0)
	(atposition counter#1::chewie_door_right_joint pstn16027=1.872)
	(atposition fridge#1::fridge_door pstn16029=1.78)
	(atposition faucet#1::joint_faucet_0 pstn16032=0.0)
	(atposition oven#1::knob_joint_3 pstn16031=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16028=-1.872)

	(position faucet#1::joint_faucet_0 pstn16032=0.0)
	(position counter#1::chewie_door_left_joint pstn16028=-1.872)
	(position oven#1::knob_joint_2 pstn16030=0.0)
	(position counter#1::chewie_door_right_joint pstn16027=1.872)
	(position fridge#1::fridge_door pstn16029=1.78)
	(position oven#1::knob_joint_3 pstn16031=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn16032=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16031=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16030=0.0)

	(pose braiserbody#1 p58298=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p58303=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p58300=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(pose chicken-leg p58299=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p58302=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p58299=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p58300=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(atpose braiserbody#1 p58298=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p58302=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p58303=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq760=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq848=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn16028=-1.872)
	(isopenedposition fridge#1::fridge_door pstn16029=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16027=1.872)

	(ataconf left aq760=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq848=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(supported braiserbody#1 p58301=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p58300=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274) counter#1::front_left_stove)

	(contained pepper-shaker p58303=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p58302=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
