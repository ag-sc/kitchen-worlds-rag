...
(define
  (problem test_kitchen_chicken_soup_250901_124042_seed_236356)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn5953=0.0)
	(position fridge#1::fridge_door pstn5950=1.78)
	(position counter#1::chewie_door_left_joint pstn5949=-1.872)
	(position oven#1::knob_joint_2 pstn5951=0.0)
	(position counter#1::chewie_door_right_joint pstn5948=1.872)
	(position oven#1::knob_joint_3 pstn5952=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn5951=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5952=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5953=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn5949=-1.872)
	(atposition oven#1::knob_joint_2 pstn5951=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5948=1.872)
	(atposition oven#1::knob_joint_3 pstn5952=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5953=0.0)
	(atposition fridge#1::fridge_door pstn5950=1.78)

	(atpose braiserbody#1 p16639=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p16640=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p16641=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))
	(atpose salt-shaker p16643=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p16644=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p16644=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p16639=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p16641=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))
	(pose chicken-leg p16640=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p16643=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn5948=1.872)
	(isopenedposition fridge#1::fridge_door pstn5950=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5949=-1.872)
	...
	(contained salt-shaker p16643=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p16644=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p16642=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p16641=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647) counter#1::front_left_stove)
