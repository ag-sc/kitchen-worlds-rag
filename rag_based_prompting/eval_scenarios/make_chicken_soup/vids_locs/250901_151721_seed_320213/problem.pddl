...
(define
  (problem test_kitchen_chicken_soup_250901_151721_seed_320213)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn9694=0.0)
	(position counter#1::chewie_door_right_joint pstn9690=1.872)
	(position oven#1::knob_joint_2 pstn9693=0.0)
	(position counter#1::chewie_door_left_joint pstn9691=-1.872)
	(position faucet#1::joint_faucet_0 pstn9695=0.0)
	(position fridge#1::fridge_door pstn9692=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn9695=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9693=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9694=0.0)

	(atposition counter#1::chewie_door_right_joint pstn9690=1.872)
	(atposition counter#1::chewie_door_left_joint pstn9691=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn9695=0.0)
	(atposition fridge#1::fridge_door pstn9692=1.78)
	(atposition oven#1::knob_joint_3 pstn9694=0.0)
	(atposition oven#1::knob_joint_2 pstn9693=0.0)

	(pose pepper-shaker p31211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p31208=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(pose chicken-leg p31207=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p31206=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p31210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn9691=-1.872)
	(isopenedposition fridge#1::fridge_door pstn9692=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn9690=1.872)

	(aconf left aq648=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq40=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p31211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p31207=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p31210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p31208=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(atpose braiserbody#1 p31206=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))

	(ataconf left aq648=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq40=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p31210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p31211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p31209=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p31208=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62) counter#1::front_left_stove)
