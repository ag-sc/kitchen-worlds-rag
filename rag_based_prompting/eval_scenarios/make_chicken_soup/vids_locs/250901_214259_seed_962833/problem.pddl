...
(define
  (problem test_kitchen_chicken_soup_250901_214259_seed_962833)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn17751=0.0)
	(atposition counter#1::chewie_door_right_joint pstn17747=1.872)
	(atposition oven#1::knob_joint_2 pstn17750=0.0)
	(atposition fridge#1::fridge_door pstn17749=1.78)
	(atposition counter#1::chewie_door_left_joint pstn17748=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn17752=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn17751=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17750=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17752=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn17748=-1.872)
	(position counter#1::chewie_door_right_joint pstn17747=1.872)
	(position faucet#1::joint_faucet_0 pstn17752=0.0)
	(position oven#1::knob_joint_3 pstn17751=0.0)
	(position oven#1::knob_joint_2 pstn17750=0.0)
	(position fridge#1::fridge_door pstn17749=1.78)

	(pose braiserbody#1 p68575=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p68577=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(pose salt-shaker p68579=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p68580=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p68576=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p68577=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(atpose chicken-leg p68576=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p68579=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p68575=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p68580=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq312=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq360=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn17748=-1.872)
	(isopenedposition fridge#1::fridge_door pstn17749=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn17747=1.872)

	(ataconf right aq360=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq312=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p68579=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p68580=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p68577=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928) counter#1::front_left_stove)
	(supported braiserbody#1 p68578=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
