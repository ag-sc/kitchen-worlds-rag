...
(define
  (problem test_kitchen_chicken_soup_250829_175849_seed_854983)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn10938=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10936=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn10937=0.0)

	(position counter#1::chewie_door_right_joint pstn10933=1.872)
	(position oven#1::knob_joint_3 pstn10937=0.0)
	(position fridge#1::fridge_door pstn10935=1.78)
	(position oven#1::knob_joint_2 pstn10936=0.0)
	(position counter#1::chewie_door_left_joint pstn10934=-1.872)
	(position faucet#1::joint_faucet_0 pstn10938=0.0)

	(atposition counter#1::chewie_door_left_joint pstn10934=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn10938=0.0)
	(atposition oven#1::knob_joint_3 pstn10937=0.0)
	(atposition fridge#1::fridge_door pstn10935=1.78)
	(atposition oven#1::knob_joint_2 pstn10936=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10933=1.872)
	(pose braiserbody#1 p14738=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p14743=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p14740=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(pose salt-shaker p14742=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p14739=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserbody#1 p14738=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p14742=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p14743=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p14740=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(atpose chicken-leg p14739=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq664=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq200=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn10934=-1.872)
	(isopenedposition fridge#1::fridge_door pstn10935=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn10933=1.872)

	(ataconf left aq664=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq200=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p14743=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p14742=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14740=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303) counter#1::front_left_stove)
	(supported braiserbody#1 p14741=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
