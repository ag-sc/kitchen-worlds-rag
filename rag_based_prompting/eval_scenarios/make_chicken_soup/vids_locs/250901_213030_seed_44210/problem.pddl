...
(define
  (problem test_kitchen_chicken_soup_250901_213030_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn17278=0.0)
	(atposition fridge#1::fridge_door pstn17276=1.78)
	(atposition oven#1::knob_joint_2 pstn17277=0.0)
	(atposition faucet#1::joint_faucet_0 pstn17279=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17275=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn17274=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn17279=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17278=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17277=0.0)

	(position counter#1::chewie_door_right_joint pstn17274=1.872)
	(position oven#1::knob_joint_3 pstn17278=0.0)
	(position fridge#1::fridge_door pstn17276=1.78)
	(position oven#1::knob_joint_2 pstn17277=0.0)
	(position counter#1::chewie_door_left_joint pstn17275=-1.872)
	(position faucet#1::joint_faucet_0 pstn17279=0.0)

	(pose braiserbody#1 p67185=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p67189=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p67186=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p67187=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(pose pepper-shaker p67190=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p67190=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p67186=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p67189=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p67187=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(atpose braiserbody#1 p67185=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn17275=-1.872)
	(isopenedposition fridge#1::fridge_door pstn17276=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn17274=1.872)
	...
	(contained salt-shaker p67189=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p67190=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p67188=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p67187=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
