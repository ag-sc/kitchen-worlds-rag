...
(define
  (problem test_kitchen_chicken_soup_250901_234210_seed_378661)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn20446=0.0)
	(position faucet#1::joint_faucet_0 pstn20448=0.0)
	(position counter#1::chewie_door_left_joint pstn20444=-1.872)
	(position fridge#1::fridge_door pstn20445=1.78)
	(position counter#1::chewie_door_right_joint pstn20443=1.872)
	(position oven#1::knob_joint_3 pstn20447=0.0)
	...
	(atposition oven#1::knob_joint_2 pstn20446=0.0)
	(atposition faucet#1::joint_faucet_0 pstn20448=0.0)
	(atposition fridge#1::fridge_door pstn20445=1.78)
	(atposition counter#1::chewie_door_left_joint pstn20444=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn20443=1.872)
	(atposition oven#1::knob_joint_3 pstn20447=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn20447=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20446=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn20448=0.0)
	...
	(pose salt-shaker p78566=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p78563=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p78562=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p78567=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p78564=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))

	(atpose pepper-shaker p78567=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p78566=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p78563=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p78564=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	(atpose braiserbody#1 p78562=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn20443=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn20444=-1.872)
	(isopenedposition fridge#1::fridge_door pstn20445=1.78)
	...
	(contained salt-shaker p78566=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p78567=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p78564=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993) counter#1::front_left_stove)
	(supported braiserbody#1 p78565=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
