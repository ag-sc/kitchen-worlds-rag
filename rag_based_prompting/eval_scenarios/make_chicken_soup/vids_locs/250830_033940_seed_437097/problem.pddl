...
(define
  (problem test_kitchen_chicken_soup_250830_033940_seed_437097)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn26610=0.0)
	(position counter#1::chewie_door_right_joint pstn26605=1.872)
	(position oven#1::knob_joint_3 pstn26609=0.0)
	(position counter#1::chewie_door_left_joint pstn26606=-1.872)
	(position fridge#1::fridge_door pstn26607=1.78)
	(position oven#1::knob_joint_2 pstn26608=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn26608=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn26609=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn26610=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn26605=1.872)
	(atposition faucet#1::joint_faucet_0 pstn26610=0.0)
	(atposition oven#1::knob_joint_3 pstn26609=0.0)
	(atposition counter#1::chewie_door_left_joint pstn26606=-1.872)
	(atposition fridge#1::fridge_door pstn26607=1.78)
	(atposition oven#1::knob_joint_2 pstn26608=0.0)

	(pose braiserlid#1 p56000=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(pose pepper-shaker p56003=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p55999=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p56002=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p55998=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq0=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq744=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose salt-shaker p56002=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p56003=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p55999=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p56000=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(atpose braiserbody#1 p55998=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn26605=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn26606=-1.872)
	(isopenedposition fridge#1::fridge_door pstn26607=1.78)

	(ataconf right aq744=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq0=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p56003=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p56002=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p56000=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96) counter#1::front_left_stove)
	(supported braiserbody#1 p56001=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
