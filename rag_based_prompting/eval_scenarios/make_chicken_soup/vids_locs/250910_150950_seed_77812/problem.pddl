...
(define
  (problem test_kitchen_chicken_soup_250910_150950_seed_77812)
  (:domain domain)
  ...
  (:init
	...
	(pose chicken-leg p18248=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p18249=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(pose salt-shaker p18251=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p18252=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p18247=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p18248=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p18247=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p18251=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p18249=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(atpose pepper-shaker p18252=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p18251=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p18252=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p18250=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p18249=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125) counter#1::front_left_stove)
