...
(define
  (problem test_kitchen_chicken_soup_250901_105232_seed_398825)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn1918=0.0)
	(position oven#1::knob_joint_3 pstn1919=0.0)
	(position counter#1::chewie_door_right_joint pstn1915=1.872)
	(position counter#1::chewie_door_left_joint pstn1916=-1.872)
	(position faucet#1::joint_faucet_0 pstn1920=0.0)
	(position fridge#1::fridge_door pstn1917=1.78)

	(atposition oven#1::knob_joint_2 pstn1918=0.0)
	(atposition oven#1::knob_joint_3 pstn1919=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1920=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1915=1.872)
	(atposition counter#1::chewie_door_left_joint pstn1916=-1.872)
	(atposition fridge#1::fridge_door pstn1917=1.78)
	...
	(isopenedposition fridge#1::fridge_door pstn1917=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1916=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1915=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn1920=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1918=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1919=0.0)

	(pose chicken-leg p9883=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p9887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p9882=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p9886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p9884=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854))

	(atpose pepper-shaker p9887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p9882=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p9884=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854))
	(atpose chicken-leg p9883=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p9886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p9887=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p9886=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p9885=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p9884=(0.567, 7.872, 0.712, 0.0, -0.0, 1.854) counter#1::front_left_stove)
