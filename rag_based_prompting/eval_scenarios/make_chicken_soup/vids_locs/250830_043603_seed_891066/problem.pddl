...
(define
  (problem test_kitchen_chicken_soup_250830_043603_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn28367=0.0)
	(atposition oven#1::knob_joint_2 pstn28365=0.0)
	(atposition oven#1::knob_joint_3 pstn28366=0.0)
	(atposition counter#1::chewie_door_left_joint pstn28363=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn28362=1.872)
	(atposition fridge#1::fridge_door pstn28364=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn28366=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn28365=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn28367=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn28364=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn28363=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn28362=1.872)
	...
	(position counter#1::chewie_door_right_joint pstn28362=1.872)
	(position oven#1::knob_joint_3 pstn28366=0.0)
	(position oven#1::knob_joint_2 pstn28365=0.0)
	(position counter#1::chewie_door_left_joint pstn28363=-1.872)
	(position fridge#1::fridge_door pstn28364=1.78)
	(position faucet#1::joint_faucet_0 pstn28367=0.0)

	(pose braiserlid#1 p58023=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose pepper-shaker p58026=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p58025=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p58021=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p58022=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p58023=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose salt-shaker p58025=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p58026=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p58021=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p58022=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p58025=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p58026=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p58024=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p58023=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)
