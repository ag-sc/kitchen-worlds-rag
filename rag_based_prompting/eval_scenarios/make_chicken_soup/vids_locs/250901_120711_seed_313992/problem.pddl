...
(define
  (problem test_kitchen_chicken_soup_250901_120711_seed_313992)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn4508=0.0)
	(position fridge#1::fridge_door pstn4507=1.78)
	(position faucet#1::joint_faucet_0 pstn4510=0.0)
	(position oven#1::knob_joint_3 pstn4509=0.0)
	(position counter#1::chewie_door_left_joint pstn4506=-1.872)
	(position counter#1::chewie_door_right_joint pstn4505=1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn4510=0.0)
	(atposition oven#1::knob_joint_3 pstn4509=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4506=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn4505=1.872)
	(atposition oven#1::knob_joint_2 pstn4508=0.0)
	(atposition fridge#1::fridge_door pstn4507=1.78)

	(isclosedposition oven#1::knob_joint_3 pstn4509=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4508=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4510=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn4507=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4505=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn4506=-1.872)

	(pose salt-shaker p14115=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p14113=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))
	(pose chicken-leg p14112=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p14116=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p14111=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p14113=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))
	(atpose chicken-leg p14112=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p14115=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p14116=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14111=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p14116=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p14115=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14113=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903) counter#1::front_left_stove)
	(supported braiserbody#1 p14114=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
