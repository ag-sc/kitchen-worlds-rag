...
(define
  (problem test_kitchen_chicken_soup_250901_193911_seed_992418)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn15463=0.0)
	(position oven#1::knob_joint_3 pstn15464=0.0)
	(position counter#1::chewie_door_right_joint pstn15460=1.872)
	(position faucet#1::joint_faucet_0 pstn15465=0.0)
	(position fridge#1::fridge_door pstn15462=1.78)
	(position counter#1::chewie_door_left_joint pstn15461=-1.872)
	...
	(atposition oven#1::knob_joint_3 pstn15464=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15460=1.872)
	(atposition fridge#1::fridge_door pstn15462=1.78)
	(atposition counter#1::chewie_door_left_joint pstn15461=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn15465=0.0)
	(atposition oven#1::knob_joint_2 pstn15463=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn15465=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15463=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15464=0.0)

	(pose chicken-leg p53488=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p53487=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p53489=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(pose salt-shaker p53491=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p53492=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p53489=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(atpose pepper-shaker p53492=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p53488=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p53491=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p53487=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq320=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq40=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn15461=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15462=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn15460=1.872)

	(ataconf right aq40=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq320=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p53491=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p53492=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p53490=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p53489=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554) counter#1::front_left_stove)
