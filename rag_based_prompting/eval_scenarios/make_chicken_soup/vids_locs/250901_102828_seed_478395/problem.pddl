...
(define
  (problem test_kitchen_chicken_soup_250901_102828_seed_478395)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn1533=1.78)
	(position faucet#1::joint_faucet_0 pstn1536=0.0)
	(position oven#1::knob_joint_3 pstn1535=0.0)
	(position oven#1::knob_joint_2 pstn1534=0.0)
	(position counter#1::chewie_door_left_joint pstn1532=-1.872)
	(position counter#1::chewie_door_right_joint pstn1531=1.872)

	(atposition faucet#1::joint_faucet_0 pstn1536=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1532=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1531=1.872)
	(atposition oven#1::knob_joint_3 pstn1535=0.0)
	(atposition oven#1::knob_joint_2 pstn1534=0.0)
	(atposition fridge#1::fridge_door pstn1533=1.78)

	(isclosedposition oven#1::knob_joint_2 pstn1534=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1535=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1536=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn1533=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1531=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1532=-1.872)

	(pose braiserlid#1 p6650=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(pose salt-shaker p6652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p6648=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p6653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p6649=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose pepper-shaker p6653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p6649=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p6652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p6648=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p6650=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	...
	(contained pepper-shaker p6653=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p6652=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p6650=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304) counter#1::front_left_stove)
	(supported braiserbody#1 p6651=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
