...
(define
  (problem test_kitchen_chicken_soup_250830_024949_seed_320213)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn13734=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13736=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13735=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn13733=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn13731=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn13732=-1.872)

	(position counter#1::chewie_door_right_joint pstn13731=1.872)
	(position counter#1::chewie_door_left_joint pstn13732=-1.872)
	(position oven#1::knob_joint_3 pstn13735=0.0)
	(position fridge#1::fridge_door pstn13733=1.78)
	(position faucet#1::joint_faucet_0 pstn13736=0.0)
	(position oven#1::knob_joint_2 pstn13734=0.0)

	(atposition counter#1::chewie_door_right_joint pstn13731=1.872)
	(atposition faucet#1::joint_faucet_0 pstn13736=0.0)
	(atposition oven#1::knob_joint_3 pstn13735=0.0)
	(atposition fridge#1::fridge_door pstn13733=1.78)
	(atposition oven#1::knob_joint_2 pstn13734=0.0)
	(atposition counter#1::chewie_door_left_joint pstn13732=-1.872)

	(pose braiserlid#1 p49693=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(pose chicken-leg p49692=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p49696=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p49695=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p49691=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p49691=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p49692=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p49695=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p49693=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(atpose pepper-shaker p49696=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p49695=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p49696=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p49693=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62) counter#1::front_left_stove)
	(supported braiserbody#1 p49694=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
