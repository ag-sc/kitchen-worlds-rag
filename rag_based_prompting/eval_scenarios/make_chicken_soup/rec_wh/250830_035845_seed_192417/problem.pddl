...
(define
  (problem test_kitchen_chicken_soup_250830_035845_seed_192417)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn14929=0.0)
	(position fridge#1::fridge_door pstn14928=1.78)
	(position oven#1::knob_joint_3 pstn14930=0.0)
	(position faucet#1::joint_faucet_0 pstn14931=0.0)
	(position counter#1::chewie_door_right_joint pstn14926=1.872)
	(position counter#1::chewie_door_left_joint pstn14927=-1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn14930=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14929=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14931=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn14928=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn14926=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn14927=-1.872)

	(atposition counter#1::chewie_door_right_joint pstn14926=1.872)
	(atposition faucet#1::joint_faucet_0 pstn14931=0.0)
	(atposition oven#1::knob_joint_3 pstn14930=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14927=-1.872)
	(atposition oven#1::knob_joint_2 pstn14929=0.0)
	(atposition fridge#1::fridge_door pstn14928=1.78)

	(pose braiserlid#1 p55089=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539))
	(pose chicken-leg p55088=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p55087=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p55092=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p55091=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p55089=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539))
	(atpose salt-shaker p55091=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p55092=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p55088=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p55087=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p55091=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p55092=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p55090=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p55089=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539) counter#1::front_left_stove)
