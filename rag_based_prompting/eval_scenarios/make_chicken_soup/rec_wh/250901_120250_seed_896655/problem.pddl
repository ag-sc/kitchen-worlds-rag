...
(define
  (problem test_kitchen_chicken_soup_250901_120250_seed_896655)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn3399=0.0)
	(position oven#1::knob_joint_3 pstn3398=0.0)
	(position oven#1::knob_joint_2 pstn3397=0.0)
	(position counter#1::chewie_door_right_joint pstn3394=1.872)
	(position counter#1::chewie_door_left_joint pstn3395=-1.872)
	(position fridge#1::fridge_door pstn3396=1.78)

	(atposition faucet#1::joint_faucet_0 pstn3399=0.0)
	(atposition oven#1::knob_joint_3 pstn3398=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3394=1.872)
	(atposition fridge#1::fridge_door pstn3396=1.78)
	(atposition oven#1::knob_joint_2 pstn3397=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3395=-1.872)

	(isclosedposition oven#1::knob_joint_3 pstn3398=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3397=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3399=0.0)

	(pose pepper-shaker p9581=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p9576=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p9577=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p9578=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(pose salt-shaker p9580=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p9578=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(atpose chicken-leg p9577=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p9580=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p9576=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p9581=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn3394=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3395=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3396=1.78)
	...
	(contained salt-shaker p9580=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p9581=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p9579=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p9578=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987) counter#1::front_left_stove)
