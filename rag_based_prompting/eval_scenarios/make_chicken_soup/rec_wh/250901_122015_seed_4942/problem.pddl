...
(define
  (problem test_kitchen_chicken_soup_250901_122015_seed_4942)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn4172=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4169=-1.872)
	(atposition oven#1::knob_joint_2 pstn4171=0.0)
	(atposition fridge#1::fridge_door pstn4170=1.78)
	(atposition faucet#1::joint_faucet_0 pstn4173=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4168=1.872)
	...
	(position fridge#1::fridge_door pstn4170=1.78)
	(position faucet#1::joint_faucet_0 pstn4173=0.0)
	(position oven#1::knob_joint_3 pstn4172=0.0)
	(position counter#1::chewie_door_left_joint pstn4169=-1.872)
	(position oven#1::knob_joint_2 pstn4171=0.0)
	(position counter#1::chewie_door_right_joint pstn4168=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn4173=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4172=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4171=0.0)

	(pose braiserlid#1 p9948=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(pose chicken-leg p9947=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p9946=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p9951=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p9950=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq672=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p9951=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p9950=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p9946=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p9947=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p9948=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(isopenedposition counter#1::chewie_door_left_joint pstn4169=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4170=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4168=1.872)

	(ataconf right aq672=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p9950=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p9951=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p9948=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391) counter#1::front_left_stove)
	(supported braiserbody#1 p9949=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
