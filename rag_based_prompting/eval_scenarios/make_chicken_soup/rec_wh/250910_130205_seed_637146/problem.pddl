...
(define
  (problem test_kitchen_chicken_soup_250910_130205_seed_637146)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn6327=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6326=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6328=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn6323=1.872)
	(position fridge#1::fridge_door pstn6325=1.78)
	(position oven#1::knob_joint_3 pstn6327=0.0)
	(position counter#1::chewie_door_left_joint pstn6324=-1.872)
	(position oven#1::knob_joint_2 pstn6326=0.0)
	(position faucet#1::joint_faucet_0 pstn6328=0.0)

	(atposition counter#1::chewie_door_right_joint pstn6323=1.872)
	(atposition oven#1::knob_joint_3 pstn6327=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6324=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn6328=0.0)
	(atposition fridge#1::fridge_door pstn6325=1.78)
	(atposition oven#1::knob_joint_2 pstn6326=0.0)

	(pose pepper-shaker p11110=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p11106=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p11105=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p11107=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(pose salt-shaker p11109=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq768=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose braiserlid#1 p11107=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(atpose pepper-shaker p11110=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p11109=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p11105=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p11106=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn6323=1.872)
	(isopenedposition fridge#1::fridge_door pstn6325=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn6324=-1.872)

	(ataconf right aq768=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p11110=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p11109=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p11107=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073) counter#1::front_left_stove)
	(supported braiserbody#1 p11108=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
