...
(define
  (problem test_kitchen_chicken_soup_250829_122817_seed_344159)
  (:domain domain)
  ...
  (:init
	...
	(pose chicken-leg p2011=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p2012=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(pose pepper-shaker p2015=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p2014=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2010=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p2012=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(atpose chicken-leg p2011=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p2010=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p2014=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p2015=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p2014=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2015=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2013=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2012=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934) counter#1::front_left_stove)
