...
(define
  (problem test_kitchen_chicken_soup_250901_125908_seed_507585)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn5164=0.0)
	(position faucet#1::joint_faucet_0 pstn5165=0.0)
	(position counter#1::chewie_door_right_joint pstn5160=1.872)
	(position fridge#1::fridge_door pstn5162=1.78)
	(position counter#1::chewie_door_left_joint pstn5161=-1.872)
	(position oven#1::knob_joint_2 pstn5163=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn5163=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5164=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5165=0.0)

	(atposition counter#1::chewie_door_left_joint pstn5161=-1.872)
	(atposition oven#1::knob_joint_3 pstn5164=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5165=0.0)
	(atposition oven#1::knob_joint_2 pstn5163=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5160=1.872)
	(atposition fridge#1::fridge_door pstn5162=1.78)

	(atpose chicken-leg p12581=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p12585=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p12580=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p12582=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(atpose salt-shaker p12584=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p12585=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p12581=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p12584=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p12580=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p12582=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))

	(isopenedposition counter#1::chewie_door_left_joint pstn5161=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5162=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn5160=1.872)
	...
	(contained salt-shaker p12584=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12585=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p12583=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p12582=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39) counter#1::front_left_stove)
