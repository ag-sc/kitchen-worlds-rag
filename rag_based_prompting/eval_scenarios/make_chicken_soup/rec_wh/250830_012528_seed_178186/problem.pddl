...
(define
  (problem test_kitchen_chicken_soup_250830_012528_seed_178186)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn11781=1.78)
	(atposition counter#1::chewie_door_right_joint pstn11779=1.872)
	(atposition oven#1::knob_joint_2 pstn11782=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11780=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn11784=0.0)
	(atposition oven#1::knob_joint_3 pstn11783=0.0)
	(position faucet#1::joint_faucet_0 pstn11784=0.0)
	(position counter#1::chewie_door_right_joint pstn11779=1.872)
	(position fridge#1::fridge_door pstn11781=1.78)
	(position oven#1::knob_joint_3 pstn11783=0.0)
	(position counter#1::chewie_door_left_joint pstn11780=-1.872)
	(position oven#1::knob_joint_2 pstn11782=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn11781=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11779=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11780=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn11784=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11783=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11782=0.0)

	(pose braiserbody#1 p42204=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p42208=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p42205=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p42206=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	(pose pepper-shaker p42209=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p42206=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	(atpose pepper-shaker p42209=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p42204=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p42208=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p42205=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p42209=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p42208=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p42206=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036) counter#1::front_left_stove)
	(supported braiserbody#1 p42207=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
