...
(define
  (problem test_kitchen_chicken_soup_250829_181231_seed_313992)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn4169=0.0)
	(position counter#1::chewie_door_left_joint pstn4166=-1.872)
	(position faucet#1::joint_faucet_0 pstn4170=0.0)
	(position counter#1::chewie_door_right_joint pstn4165=1.872)
	(position oven#1::knob_joint_2 pstn4168=0.0)
	(position fridge#1::fridge_door pstn4167=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn4169=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4168=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4170=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn4165=1.872)
	(atposition counter#1::chewie_door_left_joint pstn4166=-1.872)
	(atposition oven#1::knob_joint_2 pstn4168=0.0)
	(atposition fridge#1::fridge_door pstn4167=1.78)
	(atposition oven#1::knob_joint_3 pstn4169=0.0)
	(atposition faucet#1::joint_faucet_0 pstn4170=0.0)

	(pose chicken-leg p12724=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p12723=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p12727=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p12725=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))
	(pose pepper-shaker p12728=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p12725=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))
	(atpose pepper-shaker p12728=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p12723=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p12724=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p12727=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn4165=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn4166=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4167=1.78)
	...
	(contained salt-shaker p12727=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12728=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p12726=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p12725=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903) counter#1::front_left_stove)
