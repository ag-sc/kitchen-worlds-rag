...
(define
  (problem test_kitchen_chicken_soup_250912_090443_seed_316464)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn501=0.0)
	(position fridge#1::fridge_door pstn499=1.78)
	(position counter#1::chewie_door_right_joint pstn497=1.872)
	(position counter#1::chewie_door_left_joint pstn498=-1.872)
	(position faucet#1::joint_faucet_0 pstn502=0.0)
	(position oven#1::knob_joint_2 pstn500=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn502=0.0)
	(atposition fridge#1::fridge_door pstn499=1.78)
	(atposition counter#1::chewie_door_left_joint pstn498=-1.872)
	(atposition oven#1::knob_joint_2 pstn500=0.0)
	(atposition counter#1::chewie_door_right_joint pstn497=1.872)
	(atposition oven#1::knob_joint_3 pstn501=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn500=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn501=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn502=0.0)

	(pose pepper-shaker p1326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p1322=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p1325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1321=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))

	(atpose braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(atpose pepper-shaker p1326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p1322=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p1321=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p1325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn497=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn498=-1.872)
	(isopenedposition fridge#1::fridge_door pstn499=1.78)
	...
	(contained salt-shaker p1325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p1326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p1324=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765) counter#1::front_left_stove)
