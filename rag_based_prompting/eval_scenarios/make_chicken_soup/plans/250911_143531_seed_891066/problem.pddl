...
(define
  (problem test_kitchen_chicken_soup_250911_143531_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn9589=0.0)
	(position fridge#1::fridge_door pstn9587=1.78)
	(position counter#1::chewie_door_right_joint pstn9585=1.872)
	(position counter#1::chewie_door_left_joint pstn9586=-1.872)
	(position faucet#1::joint_faucet_0 pstn9590=0.0)
	(position oven#1::knob_joint_2 pstn9588=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn9588=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9589=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9590=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn9585=1.872)
	(atposition faucet#1::joint_faucet_0 pstn9590=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9586=-1.872)
	(atposition oven#1::knob_joint_2 pstn9588=0.0)
	(atposition oven#1::knob_joint_3 pstn9589=0.0)
	(atposition fridge#1::fridge_door pstn9587=1.78)

	(pose pepper-shaker p15300=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p15295=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p15297=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose chicken-leg p15296=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p15299=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn9586=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn9585=1.872)
	(isopenedposition fridge#1::fridge_door pstn9587=1.78)

	(atpose pepper-shaker p15300=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p15295=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p15297=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose chicken-leg p15296=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p15299=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p15300=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p15299=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p15297=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)
	(supported braiserbody#1 p15298=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
