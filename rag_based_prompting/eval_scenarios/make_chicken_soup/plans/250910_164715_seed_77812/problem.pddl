...
(define
  (problem test_kitchen_chicken_soup_250910_164715_seed_77812)
  (:domain domain)
  ...
  (:init
	...
	(supported braiserlid#1 p1671=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125) counter#1::front_left_stove)
	(supported braiserbody#1 p1672=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
