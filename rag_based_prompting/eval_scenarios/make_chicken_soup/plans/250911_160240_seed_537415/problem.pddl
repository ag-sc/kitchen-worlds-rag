...
(define
  (problem test_kitchen_chicken_soup_250911_160240_seed_537415)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn12771=0.0)
	(position oven#1::knob_joint_2 pstn12770=0.0)
	(position fridge#1::fridge_door pstn12769=1.78)
	(position counter#1::chewie_door_left_joint pstn12768=-1.872)
	(position faucet#1::joint_faucet_0 pstn12772=0.0)
	(position counter#1::chewie_door_right_joint pstn12767=1.872)

	(atposition fridge#1::fridge_door pstn12769=1.78)
	(atposition counter#1::chewie_door_left_joint pstn12768=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn12772=0.0)
	(atposition oven#1::knob_joint_3 pstn12771=0.0)
	(atposition oven#1::knob_joint_2 pstn12770=0.0)
	(atposition counter#1::chewie_door_right_joint pstn12767=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn12770=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12772=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12771=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn12769=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn12768=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn12767=1.872)

	(pose braiserbody#1 p20174=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p20178=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p20176=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(pose chicken-leg p20175=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p20179=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq24=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq248=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(atpose pepper-shaker p20179=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p20174=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p20175=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p20176=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(atpose salt-shaker p20178=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(ataconf right aq248=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq24=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p20179=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p20178=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p20177=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p20176=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718) counter#1::front_left_stove)
