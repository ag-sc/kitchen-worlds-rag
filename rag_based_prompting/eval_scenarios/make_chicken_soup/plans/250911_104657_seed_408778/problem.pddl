...
(define
  (problem test_kitchen_chicken_soup_250911_104657_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p3897=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p3901=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p3898=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p3902=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p3899=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))

	(atpose braiserlid#1 p3899=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(atpose braiserbody#1 p3897=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p3901=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p3902=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p3898=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p3901=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3902=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p3899=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
	(supported braiserbody#1 p3900=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
