...
(define
  (problem test_kitchen_chicken_soup_250911_133159_seed_452553)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn7311=0.0)
	(position fridge#1::fridge_door pstn7309=1.78)
	(position faucet#1::joint_faucet_0 pstn7312=0.0)
	(position oven#1::knob_joint_2 pstn7310=0.0)
	(position counter#1::chewie_door_left_joint pstn7308=-1.872)
	(position counter#1::chewie_door_right_joint pstn7307=1.872)

	(atposition faucet#1::joint_faucet_0 pstn7312=0.0)
	(atposition oven#1::knob_joint_2 pstn7310=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7307=1.872)
	(atposition counter#1::chewie_door_left_joint pstn7308=-1.872)
	(atposition oven#1::knob_joint_3 pstn7311=0.0)
	(atposition fridge#1::fridge_door pstn7309=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn7312=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7310=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7311=0.0)

	(pose salt-shaker p11459=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p11457=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(pose pepper-shaker p11460=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p11456=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p11455=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p11456=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p11455=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p11459=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p11460=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p11457=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))

	(isopenedposition counter#1::chewie_door_left_joint pstn7308=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn7307=1.872)
	(isopenedposition fridge#1::fridge_door pstn7309=1.78)
	...
	(contained salt-shaker p11459=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p11460=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p11458=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p11457=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452) counter#1::front_left_stove)
