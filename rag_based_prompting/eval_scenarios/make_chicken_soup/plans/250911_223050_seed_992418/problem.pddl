...
(define
  (problem test_kitchen_chicken_soup_250911_223050_seed_992418)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p2313=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p2310=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p2314=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2309=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2311=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))

	(atpose braiserlid#1 p2311=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(atpose salt-shaker p2313=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2310=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p2309=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p2314=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p2314=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2313=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p2311=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554) counter#1::front_left_stove)
	(supported braiserbody#1 p2312=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
