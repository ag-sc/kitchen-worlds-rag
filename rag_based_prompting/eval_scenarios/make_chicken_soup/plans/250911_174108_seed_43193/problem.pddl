...
(define
  (problem test_kitchen_chicken_soup_250911_174108_seed_43193)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn15947=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15948=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15946=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn15945=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn15944=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn15943=1.872)

	(position counter#1::chewie_door_right_joint pstn15943=1.872)
	(position counter#1::chewie_door_left_joint pstn15944=-1.872)
	(position oven#1::knob_joint_3 pstn15947=0.0)
	(position fridge#1::fridge_door pstn15945=1.78)
	(position faucet#1::joint_faucet_0 pstn15948=0.0)
	(position oven#1::knob_joint_2 pstn15946=0.0)

	(atposition counter#1::chewie_door_left_joint pstn15944=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn15943=1.872)
	(atposition oven#1::knob_joint_3 pstn15947=0.0)
	(atposition fridge#1::fridge_door pstn15945=1.78)
	(atposition faucet#1::joint_faucet_0 pstn15948=0.0)
	(atposition oven#1::knob_joint_2 pstn15946=0.0)

	(atpose chicken-leg p23653=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p23654=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(atpose salt-shaker p23656=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p23657=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p23652=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p23657=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p23652=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p23654=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219))
	(pose chicken-leg p23653=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p23656=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p23657=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23656=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p23654=(0.567, 7.872, 0.712, 0.0, -0.0, 1.219) counter#1::front_left_stove)
	(supported braiserbody#1 p23655=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
