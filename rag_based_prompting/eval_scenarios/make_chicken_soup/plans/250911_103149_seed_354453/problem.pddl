...
(define
  (problem test_kitchen_chicken_soup_250911_103149_seed_354453)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p2487=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p2491=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p2488=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p2489=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(pose pepper-shaker p2492=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p2488=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p2492=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p2491=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2489=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(atpose braiserbody#1 p2487=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p2490=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2489=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309) counter#1::front_left_stove)

	(contained pepper-shaker p2492=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2491=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
