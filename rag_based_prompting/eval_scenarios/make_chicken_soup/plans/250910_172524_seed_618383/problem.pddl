...
(define
  (problem test_kitchen_chicken_soup_250910_172524_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))

	(atpose braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	...
	(supported braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)
