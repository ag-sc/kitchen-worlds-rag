...
(define
  (problem test_kitchen_chicken_soup_250912_082553_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserbody#1 p2642=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p2647=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2644=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(pose chicken-leg p2643=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p2646=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p2643=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p2642=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p2647=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p2646=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2644=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	...
	(contained pepper-shaker p2647=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2646=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2645=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2644=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
