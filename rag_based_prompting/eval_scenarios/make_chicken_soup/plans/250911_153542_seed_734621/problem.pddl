...
(define
  (problem test_kitchen_chicken_soup_250911_153542_seed_734621)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn11861=0.0)
	(position oven#1::knob_joint_2 pstn11860=0.0)
	(position faucet#1::joint_faucet_0 pstn11862=0.0)
	(position counter#1::chewie_door_right_joint pstn11857=1.872)
	(position fridge#1::fridge_door pstn11859=1.78)
	(position counter#1::chewie_door_left_joint pstn11858=-1.872)

	(atposition faucet#1::joint_faucet_0 pstn11862=0.0)
	(atposition fridge#1::fridge_door pstn11859=1.78)
	(atposition counter#1::chewie_door_right_joint pstn11857=1.872)
	(atposition counter#1::chewie_door_left_joint pstn11858=-1.872)
	(atposition oven#1::knob_joint_3 pstn11861=0.0)
	(atposition oven#1::knob_joint_2 pstn11860=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn11862=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11860=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11861=0.0)

	(pose braiserbody#1 p18850=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p18855=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p18851=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p18852=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(pose salt-shaker p18854=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p18852=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(atpose salt-shaker p18854=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p18855=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p18850=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p18851=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq56=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq136=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(isopenedposition counter#1::chewie_door_right_joint pstn11857=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11858=-1.872)
	(isopenedposition fridge#1::fridge_door pstn11859=1.78)

	(ataconf right aq136=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq56=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p18855=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p18854=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p18853=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p18852=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19) counter#1::front_left_stove)
