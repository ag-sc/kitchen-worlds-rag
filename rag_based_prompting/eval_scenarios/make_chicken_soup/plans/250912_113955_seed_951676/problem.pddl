...
(define
  (problem test_kitchen_chicken_soup_250911_144736_seed_977400)
  (:domain domain)
  ...
  (:init
	...
	(atpose chicken-leg p15434=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p15433=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p15437=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p15435=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(atpose pepper-shaker p15438=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p15438=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p15435=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(pose braiserbody#1 p15433=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p15434=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p15437=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p15437=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p15438=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p15436=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p15435=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695) counter#1::front_left_stove)
