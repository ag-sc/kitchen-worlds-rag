...
(define
  (problem test_kitchen_chicken_soup_250912_101732_seed_844870)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn2838=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2835=1.872)
	(atposition faucet#1::joint_faucet_0 pstn2840=0.0)
	(atposition oven#1::knob_joint_3 pstn2839=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2836=-1.872)
	(atposition fridge#1::fridge_door pstn2837=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn2838=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2840=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2839=0.0)

	(position counter#1::chewie_door_right_joint pstn2835=1.872)
	(position faucet#1::joint_faucet_0 pstn2840=0.0)
	(position oven#1::knob_joint_2 pstn2838=0.0)
	(position oven#1::knob_joint_3 pstn2839=0.0)
	(position counter#1::chewie_door_left_joint pstn2836=-1.872)
	(position fridge#1::fridge_door pstn2837=1.78)

	(pose braiserbody#1 p6370=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p6371=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p6374=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p6372=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683))
	(pose pepper-shaker p6375=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p6374=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p6371=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p6372=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683))
	(atpose braiserbody#1 p6370=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p6375=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn2836=-1.872)
	(isopenedposition fridge#1::fridge_door pstn2837=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn2835=1.872)
	...
	(contained salt-shaker p6374=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p6375=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p6373=(0.7, 8.764, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p6372=(0.567, 7.872, 0.712, 0.0, -0.0, 1.683) counter#1::front_left_stove)
