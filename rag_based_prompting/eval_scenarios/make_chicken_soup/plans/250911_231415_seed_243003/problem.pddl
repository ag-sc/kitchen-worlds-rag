...
(define
  (problem test_kitchen_chicken_soup_250911_231415_seed_243003)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p1281=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(pose chicken-leg p1280=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p1279=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p1281=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274) counter#1::front_left_stove)
	(supported braiserbody#1 p1282=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
