...
(define
  (problem test_kitchen_chicken_soup_250910_173916_seed_989544)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn978=1.78)
	(position oven#1::knob_joint_2 pstn979=0.0)
	(position counter#1::chewie_door_left_joint pstn977=-1.872)
	(position counter#1::chewie_door_right_joint pstn976=1.872)
	(position faucet#1::joint_faucet_0 pstn981=0.0)
	(position oven#1::knob_joint_3 pstn980=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn981=0.0)
	(atposition counter#1::chewie_door_left_joint pstn977=-1.872)
	(atposition fridge#1::fridge_door pstn978=1.78)
	(atposition oven#1::knob_joint_3 pstn980=0.0)
	(atposition oven#1::knob_joint_2 pstn979=0.0)
	(atposition counter#1::chewie_door_right_joint pstn976=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn980=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn979=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn981=0.0)
	...
	(pose pepper-shaker p2730=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p2726=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p2725=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p2729=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2727=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(isopenedposition counter#1::chewie_door_left_joint pstn977=-1.872)
	(isopenedposition fridge#1::fridge_door pstn978=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn976=1.872)

	(atpose pepper-shaker p2730=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2726=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p2727=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose salt-shaker p2729=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2725=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p2729=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2730=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2728=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2727=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
