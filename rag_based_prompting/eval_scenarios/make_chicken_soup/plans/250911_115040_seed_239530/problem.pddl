...
(define
  (problem test_kitchen_chicken_soup_250911_115040_seed_239530)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn3719=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3715=1.872)
	(atposition oven#1::knob_joint_2 pstn3718=0.0)
	(atposition counter#1::chewie_door_left_joint pstn3716=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn3720=0.0)
	(atposition fridge#1::fridge_door pstn3717=1.78)

	(isclosedposition oven#1::knob_joint_3 pstn3719=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3720=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3718=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn3716=-1.872)
	(position faucet#1::joint_faucet_0 pstn3720=0.0)
	(position fridge#1::fridge_door pstn3717=1.78)
	(position counter#1::chewie_door_right_joint pstn3715=1.872)
	(position oven#1::knob_joint_3 pstn3719=0.0)
	(position oven#1::knob_joint_2 pstn3718=0.0)

	(pose salt-shaker p7885=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p7881=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p7886=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p7882=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p7883=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))

	(atpose braiserbody#1 p7881=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p7882=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p7883=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(atpose salt-shaker p7885=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p7886=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn3715=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3716=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3717=1.78)

	(ataconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq480=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p7886=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p7885=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p7884=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p7883=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285) counter#1::front_left_stove)
