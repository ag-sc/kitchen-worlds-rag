...
(define
  (problem test_kitchen_chicken_soup_250910_163248_seed_288895)
  (:domain domain)
  ...
  (:init
	...
	(atpose braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(atpose braiserbody#1 p1321=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p1326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(pose braiserbody#1 p1321=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p1324=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1323=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247) counter#1::front_left_stove)
