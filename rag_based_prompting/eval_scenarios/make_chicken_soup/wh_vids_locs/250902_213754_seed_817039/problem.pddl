...
(define
  (problem test_kitchen_chicken_soup_250902_213754_seed_817039)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn13587=0.0)
	(position oven#1::knob_joint_2 pstn13585=0.0)
	(position fridge#1::fridge_door pstn13584=1.78)
	(position oven#1::knob_joint_3 pstn13586=0.0)
	(position counter#1::chewie_door_right_joint pstn13582=1.872)
	(position counter#1::chewie_door_left_joint pstn13583=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn13585=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13587=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13586=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn13584=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn13583=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn13582=1.872)

	(atposition counter#1::chewie_door_right_joint pstn13582=1.872)
	(atposition oven#1::knob_joint_2 pstn13585=0.0)
	(atposition faucet#1::joint_faucet_0 pstn13587=0.0)
	(atposition fridge#1::fridge_door pstn13584=1.78)
	(atposition counter#1::chewie_door_left_joint pstn13583=-1.872)
	(atposition oven#1::knob_joint_3 pstn13586=0.0)

	(pose braiserlid#1 p54418=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose chicken-leg p54417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p54416=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p54421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p54420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p54417=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p54416=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p54421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p54420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p54418=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	...
	(contained pepper-shaker p54421=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p54420=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p54418=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
	(supported braiserbody#1 p54419=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
