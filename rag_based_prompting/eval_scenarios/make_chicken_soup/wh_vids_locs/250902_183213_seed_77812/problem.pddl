...
(define
  (problem test_kitchen_chicken_soup_250902_183213_seed_77812)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn9340=0.0)
	(position faucet#1::joint_faucet_0 pstn9341=0.0)
	(position counter#1::chewie_door_right_joint pstn9336=1.872)
	(position oven#1::knob_joint_2 pstn9339=0.0)
	(position counter#1::chewie_door_left_joint pstn9337=-1.872)
	(position fridge#1::fridge_door pstn9338=1.78)
	...
	(atposition oven#1::knob_joint_2 pstn9339=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9337=-1.872)
	(atposition fridge#1::fridge_door pstn9338=1.78)
	(atposition oven#1::knob_joint_3 pstn9340=0.0)
	(atposition faucet#1::joint_faucet_0 pstn9341=0.0)
	(atposition counter#1::chewie_door_right_joint pstn9336=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn9340=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9341=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9339=0.0)
	...
	(pose braiserlid#1 p44932=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(pose salt-shaker p44934=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p44930=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p44931=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p44935=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p44934=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p44930=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p44931=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p44932=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(atpose pepper-shaker p44935=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn9336=1.872)
	(isopenedposition fridge#1::fridge_door pstn9338=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn9337=-1.872)
	...
	(contained salt-shaker p44934=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p44935=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p44932=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125) counter#1::front_left_stove)
	(supported braiserbody#1 p44933=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
