...
(define
  (problem test_kitchen_chicken_soup_250902_203751_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn12072=1.78)
	(position counter#1::chewie_door_left_joint pstn12071=-1.872)
	(position oven#1::knob_joint_2 pstn12073=0.0)
	(position faucet#1::joint_faucet_0 pstn12075=0.0)
	(position oven#1::knob_joint_3 pstn12074=0.0)
	(position counter#1::chewie_door_right_joint pstn12070=1.872)

	(atposition fridge#1::fridge_door pstn12072=1.78)
	(atposition counter#1::chewie_door_left_joint pstn12071=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn12070=1.872)
	(atposition oven#1::knob_joint_2 pstn12073=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12075=0.0)
	(atposition oven#1::knob_joint_3 pstn12074=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn12073=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12075=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12074=0.0)
	...
	(pose salt-shaker p51894=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p51892=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(pose chicken-leg p51891=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p51890=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p51895=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p51891=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p51895=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p51890=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p51894=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p51892=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))

	(aconf left aq896=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq144=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn12070=1.872)
	(isopenedposition fridge#1::fridge_door pstn12072=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn12071=-1.872)

	(ataconf left aq896=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq144=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p51894=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p51895=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p51892=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
	(supported braiserbody#1 p51893=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
