...
(define
  (problem test_kitchen_chicken_soup_250903_040424_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn20895=0.0)
	(position counter#1::chewie_door_left_joint pstn20891=-1.872)
	(position oven#1::knob_joint_2 pstn20893=0.0)
	(position counter#1::chewie_door_right_joint pstn20890=1.872)
	(position fridge#1::fridge_door pstn20892=1.78)
	(position oven#1::knob_joint_3 pstn20894=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn20892=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn20891=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn20890=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn20895=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20893=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20894=0.0)

	(atposition counter#1::chewie_door_right_joint pstn20890=1.872)
	(atposition oven#1::knob_joint_3 pstn20894=0.0)
	(atposition oven#1::knob_joint_2 pstn20893=0.0)
	(atposition faucet#1::joint_faucet_0 pstn20895=0.0)
	(atposition fridge#1::fridge_door pstn20892=1.78)
	(atposition counter#1::chewie_door_left_joint pstn20891=-1.872)

	(pose braiserbody#1 p79885=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p79887=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose chicken-leg p79886=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p79889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p79890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p79887=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(atpose pepper-shaker p79890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p79886=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p79889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p79885=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p79889=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p79890=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p79887=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
	(supported braiserbody#1 p79888=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
