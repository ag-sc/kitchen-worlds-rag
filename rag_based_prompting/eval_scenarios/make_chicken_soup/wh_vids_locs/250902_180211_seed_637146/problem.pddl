...
(define
  (problem test_kitchen_chicken_soup_250902_180211_seed_637146)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn8731=0.0)
	(position counter#1::chewie_door_left_joint pstn8729=-1.872)
	(position fridge#1::fridge_door pstn8730=1.78)
	(position counter#1::chewie_door_right_joint pstn8728=1.872)
	(position faucet#1::joint_faucet_0 pstn8733=0.0)
	(position oven#1::knob_joint_3 pstn8732=0.0)
	...
	(atposition oven#1::knob_joint_2 pstn8731=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8733=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8729=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn8728=1.872)
	(atposition oven#1::knob_joint_3 pstn8732=0.0)
	(atposition fridge#1::fridge_door pstn8730=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn8733=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8732=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8731=0.0)

	(pose braiserbody#1 p42693=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p42695=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(pose pepper-shaker p42698=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p42697=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p42694=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p42695=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(atpose pepper-shaker p42698=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p42697=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p42694=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p42693=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn8728=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn8729=-1.872)
	(isopenedposition fridge#1::fridge_door pstn8730=1.78)
	...
	(contained pepper-shaker p42698=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p42697=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p42695=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073) counter#1::front_left_stove)
	(supported braiserbody#1 p42696=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
