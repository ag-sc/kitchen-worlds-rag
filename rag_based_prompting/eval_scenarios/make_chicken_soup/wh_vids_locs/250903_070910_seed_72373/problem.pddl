...
(define
  (problem test_kitchen_chicken_soup_250903_070910_seed_72373)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn24403=1.78)
	(atposition oven#1::knob_joint_2 pstn24404=0.0)
	(atposition counter#1::chewie_door_left_joint pstn24402=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn24401=1.872)
	(atposition faucet#1::joint_faucet_0 pstn24406=0.0)
	(atposition oven#1::knob_joint_3 pstn24405=0.0)
	(position faucet#1::joint_faucet_0 pstn24406=0.0)
	(position counter#1::chewie_door_right_joint pstn24401=1.872)
	(position oven#1::knob_joint_3 pstn24405=0.0)
	(position oven#1::knob_joint_2 pstn24404=0.0)
	(position counter#1::chewie_door_left_joint pstn24402=-1.872)
	(position fridge#1::fridge_door pstn24403=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn24406=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn24404=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn24405=0.0)

	(pose chicken-leg p93399=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p93398=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p93400=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373))
	(pose pepper-shaker p93403=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p93402=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p93398=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p93400=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373))
	(atpose pepper-shaker p93403=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p93402=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p93399=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq888=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq712=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn24402=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn24401=1.872)
	(isopenedposition fridge#1::fridge_door pstn24403=1.78)

	(ataconf right aq712=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq888=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p93402=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p93403=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p93400=(0.567, 7.872, 0.712, 0.0, -0.0, 1.373) counter#1::front_left_stove)
	(supported braiserbody#1 p93401=(0.7, 8.958, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
