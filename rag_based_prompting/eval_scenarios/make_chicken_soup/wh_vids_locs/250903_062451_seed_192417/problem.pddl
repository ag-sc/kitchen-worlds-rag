...
(define
  (problem test_kitchen_chicken_soup_250903_062451_seed_192417)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn23346=1.78)
	(position counter#1::chewie_door_left_joint pstn23345=-1.872)
	(position oven#1::knob_joint_2 pstn23347=0.0)
	(position oven#1::knob_joint_3 pstn23348=0.0)
	(position faucet#1::joint_faucet_0 pstn23349=0.0)
	(position counter#1::chewie_door_right_joint pstn23344=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn23347=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn23348=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn23349=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn23345=-1.872)
	(atposition oven#1::knob_joint_2 pstn23347=0.0)
	(atposition counter#1::chewie_door_right_joint pstn23344=1.872)
	(atposition oven#1::knob_joint_3 pstn23348=0.0)
	(atposition faucet#1::joint_faucet_0 pstn23349=0.0)
	(atposition fridge#1::fridge_door pstn23346=1.78)

	(pose chicken-leg p91532=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p91535=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p91531=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p91536=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p91533=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539))

	(atpose chicken-leg p91532=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p91535=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p91536=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p91533=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539))
	(atpose braiserbody#1 p91531=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq520=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq200=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn23345=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn23344=1.872)
	(isopenedposition fridge#1::fridge_door pstn23346=1.78)

	(ataconf right aq200=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq520=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p91536=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p91535=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p91533=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539) counter#1::front_left_stove)
	(supported braiserbody#1 p91534=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
