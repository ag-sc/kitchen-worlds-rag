...
(define
  (problem test_kitchen_chicken_soup_250903_010125_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn16943=0.0)
	(atposition oven#1::knob_joint_3 pstn16944=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16941=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn16945=0.0)
	(atposition fridge#1::fridge_door pstn16942=1.78)
	(atposition counter#1::chewie_door_right_joint pstn16940=1.872)
	(position fridge#1::fridge_door pstn16942=1.78)
	(position counter#1::chewie_door_right_joint pstn16940=1.872)
	(position oven#1::knob_joint_2 pstn16943=0.0)
	(position counter#1::chewie_door_left_joint pstn16941=-1.872)
	(position oven#1::knob_joint_3 pstn16944=0.0)
	(position faucet#1::joint_faucet_0 pstn16945=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn16943=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16945=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16944=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn16942=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn16941=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16940=1.872)

	(pose braiserbody#1 p68366=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p68370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p68371=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p68367=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p68368=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(aconf left aq784=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq472=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p68371=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p68367=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p68366=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p68370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p68368=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(ataconf right aq472=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq784=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p68371=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p68370=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p68369=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p68368=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
