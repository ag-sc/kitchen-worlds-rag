...
(define
  (problem test_kitchen_chicken_soup_250903_044547_seed_178186)
  (:domain domain)
  ...
  (:init
	...
	(atpose salt-shaker p83338=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p83339=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p83334=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p83335=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p83336=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	(pose pepper-shaker p83339=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p83338=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p83334=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p83335=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p83336=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036))
	...
	(contained pepper-shaker p83339=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p83338=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p83337=(0.7, 8.769, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p83336=(0.567, 7.872, 0.712, 0.0, -0.0, 3.036) counter#1::front_left_stove)
