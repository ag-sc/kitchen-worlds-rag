...
(define
  (problem test_kitchen_chicken_soup_250903_143859_seed_195627)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn6729=0.0)
	(position fridge#1::fridge_door pstn6728=1.78)
	(position faucet#1::joint_faucet_0 pstn6731=0.0)
	(position oven#1::knob_joint_3 pstn6730=0.0)
	(position counter#1::chewie_door_left_joint pstn6727=-1.872)
	(position counter#1::chewie_door_right_joint pstn6726=1.872)

	(atposition oven#1::knob_joint_2 pstn6729=0.0)
	(atposition fridge#1::fridge_door pstn6728=1.78)
	(atposition faucet#1::joint_faucet_0 pstn6731=0.0)
	(atposition oven#1::knob_joint_3 pstn6730=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6727=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn6726=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn6730=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6731=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6729=0.0)
	...
	(pose braiserbody#1 p18677=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p18678=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p18682=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p18681=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p18679=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268))

	(atpose braiserlid#1 p18679=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268))
	(atpose chicken-leg p18678=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p18682=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p18681=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p18677=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn6727=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn6726=1.872)
	(isopenedposition fridge#1::fridge_door pstn6728=1.78)
	...
	(contained salt-shaker p18681=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p18682=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p18680=(0.7, 8.928, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p18679=(0.567, 7.872, 0.712, 0.0, -0.0, 1.268) counter#1::front_left_stove)
