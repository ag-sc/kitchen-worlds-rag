...
(define
  (problem test_kitchen_chicken_soup_250903_035012_seed_607747)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn20443=1.78)
	(atposition faucet#1::joint_faucet_0 pstn20446=0.0)
	(atposition oven#1::knob_joint_3 pstn20445=0.0)
	(atposition oven#1::knob_joint_2 pstn20444=0.0)
	(atposition counter#1::chewie_door_left_joint pstn20442=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn20441=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn20444=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn20446=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20445=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn20443=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn20442=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn20441=1.872)

	(position counter#1::chewie_door_left_joint pstn20442=-1.872)
	(position faucet#1::joint_faucet_0 pstn20446=0.0)
	(position oven#1::knob_joint_3 pstn20445=0.0)
	(position fridge#1::fridge_door pstn20443=1.78)
	(position oven#1::knob_joint_2 pstn20444=0.0)
	(position counter#1::chewie_door_right_joint pstn20441=1.872)

	(pose chicken-leg p79574=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p79577=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p79575=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	(pose braiserbody#1 p79573=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p79578=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p79577=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p79573=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p79578=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p79574=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p79575=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	...
	(contained pepper-shaker p79578=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p79577=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p79575=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098) counter#1::front_left_stove)
	(supported braiserbody#1 p79576=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
