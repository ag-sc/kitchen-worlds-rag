...
(define
  (problem test_kitchen_chicken_soup_250903_013457_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn17557=0.0)
	(atposition fridge#1::fridge_door pstn17556=1.78)
	(atposition counter#1::chewie_door_right_joint pstn17554=1.872)
	(atposition counter#1::chewie_door_left_joint pstn17555=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn17559=0.0)
	(atposition oven#1::knob_joint_3 pstn17558=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn17559=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17558=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17557=0.0)

	(position counter#1::chewie_door_right_joint pstn17554=1.872)
	(position oven#1::knob_joint_2 pstn17557=0.0)
	(position counter#1::chewie_door_left_joint pstn17555=-1.872)
	(position oven#1::knob_joint_3 pstn17558=0.0)
	(position faucet#1::joint_faucet_0 pstn17559=0.0)
	(position fridge#1::fridge_door pstn17556=1.78)

	(pose chicken-leg p69928=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p69932=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p69929=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose salt-shaker p69931=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p69927=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p69929=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose braiserbody#1 p69927=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p69931=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p69928=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p69932=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq824=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq288=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn17554=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn17555=-1.872)
	(isopenedposition fridge#1::fridge_door pstn17556=1.78)

	(ataconf right aq288=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq824=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p69931=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p69932=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p69929=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)
	(supported braiserbody#1 p69930=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
