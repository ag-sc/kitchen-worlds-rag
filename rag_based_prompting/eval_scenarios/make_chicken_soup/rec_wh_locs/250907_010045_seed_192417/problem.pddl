...
(define
  (problem test_kitchen_chicken_soup_250907_010045_seed_192417)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn8583=0.0)
	(atposition fridge#1::fridge_door pstn8582=1.78)
	(atposition counter#1::chewie_door_left_joint pstn8581=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn8585=0.0)
	(atposition oven#1::knob_joint_3 pstn8584=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8580=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn8585=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8584=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8583=0.0)

	(position counter#1::chewie_door_right_joint pstn8580=1.872)
	(position fridge#1::fridge_door pstn8582=1.78)
	(position counter#1::chewie_door_left_joint pstn8581=-1.872)
	(position faucet#1::joint_faucet_0 pstn8585=0.0)
	(position oven#1::knob_joint_2 pstn8583=0.0)
	(position oven#1::knob_joint_3 pstn8584=0.0)

	(atpose salt-shaker p26518=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p26515=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p26519=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p26516=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539))
	(atpose braiserbody#1 p26514=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p26519=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p26518=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p26514=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p26516=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539))
	(pose chicken-leg p26515=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn8580=1.872)
	(isopenedposition fridge#1::fridge_door pstn8582=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8581=-1.872)
	...
	(contained salt-shaker p26518=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p26519=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p26516=(0.567, 7.872, 0.712, 0.0, -0.0, 2.539) counter#1::front_left_stove)
	(supported braiserbody#1 p26517=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
