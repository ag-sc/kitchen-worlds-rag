...
(define
  (problem test_kitchen_chicken_soup_250907_122529_seed_823374)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn17178=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17179=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17177=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn17174=1.872)
	(position faucet#1::joint_faucet_0 pstn17179=0.0)
	(position fridge#1::fridge_door pstn17176=1.78)
	(position counter#1::chewie_door_left_joint pstn17175=-1.872)
	(position oven#1::knob_joint_2 pstn17177=0.0)
	(position oven#1::knob_joint_3 pstn17178=0.0)

	(atposition counter#1::chewie_door_right_joint pstn17174=1.872)
	(atposition faucet#1::joint_faucet_0 pstn17179=0.0)
	(atposition oven#1::knob_joint_2 pstn17177=0.0)
	(atposition fridge#1::fridge_door pstn17176=1.78)
	(atposition counter#1::chewie_door_left_joint pstn17175=-1.872)
	(atposition oven#1::knob_joint_3 pstn17178=0.0)

	(pose salt-shaker p55572=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p55568=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p55570=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(pose pepper-shaker p55573=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p55569=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p55569=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p55570=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(atpose braiserbody#1 p55568=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p55572=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p55573=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq856=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq776=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn17175=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn17174=1.872)
	(isopenedposition fridge#1::fridge_door pstn17176=1.78)

	(ataconf right aq776=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq856=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p55572=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p55573=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p55571=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p55570=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762) counter#1::front_left_stove)
