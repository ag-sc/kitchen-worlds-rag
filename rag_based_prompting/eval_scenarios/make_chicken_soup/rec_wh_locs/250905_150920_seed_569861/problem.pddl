...
(define
  (problem test_kitchen_chicken_soup_250905_150920_seed_569861)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn11931=0.0)
	(position counter#1::chewie_door_left_joint pstn11928=-1.872)
	(position fridge#1::fridge_door pstn11929=1.78)
	(position faucet#1::joint_faucet_0 pstn11932=0.0)
	(position oven#1::knob_joint_2 pstn11930=0.0)
	(position counter#1::chewie_door_right_joint pstn11927=1.872)
	...
	(atposition oven#1::knob_joint_3 pstn11931=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11928=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn11932=0.0)
	(atposition oven#1::knob_joint_2 pstn11930=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11927=1.872)
	(atposition fridge#1::fridge_door pstn11929=1.78)

	(isclosedposition oven#1::knob_joint_2 pstn11930=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11931=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11932=0.0)

	(isopenedposition fridge#1::fridge_door pstn11929=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11927=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11928=-1.872)

	(pose braiserbody#1 p14118=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p14119=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p14120=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(pose pepper-shaker p14123=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p14122=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p14122=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14118=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p14120=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(atpose chicken-leg p14119=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p14123=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p14122=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14123=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14120=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022) counter#1::front_left_stove)
	(supported braiserbody#1 p14121=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
