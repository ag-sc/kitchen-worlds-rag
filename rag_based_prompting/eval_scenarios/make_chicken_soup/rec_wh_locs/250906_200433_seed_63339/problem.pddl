...
(define
  (problem test_kitchen_chicken_soup_250906_200433_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(pose chicken-leg p14107=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p14110=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p14108=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose pepper-shaker p14111=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p14106=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p14106=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p14107=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p14110=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p14111=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p14108=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	...
	(contained salt-shaker p14110=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14111=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p14109=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p14108=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
