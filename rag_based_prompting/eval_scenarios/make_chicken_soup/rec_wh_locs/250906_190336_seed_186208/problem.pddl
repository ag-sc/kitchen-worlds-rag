...
(define
  (problem test_kitchen_chicken_soup_250906_190336_seed_186208)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn2776=0.0)
	(position oven#1::knob_joint_2 pstn2775=0.0)
	(position counter#1::chewie_door_right_joint pstn2772=1.872)
	(position fridge#1::fridge_door pstn2774=1.78)
	(position faucet#1::joint_faucet_0 pstn2777=0.0)
	(position counter#1::chewie_door_left_joint pstn2773=-1.872)

	(atposition oven#1::knob_joint_3 pstn2776=0.0)
	(atposition oven#1::knob_joint_2 pstn2775=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2772=1.872)
	(atposition fridge#1::fridge_door pstn2774=1.78)
	(atposition faucet#1::joint_faucet_0 pstn2777=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2773=-1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn2774=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2773=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2772=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn2777=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2776=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2775=0.0)

	(pose pepper-shaker p11170=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p11169=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p11165=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p11167=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167))
	(pose chicken-leg p11166=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p11167=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167))
	(atpose chicken-leg p11166=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p11170=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p11165=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p11169=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p11169=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p11170=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p11168=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p11167=(0.567, 7.872, 0.712, 0.0, -0.0, 0.167) counter#1::front_left_stove)
