...
(define
  (problem test_kitchen_chicken_soup_250906_081003_seed_817039)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn721=0.0)
	(position counter#1::chewie_door_left_joint pstn717=-1.872)
	(position oven#1::knob_joint_2 pstn719=0.0)
	(position oven#1::knob_joint_3 pstn720=0.0)
	(position counter#1::chewie_door_right_joint pstn716=1.872)
	(position fridge#1::fridge_door pstn718=1.78)

	(atposition faucet#1::joint_faucet_0 pstn721=0.0)
	(atposition fridge#1::fridge_door pstn718=1.78)
	(atposition counter#1::chewie_door_left_joint pstn717=-1.872)
	(atposition oven#1::knob_joint_2 pstn719=0.0)
	(atposition oven#1::knob_joint_3 pstn720=0.0)
	(atposition counter#1::chewie_door_right_joint pstn716=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn719=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn720=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn721=0.0)

	(pose braiserbody#1 p424=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p426=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose pepper-shaker p429=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p425=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p428=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p428=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p424=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p426=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose pepper-shaker p429=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p425=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn716=1.872)
	(isopenedposition fridge#1::fridge_door pstn718=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn717=-1.872)
	...
	(contained salt-shaker p428=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p429=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p427=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p426=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
