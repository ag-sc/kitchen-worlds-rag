...
(define
  (problem test_kitchen_chicken_soup_250907_090632_seed_896655)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn14341=0.0)
	(position oven#1::knob_joint_3 pstn14340=0.0)
	(position fridge#1::fridge_door pstn14338=1.78)
	(position oven#1::knob_joint_2 pstn14339=0.0)
	(position counter#1::chewie_door_right_joint pstn14336=1.872)
	(position counter#1::chewie_door_left_joint pstn14337=-1.872)

	(atposition faucet#1::joint_faucet_0 pstn14341=0.0)
	(atposition oven#1::knob_joint_3 pstn14340=0.0)
	(atposition fridge#1::fridge_door pstn14338=1.78)
	(atposition oven#1::knob_joint_2 pstn14339=0.0)
	(atposition counter#1::chewie_door_right_joint pstn14336=1.872)
	(atposition counter#1::chewie_door_left_joint pstn14337=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn14341=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14340=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14339=0.0)

	(pose pepper-shaker p48289=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p48284=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p48288=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p48285=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p48286=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))

	(atpose braiserlid#1 p48286=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(atpose pepper-shaker p48289=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p48284=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p48285=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p48288=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn14336=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn14337=-1.872)
	(isopenedposition fridge#1::fridge_door pstn14338=1.78)
	...
	(contained pepper-shaker p48289=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p48288=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p48287=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p48286=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987) counter#1::front_left_stove)
