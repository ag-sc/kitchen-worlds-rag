...
(define
  (problem test_kitchen_chicken_soup_250907_032048_seed_543413)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn9871=0.0)
	(position fridge#1::fridge_door pstn9869=1.78)
	(position faucet#1::joint_faucet_0 pstn9872=0.0)
	(position oven#1::knob_joint_2 pstn9870=0.0)
	(position counter#1::chewie_door_right_joint pstn9867=1.872)
	(position counter#1::chewie_door_left_joint pstn9868=-1.872)
	...
	(atposition fridge#1::fridge_door pstn9869=1.78)
	(atposition faucet#1::joint_faucet_0 pstn9872=0.0)
	(atposition oven#1::knob_joint_3 pstn9871=0.0)
	(atposition counter#1::chewie_door_left_joint pstn9868=-1.872)
	(atposition oven#1::knob_joint_2 pstn9870=0.0)
	(atposition counter#1::chewie_door_right_joint pstn9867=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn9871=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9870=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9872=0.0)
	...
	(atpose chicken-leg p34098=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p34102=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p34099=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(atpose braiserbody#1 p34097=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p34101=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p34102=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p34101=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p34097=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p34099=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92))
	(pose chicken-leg p34098=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn9867=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn9868=-1.872)
	(isopenedposition fridge#1::fridge_door pstn9869=1.78)
	...
	(contained salt-shaker p34101=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p34102=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p34100=(0.7, 8.757, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p34099=(0.567, 7.872, 0.712, 0.0, -0.0, 2.92) counter#1::front_left_stove)
