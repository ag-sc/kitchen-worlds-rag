...
(define
  (problem test_kitchen_chicken_soup_250906_042121_seed_567288)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn26524=0.0)
	(position oven#1::knob_joint_3 pstn26525=0.0)
	(position faucet#1::joint_faucet_0 pstn26526=0.0)
	(position counter#1::chewie_door_left_joint pstn26522=-1.872)
	(position counter#1::chewie_door_right_joint pstn26521=1.872)
	(position fridge#1::fridge_door pstn26523=1.78)
	...
	(atposition oven#1::knob_joint_3 pstn26525=0.0)
	(atposition fridge#1::fridge_door pstn26523=1.78)
	(atposition oven#1::knob_joint_2 pstn26524=0.0)
	(atposition faucet#1::joint_faucet_0 pstn26526=0.0)
	(atposition counter#1::chewie_door_right_joint pstn26521=1.872)
	(atposition counter#1::chewie_door_left_joint pstn26522=-1.872)

	(isclosedposition oven#1::knob_joint_3 pstn26525=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn26526=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn26524=0.0)

	(pose braiserlid#1 p47765=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(pose braiserbody#1 p47763=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p47764=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p47768=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p47767=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p47765=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(atpose braiserbody#1 p47763=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p47764=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p47768=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p47767=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn26522=-1.872)
	(isopenedposition fridge#1::fridge_door pstn26523=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn26521=1.872)
	...
	(contained salt-shaker p47767=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p47768=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p47766=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p47765=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683) counter#1::front_left_stove)
