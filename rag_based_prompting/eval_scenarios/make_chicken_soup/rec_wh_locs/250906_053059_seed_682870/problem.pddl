...
(define
  (problem test_kitchen_chicken_soup_250906_053059_seed_682870)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn28727=0.0)
	(atposition counter#1::chewie_door_left_joint pstn28725=-1.872)
	(atposition fridge#1::fridge_door pstn28726=1.78)
	(atposition counter#1::chewie_door_right_joint pstn28724=1.872)
	(atposition oven#1::knob_joint_3 pstn28728=0.0)
	(atposition faucet#1::joint_faucet_0 pstn28729=0.0)

	(position faucet#1::joint_faucet_0 pstn28729=0.0)
	(position oven#1::knob_joint_3 pstn28728=0.0)
	(position counter#1::chewie_door_left_joint pstn28725=-1.872)
	(position fridge#1::fridge_door pstn28726=1.78)
	(position counter#1::chewie_door_right_joint pstn28724=1.872)
	(position oven#1::knob_joint_2 pstn28727=0.0)

	(isopenedposition fridge#1::fridge_door pstn28726=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn28724=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn28725=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn28729=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn28727=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn28728=0.0)

	(pose braiserlid#1 p48438=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126))
	(pose pepper-shaker p48441=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p48436=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p48437=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p48440=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p48437=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p48440=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p48441=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p48436=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p48438=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126))
	...
	(contained pepper-shaker p48441=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p48440=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p48439=(0.7, 8.763, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p48438=(0.567, 7.872, 0.712, 0.0, -0.0, 3.126) counter#1::front_left_stove)
