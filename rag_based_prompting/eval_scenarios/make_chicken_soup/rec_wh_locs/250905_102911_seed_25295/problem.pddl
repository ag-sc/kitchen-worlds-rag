...
(define
  (problem test_kitchen_chicken_soup_250905_102911_seed_25295)
  (:domain domain)
  ...
  (:init
	...
	(position counter#1::chewie_door_right_joint pstn4464=1.872)
	(position fridge#1::fridge_door pstn4466=1.78)
	...
	(position counter#1::chewie_door_left_joint pstn4465=-1.872)

	(atposition counter#1::chewie_door_right_joint pstn4464=1.872)
	(atposition fridge#1::fridge_door pstn4466=1.78)
	...
	(atposition counter#1::chewie_door_left_joint pstn4465=-1.872)

	(pose braiserbody#1 p4409=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p4414=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p4410=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p4411=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(pose salt-shaker p4413=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p4410=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p4409=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p4411=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(atpose salt-shaker p4413=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p4414=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn4465=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4466=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4464=1.872)
	...
	(contained pepper-shaker p4414=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4413=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p4412=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p4411=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662) counter#1::front_left_stove)
