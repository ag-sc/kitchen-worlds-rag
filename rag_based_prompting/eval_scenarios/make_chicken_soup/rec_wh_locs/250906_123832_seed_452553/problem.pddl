...
(define
  (problem test_kitchen_chicken_soup_250906_123832_seed_452553)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn5900=1.78)
	(atposition counter#1::chewie_door_right_joint pstn5898=1.872)
	(atposition counter#1::chewie_door_left_joint pstn5899=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn5903=0.0)
	(atposition oven#1::knob_joint_3 pstn5902=0.0)
	(atposition oven#1::knob_joint_2 pstn5901=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn5902=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5901=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5903=0.0)

	(isopenedposition fridge#1::fridge_door pstn5900=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5899=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn5898=1.872)

	(position counter#1::chewie_door_left_joint pstn5899=-1.872)
	(position counter#1::chewie_door_right_joint pstn5898=1.872)
	(position oven#1::knob_joint_3 pstn5902=0.0)
	(position oven#1::knob_joint_2 pstn5901=0.0)
	(position faucet#1::joint_faucet_0 pstn5903=0.0)
	(position fridge#1::fridge_door pstn5900=1.78)

	(pose salt-shaker p10032=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p10030=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(pose braiserbody#1 p10028=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p10029=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p10033=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p10033=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p10028=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p10032=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p10030=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(atpose chicken-leg p10029=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p10033=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p10032=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p10031=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p10030=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452) counter#1::front_left_stove)
