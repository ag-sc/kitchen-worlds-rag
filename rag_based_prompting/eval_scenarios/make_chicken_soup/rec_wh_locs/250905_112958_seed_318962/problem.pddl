...
(define
  (problem test_kitchen_chicken_soup_250905_112958_seed_318962)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn6384=0.0)
	(atposition oven#1::knob_joint_3 pstn6385=0.0)
	(atposition counter#1::chewie_door_right_joint pstn6381=1.872)
	(atposition fridge#1::fridge_door pstn6383=1.78)
	(atposition counter#1::chewie_door_left_joint pstn6382=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn6386=0.0)
	(position fridge#1::fridge_door pstn6383=1.78)
	(position counter#1::chewie_door_right_joint pstn6381=1.872)
	(position oven#1::knob_joint_3 pstn6385=0.0)
	(position oven#1::knob_joint_2 pstn6384=0.0)
	(position counter#1::chewie_door_left_joint pstn6382=-1.872)
	(position faucet#1::joint_faucet_0 pstn6386=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn6385=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6386=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6384=0.0)

	(pose braiserlid#1 p6095=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79))
	(pose pepper-shaker p6098=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p6094=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p6097=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p6093=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p6097=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p6093=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p6098=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p6094=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p6095=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79))

	(isopenedposition counter#1::chewie_door_left_joint pstn6382=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn6381=1.872)
	(isopenedposition fridge#1::fridge_door pstn6383=1.78)
	...
	(contained pepper-shaker p6098=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p6097=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p6095=(0.567, 7.872, 0.712, 0.0, -0.0, 0.79) counter#1::front_left_stove)
	(supported braiserbody#1 p6096=(0.7, 8.851, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
