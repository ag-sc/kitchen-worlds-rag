...
(define
  (problem test_kitchen_chicken_soup_250907_115413_seed_517017)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn16959=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16960=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16958=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn16955=1.872)
	(position fridge#1::fridge_door pstn16957=1.78)
	(position faucet#1::joint_faucet_0 pstn16960=0.0)
	(position counter#1::chewie_door_left_joint pstn16956=-1.872)
	(position oven#1::knob_joint_3 pstn16959=0.0)
	(position oven#1::knob_joint_2 pstn16958=0.0)

	(atposition counter#1::chewie_door_right_joint pstn16955=1.872)
	(atposition faucet#1::joint_faucet_0 pstn16960=0.0)
	(atposition oven#1::knob_joint_2 pstn16958=0.0)
	(atposition fridge#1::fridge_door pstn16957=1.78)
	(atposition counter#1::chewie_door_left_joint pstn16956=-1.872)
	(atposition oven#1::knob_joint_3 pstn16959=0.0)

	(pose braiserlid#1 p53306=(0.567, 7.872, 0.712, 0.0, -0.0, 2.522))
	(pose salt-shaker p53308=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p53309=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p53305=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p53304=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p53308=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p53309=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p53306=(0.567, 7.872, 0.712, 0.0, -0.0, 2.522))
	(atpose chicken-leg p53305=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p53304=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn16956=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16955=1.872)
	(isopenedposition fridge#1::fridge_door pstn16957=1.78)
	...
	(contained salt-shaker p53308=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p53309=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p53306=(0.567, 7.872, 0.712, 0.0, -0.0, 2.522) counter#1::front_left_stove)
	(supported braiserbody#1 p53307=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
