...
(define
  (problem test_kitchen_chicken_soup_250907_170841_seed_709159)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn1084=0.0)
	(atposition oven#1::knob_joint_2 pstn1082=0.0)
	(atposition fridge#1::fridge_door pstn1081=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1079=1.872)
	(atposition oven#1::knob_joint_3 pstn1083=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1080=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn1084=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1083=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1082=0.0)

	(position counter#1::chewie_door_left_joint pstn1080=-1.872)
	(position counter#1::chewie_door_right_joint pstn1079=1.872)
	(position faucet#1::joint_faucet_0 pstn1084=0.0)
	(position fridge#1::fridge_door pstn1081=1.78)
	(position oven#1::knob_joint_2 pstn1082=0.0)
	(position oven#1::knob_joint_3 pstn1083=0.0)

	(pose braiserlid#1 p898=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(pose braiserbody#1 p896=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p897=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p900=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p901=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p896=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p897=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p900=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p901=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p898=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))

	(isopenedposition counter#1::chewie_door_right_joint pstn1079=1.872)
	(isopenedposition fridge#1::fridge_door pstn1081=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1080=-1.872)
	...
	(contained pepper-shaker p901=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p900=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p898=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44) counter#1::front_left_stove)
	(supported braiserbody#1 p899=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
