...
(define
  (problem test_kitchen_chicken_soup_250905_192422_seed_478395)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn17451=0.0)
	(position fridge#1::fridge_door pstn17449=1.78)
	(position counter#1::chewie_door_left_joint pstn17448=-1.872)
	(position counter#1::chewie_door_right_joint pstn17447=1.872)
	(position oven#1::knob_joint_2 pstn17450=0.0)
	(position faucet#1::joint_faucet_0 pstn17452=0.0)
	...
	(atposition fridge#1::fridge_door pstn17449=1.78)
	(atposition counter#1::chewie_door_left_joint pstn17448=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn17452=0.0)
	(atposition oven#1::knob_joint_2 pstn17450=0.0)
	(atposition counter#1::chewie_door_right_joint pstn17447=1.872)
	(atposition oven#1::knob_joint_3 pstn17451=0.0)

	(isclosedposition faucet#1::joint_faucet_0 pstn17452=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17450=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17451=0.0)

	(atpose salt-shaker p26197=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p26194=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p26193=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p26195=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(atpose pepper-shaker p26198=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p26198=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p26197=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p26194=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p26193=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p26195=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))

	(aconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq72=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn17447=1.872)
	(isopenedposition fridge#1::fridge_door pstn17449=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn17448=-1.872)

	(ataconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq72=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p26198=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p26197=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p26196=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p26195=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304) counter#1::front_left_stove)
