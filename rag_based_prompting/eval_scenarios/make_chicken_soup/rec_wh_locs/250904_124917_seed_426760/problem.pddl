...
(define
  (problem test_kitchen_chicken_soup_250904_124917_seed_426760)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn5024=1.78)
	(atposition oven#1::knob_joint_3 pstn5026=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5023=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn5022=1.872)
	(atposition faucet#1::joint_faucet_0 pstn5027=0.0)
	(atposition oven#1::knob_joint_2 pstn5025=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn5025=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5026=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5027=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn5022=1.872)
	(position faucet#1::joint_faucet_0 pstn5027=0.0)
	(position fridge#1::fridge_door pstn5024=1.78)
	(position oven#1::knob_joint_3 pstn5026=0.0)
	(position counter#1::chewie_door_left_joint pstn5023=-1.872)
	(position oven#1::knob_joint_2 pstn5025=0.0)

	(pose chicken-leg p15627=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p15631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p15626=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p15630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p15628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352))

	(isopenedposition counter#1::chewie_door_right_joint pstn5022=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5023=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5024=1.78)

	(atpose pepper-shaker p15631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p15627=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p15628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352))
	(atpose braiserbody#1 p15626=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p15630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p15630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p15631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p15628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.352) counter#1::front_left_stove)
	(supported braiserbody#1 p15629=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
