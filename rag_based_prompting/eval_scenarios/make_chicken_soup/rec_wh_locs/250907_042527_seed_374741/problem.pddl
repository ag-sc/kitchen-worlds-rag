...
(define
  (problem test_kitchen_chicken_soup_250907_042527_seed_374741)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn10822=0.0)
	(position counter#1::chewie_door_right_joint pstn10817=1.872)
	(position counter#1::chewie_door_left_joint pstn10818=-1.872)
	(position oven#1::knob_joint_3 pstn10821=0.0)
	(position fridge#1::fridge_door pstn10819=1.78)
	(position oven#1::knob_joint_2 pstn10820=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn10821=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10820=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10822=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn10819=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn10817=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn10818=-1.872)

	(atposition counter#1::chewie_door_right_joint pstn10817=1.872)
	(atposition counter#1::chewie_door_left_joint pstn10818=-1.872)
	(atposition oven#1::knob_joint_2 pstn10820=0.0)
	(atposition oven#1::knob_joint_3 pstn10821=0.0)
	(atposition fridge#1::fridge_door pstn10819=1.78)
	(atposition faucet#1::joint_faucet_0 pstn10822=0.0)

	(pose braiserlid#1 p36097=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(pose chicken-leg p36096=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p36100=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p36095=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p36099=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p36095=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p36096=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p36099=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p36100=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p36097=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	...
	(contained salt-shaker p36099=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p36100=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p36097=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355) counter#1::front_left_stove)
	(supported braiserbody#1 p36098=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
