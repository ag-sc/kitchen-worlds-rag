...
(define
  (problem test_kitchen_chicken_soup_250906_110538_seed_738733)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn4628=1.78)
	(atposition faucet#1::joint_faucet_0 pstn4631=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4626=1.872)
	(atposition oven#1::knob_joint_2 pstn4629=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4627=-1.872)
	(atposition oven#1::knob_joint_3 pstn4630=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn4629=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4631=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4630=0.0)

	(isopenedposition fridge#1::fridge_door pstn4628=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4626=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn4627=-1.872)

	(position counter#1::chewie_door_right_joint pstn4626=1.872)
	(position oven#1::knob_joint_2 pstn4629=0.0)
	(position counter#1::chewie_door_left_joint pstn4627=-1.872)
	(position faucet#1::joint_faucet_0 pstn4631=0.0)
	(position oven#1::knob_joint_3 pstn4630=0.0)
	(position fridge#1::fridge_door pstn4628=1.78)

	(pose salt-shaker p5945=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p5942=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p5946=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p5943=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	(pose braiserbody#1 p5941=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p5942=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p5943=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	(atpose salt-shaker p5945=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p5946=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p5941=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p5946=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p5945=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p5943=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791) counter#1::front_left_stove)
	(supported braiserbody#1 p5944=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
