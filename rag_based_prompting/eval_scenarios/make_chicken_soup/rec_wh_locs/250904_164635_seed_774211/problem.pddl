...
(define
  (problem test_kitchen_chicken_soup_250904_164635_seed_774211)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn11790=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11787=1.872)
	(atposition faucet#1::joint_faucet_0 pstn11792=0.0)
	(atposition oven#1::knob_joint_3 pstn11791=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11788=-1.872)
	(atposition fridge#1::fridge_door pstn11789=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn11792=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11790=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11791=0.0)

	(position counter#1::chewie_door_right_joint pstn11787=1.872)
	(position faucet#1::joint_faucet_0 pstn11792=0.0)
	(position oven#1::knob_joint_3 pstn11791=0.0)
	(position counter#1::chewie_door_left_joint pstn11788=-1.872)
	(position fridge#1::fridge_door pstn11789=1.78)
	(position oven#1::knob_joint_2 pstn11790=0.0)

	(pose chicken-leg p32504=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p32507=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p32505=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(pose pepper-shaker p32508=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p32503=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p32503=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p32505=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	(atpose salt-shaker p32507=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p32508=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p32504=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn11787=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11788=-1.872)
	(isopenedposition fridge#1::fridge_door pstn11789=1.78)
	...
	(contained salt-shaker p32507=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p32508=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p32505=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682) counter#1::front_left_stove)
	(supported braiserbody#1 p32506=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
