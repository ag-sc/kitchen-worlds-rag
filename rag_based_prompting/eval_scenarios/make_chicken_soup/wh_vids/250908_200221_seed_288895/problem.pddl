...
(define
  (problem test_kitchen_chicken_soup_250908_200221_seed_288895)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn16387=1.78)
	(atposition oven#1::knob_joint_3 pstn16389=0.0)
	(atposition counter#1::chewie_door_right_joint pstn16385=1.872)
	(atposition oven#1::knob_joint_2 pstn16388=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16386=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn16390=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn16389=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16390=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16388=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn16386=-1.872)
	(position fridge#1::fridge_door pstn16387=1.78)
	(position oven#1::knob_joint_3 pstn16389=0.0)
	(position faucet#1::joint_faucet_0 pstn16390=0.0)
	(position oven#1::knob_joint_2 pstn16388=0.0)
	(position counter#1::chewie_door_right_joint pstn16385=1.872)

	(pose braiserbody#1 p29923=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p29924=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p29925=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(pose salt-shaker p29927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p29928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p29927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p29928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p29923=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p29924=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p29925=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))

	(aconf left aq808=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq736=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn16386=-1.872)
	(isopenedposition fridge#1::fridge_door pstn16387=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16385=1.872)

	(ataconf left aq808=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq736=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(supported braiserbody#1 p29926=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p29925=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247) counter#1::front_left_stove)

	(contained pepper-shaker p29928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p29927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
