...
(define
  (problem test_kitchen_chicken_soup_250909_040610_seed_662398)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn30430=0.0)
	(position counter#1::chewie_door_right_joint pstn30427=1.872)
	(position oven#1::knob_joint_3 pstn30431=0.0)
	(position faucet#1::joint_faucet_0 pstn30432=0.0)
	(position fridge#1::fridge_door pstn30429=1.78)
	(position counter#1::chewie_door_left_joint pstn30428=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn30432=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn30430=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn30431=0.0)

	(atposition counter#1::chewie_door_right_joint pstn30427=1.872)
	(atposition oven#1::knob_joint_3 pstn30431=0.0)
	(atposition faucet#1::joint_faucet_0 pstn30432=0.0)
	(atposition fridge#1::fridge_door pstn30429=1.78)
	(atposition counter#1::chewie_door_left_joint pstn30428=-1.872)
	(atposition oven#1::knob_joint_2 pstn30430=0.0)

	(pose chicken-leg p74251=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p74252=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(pose braiserbody#1 p74250=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p74254=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p74255=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p74251=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p74252=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(atpose braiserbody#1 p74250=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p74254=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p74255=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq968=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq488=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn30428=-1.872)
	(isopenedposition fridge#1::fridge_door pstn30429=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn30427=1.872)

	(ataconf right aq488=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq968=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p74254=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p74255=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p74253=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p74252=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574) counter#1::front_left_stove)
