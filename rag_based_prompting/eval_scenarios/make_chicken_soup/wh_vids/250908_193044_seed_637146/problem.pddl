...
(define
  (problem test_kitchen_chicken_soup_250908_193044_seed_637146)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn15324=0.0)
	(atposition counter#1::chewie_door_right_joint pstn15321=1.872)
	(atposition counter#1::chewie_door_left_joint pstn15322=-1.872)
	(atposition fridge#1::fridge_door pstn15323=1.78)
	(atposition faucet#1::joint_faucet_0 pstn15326=0.0)
	(atposition oven#1::knob_joint_3 pstn15325=0.0)
	(position fridge#1::fridge_door pstn15323=1.78)
	(position oven#1::knob_joint_3 pstn15325=0.0)
	(position faucet#1::joint_faucet_0 pstn15326=0.0)
	(position oven#1::knob_joint_2 pstn15324=0.0)
	(position counter#1::chewie_door_right_joint pstn15321=1.872)
	(position counter#1::chewie_door_left_joint pstn15322=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn15324=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15326=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15325=0.0)
	...
	(pose chicken-leg p29591=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p29595=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p29592=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(pose braiserbody#1 p29590=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p29594=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq56=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq112=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(atpose pepper-shaker p29595=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p29592=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073))
	(atpose braiserbody#1 p29590=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p29594=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p29591=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn15321=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn15322=-1.872)
	(isopenedposition fridge#1::fridge_door pstn15323=1.78)

	(ataconf right aq112=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq56=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p29594=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p29595=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p29592=(0.567, 7.872, 0.712, 0.0, -0.0, 1.073) counter#1::front_left_stove)
	(supported braiserbody#1 p29593=(0.7, 8.871, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
