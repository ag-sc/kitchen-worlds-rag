...
(define
  (problem test_kitchen_chicken_soup_250909_181652_seed_708959)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn5443=1.78)
	(position counter#1::chewie_door_right_joint pstn5441=1.872)
	(position oven#1::knob_joint_2 pstn5444=0.0)
	(position faucet#1::joint_faucet_0 pstn5446=0.0)
	(position counter#1::chewie_door_left_joint pstn5442=-1.872)
	(position oven#1::knob_joint_3 pstn5445=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn5444=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5445=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5446=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn5441=1.872)
	(atposition oven#1::knob_joint_3 pstn5445=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5442=-1.872)
	(atposition oven#1::knob_joint_2 pstn5444=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5446=0.0)
	(atposition fridge#1::fridge_door pstn5443=1.78)

	(pose braiserlid#1 p3619=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(pose salt-shaker p3621=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p3618=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p3617=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p3622=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p3618=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p3621=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p3617=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p3622=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p3619=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))

	(isopenedposition counter#1::chewie_door_left_joint pstn5442=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn5441=1.872)
	(isopenedposition fridge#1::fridge_door pstn5443=1.78)
	...
	(contained salt-shaker p3621=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3622=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p3620=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3619=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278) counter#1::front_left_stove)
