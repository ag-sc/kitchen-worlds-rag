...
(define
  (problem test_kitchen_chicken_soup_250909_221514_seed_569765)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn14003=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14004=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14002=0.0)

	(position counter#1::chewie_door_right_joint pstn13999=1.872)
	(position counter#1::chewie_door_left_joint pstn14000=-1.872)
	(position oven#1::knob_joint_3 pstn14003=0.0)
	(position fridge#1::fridge_door pstn14001=1.78)
	(position oven#1::knob_joint_2 pstn14002=0.0)
	(position faucet#1::joint_faucet_0 pstn14004=0.0)

	(atposition counter#1::chewie_door_right_joint pstn13999=1.872)
	(atposition counter#1::chewie_door_left_joint pstn14000=-1.872)
	(atposition oven#1::knob_joint_3 pstn14003=0.0)
	(atposition oven#1::knob_joint_2 pstn14002=0.0)
	(atposition fridge#1::fridge_door pstn14001=1.78)
	(atposition faucet#1::joint_faucet_0 pstn14004=0.0)

	(pose braiserbody#1 p16753=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p16754=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p16757=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p16758=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p16755=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846))

	(atpose chicken-leg p16754=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p16757=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p16758=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p16755=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846))
	(atpose braiserbody#1 p16753=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn14000=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn13999=1.872)
	(isopenedposition fridge#1::fridge_door pstn14001=1.78)
	...
	(contained salt-shaker p16757=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p16758=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p16756=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p16755=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846) counter#1::front_left_stove)
