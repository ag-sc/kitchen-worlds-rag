...
(define
  (problem test_kitchen_chicken_soup_250908_140005_seed_272790)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn5971=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5972=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5968=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn5967=1.872)
	(atposition oven#1::knob_joint_2 pstn5970=0.0)
	(atposition fridge#1::fridge_door pstn5969=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn5970=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5972=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5971=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn5969=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5968=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn5967=1.872)
	...
	(position counter#1::chewie_door_right_joint pstn5967=1.872)
	(position fridge#1::fridge_door pstn5969=1.78)
	(position counter#1::chewie_door_left_joint pstn5968=-1.872)
	(position oven#1::knob_joint_2 pstn5970=0.0)
	(position oven#1::knob_joint_3 pstn5971=0.0)
	(position faucet#1::joint_faucet_0 pstn5972=0.0)

	(pose salt-shaker p12514=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p12512=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(pose chicken-leg p12511=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p12510=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p12515=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p12515=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p12514=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p12512=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(atpose chicken-leg p12511=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p12510=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p12514=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12515=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p12513=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p12512=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401) counter#1::front_left_stove)
