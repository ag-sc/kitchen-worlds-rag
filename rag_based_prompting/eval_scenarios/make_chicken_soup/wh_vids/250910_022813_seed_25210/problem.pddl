...
(define
  (problem test_kitchen_chicken_soup_250910_022813_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn6016=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6014=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6015=0.0)

	(position counter#1::chewie_door_left_joint pstn6012=-1.872)
	(position oven#1::knob_joint_3 pstn6015=0.0)
	(position oven#1::knob_joint_2 pstn6014=0.0)
	(position fridge#1::fridge_door pstn6013=1.78)
	(position faucet#1::joint_faucet_0 pstn6016=0.0)
	(position counter#1::chewie_door_right_joint pstn6011=1.872)

	(atposition counter#1::chewie_door_right_joint pstn6011=1.872)
	(atposition oven#1::knob_joint_2 pstn6014=0.0)
	(atposition fridge#1::fridge_door pstn6013=1.78)
	(atposition counter#1::chewie_door_left_joint pstn6012=-1.872)
	(atposition oven#1::knob_joint_3 pstn6015=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6016=0.0)

	(pose braiserlid#1 p17093=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(pose braiserbody#1 p17091=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p17095=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p17096=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p17092=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p17095=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p17093=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(atpose braiserbody#1 p17091=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p17096=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p17092=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn6012=-1.872)
	(isopenedposition fridge#1::fridge_door pstn6013=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6011=1.872)
	...
	(contained salt-shaker p17095=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p17096=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p17094=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p17093=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
