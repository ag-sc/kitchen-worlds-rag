...
(define
  (problem test_kitchen_chicken_soup_250909_010006_seed_567288)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn25570=0.0)
	(position fridge#1::fridge_door pstn25569=1.78)
	(position faucet#1::joint_faucet_0 pstn25572=0.0)
	(position oven#1::knob_joint_3 pstn25571=0.0)
	(position counter#1::chewie_door_right_joint pstn25567=1.872)
	(position counter#1::chewie_door_left_joint pstn25568=-1.872)
	...
	(atposition fridge#1::fridge_door pstn25569=1.78)
	(atposition faucet#1::joint_faucet_0 pstn25572=0.0)
	(atposition oven#1::knob_joint_3 pstn25571=0.0)
	(atposition counter#1::chewie_door_left_joint pstn25568=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn25567=1.872)
	(atposition oven#1::knob_joint_2 pstn25570=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn25572=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn25571=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn25570=0.0)

	(pose pepper-shaker p58251=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p58246=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p58247=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p58250=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p58248=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))

	(aconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq328=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(atpose pepper-shaker p58251=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p58246=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p58247=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p58250=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p58248=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(isopenedposition counter#1::chewie_door_right_joint pstn25567=1.872)
	(isopenedposition fridge#1::fridge_door pstn25569=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn25568=-1.872)

	(ataconf right aq328=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq96=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p58251=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p58250=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p58248=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683) counter#1::front_left_stove)
	(supported braiserbody#1 p58249=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
