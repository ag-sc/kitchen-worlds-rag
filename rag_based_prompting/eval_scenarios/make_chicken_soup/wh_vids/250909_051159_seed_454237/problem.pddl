...
(define
  (problem test_kitchen_chicken_soup_250909_051159_seed_454237)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn1075=1.78)
	(position counter#1::chewie_door_right_joint pstn1073=1.872)
	(position oven#1::knob_joint_2 pstn1076=0.0)
	(position faucet#1::joint_faucet_0 pstn1078=0.0)
	(position counter#1::chewie_door_left_joint pstn1074=-1.872)
	(position oven#1::knob_joint_3 pstn1077=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn1078=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1077=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1076=0.0)

	(atposition counter#1::chewie_door_left_joint pstn1074=-1.872)
	(atposition fridge#1::fridge_door pstn1075=1.78)
	(atposition oven#1::knob_joint_2 pstn1076=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1073=1.872)
	(atposition faucet#1::joint_faucet_0 pstn1078=0.0)
	(atposition oven#1::knob_joint_3 pstn1077=0.0)

	(pose salt-shaker p1614=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p1615=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1610=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p1612=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129))
	(pose chicken-leg p1611=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p1612=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129))
	(atpose braiserbody#1 p1610=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p1611=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p1615=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p1614=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn1074=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1075=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1073=1.872)
	...
	(contained pepper-shaker p1615=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1614=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p1612=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129) counter#1::front_left_stove)
	(supported braiserbody#1 p1613=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
