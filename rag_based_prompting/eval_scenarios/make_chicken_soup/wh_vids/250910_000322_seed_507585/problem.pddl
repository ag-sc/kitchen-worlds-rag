...
(define
  (problem test_kitchen_chicken_soup_250910_000322_seed_507585)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn2743=0.0)
	(position fridge#1::fridge_door pstn2741=1.78)
	(position counter#1::chewie_door_left_joint pstn2740=-1.872)
	(position oven#1::knob_joint_2 pstn2742=0.0)
	(position counter#1::chewie_door_right_joint pstn2739=1.872)
	(position faucet#1::joint_faucet_0 pstn2744=0.0)

	(atposition oven#1::knob_joint_2 pstn2742=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2739=1.872)
	(atposition oven#1::knob_joint_3 pstn2743=0.0)
	(atposition fridge#1::fridge_door pstn2741=1.78)
	(atposition faucet#1::joint_faucet_0 pstn2744=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2740=-1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn2741=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2740=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2739=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn2744=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2743=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2742=0.0)

	(pose braiserbody#1 p3777=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p3782=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p3781=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p3779=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(pose chicken-leg p3778=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p3781=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p3782=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p3779=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(atpose chicken-leg p3778=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p3777=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p3781=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3782=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p3780=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3779=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39) counter#1::front_left_stove)
