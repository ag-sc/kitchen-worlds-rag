...
(define
  (problem test_kitchen_chicken_soup_250909_210306_seed_74545)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn10996=0.0)
	(atposition counter#1::chewie_door_right_joint pstn10992=1.872)
	(atposition faucet#1::joint_faucet_0 pstn10997=0.0)
	(atposition counter#1::chewie_door_left_joint pstn10993=-1.872)
	(atposition oven#1::knob_joint_2 pstn10995=0.0)
	(atposition fridge#1::fridge_door pstn10994=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn10996=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10995=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10997=0.0)

	(position counter#1::chewie_door_right_joint pstn10992=1.872)
	(position faucet#1::joint_faucet_0 pstn10997=0.0)
	(position counter#1::chewie_door_left_joint pstn10993=-1.872)
	(position oven#1::knob_joint_2 pstn10995=0.0)
	(position fridge#1::fridge_door pstn10994=1.78)
	(position oven#1::knob_joint_3 pstn10996=0.0)

	(pose salt-shaker p13233=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p13230=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p13229=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p13234=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p13231=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))

	(atpose pepper-shaker p13234=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p13233=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p13230=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p13229=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p13231=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(isopenedposition counter#1::chewie_door_left_joint pstn10993=-1.872)
	(isopenedposition fridge#1::fridge_door pstn10994=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn10992=1.872)
	...
	(contained salt-shaker p13233=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p13234=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13232=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13231=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999) counter#1::front_left_stove)
