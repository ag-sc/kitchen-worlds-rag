...
(define
  (problem test_kitchen_chicken_soup_250908_220515_seed_618383)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn20672=1.78)
	(atposition faucet#1::joint_faucet_0 pstn20675=0.0)
	(atposition oven#1::knob_joint_2 pstn20673=0.0)
	(atposition counter#1::chewie_door_left_joint pstn20671=-1.872)
	(atposition oven#1::knob_joint_3 pstn20674=0.0)
	(atposition counter#1::chewie_door_right_joint pstn20670=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn20672=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn20670=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn20671=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn20675=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20674=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20673=0.0)

	(position counter#1::chewie_door_left_joint pstn20671=-1.872)
	(position counter#1::chewie_door_right_joint pstn20670=1.872)
	(position oven#1::knob_joint_3 pstn20674=0.0)
	(position fridge#1::fridge_door pstn20672=1.78)
	(position faucet#1::joint_faucet_0 pstn20675=0.0)
	(position oven#1::knob_joint_2 pstn20673=0.0)

	(pose braiserbody#1 p40532=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p40536=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p40537=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p40533=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p40534=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	...
	(atpose pepper-shaker p40537=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p40533=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p40534=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682))
	(atpose braiserbody#1 p40532=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p40536=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(contained pepper-shaker p40537=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p40536=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p40534=(0.567, 7.872, 0.712, 0.0, -0.0, 2.682) counter#1::front_left_stove)
	(supported braiserbody#1 p40535=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
