...
(define
  (problem test_kitchen_chicken_soup_250909_234447_seed_243003)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1966=1.78)
	(atposition faucet#1::joint_faucet_0 pstn1969=0.0)
	(atposition oven#1::knob_joint_2 pstn1967=0.0)
	(atposition oven#1::knob_joint_3 pstn1968=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1965=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1964=1.872)
	(position faucet#1::joint_faucet_0 pstn1969=0.0)
	(position oven#1::knob_joint_3 pstn1968=0.0)
	(position counter#1::chewie_door_left_joint pstn1965=-1.872)
	(position counter#1::chewie_door_right_joint pstn1964=1.872)
	(position oven#1::knob_joint_2 pstn1967=0.0)
	(position fridge#1::fridge_door pstn1966=1.78)

	(isclosedposition oven#1::knob_joint_2 pstn1967=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1969=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1968=0.0)
	...
	(pose braiserlid#1 p3413=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(pose pepper-shaker p3416=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p3415=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3411=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p3412=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p3413=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(atpose salt-shaker p3415=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p3416=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p3411=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p3412=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn1965=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1964=1.872)
	(isopenedposition fridge#1::fridge_door pstn1966=1.78)
	...
	(contained salt-shaker p3415=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3416=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p3414=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3413=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274) counter#1::front_left_stove)
