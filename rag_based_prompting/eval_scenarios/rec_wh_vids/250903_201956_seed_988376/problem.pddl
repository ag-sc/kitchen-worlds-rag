...
(define
  (problem test_kitchen_chicken_soup_250903_201956_seed_988376)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn5683=0.0)
	(atposition fridge#1::fridge_door pstn5680=1.78)
	(atposition oven#1::knob_joint_3 pstn5682=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5679=-1.872)
	(atposition oven#1::knob_joint_2 pstn5681=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5678=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn5683=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5681=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5682=0.0)

	(position counter#1::chewie_door_right_joint pstn5678=1.872)
	(position fridge#1::fridge_door pstn5680=1.78)
	(position oven#1::knob_joint_2 pstn5681=0.0)
	(position counter#1::chewie_door_left_joint pstn5679=-1.872)
	(position faucet#1::joint_faucet_0 pstn5683=0.0)
	(position oven#1::knob_joint_3 pstn5682=0.0)

	(pose braiserbody#1 p13774=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p13775=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p13779=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p13776=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(pose salt-shaker p13778=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn5678=1.872)
	(isopenedposition fridge#1::fridge_door pstn5680=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5679=-1.872)

	(atpose pepper-shaker p13779=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p13774=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p13775=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p13778=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p13776=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	...
	(contained pepper-shaker p13779=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p13778=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13777=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13776=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975) counter#1::front_left_stove)
