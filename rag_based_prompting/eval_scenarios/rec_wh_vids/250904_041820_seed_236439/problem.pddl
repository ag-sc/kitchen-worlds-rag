...
(define
  (problem test_kitchen_chicken_soup_250904_041820_seed_236439)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn17539=1.78)
	(position faucet#1::joint_faucet_0 pstn17542=0.0)
	(position counter#1::chewie_door_left_joint pstn17538=-1.872)
	(position oven#1::knob_joint_2 pstn17540=0.0)
	(position counter#1::chewie_door_right_joint pstn17537=1.872)
	(position oven#1::knob_joint_3 pstn17541=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn17542=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17540=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17541=0.0)

	(atposition counter#1::chewie_door_right_joint pstn17537=1.872)
	(atposition oven#1::knob_joint_3 pstn17541=0.0)
	(atposition fridge#1::fridge_door pstn17539=1.78)
	(atposition counter#1::chewie_door_left_joint pstn17538=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn17542=0.0)
	(atposition oven#1::knob_joint_2 pstn17540=0.0)

	(pose braiserbody#1 p40854=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p40858=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p40856=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024))
	(pose chicken-leg p40855=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p40859=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p40854=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p40858=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p40856=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024))
	(atpose chicken-leg p40855=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p40859=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq632=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq952=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn17537=1.872)
	(isopenedposition fridge#1::fridge_door pstn17539=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn17538=-1.872)

	(ataconf left aq632=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq952=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p40858=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p40859=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p40857=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p40856=(0.567, 7.872, 0.712, 0.0, -0.0, 0.024) counter#1::front_left_stove)
