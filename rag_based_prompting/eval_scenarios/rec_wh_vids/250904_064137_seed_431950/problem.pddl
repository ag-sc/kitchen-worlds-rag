...
(define
  (problem test_kitchen_chicken_soup_250904_064137_seed_431950)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn22925=0.0)
	(position fridge#1::fridge_door pstn22924=1.78)
	(position faucet#1::joint_faucet_0 pstn22927=0.0)
	(position counter#1::chewie_door_right_joint pstn22922=1.872)
	(position oven#1::knob_joint_3 pstn22926=0.0)
	(position counter#1::chewie_door_left_joint pstn22923=-1.872)
	...
	(atposition fridge#1::fridge_door pstn22924=1.78)
	(atposition oven#1::knob_joint_3 pstn22926=0.0)
	(atposition oven#1::knob_joint_2 pstn22925=0.0)
	(atposition faucet#1::joint_faucet_0 pstn22927=0.0)
	(atposition counter#1::chewie_door_right_joint pstn22922=1.872)
	(atposition counter#1::chewie_door_left_joint pstn22923=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn22927=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn22926=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn22925=0.0)

	(pose braiserlid#1 p45875=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(pose chicken-leg p45874=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p45878=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p45877=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p45873=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p45877=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p45875=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(atpose chicken-leg p45874=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p45878=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p45873=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn22923=-1.872)
	(isopenedposition fridge#1::fridge_door pstn22924=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn22922=1.872)
	...
	(contained pepper-shaker p45878=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p45877=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p45875=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642) counter#1::front_left_stove)
	(supported braiserbody#1 p45876=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
