...
(define
  (problem test_kitchen_chicken_soup_250904_035416_seed_569765)
  (:domain domain)
  ...
  (:init
	...
	(atbconf q136=(2.0, 6.25, 0.2, 3.142))
	...
	(position faucet#1::joint_faucet_0 pstn17288=0.0)
	(position counter#1::chewie_door_left_joint pstn17284=-1.872)
	(position oven#1::knob_joint_3 pstn17287=0.0)
	(position fridge#1::fridge_door pstn17285=1.78)
	(position counter#1::chewie_door_right_joint pstn17283=1.872)
	(position oven#1::knob_joint_2 pstn17286=0.0)

	(isopenedposition fridge#1::fridge_door pstn17285=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn17283=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn17284=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn17288=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17287=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17286=0.0)

	(atposition counter#1::chewie_door_right_joint pstn17283=1.872)
	(atposition oven#1::knob_joint_2 pstn17286=0.0)
	(atposition faucet#1::joint_faucet_0 pstn17288=0.0)
	(atposition fridge#1::fridge_door pstn17285=1.78)
	(atposition counter#1::chewie_door_left_joint pstn17284=-1.872)
	(atposition oven#1::knob_joint_3 pstn17287=0.0)

	(pose salt-shaker p39525=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p39521=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p39522=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p39523=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846))
	(pose pepper-shaker p39526=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p39525=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p39521=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p39522=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p39523=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846))
	(atpose pepper-shaker p39526=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p39525=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p39526=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p39523=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846) counter#1::front_left_stove)
	(supported braiserbody#1 p39524=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
