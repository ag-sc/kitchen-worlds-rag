...
(define
  (problem test_kitchen_chicken_soup_250903_213437_seed_246310)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn7332=1.78)
	(position oven#1::knob_joint_3 pstn7334=0.0)
	(position faucet#1::joint_faucet_0 pstn7335=0.0)
	(position oven#1::knob_joint_2 pstn7333=0.0)
	(position counter#1::chewie_door_left_joint pstn7331=-1.872)
	(position counter#1::chewie_door_right_joint pstn7330=1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn7335=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7331=-1.872)
	(atposition fridge#1::fridge_door pstn7332=1.78)
	(atposition counter#1::chewie_door_right_joint pstn7330=1.872)
	(atposition oven#1::knob_joint_3 pstn7334=0.0)
	(atposition oven#1::knob_joint_2 pstn7333=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn7334=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn7335=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7333=0.0)

	(pose braiserbody#1 p18042=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	...
	(pose braiserlid#1 p18044=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))

	(atpose braiserbody#1 p18042=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p18044=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))

	(isopenedposition counter#1::chewie_door_right_joint pstn7330=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn7331=-1.872)
	(isopenedposition fridge#1::fridge_door pstn7332=1.78)
	...
	(supported braiserlid#1 p18044=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612) counter#1::front_left_stove)
	(supported braiserbody#1 p18045=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
