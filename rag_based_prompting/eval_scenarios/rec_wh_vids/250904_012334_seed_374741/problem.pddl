...
(define
  (problem test_kitchen_chicken_soup_250904_012334_seed_374741)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn12998=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12997=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12996=0.0)

	(position counter#1::chewie_door_left_joint pstn12994=-1.872)
	(position fridge#1::fridge_door pstn12995=1.78)
	(position oven#1::knob_joint_2 pstn12996=0.0)
	(position oven#1::knob_joint_3 pstn12997=0.0)
	(position counter#1::chewie_door_right_joint pstn12993=1.872)
	(position faucet#1::joint_faucet_0 pstn12998=0.0)

	(atposition counter#1::chewie_door_right_joint pstn12993=1.872)
	(atposition oven#1::knob_joint_3 pstn12997=0.0)
	(atposition counter#1::chewie_door_left_joint pstn12994=-1.872)
	(atposition fridge#1::fridge_door pstn12995=1.78)
	(atposition oven#1::knob_joint_2 pstn12996=0.0)
	(atposition faucet#1::joint_faucet_0 pstn12998=0.0)

	(pose braiserbody#1 p31823=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p31825=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(pose salt-shaker p31827=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p31824=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p31828=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p31823=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p31825=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355))
	(atpose salt-shaker p31827=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p31824=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p31828=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq648=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq168=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn12993=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn12994=-1.872)
	(isopenedposition fridge#1::fridge_door pstn12995=1.78)

	(ataconf left aq648=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq168=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p31827=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p31828=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p31826=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p31825=(0.567, 7.872, 0.712, 0.0, -0.0, 2.355) counter#1::front_left_stove)
