...
(define
  (problem test_kitchen_chicken_soup_250902_192412_seed_288895)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn19679=0.0)
	(atposition oven#1::knob_joint_3 pstn19680=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19676=1.872)
	(atposition counter#1::chewie_door_left_joint pstn19677=-1.872)
	(atposition fridge#1::fridge_door pstn19678=1.78)
	(atposition faucet#1::joint_faucet_0 pstn19681=0.0)

	(position faucet#1::joint_faucet_0 pstn19681=0.0)
	(position oven#1::knob_joint_3 pstn19680=0.0)
	(position oven#1::knob_joint_2 pstn19679=0.0)
	(position counter#1::chewie_door_right_joint pstn19676=1.872)
	(position counter#1::chewie_door_left_joint pstn19677=-1.872)
	(position fridge#1::fridge_door pstn19678=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn19680=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19681=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19679=0.0)

	(pose salt-shaker p33360=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p33356=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p33357=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p33358=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(pose pepper-shaker p33361=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p33361=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p33358=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247))
	(atpose chicken-leg p33357=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p33360=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p33356=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn19676=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn19677=-1.872)
	(isopenedposition fridge#1::fridge_door pstn19678=1.78)
	...
	(supported braiserbody#1 p33359=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p33358=(0.567, 7.872, 0.712, 0.0, -0.0, 0.247) counter#1::front_left_stove)

	(contained pepper-shaker p33361=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p33360=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
