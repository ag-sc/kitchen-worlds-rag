...
(define
  (problem test_kitchen_chicken_soup_250903_024607_seed_567288)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn10588=0.0)
	(position oven#1::knob_joint_3 pstn10589=0.0)
	(position counter#1::chewie_door_left_joint pstn10586=-1.872)
	(position faucet#1::joint_faucet_0 pstn10590=0.0)
	(position counter#1::chewie_door_right_joint pstn10585=1.872)
	(position fridge#1::fridge_door pstn10587=1.78)
	...
	(atposition oven#1::knob_joint_3 pstn10589=0.0)
	(atposition faucet#1::joint_faucet_0 pstn10590=0.0)
	(atposition oven#1::knob_joint_2 pstn10588=0.0)
	(atposition fridge#1::fridge_door pstn10587=1.78)
	(atposition counter#1::chewie_door_left_joint pstn10586=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn10585=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn10589=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn10590=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn10588=0.0)
	...
	(atpose chicken-leg p12691=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p12694=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p12692=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(atpose braiserbody#1 p12690=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p12695=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p12695=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p12691=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p12694=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p12692=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683))
	(pose braiserbody#1 p12690=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn10585=1.872)
	(isopenedposition fridge#1::fridge_door pstn10587=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn10586=-1.872)
	...
	(contained pepper-shaker p12695=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p12694=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p12693=(0.7, 8.772, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p12692=(0.567, 7.872, 0.712, 0.0, -0.0, 0.683) counter#1::front_left_stove)
