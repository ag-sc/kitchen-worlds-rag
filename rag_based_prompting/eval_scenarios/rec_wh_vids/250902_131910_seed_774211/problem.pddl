...
(define
  (problem test_kitchen_chicken_soup_250902_131910_seed_774211)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn8845=0.0)
	(position counter#1::chewie_door_right_joint pstn8841=1.872)
	(position faucet#1::joint_faucet_0 pstn8846=0.0)
	(position fridge#1::fridge_door pstn8843=1.78)
	(position oven#1::knob_joint_2 pstn8844=0.0)
	(position counter#1::chewie_door_left_joint pstn8842=-1.872)

	(atposition fridge#1::fridge_door pstn8843=1.78)
	(atposition faucet#1::joint_faucet_0 pstn8846=0.0)
	(atposition oven#1::knob_joint_2 pstn8844=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8842=-1.872)
	(atposition oven#1::knob_joint_3 pstn8845=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8841=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn8846=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8844=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8845=0.0)

	(pose salt-shaker p16040=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p16036=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p16041=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p16037=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p16038=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))

	(atpose salt-shaker p16040=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p16036=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p16041=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p16037=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p16038=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))

	(isopenedposition counter#1::chewie_door_right_joint pstn8841=1.872)
	(isopenedposition fridge#1::fridge_door pstn8843=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8842=-1.872)
	...
	(contained pepper-shaker p16041=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p16040=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p16039=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p16038=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682) counter#1::front_left_stove)
