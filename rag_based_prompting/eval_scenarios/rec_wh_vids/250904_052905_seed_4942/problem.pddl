...
(define
  (problem test_kitchen_chicken_soup_250904_052905_seed_4942)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn20091=1.78)
	(position oven#1::knob_joint_2 pstn20092=0.0)
	(position counter#1::chewie_door_right_joint pstn20089=1.872)
	(position counter#1::chewie_door_left_joint pstn20090=-1.872)
	(position oven#1::knob_joint_3 pstn20093=0.0)
	(position faucet#1::joint_faucet_0 pstn20094=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn20092=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20093=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn20094=0.0)

	(atposition counter#1::chewie_door_right_joint pstn20089=1.872)
	(atposition fridge#1::fridge_door pstn20091=1.78)
	(atposition oven#1::knob_joint_3 pstn20093=0.0)
	(atposition faucet#1::joint_faucet_0 pstn20094=0.0)
	(atposition oven#1::knob_joint_2 pstn20092=0.0)
	(atposition counter#1::chewie_door_left_joint pstn20090=-1.872)

	(pose salt-shaker p43232=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p43230=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(pose pepper-shaker p43233=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p43228=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p43229=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p43230=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391))
	(atpose pepper-shaker p43233=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p43232=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p43228=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p43229=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn20089=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn20090=-1.872)
	(isopenedposition fridge#1::fridge_door pstn20091=1.78)
	...
	(contained pepper-shaker p43233=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p43232=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p43231=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p43230=(0.567, 7.872, 0.712, 0.0, -0.0, 2.391) counter#1::front_left_stove)
