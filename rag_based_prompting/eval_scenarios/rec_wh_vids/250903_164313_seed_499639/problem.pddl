...
(define
  (problem test_kitchen_chicken_soup_250903_164313_seed_499639)
  (:domain domain)
  ...
  (:init
	...
	(supported braiserbody#1 p3=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531) counter#1::front_left_stove)
