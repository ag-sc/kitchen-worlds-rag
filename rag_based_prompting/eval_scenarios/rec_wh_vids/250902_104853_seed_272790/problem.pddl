...
(define
  (problem test_kitchen_chicken_soup_250902_104853_seed_272790)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn3942=0.0)
	(position counter#1::chewie_door_right_joint pstn3939=1.872)
	(position fridge#1::fridge_door pstn3941=1.78)
	(position faucet#1::joint_faucet_0 pstn3944=0.0)
	(position counter#1::chewie_door_left_joint pstn3940=-1.872)
	(position oven#1::knob_joint_3 pstn3943=0.0)

	(atposition fridge#1::fridge_door pstn3941=1.78)
	(atposition counter#1::chewie_door_left_joint pstn3940=-1.872)
	(atposition oven#1::knob_joint_3 pstn3943=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3939=1.872)
	(atposition oven#1::knob_joint_2 pstn3942=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3944=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn3942=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3944=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3943=0.0)
	...
	(pose salt-shaker p7443=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p7441=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(pose braiserbody#1 p7439=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p7440=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p7444=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p7441=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	(atpose braiserbody#1 p7439=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p7440=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p7444=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p7443=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq88=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq680=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn3939=1.872)
	(isopenedposition fridge#1::fridge_door pstn3941=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn3940=-1.872)

	(ataconf right aq680=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq88=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p7443=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p7444=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p7441=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401) counter#1::front_left_stove)
	(supported braiserbody#1 p7442=(0.7, 8.954, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
