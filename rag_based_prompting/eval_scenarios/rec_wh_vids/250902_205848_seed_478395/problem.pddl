...
(define
  (problem test_kitchen_chicken_soup_250902_205848_seed_478395)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn22037=0.0)
	(position counter#1::chewie_door_left_joint pstn22035=-1.872)
	(position faucet#1::joint_faucet_0 pstn22039=0.0)
	(position oven#1::knob_joint_3 pstn22038=0.0)
	(position fridge#1::fridge_door pstn22036=1.78)
	(position counter#1::chewie_door_right_joint pstn22034=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn22037=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn22038=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn22039=0.0)

	(atposition counter#1::chewie_door_right_joint pstn22034=1.872)
	(atposition faucet#1::joint_faucet_0 pstn22039=0.0)
	(atposition oven#1::knob_joint_3 pstn22038=0.0)
	(atposition counter#1::chewie_door_left_joint pstn22035=-1.872)
	(atposition fridge#1::fridge_door pstn22036=1.78)
	(atposition oven#1::knob_joint_2 pstn22037=0.0)

	(pose braiserlid#1 p40317=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(pose braiserbody#1 p40315=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p40316=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p40320=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p40319=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p40315=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p40320=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p40319=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p40316=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p40317=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))

	(isopenedposition counter#1::chewie_door_right_joint pstn22034=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn22035=-1.872)
	(isopenedposition fridge#1::fridge_door pstn22036=1.78)
	...
	(contained pepper-shaker p40320=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p40319=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p40317=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304) counter#1::front_left_stove)
	(supported braiserbody#1 p40318=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
