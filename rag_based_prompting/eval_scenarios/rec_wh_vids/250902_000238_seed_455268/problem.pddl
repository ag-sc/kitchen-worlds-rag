...
(define
  (problem test_kitchen_chicken_soup_250902_000238_seed_455268)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn20648=0.0)
	(position oven#1::knob_joint_2 pstn20647=0.0)
	(position fridge#1::fridge_door pstn20646=1.78)
	(position counter#1::chewie_door_left_joint pstn20645=-1.872)
	(position faucet#1::joint_faucet_0 pstn20649=0.0)
	(position counter#1::chewie_door_right_joint pstn20644=1.872)
	...
	(atposition oven#1::knob_joint_2 pstn20647=0.0)
	(atposition faucet#1::joint_faucet_0 pstn20649=0.0)
	(atposition fridge#1::fridge_door pstn20646=1.78)
	(atposition counter#1::chewie_door_left_joint pstn20645=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn20644=1.872)
	(atposition oven#1::knob_joint_3 pstn20648=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn20649=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20647=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn20648=0.0)

	(pose braiserlid#1 p79849=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279))
	(pose chicken-leg p79848=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p79851=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p79847=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p79852=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p79848=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p79852=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p79851=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p79847=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p79849=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279))

	(isopenedposition counter#1::chewie_door_right_joint pstn20644=1.872)
	(isopenedposition fridge#1::fridge_door pstn20646=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn20645=-1.872)
	...
	(contained salt-shaker p79851=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p79852=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p79850=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p79849=(0.567, 7.872, 0.712, 0.0, -0.0, 2.279) counter#1::front_left_stove)
