...
(define
  (problem test_kitchen_chicken_soup_250904_090436_seed_316464)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn26078=0.0)
	(position counter#1::chewie_door_right_joint pstn26075=1.872)
	(position counter#1::chewie_door_left_joint pstn26076=-1.872)
	(position fridge#1::fridge_door pstn26077=1.78)
	(position faucet#1::joint_faucet_0 pstn26080=0.0)
	(position oven#1::knob_joint_3 pstn26079=0.0)

	(atposition oven#1::knob_joint_3 pstn26079=0.0)
	(atposition faucet#1::joint_faucet_0 pstn26080=0.0)
	(atposition oven#1::knob_joint_2 pstn26078=0.0)
	(atposition counter#1::chewie_door_left_joint pstn26076=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn26075=1.872)
	(atposition fridge#1::fridge_door pstn26077=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn26080=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn26079=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn26078=0.0)

	(pose salt-shaker p54213=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p54209=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p54210=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p54211=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(pose pepper-shaker p54214=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p54213=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p54209=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p54210=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p54211=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(atpose pepper-shaker p54214=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq568=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq792=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn26076=-1.872)
	(isopenedposition fridge#1::fridge_door pstn26077=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn26075=1.872)

	(ataconf right aq792=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq568=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p54213=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p54214=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p54212=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p54211=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765) counter#1::front_left_stove)
