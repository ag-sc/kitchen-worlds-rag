...
(define
  (problem test_kitchen_chicken_soup_250903_094842_seed_908633)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn25356=0.0)
	(position fridge#1::fridge_door pstn25354=1.78)
	(position counter#1::chewie_door_right_joint pstn25352=1.872)
	(position counter#1::chewie_door_left_joint pstn25353=-1.872)
	(position faucet#1::joint_faucet_0 pstn25357=0.0)
	(position oven#1::knob_joint_2 pstn25355=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn25354=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn25352=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn25353=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn25357=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn25356=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn25355=0.0)

	(atposition counter#1::chewie_door_right_joint pstn25352=1.872)
	(atposition fridge#1::fridge_door pstn25354=1.78)
	(atposition oven#1::knob_joint_2 pstn25355=0.0)
	(atposition counter#1::chewie_door_left_joint pstn25353=-1.872)
	(atposition oven#1::knob_joint_3 pstn25356=0.0)
	(atposition faucet#1::joint_faucet_0 pstn25357=0.0)

	(pose braiserbody#1 p44422=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p44427=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p44424=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944))
	(pose salt-shaker p44426=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p44423=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p44426=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p44423=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p44422=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p44424=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944))
	(atpose pepper-shaker p44427=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p44426=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p44427=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p44425=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p44424=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944) counter#1::front_left_stove)
