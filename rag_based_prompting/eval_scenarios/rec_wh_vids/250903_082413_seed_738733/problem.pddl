...
(define
  (problem test_kitchen_chicken_soup_250903_082413_seed_738733)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn23196=0.0)
	(atposition oven#1::knob_joint_2 pstn23195=0.0)
	(atposition counter#1::chewie_door_left_joint pstn23193=-1.872)
	(atposition fridge#1::fridge_door pstn23194=1.78)
	(atposition counter#1::chewie_door_right_joint pstn23192=1.872)
	(atposition faucet#1::joint_faucet_0 pstn23197=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn23195=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn23197=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn23196=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn23192=1.872)
	(position faucet#1::joint_faucet_0 pstn23197=0.0)
	(position oven#1::knob_joint_3 pstn23196=0.0)
	(position oven#1::knob_joint_2 pstn23195=0.0)
	(position fridge#1::fridge_door pstn23194=1.78)
	(position counter#1::chewie_door_left_joint pstn23193=-1.872)

	(pose braiserbody#1 p39184=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p39185=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p39189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p39186=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	(pose salt-shaker p39188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p39185=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p39186=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791))
	(atpose salt-shaker p39188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p39189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p39184=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq656=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq128=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn23193=-1.872)
	(isopenedposition fridge#1::fridge_door pstn23194=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn23192=1.872)

	(ataconf right aq128=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq656=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p39189=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p39188=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p39187=(0.7, 8.864, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p39186=(0.567, 7.872, 0.712, 0.0, -0.0, 2.791) counter#1::front_left_stove)
