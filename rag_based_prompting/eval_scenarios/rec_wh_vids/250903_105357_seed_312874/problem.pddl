...
(define
  (problem test_kitchen_chicken_soup_250903_105357_seed_312874)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn26471=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn26473=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn26472=0.0)

	(isopenedposition fridge#1::fridge_door pstn26470=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn26468=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn26469=-1.872)
	...
	(position counter#1::chewie_door_right_joint pstn26468=1.872)
	(position faucet#1::joint_faucet_0 pstn26473=0.0)
	(position oven#1::knob_joint_2 pstn26471=0.0)
	(position oven#1::knob_joint_3 pstn26472=0.0)
	(position fridge#1::fridge_door pstn26470=1.78)
	(position counter#1::chewie_door_left_joint pstn26469=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn26469=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn26473=0.0)
	(atposition oven#1::knob_joint_3 pstn26472=0.0)
	(atposition fridge#1::fridge_door pstn26470=1.78)
	(atposition oven#1::knob_joint_2 pstn26471=0.0)
	(atposition counter#1::chewie_door_right_joint pstn26468=1.872)

	(pose salt-shaker p51363=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p51360=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p51364=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p51361=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(pose braiserbody#1 p51359=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p51361=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(atpose chicken-leg p51360=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p51359=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p51364=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p51363=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p51364=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p51363=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p51362=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p51361=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441) counter#1::front_left_stove)
