...
(define
  (problem test_kitchen_chicken_soup_250904_102458_seed_665733)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2909=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(pose chicken-leg p2908=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p2911=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p2912=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2907=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p2907=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p2909=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418))
	(atpose salt-shaker p2911=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p2912=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2908=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p2912=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2911=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2910=(0.7, 8.903, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2909=(0.567, 7.872, 0.712, 0.0, -0.0, 0.418) counter#1::front_left_stove)
