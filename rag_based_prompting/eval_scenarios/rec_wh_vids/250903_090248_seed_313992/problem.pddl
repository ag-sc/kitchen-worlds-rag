...
(define
  (problem test_kitchen_chicken_soup_250903_090248_seed_313992)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn23654=0.0)
	(position counter#1::chewie_door_left_joint pstn23652=-1.872)
	(position counter#1::chewie_door_right_joint pstn23651=1.872)
	(position oven#1::knob_joint_3 pstn23655=0.0)
	(position faucet#1::joint_faucet_0 pstn23656=0.0)
	(position fridge#1::fridge_door pstn23653=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn23654=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn23655=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn23656=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn23651=1.872)
	(atposition counter#1::chewie_door_left_joint pstn23652=-1.872)
	(atposition fridge#1::fridge_door pstn23653=1.78)
	(atposition oven#1::knob_joint_2 pstn23654=0.0)
	(atposition oven#1::knob_joint_3 pstn23655=0.0)
	(atposition faucet#1::joint_faucet_0 pstn23656=0.0)
	(pose braiserbody#1 p41750=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p41754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p41755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p41752=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))
	(pose chicken-leg p41751=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p41754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p41752=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903))
	(atpose braiserbody#1 p41750=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p41755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p41751=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn23651=1.872)
	(isopenedposition fridge#1::fridge_door pstn23653=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn23652=-1.872)
	...
	(supported braiserbody#1 p41753=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p41752=(0.567, 7.872, 0.712, 0.0, -0.0, 0.903) counter#1::front_left_stove)

	(contained pepper-shaker p41755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p41754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
