...
(define
  (problem test_kitchen_chicken_soup_250904_015018_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn13249=1.78)
	(position oven#1::knob_joint_2 pstn13250=0.0)
	(position oven#1::knob_joint_3 pstn13251=0.0)
	(position faucet#1::joint_faucet_0 pstn13252=0.0)
	(position counter#1::chewie_door_right_joint pstn13247=1.872)
	(position counter#1::chewie_door_left_joint pstn13248=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn13250=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn13252=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn13251=0.0)

	(atposition counter#1::chewie_door_left_joint pstn13248=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn13247=1.872)
	(atposition fridge#1::fridge_door pstn13249=1.78)
	(atposition oven#1::knob_joint_2 pstn13250=0.0)
	(atposition oven#1::knob_joint_3 pstn13251=0.0)
	(atposition faucet#1::joint_faucet_0 pstn13252=0.0)

	(pose salt-shaker p33160=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p33161=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p33158=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(pose chicken-leg p33157=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p33156=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p33157=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p33160=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p33156=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p33161=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p33158=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))

	(aconf left aq896=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq816=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn13247=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn13248=-1.872)
	(isopenedposition fridge#1::fridge_door pstn13249=1.78)

	(ataconf left aq896=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq816=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p33161=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p33160=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p33159=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p33158=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
