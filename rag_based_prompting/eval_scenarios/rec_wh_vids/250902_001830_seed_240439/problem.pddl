...
(define
  (problem test_kitchen_chicken_soup_250902_001830_seed_240439)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn21120=0.0)
	(atposition fridge#1::fridge_door pstn21119=1.78)
	(atposition oven#1::knob_joint_3 pstn21121=0.0)
	(atposition counter#1::chewie_door_left_joint pstn21118=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn21122=0.0)
	(atposition counter#1::chewie_door_right_joint pstn21117=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn21120=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn21121=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21122=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn21117=1.872)
	(position oven#1::knob_joint_2 pstn21120=0.0)
	(position oven#1::knob_joint_3 pstn21121=0.0)
	(position fridge#1::fridge_door pstn21119=1.78)
	(position counter#1::chewie_door_left_joint pstn21118=-1.872)
	(position faucet#1::joint_faucet_0 pstn21122=0.0)

	(pose chicken-leg p80277=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p80280=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p80278=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))
	(pose pepper-shaker p80281=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p80276=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p80280=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p80276=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p80281=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p80277=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p80278=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))

	(isopenedposition counter#1::chewie_door_left_joint pstn21118=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn21117=1.872)
	(isopenedposition fridge#1::fridge_door pstn21119=1.78)
	...
	(contained pepper-shaker p80281=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p80280=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p80278=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159) counter#1::front_left_stove)
	(supported braiserbody#1 p80279=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
