...
(define
  (problem test_kitchen_chicken_soup_250910_170949_seed_344159)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	...
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934) counter#1::front_left_stove)
