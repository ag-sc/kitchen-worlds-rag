...
(define
  (problem test_kitchen_chicken_soup_250911_215308_seed_643547)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn1471=0.0)
	(atposition oven#1::knob_joint_2 pstn1470=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1467=1.872)
	(atposition counter#1::chewie_door_left_joint pstn1468=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn1472=0.0)
	(atposition fridge#1::fridge_door pstn1469=1.78)
	...
	(position faucet#1::joint_faucet_0 pstn1472=0.0)
	(position fridge#1::fridge_door pstn1469=1.78)
	(position oven#1::knob_joint_3 pstn1471=0.0)
	(position counter#1::chewie_door_right_joint pstn1467=1.872)
	(position counter#1::chewie_door_left_joint pstn1468=-1.872)
	(position oven#1::knob_joint_2 pstn1470=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn1470=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1472=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1471=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn1469=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1467=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1468=-1.872)

	(pose braiserlid#1 p2081=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(pose braiserbody#1 p2079=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p2080=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p2083=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p2084=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p2084=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p2083=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2081=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(atpose braiserbody#1 p2079=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p2080=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p2084=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2083=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2082=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2081=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313) counter#1::front_left_stove)
