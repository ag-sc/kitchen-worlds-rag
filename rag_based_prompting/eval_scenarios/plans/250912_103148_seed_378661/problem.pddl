...
(define
  (problem test_kitchen_chicken_soup_250912_103148_seed_378661)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn3290=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3291=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3292=0.0)

	(position counter#1::chewie_door_left_joint pstn3288=-1.872)
	(position oven#1::knob_joint_2 pstn3290=0.0)
	(position faucet#1::joint_faucet_0 pstn3292=0.0)
	(position counter#1::chewie_door_right_joint pstn3287=1.872)
	(position oven#1::knob_joint_3 pstn3291=0.0)
	(position fridge#1::fridge_door pstn3289=1.78)

	(atposition counter#1::chewie_door_left_joint pstn3288=-1.872)
	(atposition fridge#1::fridge_door pstn3289=1.78)
	(atposition faucet#1::joint_faucet_0 pstn3292=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3287=1.872)
	(atposition oven#1::knob_joint_3 pstn3291=0.0)
	(atposition oven#1::knob_joint_2 pstn3290=0.0)

	(pose salt-shaker p7560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p7558=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	(pose pepper-shaker p7561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p7556=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p7557=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose pepper-shaker p7561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p7558=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	(atpose salt-shaker p7560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p7556=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p7557=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn3287=1.872)
	(isopenedposition fridge#1::fridge_door pstn3289=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn3288=-1.872)
	...
	(contained salt-shaker p7560=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p7561=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p7558=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993) counter#1::front_left_stove)
	(supported braiserbody#1 p7559=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
