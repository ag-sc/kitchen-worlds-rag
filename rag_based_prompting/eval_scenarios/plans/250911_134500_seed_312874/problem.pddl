...
(define
  (problem test_kitchen_chicken_soup_250911_134500_seed_312874)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn7769=0.0)
	(atposition fridge#1::fridge_door pstn7767=1.78)
	(atposition oven#1::knob_joint_2 pstn7768=0.0)
	(atposition faucet#1::joint_faucet_0 pstn7770=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7765=1.872)
	(atposition counter#1::chewie_door_left_joint pstn7766=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn7770=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7769=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7768=0.0)

	(position counter#1::chewie_door_right_joint pstn7765=1.872)
	(position oven#1::knob_joint_3 pstn7769=0.0)
	(position fridge#1::fridge_door pstn7767=1.78)
	(position oven#1::knob_joint_2 pstn7768=0.0)
	(position faucet#1::joint_faucet_0 pstn7770=0.0)
	(position counter#1::chewie_door_left_joint pstn7766=-1.872)

	(pose braiserlid#1 p12649=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(pose chicken-leg p12648=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p12647=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p12651=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p12652=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn7766=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn7765=1.872)
	(isopenedposition fridge#1::fridge_door pstn7767=1.78)

	(atpose pepper-shaker p12652=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p12647=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p12649=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441))
	(atpose salt-shaker p12651=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p12648=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p12651=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12652=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p12650=(0.7, 8.953, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p12649=(0.567, 7.872, 0.712, 0.0, -0.0, 1.441) counter#1::front_left_stove)
