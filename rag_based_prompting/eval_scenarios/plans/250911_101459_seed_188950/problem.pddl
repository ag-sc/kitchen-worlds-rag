...
(define
  (problem test_kitchen_chicken_soup_250911_101459_seed_188950)
  (:domain domain)
  ...
  (:init
	...
	(atpose chicken-leg p1167=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p1168=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	(atpose pepper-shaker p1171=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1166=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p1170=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p1171=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1166=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p1170=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p1167=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1168=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	...
	(contained pepper-shaker p1171=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1170=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p1168=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735) counter#1::front_left_stove)
	(supported braiserbody#1 p1169=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
