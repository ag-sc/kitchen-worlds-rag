...
(define
  (problem test_kitchen_chicken_soup_250911_233308_seed_507585)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn399=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn401=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn400=0.0)

	(isopenedposition fridge#1::fridge_door pstn398=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn396=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn397=-1.872)

	(position counter#1::chewie_door_right_joint pstn396=1.872)
	(position oven#1::knob_joint_3 pstn400=0.0)
	(position oven#1::knob_joint_2 pstn399=0.0)
	(position fridge#1::fridge_door pstn398=1.78)
	(position counter#1::chewie_door_left_joint pstn397=-1.872)
	(position faucet#1::joint_faucet_0 pstn401=0.0)

	(atposition counter#1::chewie_door_left_joint pstn397=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn401=0.0)
	(atposition oven#1::knob_joint_3 pstn400=0.0)
	(atposition fridge#1::fridge_door pstn398=1.78)
	(atposition oven#1::knob_joint_2 pstn399=0.0)
	(atposition counter#1::chewie_door_right_joint pstn396=1.872)

	(pose braiserlid#1 p3248=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(pose salt-shaker p3250=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p3251=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3246=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p3247=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p3248=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39))
	(atpose braiserbody#1 p3246=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p3247=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p3251=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p3250=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(supported braiserbody#1 p3249=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3248=(0.567, 7.872, 0.712, 0.0, -0.0, 1.39) counter#1::front_left_stove)

	(contained pepper-shaker p3251=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3250=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
