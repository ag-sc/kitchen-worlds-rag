...
(define
  (problem test_kitchen_chicken_soup_250911_181125_seed_25586)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn16863=0.0)
	(position faucet#1::joint_faucet_0 pstn16864=0.0)
	(position counter#1::chewie_door_right_joint pstn16859=1.872)
	(position fridge#1::fridge_door pstn16861=1.78)
	(position counter#1::chewie_door_left_joint pstn16860=-1.872)
	(position oven#1::knob_joint_2 pstn16862=0.0)

	(atposition faucet#1::joint_faucet_0 pstn16864=0.0)
	(atposition fridge#1::fridge_door pstn16861=1.78)
	(atposition counter#1::chewie_door_left_joint pstn16860=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn16859=1.872)
	(atposition oven#1::knob_joint_2 pstn16862=0.0)
	(atposition oven#1::knob_joint_3 pstn16863=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn16864=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16862=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16863=0.0)

	(pose braiserlid#1 p24984=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(pose braiserbody#1 p24982=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p24983=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p24987=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p24986=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq880=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p24987=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p24986=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p24984=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(atpose braiserbody#1 p24982=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p24983=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_left_joint pstn16860=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16859=1.872)
	(isopenedposition fridge#1::fridge_door pstn16861=1.78)

	(ataconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq880=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p24987=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p24986=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p24984=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973) counter#1::front_left_stove)
	(supported braiserbody#1 p24985=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
