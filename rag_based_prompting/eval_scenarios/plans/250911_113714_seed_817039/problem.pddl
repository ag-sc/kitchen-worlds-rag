...
(define
  (problem test_kitchen_chicken_soup_250911_113714_seed_817039)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn3266=0.0)
	(position oven#1::knob_joint_3 pstn3267=0.0)
	(position faucet#1::joint_faucet_0 pstn3268=0.0)
	(position counter#1::chewie_door_left_joint pstn3264=-1.872)
	(position fridge#1::fridge_door pstn3265=1.78)
	(position counter#1::chewie_door_right_joint pstn3263=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn3267=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3266=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn3268=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn3265=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn3263=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3264=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn3264=-1.872)
	(atposition fridge#1::fridge_door pstn3265=1.78)
	(atposition oven#1::knob_joint_2 pstn3266=0.0)
	(atposition oven#1::knob_joint_3 pstn3267=0.0)
	(atposition faucet#1::joint_faucet_0 pstn3268=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3263=1.872)

	(atpose chicken-leg p6696=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p6700=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p6695=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p6697=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose salt-shaker p6699=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p6700=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p6697=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose salt-shaker p6699=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p6695=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p6696=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p6700=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p6699=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p6697=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
	(supported braiserbody#1 p6698=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
