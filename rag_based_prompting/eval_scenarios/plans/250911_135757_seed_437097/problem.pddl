...
(define
  (problem test_kitchen_chicken_soup_250911_135757_seed_437097)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn8227=0.0)
	(position faucet#1::joint_faucet_0 pstn8228=0.0)
	(position counter#1::chewie_door_left_joint pstn8224=-1.872)
	(position counter#1::chewie_door_right_joint pstn8223=1.872)
	(position fridge#1::fridge_door pstn8225=1.78)
	(position oven#1::knob_joint_2 pstn8226=0.0)

	(atposition fridge#1::fridge_door pstn8225=1.78)
	(atposition oven#1::knob_joint_2 pstn8226=0.0)
	(atposition oven#1::knob_joint_3 pstn8227=0.0)
	(atposition faucet#1::joint_faucet_0 pstn8228=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8223=1.872)
	(atposition counter#1::chewie_door_left_joint pstn8224=-1.872)

	(isclosedposition oven#1::knob_joint_2 pstn8226=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn8227=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8228=0.0)
	...
	(pose braiserbody#1 p12785=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p12787=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(pose pepper-shaker p12790=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p12786=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p12789=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p12787=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(atpose chicken-leg p12786=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p12785=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p12789=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p12790=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn8223=1.872)
	(isopenedposition fridge#1::fridge_door pstn8225=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn8224=-1.872)
	...
	(contained pepper-shaker p12790=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p12789=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p12787=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96) counter#1::front_left_stove)
	(supported braiserbody#1 p12788=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
