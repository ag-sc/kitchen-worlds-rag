...
(define
  (problem test_kitchen_chicken_soup_250911_182629_seed_320213)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn17316=0.0)
	(atposition oven#1::knob_joint_2 pstn17314=0.0)
	(atposition oven#1::knob_joint_3 pstn17315=0.0)
	(atposition fridge#1::fridge_door pstn17313=1.78)
	(atposition counter#1::chewie_door_right_joint pstn17311=1.872)
	(atposition counter#1::chewie_door_left_joint pstn17312=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn17316=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn17315=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17314=0.0)

	(position counter#1::chewie_door_left_joint pstn17312=-1.872)
	(position faucet#1::joint_faucet_0 pstn17316=0.0)
	(position oven#1::knob_joint_2 pstn17314=0.0)
	(position oven#1::knob_joint_3 pstn17315=0.0)
	(position fridge#1::fridge_door pstn17313=1.78)
	(position counter#1::chewie_door_right_joint pstn17311=1.872)

	(pose salt-shaker p26172=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p26168=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p26169=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p26173=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p26170=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))

	(atpose chicken-leg p26169=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p26170=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(atpose pepper-shaker p26173=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p26172=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p26168=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn17312=-1.872)
	(isopenedposition fridge#1::fridge_door pstn17313=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn17311=1.872)
	...
	(contained pepper-shaker p26173=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p26172=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p26171=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p26170=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62) counter#1::front_left_stove)
