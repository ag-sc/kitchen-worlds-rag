...
(define
  (problem test_kitchen_chicken_soup_250910_161022_seed_569861)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn1465=0.0)
	(position fridge#1::fridge_door pstn1463=1.78)
	(position oven#1::knob_joint_2 pstn1464=0.0)
	(position faucet#1::joint_faucet_0 pstn1466=0.0)
	(position counter#1::chewie_door_left_joint pstn1462=-1.872)
	(position counter#1::chewie_door_right_joint pstn1461=1.872)
	...
	(atposition fridge#1::fridge_door pstn1463=1.78)
	(atposition oven#1::knob_joint_3 pstn1465=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1466=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1462=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1461=1.872)
	(atposition oven#1::knob_joint_2 pstn1464=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn1464=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1465=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1466=0.0)
	...
	(pose braiserbody#1 p3375=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p3377=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(pose pepper-shaker p3380=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p3376=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p3379=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p3375=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p3380=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p3379=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p3377=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022))
	(atpose chicken-leg p3376=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn1462=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1461=1.872)
	(isopenedposition fridge#1::fridge_door pstn1463=1.78)
	...
	(contained pepper-shaker p3380=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3379=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p3378=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3377=(0.567, 7.872, 0.712, 0.0, -0.0, 0.022) counter#1::front_left_stove)
