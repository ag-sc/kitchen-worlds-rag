...
(define
  (problem test_kitchen_chicken_soup_250910_142220_seed_854983)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn1193=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1194=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1192=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn1189=1.872)
	(position oven#1::knob_joint_2 pstn1192=0.0)
	(position fridge#1::fridge_door pstn1191=1.78)
	(position faucet#1::joint_faucet_0 pstn1194=0.0)
	(position oven#1::knob_joint_3 pstn1193=0.0)
	(position counter#1::chewie_door_left_joint pstn1190=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn1190=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn1194=0.0)
	(atposition fridge#1::fridge_door pstn1191=1.78)
	(atposition oven#1::knob_joint_2 pstn1192=0.0)
	(atposition oven#1::knob_joint_3 pstn1193=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1189=1.872)
	(pose braiserbody#1 p3704=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p3705=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p3706=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(pose pepper-shaker p3709=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p3708=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p3704=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p3708=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p3706=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303))
	(atpose chicken-leg p3705=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p3709=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn1189=1.872)
	(isopenedposition fridge#1::fridge_door pstn1191=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1190=-1.872)
	...
	(supported braiserbody#1 p3707=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p3706=(0.567, 7.872, 0.712, 0.0, -0.0, 1.303) counter#1::front_left_stove)

	(contained pepper-shaker p3709=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3708=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
