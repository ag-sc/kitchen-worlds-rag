...
(define
  (problem test_kitchen_chicken_soup_250910_142846_seed_774211)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682))
	...
	(supported braiserbody#1 p3=(0.7, 8.89, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.682) counter#1::front_left_stove)
