...
(define
  (problem test_kitchen_chicken_soup_250910_134049_seed_272790)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	...
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 2.401) counter#1::front_left_stove)
