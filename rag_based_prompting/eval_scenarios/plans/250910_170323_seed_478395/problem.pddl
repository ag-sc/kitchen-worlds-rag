...
(define
  (problem test_kitchen_chicken_soup_250910_170323_seed_478395)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn1176=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1172=-1.872)
	(atposition fridge#1::fridge_door pstn1173=1.78)
	(atposition oven#1::knob_joint_3 pstn1175=0.0)
	(atposition oven#1::knob_joint_2 pstn1174=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1171=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn1174=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1176=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1175=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn1172=-1.872)
	(position fridge#1::fridge_door pstn1173=1.78)
	(position oven#1::knob_joint_2 pstn1174=0.0)
	(position faucet#1::joint_faucet_0 pstn1176=0.0)
	(position counter#1::chewie_door_right_joint pstn1171=1.872)
	(position oven#1::knob_joint_3 pstn1175=0.0)

	(pose pepper-shaker p2947=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p2943=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p2946=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2942=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2944=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))

	(atpose braiserlid#1 p2944=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304))
	(atpose pepper-shaker p2947=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2943=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p2942=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p2946=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn1172=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1173=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1171=1.872)
	...
	(contained pepper-shaker p2947=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2946=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2945=(0.7, 8.785, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2944=(0.567, 7.872, 0.712, 0.0, -0.0, 0.304) counter#1::front_left_stove)
