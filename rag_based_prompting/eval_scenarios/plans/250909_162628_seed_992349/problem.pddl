...
(define
  (problem test_kitchen_chicken_soup_250909_162628_seed_992349)
  (:domain domain)
  ...
  (:init
	...
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.273))
	(atpose braiserbody#1 p0=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.273))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 1.273) counter#1::front_left_stove)
