...
(define
  (problem test_kitchen_chicken_soup_250911_185502_seed_708959)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn18218=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18215=1.872)
	(atposition oven#1::knob_joint_3 pstn18219=0.0)
	(atposition fridge#1::fridge_door pstn18217=1.78)
	(atposition counter#1::chewie_door_left_joint pstn18216=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn18220=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn18219=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18218=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn18220=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn18215=1.872)
	(position oven#1::knob_joint_2 pstn18218=0.0)
	(position oven#1::knob_joint_3 pstn18219=0.0)
	(position fridge#1::fridge_door pstn18217=1.78)
	(position counter#1::chewie_door_left_joint pstn18216=-1.872)
	(position faucet#1::joint_faucet_0 pstn18220=0.0)

	(atpose braiserbody#1 p27486=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p27491=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p27487=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p27488=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(atpose salt-shaker p27490=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(pose braiserlid#1 p27488=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(pose chicken-leg p27487=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p27491=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p27490=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p27486=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq368=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq840=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn18216=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn18215=1.872)
	(isopenedposition fridge#1::fridge_door pstn18217=1.78)

	(ataconf right aq840=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq368=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p27490=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p27491=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p27488=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278) counter#1::front_left_stove)
	(supported braiserbody#1 p27489=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
