...
(define
  (problem test_kitchen_chicken_soup_250911_141121_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn8685=0.0)
	(atposition counter#1::chewie_door_right_joint pstn8681=1.872)
	(atposition counter#1::chewie_door_left_joint pstn8682=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn8686=0.0)
	(atposition fridge#1::fridge_door pstn8683=1.78)
	(atposition oven#1::knob_joint_2 pstn8684=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn8685=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8686=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8684=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn8683=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn8681=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn8682=-1.872)

	(position counter#1::chewie_door_right_joint pstn8681=1.872)
	(position oven#1::knob_joint_3 pstn8685=0.0)
	(position counter#1::chewie_door_left_joint pstn8682=-1.872)
	(position faucet#1::joint_faucet_0 pstn8686=0.0)
	(position fridge#1::fridge_door pstn8683=1.78)
	(position oven#1::knob_joint_2 pstn8684=0.0)

	(pose braiserbody#1 p13977=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p13982=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p13979=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose salt-shaker p13981=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p13978=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p13978=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p13977=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p13982=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p13979=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose salt-shaker p13981=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p13982=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p13981=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p13979=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
	(supported braiserbody#1 p13980=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
