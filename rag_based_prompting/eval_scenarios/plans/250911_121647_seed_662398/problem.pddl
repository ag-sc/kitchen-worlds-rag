...
(define
  (problem test_kitchen_chicken_soup_250911_121647_seed_662398)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn4617=0.0)
	(atposition fridge#1::fridge_door pstn4615=1.78)
	(atposition counter#1::chewie_door_left_joint pstn4614=-1.872)
	(atposition oven#1::knob_joint_2 pstn4616=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4613=1.872)
	(atposition faucet#1::joint_faucet_0 pstn4618=0.0)

	(position faucet#1::joint_faucet_0 pstn4618=0.0)
	(position oven#1::knob_joint_3 pstn4617=0.0)
	(position counter#1::chewie_door_right_joint pstn4613=1.872)
	(position fridge#1::fridge_door pstn4615=1.78)
	(position counter#1::chewie_door_left_joint pstn4614=-1.872)
	(position oven#1::knob_joint_2 pstn4616=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn4617=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4616=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4618=0.0)
	...
	(pose braiserlid#1 p8234=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(pose braiserbody#1 p8232=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p8237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p8233=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p8236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p8233=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p8236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p8234=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574))
	(atpose braiserbody#1 p8232=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p8237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn4614=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4615=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4613=1.872)
	...
	(contained pepper-shaker p8237=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p8236=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p8234=(0.567, 7.872, 0.712, 0.0, -0.0, 0.574) counter#1::front_left_stove)
	(supported braiserbody#1 p8235=(0.7, 8.973, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
