...
(define
  (problem test_kitchen_chicken_soup_250911_212334_seed_190390)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p414=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p410=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p411=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p415=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p412=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))

	(atpose braiserlid#1 p412=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(atpose salt-shaker p414=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p410=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p411=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p415=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p415=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p414=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p412=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928) counter#1::front_left_stove)
	(supported braiserbody#1 p413=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
