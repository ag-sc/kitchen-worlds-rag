...
(define
  (problem test_kitchen_chicken_soup_250912_092125_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2644=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(pose chicken-leg p2643=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p2642=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p2644=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(atpose braiserbody#1 p2642=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p2645=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2644=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
