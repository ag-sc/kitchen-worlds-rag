...
(define
  (problem test_kitchen_chicken_soup_250911_215937_seed_569765)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846))
	...
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846) counter#1::front_left_stove)
