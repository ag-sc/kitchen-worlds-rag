...
(define
  (problem test_kitchen_chicken_soup_250911_184206_seed_246310)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn17773=0.0)
	(position counter#1::chewie_door_left_joint pstn17770=-1.872)
	(position fridge#1::fridge_door pstn17771=1.78)
	(position counter#1::chewie_door_right_joint pstn17769=1.872)
	(position faucet#1::joint_faucet_0 pstn17774=0.0)
	(position oven#1::knob_joint_2 pstn17772=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn17773=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17774=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17772=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn17771=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn17769=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn17770=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn17770=-1.872)
	(atposition fridge#1::fridge_door pstn17771=1.78)
	(atposition faucet#1::joint_faucet_0 pstn17774=0.0)
	(atposition oven#1::knob_joint_2 pstn17772=0.0)
	(atposition oven#1::knob_joint_3 pstn17773=0.0)
	(atposition counter#1::chewie_door_right_joint pstn17769=1.872)

	(atpose braiserbody#1 p26306=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p26307=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p26310=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p26311=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p26308=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))

	(pose pepper-shaker p26311=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p26308=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))
	(pose braiserbody#1 p26306=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p26307=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p26310=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p26310=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p26311=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p26309=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p26308=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612) counter#1::front_left_stove)
