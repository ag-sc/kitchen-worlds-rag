...
(define
  (problem test_kitchen_chicken_soup_250912_093702_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn1478=0.0)
	(position counter#1::chewie_door_left_joint pstn1474=-1.872)
	(position counter#1::chewie_door_right_joint pstn1473=1.872)
	(position fridge#1::fridge_door pstn1475=1.78)
	(position oven#1::knob_joint_3 pstn1477=0.0)
	(position oven#1::knob_joint_2 pstn1476=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn1477=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1478=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn1476=0.0)

	(isopenedposition fridge#1::fridge_door pstn1475=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1474=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1473=1.872)

	(atposition counter#1::chewie_door_right_joint pstn1473=1.872)
	(atposition faucet#1::joint_faucet_0 pstn1478=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1474=-1.872)
	(atposition oven#1::knob_joint_2 pstn1476=0.0)
	(atposition fridge#1::fridge_door pstn1475=1.78)
	(atposition oven#1::knob_joint_3 pstn1477=0.0)

	(pose pepper-shaker p4051=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4048=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(pose salt-shaker p4050=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p4047=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p4046=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p4051=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p4048=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(atpose salt-shaker p4050=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p4047=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p4046=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p4050=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p4051=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4048=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
	(supported braiserbody#1 p4049=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
