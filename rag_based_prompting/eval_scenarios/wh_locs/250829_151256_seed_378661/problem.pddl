...
(define
  (problem test_kitchen_chicken_soup_250829_151256_seed_378661)
  (:domain domain)
  ...
  (:init
	...
	(pose salt-shaker p4104=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p4101=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p4105=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p4102=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	(pose braiserbody#1 p4100=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p4101=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p4104=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p4105=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p4102=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	(atpose braiserbody#1 p4100=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p4104=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p4105=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4102=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993) counter#1::front_left_stove)
	(supported braiserbody#1 p4103=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
