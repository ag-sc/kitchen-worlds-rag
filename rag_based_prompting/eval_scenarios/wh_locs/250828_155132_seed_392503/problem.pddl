...
(define
  (problem test_kitchen_chicken_soup_250828_155132_seed_392503)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn983=0.0)
	(position counter#1::chewie_door_left_joint pstn981=-1.872)
	(position faucet#1::joint_faucet_0 pstn985=0.0)
	(position fridge#1::fridge_door pstn982=1.78)
	(position counter#1::chewie_door_right_joint pstn980=1.872)
	(position oven#1::knob_joint_3 pstn984=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn985=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn984=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn983=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn981=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn985=0.0)
	(atposition fridge#1::fridge_door pstn982=1.78)
	(atposition counter#1::chewie_door_right_joint pstn980=1.872)
	(atposition oven#1::knob_joint_2 pstn983=0.0)
	(atposition oven#1::knob_joint_3 pstn984=0.0)

	(pose braiserbody#1 p2758=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p2763=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p2759=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p2760=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974))
	(pose salt-shaker p2762=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p2758=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p2763=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p2760=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974))
	(atpose salt-shaker p2762=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2759=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn981=-1.872)
	(isopenedposition fridge#1::fridge_door pstn982=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn980=1.872)
	...
	(contained pepper-shaker p2763=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2762=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2761=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2760=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974) counter#1::front_left_stove)
