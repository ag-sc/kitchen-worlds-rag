...
(define
  (problem test_kitchen_chicken_soup_250828_181108_seed_188950)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn4862=0.0)
	(position oven#1::knob_joint_2 pstn4860=0.0)
	(position counter#1::chewie_door_right_joint pstn4857=1.872)
	(position fridge#1::fridge_door pstn4859=1.78)
	(position counter#1::chewie_door_left_joint pstn4858=-1.872)
	(position oven#1::knob_joint_3 pstn4861=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn4860=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4862=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4861=0.0)

	(isopenedposition fridge#1::fridge_door pstn4859=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn4858=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn4857=1.872)

	(atposition counter#1::chewie_door_left_joint pstn4858=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn4862=0.0)
	(atposition fridge#1::fridge_door pstn4859=1.78)
	(atposition oven#1::knob_joint_3 pstn4861=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4857=1.872)
	(atposition oven#1::knob_joint_2 pstn4860=0.0)

	(pose braiserbody#1 p5665=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5670=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p5667=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	(pose salt-shaker p5669=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p5666=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserbody#1 p5665=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p5667=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735))
	(atpose pepper-shaker p5670=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p5669=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p5666=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p5669=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p5670=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p5667=(0.567, 7.872, 0.712, 0.0, -0.0, 1.735) counter#1::front_left_stove)
	(supported braiserbody#1 p5668=(0.7, 8.732, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
