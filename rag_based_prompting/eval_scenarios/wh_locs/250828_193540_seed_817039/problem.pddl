...
(define
  (problem test_kitchen_chicken_soup_250828_193540_seed_817039)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn688=1.78)
	(position counter#1::chewie_door_left_joint pstn687=-1.872)
	(position oven#1::knob_joint_3 pstn690=0.0)
	(position faucet#1::joint_faucet_0 pstn691=0.0)
	(position counter#1::chewie_door_right_joint pstn686=1.872)
	(position oven#1::knob_joint_2 pstn689=0.0)
	...
	(atposition fridge#1::fridge_door pstn688=1.78)
	(atposition oven#1::knob_joint_3 pstn690=0.0)
	(atposition counter#1::chewie_door_right_joint pstn686=1.872)
	(atposition oven#1::knob_joint_2 pstn689=0.0)
	(atposition faucet#1::joint_faucet_0 pstn691=0.0)
	(atposition counter#1::chewie_door_left_joint pstn687=-1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn688=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn686=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn687=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn691=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn689=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn690=0.0)

	(pose chicken-leg p2936=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p2940=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p2939=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2935=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p2937=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))

	(atpose chicken-leg p2936=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p2937=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose pepper-shaker p2940=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p2939=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p2935=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p2939=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p2940=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2938=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2937=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
