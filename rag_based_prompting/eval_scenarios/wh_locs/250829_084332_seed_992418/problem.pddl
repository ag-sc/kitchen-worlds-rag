...
(define
  (problem test_kitchen_chicken_soup_250829_084332_seed_992418)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn16752=0.0)
	(atposition faucet#1::joint_faucet_0 pstn16754=0.0)
	(atposition fridge#1::fridge_door pstn16751=1.78)
	(atposition counter#1::chewie_door_right_joint pstn16749=1.872)
	(atposition oven#1::knob_joint_3 pstn16753=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16750=-1.872)

	(position faucet#1::joint_faucet_0 pstn16754=0.0)
	(position counter#1::chewie_door_left_joint pstn16750=-1.872)
	(position oven#1::knob_joint_2 pstn16752=0.0)
	(position counter#1::chewie_door_right_joint pstn16749=1.872)
	(position fridge#1::fridge_door pstn16751=1.78)
	(position oven#1::knob_joint_3 pstn16753=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn16754=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16753=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16752=0.0)

	(pose braiserbody#1 p63910=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p63914=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p63912=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(pose pepper-shaker p63915=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p63911=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserbody#1 p63910=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p63915=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p63914=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p63912=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(atpose chicken-leg p63911=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq712=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn16750=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16749=1.872)
	(isopenedposition fridge#1::fridge_door pstn16751=1.78)

	(ataconf left aq608=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq712=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p63914=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p63915=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p63913=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p63912=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554) counter#1::front_left_stove)
