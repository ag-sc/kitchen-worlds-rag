...
(define
  (problem test_kitchen_chicken_soup_250829_005501_seed_607747)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn8854=0.0)
	(atposition fridge#1::fridge_door pstn8853=1.78)
	(atposition faucet#1::joint_faucet_0 pstn8856=0.0)
	(atposition counter#1::chewie_door_left_joint pstn8852=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn8851=1.872)
	(atposition oven#1::knob_joint_3 pstn8855=0.0)
	...
	(position faucet#1::joint_faucet_0 pstn8856=0.0)
	(position oven#1::knob_joint_2 pstn8854=0.0)
	(position fridge#1::fridge_door pstn8853=1.78)
	(position counter#1::chewie_door_right_joint pstn8851=1.872)
	(position counter#1::chewie_door_left_joint pstn8852=-1.872)
	(position oven#1::knob_joint_3 pstn8855=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn8855=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn8854=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn8856=0.0)
	...
	(pose chicken-leg p28166=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p28169=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p28165=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p28167=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	(pose pepper-shaker p28170=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p28166=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p28167=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	(atpose salt-shaker p28169=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p28165=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p28170=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn8852=-1.872)
	(isopenedposition fridge#1::fridge_door pstn8853=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn8851=1.872)
	...
	(contained salt-shaker p28169=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p28170=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p28168=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p28167=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098) counter#1::front_left_stove)
