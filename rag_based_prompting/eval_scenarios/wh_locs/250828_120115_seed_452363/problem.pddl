...
(define
  (problem test_kitchen_chicken_soup_250828_120115_seed_452363)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn234=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn235=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn236=0.0)

	(position counter#1::chewie_door_left_joint pstn232=-1.872)
	(position counter#1::chewie_door_right_joint pstn231=1.872)
	(position faucet#1::joint_faucet_0 pstn236=0.0)
	(position oven#1::knob_joint_2 pstn234=0.0)
	(position oven#1::knob_joint_3 pstn235=0.0)
	(position fridge#1::fridge_door pstn233=1.78)

	(atposition counter#1::chewie_door_right_joint pstn231=1.872)
	(atposition counter#1::chewie_door_left_joint pstn232=-1.872)
	(atposition oven#1::knob_joint_3 pstn235=0.0)
	(atposition faucet#1::joint_faucet_0 pstn236=0.0)
	(atposition fridge#1::fridge_door pstn233=1.78)
	(atposition oven#1::knob_joint_2 pstn234=0.0)

	(pose braiserlid#1 p914=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))
	(pose pepper-shaker p917=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p913=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p916=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p912=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p913=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p912=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p916=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p914=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252))
	(atpose pepper-shaker p917=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_right_joint pstn231=1.872)
	(isopenedposition fridge#1::fridge_door pstn233=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn232=-1.872)
	...
	(contained pepper-shaker p917=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p916=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p914=(0.567, 7.872, 0.712, 0.0, -0.0, 1.252) counter#1::front_left_stove)
	(supported braiserbody#1 p915=(0.7, 8.894, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
