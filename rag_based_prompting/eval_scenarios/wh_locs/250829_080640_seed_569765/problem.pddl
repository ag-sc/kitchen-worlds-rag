...
(define
  (problem test_kitchen_chicken_soup_250829_080640_seed_569765)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn16376=0.0)
	(position counter#1::chewie_door_left_joint pstn16372=-1.872)
	(position oven#1::knob_joint_3 pstn16375=0.0)
	(position counter#1::chewie_door_right_joint pstn16371=1.872)
	(position oven#1::knob_joint_2 pstn16374=0.0)
	(position fridge#1::fridge_door pstn16373=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn16374=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16376=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16375=0.0)

	(atposition counter#1::chewie_door_left_joint pstn16372=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn16376=0.0)
	(atposition oven#1::knob_joint_3 pstn16375=0.0)
	(atposition oven#1::knob_joint_2 pstn16374=0.0)
	(atposition counter#1::chewie_door_right_joint pstn16371=1.872)
	(atposition fridge#1::fridge_door pstn16373=1.78)

	(pose braiserbody#1 p60372=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p60374=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846))
	(pose chicken-leg p60373=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p60376=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p60377=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p60372=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p60373=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p60374=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846))
	(atpose pepper-shaker p60377=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p60376=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq576=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn16372=-1.872)
	(isopenedposition fridge#1::fridge_door pstn16373=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn16371=1.872)

	(ataconf right aq576=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq240=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p60377=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p60376=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(supported braiserbody#1 p60375=(0.7, 8.82, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p60374=(0.567, 7.872, 0.712, 0.0, -0.0, 0.846) counter#1::front_left_stove)
