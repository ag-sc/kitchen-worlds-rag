...
(define
  (problem test_kitchen_chicken_soup_250829_144148_seed_709159)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn2542=0.0)
	(position oven#1::knob_joint_2 pstn2541=0.0)
	(position faucet#1::joint_faucet_0 pstn2543=0.0)
	(position fridge#1::fridge_door pstn2540=1.78)
	(position counter#1::chewie_door_left_joint pstn2539=-1.872)
	(position counter#1::chewie_door_right_joint pstn2538=1.872)

	(atposition oven#1::knob_joint_2 pstn2541=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2539=-1.872)
	(atposition oven#1::knob_joint_3 pstn2542=0.0)
	(atposition faucet#1::joint_faucet_0 pstn2543=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2538=1.872)
	(atposition fridge#1::fridge_door pstn2540=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn2543=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2541=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2542=0.0)
	...
	(pose chicken-leg p2396=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p2399=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p2395=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p2400=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p2397=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))

	(atpose braiserbody#1 p2395=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p2397=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44))
	(atpose pepper-shaker p2400=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p2396=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p2399=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn2539=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn2538=1.872)
	(isopenedposition fridge#1::fridge_door pstn2540=1.78)
	...
	(contained pepper-shaker p2400=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p2399=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p2398=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p2397=(0.567, 7.872, 0.712, 0.0, -0.0, 0.44) counter#1::front_left_stove)
