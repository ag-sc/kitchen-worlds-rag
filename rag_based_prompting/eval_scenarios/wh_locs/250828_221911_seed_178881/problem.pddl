...
(define
  (problem test_kitchen_chicken_soup_250828_221911_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn5288=1.78)
	(position faucet#1::joint_faucet_0 pstn5291=0.0)
	(position oven#1::knob_joint_3 pstn5290=0.0)
	(position counter#1::chewie_door_left_joint pstn5287=-1.872)
	(position oven#1::knob_joint_2 pstn5289=0.0)
	(position counter#1::chewie_door_right_joint pstn5286=1.872)
	...
	(atposition faucet#1::joint_faucet_0 pstn5291=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5286=1.872)
	(atposition counter#1::chewie_door_left_joint pstn5287=-1.872)
	(atposition fridge#1::fridge_door pstn5288=1.78)
	(atposition oven#1::knob_joint_3 pstn5290=0.0)
	(atposition oven#1::knob_joint_2 pstn5289=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn5289=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5291=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5290=0.0)
	...
	(pose salt-shaker p14538=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p14535=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p14534=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p14539=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p14536=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(isopenedposition counter#1::chewie_door_right_joint pstn5286=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5287=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5288=1.78)

	(aconf left aq848=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq896=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p14539=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p14536=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(atpose salt-shaker p14538=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p14535=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p14534=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))

	(ataconf left aq848=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq896=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p14538=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14539=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14536=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
	(supported braiserbody#1 p14537=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
