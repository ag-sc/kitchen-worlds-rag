...
(define
  (problem test_kitchen_chicken_soup_250828_192148_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn194=0.0)
	(atposition counter#1::chewie_door_right_joint pstn189=1.872)
	(atposition oven#1::knob_joint_2 pstn192=0.0)
	(atposition counter#1::chewie_door_left_joint pstn190=-1.872)
	(atposition oven#1::knob_joint_3 pstn193=0.0)
	(atposition fridge#1::fridge_door pstn191=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn194=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn193=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn192=0.0)

	(position counter#1::chewie_door_right_joint pstn189=1.872)
	(position oven#1::knob_joint_2 pstn192=0.0)
	(position counter#1::chewie_door_left_joint pstn190=-1.872)
	(position oven#1::knob_joint_3 pstn193=0.0)
	(position fridge#1::fridge_door pstn191=1.78)
	(position faucet#1::joint_faucet_0 pstn194=0.0)

	(pose braiserlid#1 p1616=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(pose salt-shaker p1618=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p1619=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1614=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p1615=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p1616=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(atpose pepper-shaker p1619=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1614=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p1615=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p1618=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn189=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn190=-1.872)
	(isopenedposition fridge#1::fridge_door pstn191=1.78)
	...
	(contained salt-shaker p1618=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p1619=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p1616=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
	(supported braiserbody#1 p1617=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
