...
(define
  (problem test_kitchen_chicken_soup_250828_184434_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn5835=1.78)
	(atposition counter#1::chewie_door_left_joint pstn5834=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn5833=1.872)
	(atposition faucet#1::joint_faucet_0 pstn5838=0.0)
	(atposition oven#1::knob_joint_2 pstn5836=0.0)
	(atposition oven#1::knob_joint_3 pstn5837=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn5836=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5837=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5838=0.0)

	(isopenedposition fridge#1::fridge_door pstn5835=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5834=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn5833=1.872)

	(position counter#1::chewie_door_left_joint pstn5834=-1.872)
	(position counter#1::chewie_door_right_joint pstn5833=1.872)
	(position oven#1::knob_joint_2 pstn5836=0.0)
	(position oven#1::knob_joint_3 pstn5837=0.0)
	(position faucet#1::joint_faucet_0 pstn5838=0.0)
	(position fridge#1::fridge_door pstn5835=1.78)

	(atpose chicken-leg p8402=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p8406=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p8405=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p8403=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(atpose braiserbody#1 p8401=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p8406=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p8405=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p8403=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(pose braiserbody#1 p8401=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p8402=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p8405=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p8406=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p8404=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p8403=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
