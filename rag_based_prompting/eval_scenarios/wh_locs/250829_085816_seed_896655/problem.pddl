...
(define
  (problem test_kitchen_chicken_soup_250829_085816_seed_896655)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn16943=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16942=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16941=0.0)

	(position counter#1::chewie_door_left_joint pstn16939=-1.872)
	(position oven#1::knob_joint_2 pstn16941=0.0)
	(position counter#1::chewie_door_right_joint pstn16938=1.872)
	(position fridge#1::fridge_door pstn16940=1.78)
	(position faucet#1::joint_faucet_0 pstn16943=0.0)
	(position oven#1::knob_joint_3 pstn16942=0.0)

	(atposition counter#1::chewie_door_left_joint pstn16939=-1.872)
	(atposition oven#1::knob_joint_3 pstn16942=0.0)
	(atposition oven#1::knob_joint_2 pstn16941=0.0)
	(atposition fridge#1::fridge_door pstn16940=1.78)
	(atposition counter#1::chewie_door_right_joint pstn16938=1.872)
	(atposition faucet#1::joint_faucet_0 pstn16943=0.0)

	(pose pepper-shaker p66211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p66207=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p66210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p66208=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(pose braiserbody#1 p66206=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq728=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq448=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p66211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p66207=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p66208=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987))
	(atpose braiserbody#1 p66206=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p66210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_left_joint pstn16939=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16938=1.872)
	(isopenedposition fridge#1::fridge_door pstn16940=1.78)

	(ataconf left aq728=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq448=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p66211=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p66210=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p66208=(0.567, 7.872, 0.712, 0.0, -0.0, 0.987) counter#1::front_left_stove)
	(supported braiserbody#1 p66209=(0.7, 8.863, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
