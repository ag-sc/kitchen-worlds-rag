...
(define
  (problem test_kitchen_chicken_soup_250829_000609_seed_499639)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn7981=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7976=1.872)
	(atposition oven#1::knob_joint_2 pstn7979=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7977=-1.872)
	(atposition oven#1::knob_joint_3 pstn7980=0.0)
	(atposition fridge#1::fridge_door pstn7978=1.78)
	...
	(isopenedposition fridge#1::fridge_door pstn7978=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn7976=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn7977=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn7981=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7979=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7980=0.0)

	(position counter#1::chewie_door_left_joint pstn7977=-1.872)
	(position oven#1::knob_joint_2 pstn7979=0.0)
	(position faucet#1::joint_faucet_0 pstn7981=0.0)
	(position oven#1::knob_joint_3 pstn7980=0.0)
	(position fridge#1::fridge_door pstn7978=1.78)
	(position counter#1::chewie_door_right_joint pstn7976=1.872)

	(atpose salt-shaker p24240=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p24241=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p24238=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	(atpose chicken-leg p24237=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p24236=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p24241=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p24237=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p24240=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p24236=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p24238=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531))
	...
	(contained salt-shaker p24240=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p24241=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p24238=(0.567, 7.872, 0.712, 0.0, -0.0, 2.531) counter#1::front_left_stove)
	(supported braiserbody#1 p24239=(0.7, 8.887, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
