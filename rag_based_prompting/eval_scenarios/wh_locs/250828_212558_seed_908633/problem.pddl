...
(define
  (problem test_kitchen_chicken_soup_250828_212558_seed_908633)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn3375=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3374=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3373=0.0)

	(position counter#1::chewie_door_left_joint pstn3371=-1.872)
	(position fridge#1::fridge_door pstn3372=1.78)
	(position faucet#1::joint_faucet_0 pstn3375=0.0)
	(position counter#1::chewie_door_right_joint pstn3370=1.872)
	(position oven#1::knob_joint_3 pstn3374=0.0)
	(position oven#1::knob_joint_2 pstn3373=0.0)

	(atposition counter#1::chewie_door_left_joint pstn3371=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn3375=0.0)
	(atposition fridge#1::fridge_door pstn3372=1.78)
	(atposition oven#1::knob_joint_3 pstn3374=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3370=1.872)
	(atposition oven#1::knob_joint_2 pstn3373=0.0)

	(atpose chicken-leg p11950=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p11951=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944))
	(atpose pepper-shaker p11954=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p11953=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p11949=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p11954=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p11953=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p11951=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944))
	(pose braiserbody#1 p11949=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p11950=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn3370=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3371=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3372=1.78)
	...
	(contained salt-shaker p11953=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p11954=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p11952=(0.7, 8.745, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p11951=(0.567, 7.872, 0.712, 0.0, -0.0, 1.944) counter#1::front_left_stove)
