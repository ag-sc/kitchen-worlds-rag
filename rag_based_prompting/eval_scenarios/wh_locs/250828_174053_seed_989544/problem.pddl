...
(define
  (problem test_kitchen_chicken_soup_250828_174053_seed_989544)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn3311=0.0)
	(position faucet#1::joint_faucet_0 pstn3312=0.0)
	(position counter#1::chewie_door_right_joint pstn3307=1.872)
	(position counter#1::chewie_door_left_joint pstn3308=-1.872)
	(position fridge#1::fridge_door pstn3309=1.78)
	(position oven#1::knob_joint_2 pstn3310=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn3312=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn3310=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn3311=0.0)

	(atposition counter#1::chewie_door_left_joint pstn3308=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn3312=0.0)
	(atposition oven#1::knob_joint_3 pstn3311=0.0)
	(atposition fridge#1::fridge_door pstn3309=1.78)
	(atposition oven#1::knob_joint_2 pstn3310=0.0)
	(atposition counter#1::chewie_door_right_joint pstn3307=1.872)

	(pose salt-shaker p4937=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p4938=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p4933=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p4934=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p4935=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))

	(atpose pepper-shaker p4938=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p4937=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p4934=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p4933=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p4935=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(isopenedposition counter#1::chewie_door_right_joint pstn3307=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn3308=-1.872)
	(isopenedposition fridge#1::fridge_door pstn3309=1.78)
	...
	(contained pepper-shaker p4938=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p4937=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p4935=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
	(supported braiserbody#1 p4936=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
