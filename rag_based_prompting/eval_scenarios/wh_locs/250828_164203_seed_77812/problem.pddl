...
(define
  (problem test_kitchen_chicken_soup_250828_164203_seed_77812)
  (:domain domain)
  ...
  (:init
	...
	(pose chicken-leg p1094=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p1095=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(pose pepper-shaker p1098=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p1097=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p1093=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p1095=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125))
	(atpose pepper-shaker p1098=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p1097=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p1093=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p1094=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p1098=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p1097=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p1096=(0.7, 8.963, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p1095=(0.567, 7.872, 0.712, 0.0, -0.0, 2.125) counter#1::front_left_stove)
