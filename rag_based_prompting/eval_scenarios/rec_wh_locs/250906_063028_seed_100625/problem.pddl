...
(define
  (problem test_kitchen_chicken_soup_250906_063028_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn29229=0.0)
	(atposition faucet#1::joint_faucet_0 pstn29230=0.0)
	(atposition fridge#1::fridge_door pstn29227=1.78)
	(atposition counter#1::chewie_door_right_joint pstn29225=1.872)
	(atposition counter#1::chewie_door_left_joint pstn29226=-1.872)
	(atposition oven#1::knob_joint_2 pstn29228=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn29228=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn29230=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn29229=0.0)

	(position counter#1::chewie_door_right_joint pstn29225=1.872)
	(position fridge#1::fridge_door pstn29227=1.78)
	(position oven#1::knob_joint_3 pstn29229=0.0)
	(position counter#1::chewie_door_left_joint pstn29226=-1.872)
	(position oven#1::knob_joint_2 pstn29228=0.0)
	(position faucet#1::joint_faucet_0 pstn29230=0.0)

	(pose braiserbody#1 p50703=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p50707=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p50704=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p50708=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p50705=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))

	(atpose chicken-leg p50704=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p50708=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p50703=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p50705=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(atpose salt-shaker p50707=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq184=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq648=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn29225=1.872)
	(isopenedposition fridge#1::fridge_door pstn29227=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn29226=-1.872)

	(ataconf left aq184=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq648=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p50707=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p50708=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p50705=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
	(supported braiserbody#1 p50706=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
