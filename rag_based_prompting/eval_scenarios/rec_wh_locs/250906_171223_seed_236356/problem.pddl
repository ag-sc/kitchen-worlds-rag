...
(define
  (problem test_kitchen_chicken_soup_250906_171223_seed_236356)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn1386=1.78)
	(position faucet#1::joint_faucet_0 pstn1389=0.0)
	(position oven#1::knob_joint_3 pstn1388=0.0)
	(position counter#1::chewie_door_left_joint pstn1385=-1.872)
	(position counter#1::chewie_door_right_joint pstn1384=1.872)
	(position oven#1::knob_joint_2 pstn1387=0.0)

	(atposition fridge#1::fridge_door pstn1386=1.78)
	(atposition faucet#1::joint_faucet_0 pstn1389=0.0)
	(atposition oven#1::knob_joint_2 pstn1387=0.0)
	(atposition oven#1::knob_joint_3 pstn1388=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1385=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn1384=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn1387=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1388=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1389=0.0)
	...
	(atpose chicken-leg p5291=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p5294=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p5292=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))
	(atpose pepper-shaker p5295=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p5290=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p5295=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p5290=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p5294=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p5292=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))
	(pose chicken-leg p5291=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn1384=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1385=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1386=1.78)
	...
	(contained pepper-shaker p5295=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p5294=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p5292=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647) counter#1::front_left_stove)
	(supported braiserbody#1 p5293=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
