...
(define
  (problem test_kitchen_chicken_soup_250905_140834_seed_392503)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn9710=1.78)
	(position oven#1::knob_joint_3 pstn9712=0.0)
	(position oven#1::knob_joint_2 pstn9711=0.0)
	(position counter#1::chewie_door_right_joint pstn9708=1.872)
	(position faucet#1::joint_faucet_0 pstn9713=0.0)
	(position counter#1::chewie_door_left_joint pstn9709=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn9713=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9712=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9711=0.0)

	(atposition counter#1::chewie_door_left_joint pstn9709=-1.872)
	(atposition fridge#1::fridge_door pstn9710=1.78)
	(atposition oven#1::knob_joint_2 pstn9711=0.0)
	(atposition faucet#1::joint_faucet_0 pstn9713=0.0)
	(atposition counter#1::chewie_door_right_joint pstn9708=1.872)
	(atposition oven#1::knob_joint_3 pstn9712=0.0)

	(pose braiserlid#1 p13447=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974))
	(pose braiserbody#1 p13445=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p13446=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p13450=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p13449=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p13447=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974))
	(atpose pepper-shaker p13450=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p13449=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p13445=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p13446=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_right_joint pstn9708=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn9709=-1.872)
	(isopenedposition fridge#1::fridge_door pstn9710=1.78)
	...
	(contained pepper-shaker p13450=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p13449=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p13448=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p13447=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974) counter#1::front_left_stove)
