...
(define
  (problem test_kitchen_chicken_soup_250906_141947_seed_178881)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn7192=0.0)
	(position counter#1::chewie_door_left_joint pstn7189=-1.872)
	(position fridge#1::fridge_door pstn7190=1.78)
	(position oven#1::knob_joint_2 pstn7191=0.0)
	(position faucet#1::joint_faucet_0 pstn7193=0.0)
	(position counter#1::chewie_door_right_joint pstn7188=1.872)
	...
	(atposition oven#1::knob_joint_3 pstn7192=0.0)
	(atposition faucet#1::joint_faucet_0 pstn7193=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7189=-1.872)
	(atposition fridge#1::fridge_door pstn7190=1.78)
	(atposition oven#1::knob_joint_2 pstn7191=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7188=1.872)

	(isopenedposition fridge#1::fridge_door pstn7190=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn7188=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn7189=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn7193=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7191=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7192=0.0)

	(atpose salt-shaker p14230=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p14231=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p14227=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p14226=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p14228=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose pepper-shaker p14231=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p14227=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p14226=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p14228=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857))
	(pose salt-shaker p14230=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p14230=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14231=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p14228=(0.567, 7.872, 0.712, 0.0, -0.0, 2.857) counter#1::front_left_stove)
	(supported braiserbody#1 p14229=(0.7, 8.86, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
