...
(define
  (problem test_kitchen_chicken_soup_250906_163844_seed_889162)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn1167=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1165=1.872)
	(atposition counter#1::chewie_door_left_joint pstn1166=-1.872)
	...
	(position counter#1::chewie_door_right_joint pstn1165=1.872)
	(position fridge#1::fridge_door pstn1167=1.78)
	(position oven#1::knob_joint_2 pstn1168=0.0)
	(position counter#1::chewie_door_left_joint pstn1166=-1.872)
	(position oven#1::knob_joint_3 pstn1169=0.0)
	(position faucet#1::joint_faucet_0 pstn1170=0.0)

	(pose braiserlid#1 p3973=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209))
	(pose chicken-leg p3972=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p3976=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p3971=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p3975=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p3971=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p3975=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p3972=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p3973=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209))
	(atpose pepper-shaker p3976=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn1166=-1.872)
	(isopenedposition fridge#1::fridge_door pstn1167=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1165=1.872)
	...
	(contained salt-shaker p3975=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p3976=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p3973=(0.567, 7.872, 0.712, 0.0, -0.0, 0.209) counter#1::front_left_stove)
	(supported braiserbody#1 p3974=(0.7, 8.994, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
