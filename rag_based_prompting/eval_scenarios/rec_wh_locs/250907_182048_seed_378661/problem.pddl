...
(define
  (problem test_kitchen_chicken_soup_250907_182048_seed_378661)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn1941=0.0)
	(position faucet#1::joint_faucet_0 pstn1942=0.0)
	(position counter#1::chewie_door_right_joint pstn1937=1.872)
	(position oven#1::knob_joint_2 pstn1940=0.0)
	(position fridge#1::fridge_door pstn1939=1.78)
	(position counter#1::chewie_door_left_joint pstn1938=-1.872)
	...
	(atposition oven#1::knob_joint_2 pstn1940=0.0)
	(atposition counter#1::chewie_door_left_joint pstn1938=-1.872)
	(atposition fridge#1::fridge_door pstn1939=1.78)
	(atposition counter#1::chewie_door_right_joint pstn1937=1.872)
	(atposition oven#1::knob_joint_3 pstn1941=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1942=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn1940=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1941=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1942=0.0)

	(isopenedposition fridge#1::fridge_door pstn1939=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn1937=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn1938=-1.872)

	(pose salt-shaker p6113=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p6111=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	(pose chicken-leg p6110=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p6114=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p6109=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))

	(atpose chicken-leg p6110=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p6114=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p6109=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p6111=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993))
	(atpose salt-shaker p6113=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p6113=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p6114=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p6112=(0.7, 8.91, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p6111=(0.567, 7.872, 0.712, 0.0, -0.0, 1.993) counter#1::front_left_stove)
