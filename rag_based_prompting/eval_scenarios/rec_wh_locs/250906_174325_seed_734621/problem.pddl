...
(define
  (problem test_kitchen_chicken_soup_250906_174325_seed_734621)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn2144=0.0)
	(position fridge#1::fridge_door pstn2141=1.78)
	(position oven#1::knob_joint_3 pstn2143=0.0)
	(position counter#1::chewie_door_right_joint pstn2139=1.872)
	(position counter#1::chewie_door_left_joint pstn2140=-1.872)
	(position oven#1::knob_joint_2 pstn2142=0.0)

	(atposition faucet#1::joint_faucet_0 pstn2144=0.0)
	(atposition counter#1::chewie_door_left_joint pstn2140=-1.872)
	(atposition fridge#1::fridge_door pstn2141=1.78)
	(atposition oven#1::knob_joint_2 pstn2142=0.0)
	(atposition counter#1::chewie_door_right_joint pstn2139=1.872)
	(atposition oven#1::knob_joint_3 pstn2143=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn2142=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn2143=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2144=0.0)
	...
	(atpose salt-shaker p6633=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p6630=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p6631=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(atpose braiserbody#1 p6629=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p6634=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p6634=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p6631=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19))
	(pose salt-shaker p6633=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p6630=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p6629=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn2140=-1.872)
	(isopenedposition fridge#1::fridge_door pstn2141=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn2139=1.872)
	...
	(contained salt-shaker p6633=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p6634=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p6632=(0.7, 8.804, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p6631=(0.567, 7.872, 0.712, 0.0, -0.0, 0.19) counter#1::front_left_stove)
