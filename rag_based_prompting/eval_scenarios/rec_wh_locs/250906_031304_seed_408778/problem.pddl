...
(define
  (problem test_kitchen_chicken_soup_250906_031304_seed_408778)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn26030=0.0)
	(atposition counter#1::chewie_door_left_joint pstn26027=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn26026=1.872)
	(atposition faucet#1::joint_faucet_0 pstn26031=0.0)
	(atposition fridge#1::fridge_door pstn26028=1.78)
	(atposition oven#1::knob_joint_2 pstn26029=0.0)

	(position faucet#1::joint_faucet_0 pstn26031=0.0)
	(position counter#1::chewie_door_left_joint pstn26027=-1.872)
	(position counter#1::chewie_door_right_joint pstn26026=1.872)
	(position oven#1::knob_joint_3 pstn26030=0.0)
	(position fridge#1::fridge_door pstn26028=1.78)
	(position oven#1::knob_joint_2 pstn26029=0.0)

	(isopenedposition fridge#1::fridge_door pstn26028=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn26026=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn26027=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn26031=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn26029=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn26030=0.0)

	(pose chicken-leg p44172=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p44175=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p44173=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(pose pepper-shaker p44176=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p44171=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))

	(atpose pepper-shaker p44176=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p44173=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19))
	(atpose braiserbody#1 p44171=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p44172=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p44175=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p44175=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p44176=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p44173=(0.567, 7.872, 0.712, 0.0, -0.0, 2.19) counter#1::front_left_stove)
	(supported braiserbody#1 p44174=(0.7, 8.96, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
