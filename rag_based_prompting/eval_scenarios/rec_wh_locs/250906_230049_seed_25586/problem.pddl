...
(define
  (problem test_kitchen_chicken_soup_250906_230049_seed_25586)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn6084=0.0)
	(atposition counter#1::chewie_door_left_joint pstn6081=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn6080=1.872)
	(atposition oven#1::knob_joint_2 pstn6083=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6085=0.0)
	(atposition fridge#1::fridge_door pstn6082=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn6083=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6085=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6084=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn6082=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6080=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn6081=-1.872)

	(position counter#1::chewie_door_left_joint pstn6081=-1.872)
	(position counter#1::chewie_door_right_joint pstn6080=1.872)
	(position faucet#1::joint_faucet_0 pstn6085=0.0)
	(position fridge#1::fridge_door pstn6082=1.78)
	(position oven#1::knob_joint_3 pstn6084=0.0)
	(position oven#1::knob_joint_2 pstn6083=0.0)

	(pose salt-shaker p23416=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p23413=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p23417=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p23414=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(pose braiserbody#1 p23412=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserbody#1 p23412=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p23417=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p23414=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(atpose chicken-leg p23413=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p23416=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p23417=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p23416=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p23414=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973) counter#1::front_left_stove)
	(supported braiserbody#1 p23415=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
