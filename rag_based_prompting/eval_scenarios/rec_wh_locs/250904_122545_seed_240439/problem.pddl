...
(define
  (problem test_kitchen_chicken_soup_250904_122545_seed_240439)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p13092=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))
	(pose braiserbody#1 p13090=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p13094=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p13095=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p13091=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p13094=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p13091=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p13095=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p13092=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159))
	(atpose braiserbody#1 p13090=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571))
	...
	(contained salt-shaker p13094=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p13095=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p13092=(0.567, 7.872, 0.712, 0.0, -0.0, 2.159) counter#1::front_left_stove)
	(supported braiserbody#1 p13093=(0.7, 8.752, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
