...
(define
  (problem test_kitchen_chicken_soup_250907_055940_seed_190390)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn11976=1.78)
	(atposition counter#1::chewie_door_left_joint pstn11975=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn11974=1.872)
	(atposition oven#1::knob_joint_3 pstn11978=0.0)
	(atposition oven#1::knob_joint_2 pstn11977=0.0)
	(atposition faucet#1::joint_faucet_0 pstn11979=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn11978=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11977=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11979=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn11976=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11974=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11975=-1.872)

	(position counter#1::chewie_door_left_joint pstn11975=-1.872)
	(position counter#1::chewie_door_right_joint pstn11974=1.872)
	(position oven#1::knob_joint_3 pstn11978=0.0)
	(position fridge#1::fridge_door pstn11976=1.78)
	(position faucet#1::joint_faucet_0 pstn11979=0.0)
	(position oven#1::knob_joint_2 pstn11977=0.0)

	(pose chicken-leg p40691=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p40695=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p40692=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	(pose salt-shaker p40694=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p40690=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p40692=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928))
	...
	(atpose braiserbody#1 p40690=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p40692=(0.567, 7.872, 0.712, 0.0, -0.0, 2.928) counter#1::front_left_stove)
	(supported braiserbody#1 p40693=(0.7, 8.797, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
