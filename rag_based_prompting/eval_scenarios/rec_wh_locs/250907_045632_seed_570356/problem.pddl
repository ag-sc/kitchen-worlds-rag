...
(define
  (problem test_kitchen_chicken_soup_250907_045632_seed_570356)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn11029=0.0)
	(position counter#1::chewie_door_left_joint pstn11025=-1.872)
	(position counter#1::chewie_door_right_joint pstn11024=1.872)
	(position oven#1::knob_joint_3 pstn11028=0.0)
	(position fridge#1::fridge_door pstn11026=1.78)
	(position oven#1::knob_joint_2 pstn11027=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn11027=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11028=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11029=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn11025=-1.872)
	(atposition oven#1::knob_joint_2 pstn11027=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11024=1.872)
	(atposition oven#1::knob_joint_3 pstn11028=0.0)
	(atposition fridge#1::fridge_door pstn11026=1.78)
	(atposition faucet#1::joint_faucet_0 pstn11029=0.0)

	(pose salt-shaker p38010=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p38007=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p38006=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p38008=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(pose pepper-shaker p38011=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p38006=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p38011=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p38008=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595))
	(atpose chicken-leg p38007=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p38010=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn11025=-1.872)
	(isopenedposition fridge#1::fridge_door pstn11026=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11024=1.872)
	...
	(contained pepper-shaker p38011=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p38010=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p38009=(0.7, 8.999, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p38008=(0.567, 7.872, 0.712, 0.0, -0.0, 0.595) counter#1::front_left_stove)
