...
(define
  (problem test_kitchen_chicken_soup_250907_083336_seed_992418)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn14132=0.0)
	(position counter#1::chewie_door_right_joint pstn14129=1.872)
	(position oven#1::knob_joint_3 pstn14133=0.0)
	(position fridge#1::fridge_door pstn14131=1.78)
	(position counter#1::chewie_door_left_joint pstn14130=-1.872)
	(position faucet#1::joint_faucet_0 pstn14134=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn14133=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14132=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14134=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn14131=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn14130=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn14129=1.872)

	(atposition counter#1::chewie_door_right_joint pstn14129=1.872)
	(atposition oven#1::knob_joint_3 pstn14133=0.0)
	(atposition fridge#1::fridge_door pstn14131=1.78)
	(atposition counter#1::chewie_door_left_joint pstn14130=-1.872)
	(atposition oven#1::knob_joint_2 pstn14132=0.0)
	(atposition faucet#1::joint_faucet_0 pstn14134=0.0)

	(pose salt-shaker p46315=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p46313=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(pose chicken-leg p46312=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p46311=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p46316=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p46313=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554))
	(atpose braiserbody#1 p46311=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p46316=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p46315=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p46312=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained pepper-shaker p46316=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p46315=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p46314=(0.7, 8.825, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p46313=(0.567, 7.872, 0.712, 0.0, -0.0, 0.554) counter#1::front_left_stove)
