...
(define
  (problem test_kitchen_chicken_soup_250907_062531_seed_112279)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn12191=0.0)
	(position oven#1::knob_joint_2 pstn12190=0.0)
	(position counter#1::chewie_door_right_joint pstn12187=1.872)
	(position counter#1::chewie_door_left_joint pstn12188=-1.872)
	(position fridge#1::fridge_door pstn12189=1.78)
	(position faucet#1::joint_faucet_0 pstn12192=0.0)
	...
	(atposition oven#1::knob_joint_3 pstn12191=0.0)
	(atposition counter#1::chewie_door_right_joint pstn12187=1.872)
	(atposition oven#1::knob_joint_2 pstn12190=0.0)
	(atposition counter#1::chewie_door_left_joint pstn12188=-1.872)
	(atposition fridge#1::fridge_door pstn12189=1.78)
	(atposition faucet#1::joint_faucet_0 pstn12192=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn12190=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12192=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12191=0.0)
	...
	(pose braiserbody#1 p42297=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p42302=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p42298=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p42301=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p42299=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))

	(atpose chicken-leg p42298=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p42301=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p42297=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p42299=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655))
	(atpose pepper-shaker p42302=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn12188=-1.872)
	(isopenedposition fridge#1::fridge_door pstn12189=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12187=1.872)
	...
	(contained pepper-shaker p42302=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p42301=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p42299=(0.567, 7.872, 0.712, 0.0, -0.0, 1.655) counter#1::front_left_stove)
	(supported braiserbody#1 p42300=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
