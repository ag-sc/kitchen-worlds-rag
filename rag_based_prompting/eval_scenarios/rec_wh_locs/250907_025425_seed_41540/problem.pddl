...
(define
  (problem test_kitchen_chicken_soup_250907_025425_seed_41540)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn9430=0.0)
	(position faucet#1::joint_faucet_0 pstn9431=0.0)
	(position oven#1::knob_joint_2 pstn9429=0.0)
	(position counter#1::chewie_door_right_joint pstn9426=1.872)
	(position counter#1::chewie_door_left_joint pstn9427=-1.872)
	(position fridge#1::fridge_door pstn9428=1.78)

	(atposition oven#1::knob_joint_2 pstn9429=0.0)
	(atposition faucet#1::joint_faucet_0 pstn9431=0.0)
	(atposition counter#1::chewie_door_right_joint pstn9426=1.872)
	(atposition counter#1::chewie_door_left_joint pstn9427=-1.872)
	(atposition fridge#1::fridge_door pstn9428=1.78)
	(atposition oven#1::knob_joint_3 pstn9430=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn9428=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn9427=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn9426=1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn9431=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9430=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn9429=0.0)

	(pose braiserbody#1 p32626=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p32630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p32627=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p32631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p32628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))

	(atpose salt-shaker p32630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p32626=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p32628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584))
	(atpose chicken-leg p32627=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p32631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(supported braiserbody#1 p32629=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p32628=(0.567, 7.872, 0.712, 0.0, -0.0, 1.584) counter#1::front_left_stove)

	(contained pepper-shaker p32631=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p32630=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
