...
(define
  (problem test_kitchen_chicken_soup_250906_193152_seed_607747)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn2995=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn2994=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn2996=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn2991=1.872)
	(position counter#1::chewie_door_left_joint pstn2992=-1.872)
	(position oven#1::knob_joint_3 pstn2995=0.0)
	(position fridge#1::fridge_door pstn2993=1.78)
	(position faucet#1::joint_faucet_0 pstn2996=0.0)
	(position oven#1::knob_joint_2 pstn2994=0.0)

	(atposition counter#1::chewie_door_right_joint pstn2991=1.872)
	(atposition counter#1::chewie_door_left_joint pstn2992=-1.872)
	(atposition oven#1::knob_joint_3 pstn2995=0.0)
	(atposition fridge#1::fridge_door pstn2993=1.78)
	(atposition oven#1::knob_joint_2 pstn2994=0.0)
	(atposition faucet#1::joint_faucet_0 pstn2996=0.0)

	(pose chicken-leg p12810=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p12809=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p12814=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p12813=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p12811=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))

	(isopenedposition counter#1::chewie_door_right_joint pstn2991=1.872)
	(isopenedposition fridge#1::fridge_door pstn2993=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn2992=-1.872)

	(aconf left aq592=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq120=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p12814=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p12813=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p12811=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	(atpose chicken-leg p12810=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p12809=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(ataconf left aq592=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq120=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p12813=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12814=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p12811=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098) counter#1::front_left_stove)
	(supported braiserbody#1 p12812=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
