...
(define
  (problem test_kitchen_chicken_soup_250903_055858_seed_246310)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn23029=0.0)
	(position oven#1::knob_joint_3 pstn23030=0.0)
	(position counter#1::chewie_door_right_joint pstn23026=1.872)
	(position counter#1::chewie_door_left_joint pstn23027=-1.872)
	(position fridge#1::fridge_door pstn23028=1.78)
	(position faucet#1::joint_faucet_0 pstn23031=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn23031=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn23030=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn23029=0.0)

	(atposition counter#1::chewie_door_right_joint pstn23026=1.872)
	(atposition faucet#1::joint_faucet_0 pstn23031=0.0)
	(atposition counter#1::chewie_door_left_joint pstn23027=-1.872)
	(atposition oven#1::knob_joint_3 pstn23030=0.0)
	(atposition fridge#1::fridge_door pstn23028=1.78)
	(atposition oven#1::knob_joint_2 pstn23029=0.0)

	(atpose braiserbody#1 p89045=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p89047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))
	(atpose chicken-leg p89046=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p89049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p89050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(pose pepper-shaker p89050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p89047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612))
	(pose chicken-leg p89046=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p89045=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p89049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn23027=-1.872)
	(isopenedposition fridge#1::fridge_door pstn23028=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn23026=1.872)
	...
	(contained salt-shaker p89049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p89050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p89048=(0.7, 9.0, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p89047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.612) counter#1::front_left_stove)
