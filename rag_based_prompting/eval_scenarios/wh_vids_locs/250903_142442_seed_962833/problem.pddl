...
(define
  (problem test_kitchen_chicken_soup_250903_142442_seed_962833)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn6516=0.0)
	(atposition fridge#1::fridge_door pstn6515=1.78)
	(atposition counter#1::chewie_door_left_joint pstn6514=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn6513=1.872)
	(atposition oven#1::knob_joint_3 pstn6517=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6518=0.0)
	...
	(position faucet#1::joint_faucet_0 pstn6518=0.0)
	(position counter#1::chewie_door_right_joint pstn6513=1.872)
	(position fridge#1::fridge_door pstn6515=1.78)
	(position oven#1::knob_joint_3 pstn6517=0.0)
	(position counter#1::chewie_door_left_joint pstn6514=-1.872)
	(position oven#1::knob_joint_2 pstn6516=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn6518=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6516=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn6517=0.0)
	...
	(pose pepper-shaker p16703=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p16700=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(pose salt-shaker p16702=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p16698=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p16699=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p16700=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928))
	(atpose braiserbody#1 p16698=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p16702=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p16699=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p16703=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_left_joint pstn6514=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn6513=1.872)
	(isopenedposition fridge#1::fridge_door pstn6515=1.78)
	...
	(contained salt-shaker p16702=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p16703=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p16701=(0.7, 8.758, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p16700=(0.567, 7.872, 0.712, 0.0, -0.0, 1.928) counter#1::front_left_stove)
