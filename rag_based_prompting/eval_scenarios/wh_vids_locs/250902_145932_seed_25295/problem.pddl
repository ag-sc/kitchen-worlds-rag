...
(define
  (problem test_kitchen_chicken_soup_250902_145932_seed_25295)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn5692=0.0)
	(position oven#1::knob_joint_3 pstn5691=0.0)
	(position counter#1::chewie_door_right_joint pstn5687=1.872)
	(position counter#1::chewie_door_left_joint pstn5688=-1.872)
	(position fridge#1::fridge_door pstn5689=1.78)
	(position oven#1::knob_joint_2 pstn5690=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn5692=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5690=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5691=0.0)

	(atposition counter#1::chewie_door_left_joint pstn5688=-1.872)
	(atposition oven#1::knob_joint_3 pstn5691=0.0)
	(atposition faucet#1::joint_faucet_0 pstn5692=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5687=1.872)
	(atposition fridge#1::fridge_door pstn5689=1.78)
	(atposition oven#1::knob_joint_2 pstn5690=0.0)

	(pose braiserbody#1 p28551=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p28555=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p28556=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p28553=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(pose chicken-leg p28552=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose salt-shaker p28555=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p28556=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p28552=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p28553=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662))
	(atpose braiserbody#1 p28551=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn5687=1.872)
	(isopenedposition fridge#1::fridge_door pstn5689=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5688=-1.872)
	...
	(contained pepper-shaker p28556=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p28555=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p28554=(0.7, 8.771, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p28553=(0.567, 7.872, 0.712, 0.0, -0.0, 2.662) counter#1::front_left_stove)
