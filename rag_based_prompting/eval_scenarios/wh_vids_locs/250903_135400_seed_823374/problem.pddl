...
(define
  (problem test_kitchen_chicken_soup_250903_135400_seed_823374)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn5535=0.0)
	(atposition fridge#1::fridge_door pstn5533=1.78)
	(atposition faucet#1::joint_faucet_0 pstn5536=0.0)
	(atposition counter#1::chewie_door_left_joint pstn5532=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn5531=1.872)
	(atposition oven#1::knob_joint_2 pstn5534=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn5535=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5534=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn5536=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn5533=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn5532=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn5531=1.872)
	...
	(position counter#1::chewie_door_left_joint pstn5532=-1.872)
	(position faucet#1::joint_faucet_0 pstn5536=0.0)
	(position counter#1::chewie_door_right_joint pstn5531=1.872)
	(position oven#1::knob_joint_2 pstn5534=0.0)
	(position oven#1::knob_joint_3 pstn5535=0.0)
	(position fridge#1::fridge_door pstn5533=1.78)

	(pose braiserlid#1 p14702=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(pose pepper-shaker p14705=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p14700=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p14704=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p14701=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq800=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq712=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p14705=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p14700=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p14701=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p14702=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(atpose salt-shaker p14704=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(ataconf left aq800=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq712=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p14704=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p14705=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p14703=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p14702=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762) counter#1::front_left_stove)
