...
(define
  (problem test_kitchen_chicken_soup_250902_190345_seed_344159)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn9953=0.0)
	(position counter#1::chewie_door_right_joint pstn9950=1.872)
	(position faucet#1::joint_faucet_0 pstn9955=0.0)
	(position fridge#1::fridge_door pstn9952=1.78)
	(position oven#1::knob_joint_3 pstn9954=0.0)
	(position counter#1::chewie_door_left_joint pstn9951=-1.872)
	...
	(atposition oven#1::knob_joint_3 pstn9954=0.0)
	(atposition oven#1::knob_joint_2 pstn9953=0.0)
	(atposition fridge#1::fridge_door pstn9952=1.78)
	(atposition counter#1::chewie_door_right_joint pstn9950=1.872)
	(atposition counter#1::chewie_door_left_joint pstn9951=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn9955=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn9953=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9955=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9954=0.0)

	(isopenedposition fridge#1::fridge_door pstn9952=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn9950=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn9951=-1.872)
	...
	(pose braiserlid#1 p47144=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(pose chicken-leg p47143=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p47147=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p47142=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p47146=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p47147=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p47142=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p47144=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(atpose chicken-leg p47143=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p47146=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained pepper-shaker p47147=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p47146=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p47144=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934) counter#1::front_left_stove)
	(supported braiserbody#1 p47145=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
