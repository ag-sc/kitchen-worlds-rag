...
(define
  (problem test_kitchen_chicken_soup_250903_103228_seed_74545)
  (:domain domain)
  ...
  (:init
	...
	(pose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	...
	(pose braiserbody#1 p0=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	...
	(atpose braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999))
	(atpose braiserbody#1 p0=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserlid#1 p2=(0.567, 7.872, 0.712, 0.0, -0.0, 0.999) counter#1::front_left_stove)
	(supported braiserbody#1 p3=(0.7, 8.777, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
