...
(define
  (problem test_kitchen_chicken_soup_250903_015317_seed_977400)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn17724=0.0)
	(atposition oven#1::knob_joint_2 pstn17722=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17720=-1.872)
	(atposition fridge#1::fridge_door pstn17721=1.78)
	(atposition oven#1::knob_joint_3 pstn17723=0.0)
	(atposition counter#1::chewie_door_right_joint pstn17719=1.872)

	(isclosedposition oven#1::knob_joint_3 pstn17723=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17722=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17724=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn17719=1.872)
	(position oven#1::knob_joint_3 pstn17723=0.0)
	(position oven#1::knob_joint_2 pstn17722=0.0)
	(position counter#1::chewie_door_left_joint pstn17720=-1.872)
	(position faucet#1::joint_faucet_0 pstn17724=0.0)
	(position fridge#1::fridge_door pstn17721=1.78)

	(atpose salt-shaker p72203=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p72199=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p72201=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(atpose pepper-shaker p72204=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p72200=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p72204=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p72201=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(pose chicken-leg p72200=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p72203=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p72199=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn17720=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn17719=1.872)
	(isopenedposition fridge#1::fridge_door pstn17721=1.78)
	...
	(contained pepper-shaker p72204=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p72203=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p72201=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695) counter#1::front_left_stove)
	(supported braiserbody#1 p72202=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
