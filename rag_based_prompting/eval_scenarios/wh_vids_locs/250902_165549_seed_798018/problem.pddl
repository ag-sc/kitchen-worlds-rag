...
(define
  (problem test_kitchen_chicken_soup_250902_165549_seed_798018)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn7741=0.0)
	(position counter#1::chewie_door_right_joint pstn7736=1.872)
	(position oven#1::knob_joint_2 pstn7739=0.0)
	(position counter#1::chewie_door_left_joint pstn7737=-1.872)
	(position oven#1::knob_joint_3 pstn7740=0.0)
	(position fridge#1::fridge_door pstn7738=1.78)

	(isclosedposition oven#1::knob_joint_2 pstn7739=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7740=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn7741=0.0)
	...
	(atposition counter#1::chewie_door_left_joint pstn7737=-1.872)
	(atposition oven#1::knob_joint_2 pstn7739=0.0)
	(atposition fridge#1::fridge_door pstn7738=1.78)
	(atposition faucet#1::joint_faucet_0 pstn7741=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7736=1.872)
	(atposition oven#1::knob_joint_3 pstn7740=0.0)

	(pose chicken-leg p37223=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p37226=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p37224=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(pose braiserbody#1 p37222=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p37227=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p37224=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518))
	(atpose braiserbody#1 p37222=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p37223=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p37226=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p37227=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_left_joint pstn7737=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn7736=1.872)
	(isopenedposition fridge#1::fridge_door pstn7738=1.78)
	...
	(contained salt-shaker p37226=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p37227=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p37224=(0.567, 7.872, 0.712, 0.0, -0.0, 2.518) counter#1::front_left_stove)
	(supported braiserbody#1 p37225=(0.7, 8.755, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
