...
(define
  (problem test_kitchen_chicken_soup_250902_223950_seed_267172)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn14801=0.0)
	(atposition oven#1::knob_joint_3 pstn14802=0.0)
	(atposition counter#1::chewie_door_left_joint pstn14799=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn14798=1.872)
	(atposition faucet#1::joint_faucet_0 pstn14803=0.0)
	(atposition fridge#1::fridge_door pstn14800=1.78)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn14803=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14802=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn14801=0.0)

	(position counter#1::chewie_door_right_joint pstn14798=1.872)
	(position oven#1::knob_joint_2 pstn14801=0.0)
	(position counter#1::chewie_door_left_joint pstn14799=-1.872)
	(position fridge#1::fridge_door pstn14800=1.78)
	(position oven#1::knob_joint_3 pstn14802=0.0)
	(position faucet#1::joint_faucet_0 pstn14803=0.0)

	(pose braiserlid#1 p58892=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	(pose salt-shaker p58894=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p58890=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p58891=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p58895=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserbody#1 p58890=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p58891=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p58895=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p58892=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75))
	(atpose salt-shaker p58894=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq528=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq672=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn14799=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn14798=1.872)
	(isopenedposition fridge#1::fridge_door pstn14800=1.78)

	(ataconf right aq672=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq528=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p58894=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p58895=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p58892=(0.567, 7.872, 0.712, 0.0, -0.0, 2.75) counter#1::front_left_stove)
	(supported braiserbody#1 p58893=(0.7, 8.743, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
