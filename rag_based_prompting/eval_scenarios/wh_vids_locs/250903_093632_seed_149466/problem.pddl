...
(define
  (problem test_kitchen_chicken_soup_250903_093632_seed_149466)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn1027=0.0)
	(position counter#1::chewie_door_left_joint pstn1024=-1.872)
	(position counter#1::chewie_door_right_joint pstn1023=1.872)
	(position fridge#1::fridge_door pstn1025=1.78)
	(position faucet#1::joint_faucet_0 pstn1028=0.0)
	(position oven#1::knob_joint_2 pstn1026=0.0)
	...
	(atposition oven#1::knob_joint_2 pstn1026=0.0)
	(atposition faucet#1::joint_faucet_0 pstn1028=0.0)
	(atposition counter#1::chewie_door_right_joint pstn1023=1.872)
	(atposition fridge#1::fridge_door pstn1025=1.78)
	(atposition counter#1::chewie_door_left_joint pstn1024=-1.872)
	(atposition oven#1::knob_joint_3 pstn1027=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn1026=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn1027=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn1028=0.0)

	(isopenedposition fridge#1::fridge_door pstn1025=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn1024=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn1023=1.872)

	(pose braiserbody#1 p3290=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p3292=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(pose chicken-leg p3291=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p3295=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p3294=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose chicken-leg p3291=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p3294=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p3295=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p3290=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p3292=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	...
	(contained pepper-shaker p3295=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p3294=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p3292=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9) counter#1::front_left_stove)
	(supported braiserbody#1 p3293=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
