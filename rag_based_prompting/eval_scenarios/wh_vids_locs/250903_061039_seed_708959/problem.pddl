...
(define
  (problem test_kitchen_chicken_soup_250903_061039_seed_708959)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn23189=0.0)
	(position faucet#1::joint_faucet_0 pstn23190=0.0)
	(position counter#1::chewie_door_right_joint pstn23185=1.872)
	(position counter#1::chewie_door_left_joint pstn23186=-1.872)
	(position fridge#1::fridge_door pstn23187=1.78)
	(position oven#1::knob_joint_2 pstn23188=0.0)

	(atposition fridge#1::fridge_door pstn23187=1.78)
	(atposition counter#1::chewie_door_left_joint pstn23186=-1.872)
	(atposition oven#1::knob_joint_3 pstn23189=0.0)
	(atposition oven#1::knob_joint_2 pstn23188=0.0)
	(atposition faucet#1::joint_faucet_0 pstn23190=0.0)
	(atposition counter#1::chewie_door_right_joint pstn23185=1.872)

	(isclosedposition oven#1::knob_joint_2 pstn23188=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn23189=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn23190=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn23187=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn23185=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn23186=-1.872)

	(pose braiserbody#1 p90288=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p90293=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p90290=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(pose salt-shaker p90292=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p90289=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p90290=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(atpose salt-shaker p90292=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p90288=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p90289=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p90293=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p90292=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p90293=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p90290=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278) counter#1::front_left_stove)
	(supported braiserbody#1 p90291=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
