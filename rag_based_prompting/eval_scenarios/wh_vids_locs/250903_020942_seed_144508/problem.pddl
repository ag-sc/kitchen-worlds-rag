...
(define
  (problem test_kitchen_chicken_soup_250903_020942_seed_144508)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn18173=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18168=1.872)
	(atposition fridge#1::fridge_door pstn18170=1.78)
	(atposition oven#1::knob_joint_2 pstn18171=0.0)
	(atposition counter#1::chewie_door_left_joint pstn18169=-1.872)
	(atposition oven#1::knob_joint_3 pstn18172=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn18172=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn18171=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn18173=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn18168=1.872)
	(position fridge#1::fridge_door pstn18170=1.78)
	(position oven#1::knob_joint_3 pstn18172=0.0)
	(position oven#1::knob_joint_2 pstn18171=0.0)
	(position counter#1::chewie_door_left_joint pstn18169=-1.872)
	(position faucet#1::joint_faucet_0 pstn18173=0.0)

	(pose salt-shaker p72515=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p72516=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p72512=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p72511=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p72513=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189))

	(atpose salt-shaker p72515=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p72512=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p72513=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189))
	(atpose braiserbody#1 p72511=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p72516=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq384=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq464=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn18168=1.872)
	(isopenedposition fridge#1::fridge_door pstn18170=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn18169=-1.872)

	(ataconf left aq384=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq464=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p72516=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p72515=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p72514=(0.7, 8.992, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p72513=(0.567, 7.872, 0.712, 0.0, -0.0, 0.189) counter#1::front_left_stove)
