...
(define
  (problem test_kitchen_chicken_soup_250903_032137_seed_537415)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn19843=0.0)
	(position counter#1::chewie_door_right_joint pstn19839=1.872)
	(position counter#1::chewie_door_left_joint pstn19840=-1.872)
	(position faucet#1::joint_faucet_0 pstn19844=0.0)
	(position fridge#1::fridge_door pstn19841=1.78)
	(position oven#1::knob_joint_2 pstn19842=0.0)

	(isclosedposition oven#1::knob_joint_3 pstn19843=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19842=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19844=0.0)
	...
	(atposition counter#1::chewie_door_right_joint pstn19839=1.872)
	(atposition faucet#1::joint_faucet_0 pstn19844=0.0)
	(atposition counter#1::chewie_door_left_joint pstn19840=-1.872)
	(atposition fridge#1::fridge_door pstn19841=1.78)
	(atposition oven#1::knob_joint_2 pstn19842=0.0)
	(atposition oven#1::knob_joint_3 pstn19843=0.0)

	(pose salt-shaker p78028=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p78025=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p78024=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p78029=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p78026=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))

	(atpose pepper-shaker p78029=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p78026=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718))
	(atpose salt-shaker p78028=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p78025=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p78024=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn19840=-1.872)
	(isopenedposition fridge#1::fridge_door pstn19841=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn19839=1.872)
	...
	(contained salt-shaker p78028=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p78029=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p78027=(0.7, 8.727, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p78026=(0.567, 7.872, 0.712, 0.0, -0.0, 2.718) counter#1::front_left_stove)
