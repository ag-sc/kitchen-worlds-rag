...
(define
  (problem test_kitchen_chicken_soup_250902_202038_seed_354453)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn11910=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11905=1.872)
	(atposition oven#1::knob_joint_2 pstn11908=0.0)
	(atposition oven#1::knob_joint_3 pstn11909=0.0)
	(atposition counter#1::chewie_door_left_joint pstn11906=-1.872)
	(atposition fridge#1::fridge_door pstn11907=1.78)

	(isclosedposition oven#1::knob_joint_3 pstn11909=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn11908=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11910=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn11905=1.872)
	(position oven#1::knob_joint_3 pstn11909=0.0)
	(position oven#1::knob_joint_2 pstn11908=0.0)
	(position fridge#1::fridge_door pstn11907=1.78)
	(position counter#1::chewie_door_left_joint pstn11906=-1.872)
	(position faucet#1::joint_faucet_0 pstn11910=0.0)

	(pose braiserlid#1 p50627=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(pose braiserbody#1 p50625=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p50626=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p50629=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p50630=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose salt-shaker p50629=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p50630=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p50626=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p50627=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309))
	(atpose braiserbody#1 p50625=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn11905=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11906=-1.872)
	(isopenedposition fridge#1::fridge_door pstn11907=1.78)
	...
	(contained salt-shaker p50629=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p50630=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p50627=(0.567, 7.872, 0.712, 0.0, -0.0, 1.309) counter#1::front_left_stove)
	(supported braiserbody#1 p50628=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
