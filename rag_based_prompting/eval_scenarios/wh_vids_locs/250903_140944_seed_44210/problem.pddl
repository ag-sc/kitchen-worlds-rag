...
(define
  (problem test_kitchen_chicken_soup_250903_140944_seed_44210)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn6310=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn6311=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn6309=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn6306=1.872)
	(position oven#1::knob_joint_2 pstn6309=0.0)
	(position oven#1::knob_joint_3 pstn6310=0.0)
	(position faucet#1::joint_faucet_0 pstn6311=0.0)
	(position fridge#1::fridge_door pstn6308=1.78)
	(position counter#1::chewie_door_left_joint pstn6307=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn6307=-1.872)
	(atposition oven#1::knob_joint_2 pstn6309=0.0)
	(atposition oven#1::knob_joint_3 pstn6310=0.0)
	(atposition faucet#1::joint_faucet_0 pstn6311=0.0)
	(atposition fridge#1::fridge_door pstn6308=1.78)
	(atposition counter#1::chewie_door_right_joint pstn6306=1.872)

	(pose salt-shaker p15070=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p15067=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p15071=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p15068=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(pose braiserbody#1 p15066=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p15070=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p15068=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858))
	(atpose chicken-leg p15067=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p15066=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p15071=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq56=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq232=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn6307=-1.872)
	(isopenedposition fridge#1::fridge_door pstn6308=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn6306=1.872)

	(ataconf right aq232=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq56=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p15071=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p15070=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p15069=(0.7, 8.817, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p15068=(0.567, 7.872, 0.712, 0.0, -0.0, 1.858) counter#1::front_left_stove)
