...
(define
  (problem test_kitchen_chicken_soup_250903_145509_seed_316464)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn7503=1.78)
	(atposition faucet#1::joint_faucet_0 pstn7506=0.0)
	(atposition oven#1::knob_joint_2 pstn7504=0.0)
	(atposition counter#1::chewie_door_left_joint pstn7502=-1.872)
	(atposition oven#1::knob_joint_3 pstn7505=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7501=1.872)
	...
	(isopenedposition fridge#1::fridge_door pstn7503=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn7501=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn7502=-1.872)

	(isclosedposition faucet#1::joint_faucet_0 pstn7506=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn7505=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7504=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn7501=1.872)
	(position faucet#1::joint_faucet_0 pstn7506=0.0)
	(position oven#1::knob_joint_2 pstn7504=0.0)
	(position counter#1::chewie_door_left_joint pstn7502=-1.872)
	(position oven#1::knob_joint_3 pstn7505=0.0)
	(position fridge#1::fridge_door pstn7503=1.78)

	(pose chicken-leg p19044=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p19045=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(pose salt-shaker p19047=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p19043=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p19048=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose braiserlid#1 p19045=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(atpose braiserbody#1 p19043=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p19047=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p19048=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p19044=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p19047=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p19048=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p19046=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p19045=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765) counter#1::front_left_stove)
