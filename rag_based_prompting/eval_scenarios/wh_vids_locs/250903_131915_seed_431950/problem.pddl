...
(define
  (problem test_kitchen_chicken_soup_250903_131915_seed_431950)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn4548=0.0)
	(atposition oven#1::knob_joint_2 pstn4546=0.0)
	(atposition counter#1::chewie_door_left_joint pstn4544=-1.872)
	(atposition fridge#1::fridge_door pstn4545=1.78)
	(atposition oven#1::knob_joint_3 pstn4547=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4543=1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn4548=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4546=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4547=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn4543=1.872)
	(position counter#1::chewie_door_left_joint pstn4544=-1.872)
	(position fridge#1::fridge_door pstn4545=1.78)
	(position oven#1::knob_joint_3 pstn4547=0.0)
	(position faucet#1::joint_faucet_0 pstn4548=0.0)
	(position oven#1::knob_joint_2 pstn4546=0.0)

	(pose chicken-leg p12046=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p12047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(pose pepper-shaker p12050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p12049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p12045=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_right_joint pstn4543=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn4544=-1.872)
	(isopenedposition fridge#1::fridge_door pstn4545=1.78)

	(aconf left aq576=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq224=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p12050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p12046=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p12045=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p12047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642))
	(atpose salt-shaker p12049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(ataconf right aq224=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq576=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p12049=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12050=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p12047=(0.567, 7.872, 0.712, 0.0, -0.0, 2.642) counter#1::front_left_stove)
	(supported braiserbody#1 p12048=(0.7, 8.836, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
