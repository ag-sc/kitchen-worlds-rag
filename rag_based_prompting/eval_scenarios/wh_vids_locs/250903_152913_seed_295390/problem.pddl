...
(define
  (problem test_kitchen_chicken_soup_250903_152913_seed_295390)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn9030=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn9032=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn9031=0.0)
	...
	(position counter#1::chewie_door_left_joint pstn9028=-1.872)
	(position faucet#1::joint_faucet_0 pstn9032=0.0)
	(position counter#1::chewie_door_right_joint pstn9027=1.872)
	(position fridge#1::fridge_door pstn9029=1.78)
	(position oven#1::knob_joint_2 pstn9030=0.0)
	(position oven#1::knob_joint_3 pstn9031=0.0)

	(atposition counter#1::chewie_door_right_joint pstn9027=1.872)
	(atposition counter#1::chewie_door_left_joint pstn9028=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn9032=0.0)
	(atposition oven#1::knob_joint_3 pstn9031=0.0)
	(atposition fridge#1::fridge_door pstn9029=1.78)
	(atposition oven#1::knob_joint_2 pstn9030=0.0)

	(pose chicken-leg p19845=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p19846=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))
	(pose braiserbody#1 p19844=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p19848=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p19849=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p19845=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p19844=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p19848=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p19849=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p19846=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565))

	(aconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq648=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn9028=-1.872)
	(isopenedposition fridge#1::fridge_door pstn9029=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn9027=1.872)

	(ataconf left aq40=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq648=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p19848=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p19849=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p19847=(0.7, 8.893, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p19846=(0.567, 7.872, 0.712, 0.0, -0.0, 0.565) counter#1::front_left_stove)
