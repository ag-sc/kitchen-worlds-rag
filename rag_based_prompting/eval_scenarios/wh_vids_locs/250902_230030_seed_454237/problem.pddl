...
(define
  (problem test_kitchen_chicken_soup_250902_230030_seed_454237)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_2 pstn14960=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn14961=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn14962=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn14959=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn14957=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn14958=-1.872)

	(position counter#1::chewie_door_right_joint pstn14957=1.872)
	(position faucet#1::joint_faucet_0 pstn14962=0.0)
	(position counter#1::chewie_door_left_joint pstn14958=-1.872)
	(position oven#1::knob_joint_2 pstn14960=0.0)
	(position fridge#1::fridge_door pstn14959=1.78)
	(position oven#1::knob_joint_3 pstn14961=0.0)

	(atposition counter#1::chewie_door_left_joint pstn14958=-1.872)
	(atposition oven#1::knob_joint_2 pstn14960=0.0)
	(atposition oven#1::knob_joint_3 pstn14961=0.0)
	(atposition fridge#1::fridge_door pstn14959=1.78)
	(atposition counter#1::chewie_door_right_joint pstn14957=1.872)
	(atposition faucet#1::joint_faucet_0 pstn14962=0.0)

	(pose chicken-leg p61126=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p61127=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129))
	(pose salt-shaker p61129=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p61130=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p61125=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))

	(atpose salt-shaker p61129=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p61125=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p61130=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p61126=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p61127=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129))
	...
	(contained salt-shaker p61129=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p61130=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p61128=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p61127=(0.567, 7.872, 0.712, 0.0, -0.0, 2.129) counter#1::front_left_stove)
