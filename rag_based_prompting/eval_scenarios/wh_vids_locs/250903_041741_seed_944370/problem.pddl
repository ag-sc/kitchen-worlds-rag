...
(define
  (problem test_kitchen_chicken_soup_250903_041741_seed_944370)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn21054=0.0)
	(position counter#1::chewie_door_right_joint pstn21049=1.872)
	(position fridge#1::fridge_door pstn21051=1.78)
	(position counter#1::chewie_door_left_joint pstn21050=-1.872)
	(position oven#1::knob_joint_3 pstn21053=0.0)
	(position oven#1::knob_joint_2 pstn21052=0.0)

	(atposition faucet#1::joint_faucet_0 pstn21054=0.0)
	(atposition fridge#1::fridge_door pstn21051=1.78)
	(atposition oven#1::knob_joint_3 pstn21053=0.0)
	(atposition counter#1::chewie_door_left_joint pstn21050=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn21049=1.872)
	(atposition oven#1::knob_joint_2 pstn21052=0.0)

	(isclosedposition oven#1::knob_joint_2 pstn21052=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21054=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn21053=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn21051=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn21049=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn21050=-1.872)

	(pose braiserbody#1 p81128=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p81133=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p81130=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(pose salt-shaker p81132=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p81129=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(aconf left aq0=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq496=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(atpose pepper-shaker p81133=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p81129=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p81128=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p81130=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(atpose salt-shaker p81132=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(ataconf right aq496=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq0=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained pepper-shaker p81133=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p81132=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p81131=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p81130=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823) counter#1::front_left_stove)
