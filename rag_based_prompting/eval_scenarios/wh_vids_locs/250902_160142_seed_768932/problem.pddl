...
(define
  (problem test_kitchen_chicken_soup_250902_160142_seed_768932)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn7203=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn7204=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7202=0.0)
	...
	(position counter#1::chewie_door_right_joint pstn7199=1.872)
	(position oven#1::knob_joint_3 pstn7203=0.0)
	(position faucet#1::joint_faucet_0 pstn7204=0.0)
	(position counter#1::chewie_door_left_joint pstn7200=-1.872)
	(position oven#1::knob_joint_2 pstn7202=0.0)
	(position fridge#1::fridge_door pstn7201=1.78)

	(atposition counter#1::chewie_door_left_joint pstn7200=-1.872)
	(atposition oven#1::knob_joint_2 pstn7202=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7199=1.872)
	(atposition oven#1::knob_joint_3 pstn7203=0.0)
	(atposition faucet#1::joint_faucet_0 pstn7204=0.0)
	(atposition fridge#1::fridge_door pstn7201=1.78)

	(pose salt-shaker p31422=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p31423=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p31420=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))
	(pose braiserbody#1 p31418=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p31419=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p31420=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))
	(atpose salt-shaker p31422=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p31423=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p31418=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p31419=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_left_joint pstn7200=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn7199=1.872)
	(isopenedposition fridge#1::fridge_door pstn7201=1.78)
	...
	(contained pepper-shaker p31423=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p31422=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p31420=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469) counter#1::front_left_stove)
	(supported braiserbody#1 p31421=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
