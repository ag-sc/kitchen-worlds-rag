...
(define
  (problem test_kitchen_chicken_soup_250902_134227_seed_923103)
  (:domain domain)
  ...
  (:init
	...
	(isopenedposition fridge#1::fridge_door pstn4314=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn4312=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn4313=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn4317=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn4316=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4315=0.0)

	(position counter#1::chewie_door_left_joint pstn4313=-1.872)
	(position fridge#1::fridge_door pstn4314=1.78)
	(position counter#1::chewie_door_right_joint pstn4312=1.872)
	(position faucet#1::joint_faucet_0 pstn4317=0.0)
	(position oven#1::knob_joint_3 pstn4316=0.0)
	(position oven#1::knob_joint_2 pstn4315=0.0)

	(atposition counter#1::chewie_door_left_joint pstn4313=-1.872)
	(atposition fridge#1::fridge_door pstn4314=1.78)
	(atposition oven#1::knob_joint_2 pstn4315=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4312=1.872)
	(atposition faucet#1::joint_faucet_0 pstn4317=0.0)
	(atposition oven#1::knob_joint_3 pstn4316=0.0)

	(atpose salt-shaker p24202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p24200=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	(atpose braiserbody#1 p24198=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p24199=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p24203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose pepper-shaker p24203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p24198=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p24199=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p24202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p24200=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097))
	...
	(contained salt-shaker p24202=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p24203=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p24201=(0.7, 8.896, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p24200=(0.567, 7.872, 0.712, 0.0, -0.0, 0.097) counter#1::front_left_stove)
