...
(define
  (problem test_kitchen_chicken_soup_250903_054257_seed_320213)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn22870=0.0)
	(atposition counter#1::chewie_door_right_joint pstn22867=1.872)
	(atposition counter#1::chewie_door_left_joint pstn22868=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn22872=0.0)
	(atposition oven#1::knob_joint_3 pstn22871=0.0)
	(atposition fridge#1::fridge_door pstn22869=1.78)

	(position faucet#1::joint_faucet_0 pstn22872=0.0)
	(position oven#1::knob_joint_3 pstn22871=0.0)
	(position counter#1::chewie_door_left_joint pstn22868=-1.872)
	(position oven#1::knob_joint_2 pstn22870=0.0)
	(position counter#1::chewie_door_right_joint pstn22867=1.872)
	(position fridge#1::fridge_door pstn22869=1.78)

	(isclosedposition oven#1::knob_joint_3 pstn22871=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn22872=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn22870=0.0)
	...
	(isopenedposition fridge#1::fridge_door pstn22869=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn22867=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn22868=-1.872)

	(pose chicken-leg p87803=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p87804=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(pose braiserbody#1 p87802=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p87806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p87807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose chicken-leg p87803=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p87804=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(atpose braiserbody#1 p87802=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p87807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p87806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p87806=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p87807=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p87805=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p87804=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62) counter#1::front_left_stove)
