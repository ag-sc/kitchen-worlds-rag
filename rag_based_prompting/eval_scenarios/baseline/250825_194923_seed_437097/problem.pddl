...
(define
  (problem test_kitchen_chicken_soup_250825_194923_seed_437097)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn15974=0.0)
	(position counter#1::chewie_door_right_joint pstn15970=1.872)
	(position faucet#1::joint_faucet_0 pstn15975=0.0)
	(position oven#1::knob_joint_2 pstn15973=0.0)
	(position counter#1::chewie_door_left_joint pstn15971=-1.872)
	(position fridge#1::fridge_door pstn15972=1.78)
	...
	(atposition fridge#1::fridge_door pstn15972=1.78)
	(atposition faucet#1::joint_faucet_0 pstn15975=0.0)
	(atposition counter#1::chewie_door_left_joint pstn15971=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn15970=1.872)
	(atposition oven#1::knob_joint_2 pstn15973=0.0)
	(atposition oven#1::knob_joint_3 pstn15974=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn15974=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15973=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn15975=0.0)

	(atpose braiserbody#1 p48754=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p48756=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(atpose chicken-leg p48755=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p48759=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p48758=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p48759=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p48758=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p48754=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p48756=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96))
	(pose chicken-leg p48755=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn15971=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn15970=1.872)
	(isopenedposition fridge#1::fridge_door pstn15972=1.78)
	...
	(contained salt-shaker p48758=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p48759=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p48757=(0.7, 8.964, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p48756=(0.567, 7.872, 0.712, 0.0, -0.0, 1.96) counter#1::front_left_stove)
