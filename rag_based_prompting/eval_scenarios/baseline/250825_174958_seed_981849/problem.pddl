...
(define
  (problem test_kitchen_chicken_soup_250825_174958_seed_981849)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn12522=0.0)
	(atposition oven#1::knob_joint_2 pstn12520=0.0)
	(atposition counter#1::chewie_door_left_joint pstn12518=-1.872)
	(atposition oven#1::knob_joint_3 pstn12521=0.0)
	(atposition fridge#1::fridge_door pstn12519=1.78)
	(atposition counter#1::chewie_door_right_joint pstn12517=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn12521=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12520=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn12522=0.0)

	(position counter#1::chewie_door_left_joint pstn12518=-1.872)
	(position oven#1::knob_joint_3 pstn12521=0.0)
	(position oven#1::knob_joint_2 pstn12520=0.0)
	(position fridge#1::fridge_door pstn12519=1.78)
	(position faucet#1::joint_faucet_0 pstn12522=0.0)
	(position counter#1::chewie_door_right_joint pstn12517=1.872)

	(atpose salt-shaker p41325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p41323=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(atpose pepper-shaker p41326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p41322=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p41321=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p41326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p41322=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p41321=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p41323=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705))
	(pose salt-shaker p41325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(aconf left aq168=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq672=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn12518=-1.872)
	(isopenedposition fridge#1::fridge_door pstn12519=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn12517=1.872)

	(ataconf right aq672=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(ataconf left aq168=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))

	(contained salt-shaker p41325=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p41326=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p41324=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p41323=(0.567, 7.872, 0.712, 0.0, -0.0, 1.705) counter#1::front_left_stove)
