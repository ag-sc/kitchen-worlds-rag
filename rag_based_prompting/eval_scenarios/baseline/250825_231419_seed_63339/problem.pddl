...
(define
  (problem test_kitchen_chicken_soup_250825_231419_seed_63339)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn19354=0.0)
	(atposition counter#1::chewie_door_left_joint pstn19352=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn19356=0.0)
	(atposition counter#1::chewie_door_right_joint pstn19351=1.872)
	(atposition fridge#1::fridge_door pstn19353=1.78)
	(atposition oven#1::knob_joint_3 pstn19355=0.0)

	(position faucet#1::joint_faucet_0 pstn19356=0.0)
	(position fridge#1::fridge_door pstn19353=1.78)
	(position oven#1::knob_joint_2 pstn19354=0.0)
	(position oven#1::knob_joint_3 pstn19355=0.0)
	(position counter#1::chewie_door_right_joint pstn19351=1.872)
	(position counter#1::chewie_door_left_joint pstn19352=-1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn19354=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19355=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn19356=0.0)

	(isopenedposition fridge#1::fridge_door pstn19353=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn19351=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn19352=-1.872)

	(pose salt-shaker p67754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p67752=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(pose braiserbody#1 p67750=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p67755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p67751=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p67751=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p67754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p67750=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p67752=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07))
	(atpose pepper-shaker p67755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p67754=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p67755=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p67753=(0.7, 8.805, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p67752=(0.567, 7.872, 0.712, 0.0, -0.0, 3.07) counter#1::front_left_stove)
