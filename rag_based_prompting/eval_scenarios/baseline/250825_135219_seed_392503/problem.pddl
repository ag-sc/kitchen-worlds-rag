...
(define
  (problem test_kitchen_chicken_soup_250825_135219_seed_392503)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn5574=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn5572=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn5573=0.0)

	(position counter#1::chewie_door_right_joint pstn5569=1.872)
	(position faucet#1::joint_faucet_0 pstn5574=0.0)
	(position counter#1::chewie_door_left_joint pstn5570=-1.872)
	(position fridge#1::fridge_door pstn5571=1.78)
	(position oven#1::knob_joint_3 pstn5573=0.0)
	(position oven#1::knob_joint_2 pstn5572=0.0)

	(atposition counter#1::chewie_door_left_joint pstn5570=-1.872)
	(atposition oven#1::knob_joint_3 pstn5573=0.0)
	(atposition counter#1::chewie_door_right_joint pstn5569=1.872)
	(atposition faucet#1::joint_faucet_0 pstn5574=0.0)
	(atposition fridge#1::fridge_door pstn5571=1.78)
	(atposition oven#1::knob_joint_2 pstn5572=0.0)

	(pose braiserbody#1 p20956=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p20957=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p20961=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p20960=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p20958=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974))

	(atpose braiserlid#1 p20958=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974))
	(atpose braiserbody#1 p20956=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p20957=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p20960=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose pepper-shaker p20961=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn5569=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn5570=-1.872)
	(isopenedposition fridge#1::fridge_door pstn5571=1.78)
	...
	(contained salt-shaker p20960=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p20961=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p20959=(0.7, 8.936, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p20958=(0.567, 7.872, 0.712, 0.0, -0.0, 2.974) counter#1::front_left_stove)
