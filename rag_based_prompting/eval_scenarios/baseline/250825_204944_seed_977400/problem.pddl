...
(define
  (problem test_kitchen_chicken_soup_250825_204944_seed_977400)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn16736=0.0)
	(position counter#1::chewie_door_right_joint pstn16732=1.872)
	(position oven#1::knob_joint_2 pstn16735=0.0)
	(position faucet#1::joint_faucet_0 pstn16737=0.0)
	(position fridge#1::fridge_door pstn16734=1.78)
	(position counter#1::chewie_door_left_joint pstn16733=-1.872)
	...
	(atposition fridge#1::fridge_door pstn16734=1.78)
	(atposition faucet#1::joint_faucet_0 pstn16737=0.0)
	(atposition counter#1::chewie_door_right_joint pstn16732=1.872)
	(atposition oven#1::knob_joint_2 pstn16735=0.0)
	(atposition counter#1::chewie_door_left_joint pstn16733=-1.872)
	(atposition oven#1::knob_joint_3 pstn16736=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn16736=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn16737=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16735=0.0)

	(atpose chicken-leg p54194=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p54198=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p54195=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(atpose braiserbody#1 p54193=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p54197=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p54198=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p54193=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p54195=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695))
	(pose chicken-leg p54194=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p54197=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(isopenedposition counter#1::chewie_door_left_joint pstn16733=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16732=1.872)
	(isopenedposition fridge#1::fridge_door pstn16734=1.78)
	...
	(contained pepper-shaker p54198=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p54197=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p54196=(0.7, 8.868, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p54195=(0.567, 7.872, 0.712, 0.0, -0.0, 2.695) counter#1::front_left_stove)
