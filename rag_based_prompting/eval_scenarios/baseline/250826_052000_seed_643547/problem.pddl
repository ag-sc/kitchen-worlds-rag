...
(define
  (problem test_kitchen_chicken_soup_250826_052000_seed_643547)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_3 pstn26467=0.0)
	(position faucet#1::joint_faucet_0 pstn26468=0.0)
	(position fridge#1::fridge_door pstn26465=1.78)
	(position oven#1::knob_joint_2 pstn26466=0.0)
	(position counter#1::chewie_door_left_joint pstn26464=-1.872)
	(position counter#1::chewie_door_right_joint pstn26463=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn26467=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn26466=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn26468=0.0)

	(isopenedposition fridge#1::fridge_door pstn26465=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn26464=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn26463=1.872)

	(atposition counter#1::chewie_door_right_joint pstn26463=1.872)
	(atposition counter#1::chewie_door_left_joint pstn26464=-1.872)
	(atposition fridge#1::fridge_door pstn26465=1.78)
	(atposition oven#1::knob_joint_2 pstn26466=0.0)
	(atposition oven#1::knob_joint_3 pstn26467=0.0)
	(atposition faucet#1::joint_faucet_0 pstn26468=0.0)

	(pose braiserbody#1 p95335=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p95340=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p95337=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(pose chicken-leg p95336=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p95339=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p95339=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p95335=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p95340=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p95337=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313))
	(atpose chicken-leg p95336=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	...
	(contained salt-shaker p95339=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p95340=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p95338=(0.7, 8.776, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p95337=(0.567, 7.872, 0.712, 0.0, -0.0, 0.313) counter#1::front_left_stove)
