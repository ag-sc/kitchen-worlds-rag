...
(define
  (problem test_kitchen_chicken_soup_250826_011415_seed_320213)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn21585=0.0)
	(position oven#1::knob_joint_3 pstn21584=0.0)
	(position oven#1::knob_joint_2 pstn21583=0.0)
	(position counter#1::chewie_door_left_joint pstn21581=-1.872)
	(position counter#1::chewie_door_right_joint pstn21580=1.872)
	(position fridge#1::fridge_door pstn21582=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn21583=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn21584=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn21585=0.0)

	(atposition counter#1::chewie_door_right_joint pstn21580=1.872)
	(atposition oven#1::knob_joint_3 pstn21584=0.0)
	(atposition oven#1::knob_joint_2 pstn21583=0.0)
	(atposition faucet#1::joint_faucet_0 pstn21585=0.0)
	(atposition counter#1::chewie_door_left_joint pstn21581=-1.872)
	(atposition fridge#1::fridge_door pstn21582=1.78)

	(pose salt-shaker p75613=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p75609=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p75614=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p75610=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p75611=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))

	(atpose salt-shaker p75613=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p75611=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62))
	(atpose braiserbody#1 p75609=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p75614=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p75610=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn21581=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn21580=1.872)
	(isopenedposition fridge#1::fridge_door pstn21582=1.78)
	...
	(contained pepper-shaker p75614=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p75613=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p75611=(0.567, 7.872, 0.712, 0.0, -0.0, 1.62) counter#1::front_left_stove)
	(supported braiserbody#1 p75612=(0.7, 8.931, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
