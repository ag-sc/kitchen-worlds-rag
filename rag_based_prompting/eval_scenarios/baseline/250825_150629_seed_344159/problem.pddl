...
(define
  (problem test_kitchen_chicken_soup_250825_150629_seed_344159)
  (:domain domain)
  ...
  (:init
	...
	(atposition fridge#1::fridge_door pstn7871=1.78)
	(atposition counter#1::chewie_door_left_joint pstn7870=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn7874=0.0)
	(atposition oven#1::knob_joint_3 pstn7873=0.0)
	(atposition oven#1::knob_joint_2 pstn7872=0.0)
	(atposition counter#1::chewie_door_right_joint pstn7869=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn7873=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn7872=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn7874=0.0)

	(position counter#1::chewie_door_left_joint pstn7870=-1.872)
	(position faucet#1::joint_faucet_0 pstn7874=0.0)
	(position oven#1::knob_joint_3 pstn7873=0.0)
	(position oven#1::knob_joint_2 pstn7872=0.0)
	(position counter#1::chewie_door_right_joint pstn7869=1.872)
	(position fridge#1::fridge_door pstn7871=1.78)

	(atpose braiserbody#1 p27488=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p27493=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p27492=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p27489=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p27490=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))

	(pose pepper-shaker p27493=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p27488=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p27490=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934))
	(pose salt-shaker p27492=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p27489=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_left_joint pstn7870=-1.872)
	(isopenedposition fridge#1::fridge_door pstn7871=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn7869=1.872)
	...
	(contained pepper-shaker p27493=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p27492=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p27490=(0.567, 7.872, 0.712, 0.0, -0.0, 2.934) counter#1::front_left_stove)
	(supported braiserbody#1 p27491=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
