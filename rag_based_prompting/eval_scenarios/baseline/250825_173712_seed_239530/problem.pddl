...
(define
  (problem test_kitchen_chicken_soup_250825_173712_seed_239530)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn12034=1.78)
	(position counter#1::chewie_door_right_joint pstn12032=1.872)
	(position faucet#1::joint_faucet_0 pstn12037=0.0)
	(position oven#1::knob_joint_2 pstn12035=0.0)
	(position counter#1::chewie_door_left_joint pstn12033=-1.872)
	(position oven#1::knob_joint_3 pstn12036=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn12037=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn12035=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn12036=0.0)

	(atposition counter#1::chewie_door_left_joint pstn12033=-1.872)
	(atposition fridge#1::fridge_door pstn12034=1.78)
	(atposition oven#1::knob_joint_3 pstn12036=0.0)
	(atposition counter#1::chewie_door_right_joint pstn12032=1.872)
	(atposition faucet#1::joint_faucet_0 pstn12037=0.0)
	(atposition oven#1::knob_joint_2 pstn12035=0.0)

	(pose salt-shaker p40977=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p40975=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(pose chicken-leg p40974=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p40978=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p40973=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq584=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq816=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose pepper-shaker p40978=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p40977=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p40975=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285))
	(atpose chicken-leg p40974=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p40973=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_right_joint pstn12032=1.872)
	(isopenedposition fridge#1::fridge_door pstn12034=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn12033=-1.872)

	(ataconf left aq584=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq816=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p40978=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p40977=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p40975=(0.567, 7.872, 0.712, 0.0, -0.0, 0.285) counter#1::front_left_stove)
	(supported braiserbody#1 p40976=(0.7, 8.852, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
