...
(define
  (problem test_kitchen_chicken_soup_250825_124714_seed_768932)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition oven#1::knob_joint_3 pstn4290=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn4291=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn4289=0.0)

	(position counter#1::chewie_door_right_joint pstn4286=1.872)
	(position fridge#1::fridge_door pstn4288=1.78)
	(position oven#1::knob_joint_3 pstn4290=0.0)
	(position faucet#1::joint_faucet_0 pstn4291=0.0)
	(position oven#1::knob_joint_2 pstn4289=0.0)
	(position counter#1::chewie_door_left_joint pstn4287=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn4287=-1.872)
	(atposition fridge#1::fridge_door pstn4288=1.78)
	(atposition oven#1::knob_joint_2 pstn4289=0.0)
	(atposition counter#1::chewie_door_right_joint pstn4286=1.872)
	(atposition oven#1::knob_joint_3 pstn4290=0.0)
	(atposition faucet#1::joint_faucet_0 pstn4291=0.0)

	(pose chicken-leg p12871=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p12875=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p12870=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p12872=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))
	(pose salt-shaker p12874=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))

	(atpose salt-shaker p12874=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p12871=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserbody#1 p12870=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p12875=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p12872=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469))

	(isopenedposition counter#1::chewie_door_right_joint pstn4286=1.872)
	(isopenedposition fridge#1::fridge_door pstn4288=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn4287=-1.872)
	...
	(contained salt-shaker p12874=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p12875=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p12873=(0.7, 8.801, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p12872=(0.567, 7.872, 0.712, 0.0, -0.0, 0.469) counter#1::front_left_stove)
