...
(define
  (problem test_kitchen_chicken_soup_250826_033521_seed_149466)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn25024=0.0)
	(position counter#1::chewie_door_left_joint pstn25022=-1.872)
	(position counter#1::chewie_door_right_joint pstn25021=1.872)
	(position oven#1::knob_joint_3 pstn25025=0.0)
	(position faucet#1::joint_faucet_0 pstn25026=0.0)
	(position fridge#1::fridge_door pstn25023=1.78)
	...
	(atposition faucet#1::joint_faucet_0 pstn25026=0.0)
	(atposition counter#1::chewie_door_right_joint pstn25021=1.872)
	(atposition fridge#1::fridge_door pstn25023=1.78)
	(atposition counter#1::chewie_door_left_joint pstn25022=-1.872)
	(atposition oven#1::knob_joint_3 pstn25025=0.0)
	(atposition oven#1::knob_joint_2 pstn25024=0.0)
	...
	(isclosedposition oven#1::knob_joint_3 pstn25025=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn25026=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn25024=0.0)

	(isopenedposition fridge#1::fridge_door pstn25023=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn25022=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn25021=1.872)

	(pose salt-shaker p84150=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p84151=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p84146=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p84147=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p84148=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))

	(atpose salt-shaker p84150=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p84146=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p84147=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p84148=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9))
	(atpose pepper-shaker p84151=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	...
	(contained salt-shaker p84150=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p84151=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p84149=(0.7, 8.886, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p84148=(0.567, 7.872, 0.712, 0.0, -0.0, 0.9) counter#1::front_left_stove)
