...
(define
  (problem test_kitchen_chicken_soup_250825_192221_seed_452553)
  (:domain domain)
  ...
  (:init
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn15005=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn15004=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn15003=0.0)

	(position counter#1::chewie_door_right_joint pstn15000=1.872)
	(position oven#1::knob_joint_2 pstn15003=0.0)
	(position counter#1::chewie_door_left_joint pstn15001=-1.872)
	(position faucet#1::joint_faucet_0 pstn15005=0.0)
	(position oven#1::knob_joint_3 pstn15004=0.0)
	(position fridge#1::fridge_door pstn15002=1.78)

	(atposition counter#1::chewie_door_left_joint pstn15001=-1.872)
	(atposition oven#1::knob_joint_2 pstn15003=0.0)
	(atposition fridge#1::fridge_door pstn15002=1.78)
	(atposition counter#1::chewie_door_right_joint pstn15000=1.872)
	(atposition oven#1::knob_joint_3 pstn15004=0.0)
	(atposition faucet#1::joint_faucet_0 pstn15005=0.0)

	(pose braiserbody#1 p48058=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p48060=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(pose chicken-leg p48059=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p48062=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p48063=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p48063=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p48058=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p48060=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452))
	(atpose chicken-leg p48059=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p48062=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(isopenedposition counter#1::chewie_door_right_joint pstn15000=1.872)
	(isopenedposition fridge#1::fridge_door pstn15002=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn15001=-1.872)
	...
	(contained salt-shaker p48062=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p48063=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p48061=(0.7, 8.95, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p48060=(0.567, 7.872, 0.712, 0.0, -0.0, 2.452) counter#1::front_left_stove)
