...
(define
  (problem test_kitchen_chicken_soup_250825_170810_seed_100625)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn11363=0.0)
	(position counter#1::chewie_door_right_joint pstn11358=1.872)
	(position counter#1::chewie_door_left_joint pstn11359=-1.872)
	(position oven#1::knob_joint_2 pstn11361=0.0)
	(position oven#1::knob_joint_3 pstn11362=0.0)
	(position fridge#1::fridge_door pstn11360=1.78)
	...
	(isclosedposition oven#1::knob_joint_2 pstn11361=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn11362=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn11363=0.0)

	(isopenedposition fridge#1::fridge_door pstn11360=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn11358=1.872)
	(isopenedposition counter#1::chewie_door_left_joint pstn11359=-1.872)

	(atposition counter#1::chewie_door_left_joint pstn11359=-1.872)
	(atposition oven#1::knob_joint_3 pstn11362=0.0)
	(atposition fridge#1::fridge_door pstn11360=1.78)
	(atposition faucet#1::joint_faucet_0 pstn11363=0.0)
	(atposition oven#1::knob_joint_2 pstn11361=0.0)
	(atposition counter#1::chewie_door_right_joint pstn11358=1.872)

	(pose salt-shaker p37379=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p37377=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(pose braiserbody#1 p37375=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p37380=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p37376=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose braiserlid#1 p37377=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975))
	(atpose pepper-shaker p37380=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p37376=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p37379=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p37375=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571))
	...
	(contained pepper-shaker p37380=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p37379=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p37378=(0.7, 8.959, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p37377=(0.567, 7.872, 0.712, 0.0, -0.0, 2.975) counter#1::front_left_stove)
