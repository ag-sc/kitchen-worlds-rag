...
(define
  (problem test_kitchen_chicken_soup_250825_233213_seed_944370)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn19543=0.0)
	(position counter#1::chewie_door_right_joint pstn19540=1.872)
	(position fridge#1::fridge_door pstn19542=1.78)
	(position counter#1::chewie_door_left_joint pstn19541=-1.872)
	(position faucet#1::joint_faucet_0 pstn19545=0.0)
	(position oven#1::knob_joint_3 pstn19544=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn19545=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn19544=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn19543=0.0)

	(atposition counter#1::chewie_door_right_joint pstn19540=1.872)
	(atposition fridge#1::fridge_door pstn19542=1.78)
	(atposition counter#1::chewie_door_left_joint pstn19541=-1.872)
	(atposition oven#1::knob_joint_3 pstn19544=0.0)
	(atposition faucet#1::joint_faucet_0 pstn19545=0.0)
	(atposition oven#1::knob_joint_2 pstn19543=0.0)

	(pose pepper-shaker p69028=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p69024=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p69027=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p69025=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(pose braiserbody#1 p69023=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p69025=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823))
	(atpose pepper-shaker p69028=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p69024=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose salt-shaker p69027=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p69023=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn19541=-1.872)
	(isopenedposition fridge#1::fridge_door pstn19542=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn19540=1.872)
	...
	(contained pepper-shaker p69028=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p69027=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p69025=(0.567, 7.872, 0.712, 0.0, -0.0, 0.823) counter#1::front_left_stove)
	(supported braiserbody#1 p69026=(0.7, 8.799, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
