...
(define
  (problem test_kitchen_chicken_soup_250826_091449_seed_316464)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn32083=1.78)
	(position oven#1::knob_joint_3 pstn32085=0.0)
	(position faucet#1::joint_faucet_0 pstn32086=0.0)
	(position oven#1::knob_joint_2 pstn32084=0.0)
	(position counter#1::chewie_door_right_joint pstn32081=1.872)
	(position counter#1::chewie_door_left_joint pstn32082=-1.872)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn32086=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn32084=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn32085=0.0)

	(atposition counter#1::chewie_door_left_joint pstn32082=-1.872)
	(atposition oven#1::knob_joint_3 pstn32085=0.0)
	(atposition fridge#1::fridge_door pstn32083=1.78)
	(atposition faucet#1::joint_faucet_0 pstn32086=0.0)
	(atposition counter#1::chewie_door_right_joint pstn32081=1.872)
	(atposition oven#1::knob_joint_2 pstn32084=0.0)

	(pose braiserbody#1 p110096=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p110101=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose salt-shaker p110100=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p110097=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserlid#1 p110098=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))

	(atpose salt-shaker p110100=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p110097=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p110098=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765))
	(atpose braiserbody#1 p110096=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p110101=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq656=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq296=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_right_joint pstn32081=1.872)
	(isopenedposition fridge#1::fridge_door pstn32083=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn32082=-1.872)

	(ataconf left aq656=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq296=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p110101=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p110100=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p110099=(0.7, 8.729, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p110098=(0.567, 7.872, 0.712, 0.0, -0.0, 1.765) counter#1::front_left_stove)
