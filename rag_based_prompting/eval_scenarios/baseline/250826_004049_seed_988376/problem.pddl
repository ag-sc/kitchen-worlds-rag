...
(define
  (problem test_kitchen_chicken_soup_250826_004049_seed_988376)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn20896=1.78)
	(position oven#1::knob_joint_2 pstn20897=0.0)
	(position oven#1::knob_joint_3 pstn20898=0.0)
	(position faucet#1::joint_faucet_0 pstn20899=0.0)
	(position counter#1::chewie_door_left_joint pstn20895=-1.872)
	(position counter#1::chewie_door_right_joint pstn20894=1.872)
	...
	(isclosedposition oven#1::knob_joint_3 pstn20898=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn20897=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn20899=0.0)

	(atposition counter#1::chewie_door_right_joint pstn20894=1.872)
	(atposition faucet#1::joint_faucet_0 pstn20899=0.0)
	(atposition counter#1::chewie_door_left_joint pstn20895=-1.872)
	(atposition fridge#1::fridge_door pstn20896=1.78)
	(atposition oven#1::knob_joint_2 pstn20897=0.0)
	(atposition oven#1::knob_joint_3 pstn20898=0.0)

	(pose pepper-shaker p73299=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p73296=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(pose salt-shaker p73298=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p73295=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p73294=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))

	(atpose braiserlid#1 p73296=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975))
	(atpose salt-shaker p73298=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p73295=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p73299=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p73294=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn20895=-1.872)
	(isopenedposition fridge#1::fridge_door pstn20896=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn20894=1.872)
	...
	(contained pepper-shaker p73299=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p73298=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p73296=(0.567, 7.872, 0.712, 0.0, -0.0, 1.975) counter#1::front_left_stove)
	(supported braiserbody#1 p73297=(0.7, 8.844, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
