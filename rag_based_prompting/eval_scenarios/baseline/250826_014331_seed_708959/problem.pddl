...
(define
  (problem test_kitchen_chicken_soup_250826_014331_seed_708959)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn22535=0.0)
	(atposition fridge#1::fridge_door pstn22534=1.78)
	(atposition counter#1::chewie_door_left_joint pstn22533=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn22537=0.0)
	(atposition oven#1::knob_joint_3 pstn22536=0.0)
	(atposition counter#1::chewie_door_right_joint pstn22532=1.872)
	(position fridge#1::fridge_door pstn22534=1.78)
	(position counter#1::chewie_door_left_joint pstn22533=-1.872)
	(position oven#1::knob_joint_2 pstn22535=0.0)
	(position faucet#1::joint_faucet_0 pstn22537=0.0)
	(position oven#1::knob_joint_3 pstn22536=0.0)
	(position counter#1::chewie_door_right_joint pstn22532=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn22535=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn22537=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn22536=0.0)

	(atpose braiserbody#1 p76380=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p76384=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p76382=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(atpose pepper-shaker p76385=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose chicken-leg p76381=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p76384=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p76382=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278))
	(pose pepper-shaker p76385=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p76381=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p76380=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))

	(isopenedposition counter#1::chewie_door_left_joint pstn22533=-1.872)
	(isopenedposition fridge#1::fridge_door pstn22534=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn22532=1.872)
	...
	(contained salt-shaker p76384=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p76385=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p76382=(0.561, 7.879, 0.712, 0.0, -0.0, 0.278) counter#1::front_left_stove)
	(supported braiserbody#1 p76383=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
