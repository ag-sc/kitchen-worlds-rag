...
(define
  (problem test_kitchen_chicken_soup_250826_080442_seed_823374)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn30139=0.0)
	(atposition counter#1::chewie_door_right_joint pstn30135=1.872)
	(atposition counter#1::chewie_door_left_joint pstn30136=-1.872)
	(atposition oven#1::knob_joint_2 pstn30138=0.0)
	(atposition fridge#1::fridge_door pstn30137=1.78)
	(atposition faucet#1::joint_faucet_0 pstn30140=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn30138=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn30140=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn30139=0.0)

	(position counter#1::chewie_door_right_joint pstn30135=1.872)
	(position oven#1::knob_joint_2 pstn30138=0.0)
	(position fridge#1::fridge_door pstn30137=1.78)
	(position faucet#1::joint_faucet_0 pstn30140=0.0)
	(position counter#1::chewie_door_left_joint pstn30136=-1.872)
	(position oven#1::knob_joint_3 pstn30139=0.0)

	(atpose chicken-leg p106924=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p106928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p106925=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(atpose salt-shaker p106927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p106923=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose pepper-shaker p106928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p106925=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762))
	(pose salt-shaker p106927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p106923=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p106924=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(isopenedposition counter#1::chewie_door_right_joint pstn30135=1.872)
	(isopenedposition fridge#1::fridge_door pstn30137=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn30136=-1.872)
	...
	(contained pepper-shaker p106928=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p106927=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p106925=(0.567, 7.872, 0.712, 0.0, -0.0, 1.762) counter#1::front_left_stove)
	(supported braiserbody#1 p106926=(0.7, 8.754, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
