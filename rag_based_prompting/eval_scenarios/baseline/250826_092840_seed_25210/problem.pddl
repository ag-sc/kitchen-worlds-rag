...
(define
  (problem test_kitchen_chicken_soup_250826_092840_seed_25210)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_3 pstn32546=0.0)
	(atposition counter#1::chewie_door_right_joint pstn32542=1.872)
	(atposition fridge#1::fridge_door pstn32544=1.78)
	(atposition counter#1::chewie_door_left_joint pstn32543=-1.872)
	(atposition oven#1::knob_joint_2 pstn32545=0.0)
	(atposition faucet#1::joint_faucet_0 pstn32547=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn32547=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn32545=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn32546=0.0)

	(position counter#1::chewie_door_left_joint pstn32543=-1.872)
	(position fridge#1::fridge_door pstn32544=1.78)
	(position faucet#1::joint_faucet_0 pstn32547=0.0)
	(position counter#1::chewie_door_right_joint pstn32542=1.872)
	(position oven#1::knob_joint_2 pstn32545=0.0)
	(position oven#1::knob_joint_3 pstn32546=0.0)

	(pose salt-shaker p110517=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p110518=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p110515=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(pose chicken-leg p110514=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose braiserbody#1 p110513=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))

	(aconf left aq672=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq616=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(atpose braiserlid#1 p110515=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195))
	(atpose salt-shaker p110517=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p110514=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p110518=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p110513=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571))
	(isopenedposition counter#1::chewie_door_left_joint pstn32543=-1.872)
	(isopenedposition fridge#1::fridge_door pstn32544=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn32542=1.872)

	(ataconf left aq672=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq616=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p110517=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p110518=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserbody#1 p110516=(0.7, 8.901, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p110515=(0.567, 7.872, 0.712, 0.0, -0.0, 1.195) counter#1::front_left_stove)
