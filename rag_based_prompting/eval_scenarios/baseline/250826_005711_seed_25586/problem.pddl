...
(define
  (problem test_kitchen_chicken_soup_250826_005711_seed_25586)
  (:domain domain)
  ...
  (:init
	...
	(atposition oven#1::knob_joint_2 pstn21382=0.0)
	(atposition faucet#1::joint_faucet_0 pstn21384=0.0)
	(atposition oven#1::knob_joint_3 pstn21383=0.0)
	(atposition fridge#1::fridge_door pstn21381=1.78)
	(atposition counter#1::chewie_door_left_joint pstn21380=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn21379=1.872)
	(position fridge#1::fridge_door pstn21381=1.78)
	(position faucet#1::joint_faucet_0 pstn21384=0.0)
	(position oven#1::knob_joint_3 pstn21383=0.0)
	(position counter#1::chewie_door_right_joint pstn21379=1.872)
	(position counter#1::chewie_door_left_joint pstn21380=-1.872)
	(position oven#1::knob_joint_2 pstn21382=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn21384=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn21382=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn21383=0.0)

	(pose salt-shaker p73646=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p73642=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p73643=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p73647=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p73644=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))

	(atpose braiserlid#1 p73644=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973))
	(atpose salt-shaker p73646=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p73642=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571))
	(atpose chicken-leg p73643=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p73647=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq728=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq208=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn21380=-1.872)
	(isopenedposition fridge#1::fridge_door pstn21381=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn21379=1.872)

	(ataconf left aq728=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq208=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained pepper-shaker p73647=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p73646=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p73644=(0.567, 7.872, 0.712, 0.0, -0.0, 2.973) counter#1::front_left_stove)
	(supported braiserbody#1 p73645=(0.7, 8.933, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
