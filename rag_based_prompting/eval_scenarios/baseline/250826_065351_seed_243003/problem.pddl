...
(define
  (problem test_kitchen_chicken_soup_250826_065351_seed_243003)
  (:domain domain)
  ...
  (:init
	...
	(position oven#1::knob_joint_2 pstn29062=0.0)
	(position fridge#1::fridge_door pstn29061=1.78)
	(position counter#1::chewie_door_left_joint pstn29060=-1.872)
	(position counter#1::chewie_door_right_joint pstn29059=1.872)
	(position faucet#1::joint_faucet_0 pstn29064=0.0)
	(position oven#1::knob_joint_3 pstn29063=0.0)
	...
	(atposition faucet#1::joint_faucet_0 pstn29064=0.0)
	(atposition oven#1::knob_joint_2 pstn29062=0.0)
	(atposition oven#1::knob_joint_3 pstn29063=0.0)
	(atposition fridge#1::fridge_door pstn29061=1.78)
	(atposition counter#1::chewie_door_left_joint pstn29060=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn29059=1.872)
	...
	(isclosedposition oven#1::knob_joint_2 pstn29062=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn29064=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn29063=0.0)

	(isopenedposition fridge#1::fridge_door pstn29061=1.78)
	(isopenedposition counter#1::chewie_door_left_joint pstn29060=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn29059=1.872)

	(pose pepper-shaker p101094=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose chicken-leg p101090=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p101093=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p101089=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p101091=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))

	(atpose braiserlid#1 p101091=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274))
	(atpose chicken-leg p101090=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p101094=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose salt-shaker p101093=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p101089=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	...
	(supported braiserbody#1 p101092=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p101091=(0.567, 7.872, 0.712, 0.0, -0.0, 2.274) counter#1::front_left_stove)

	(contained pepper-shaker p101094=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p101093=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
