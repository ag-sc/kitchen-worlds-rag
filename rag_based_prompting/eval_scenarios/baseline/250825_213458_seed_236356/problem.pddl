...
(define
  (problem test_kitchen_chicken_soup_250825_213458_seed_236356)
  (:domain domain)
  ...
  (:init
	...
	(atposition faucet#1::joint_faucet_0 pstn17606=0.0)
	(atposition counter#1::chewie_door_right_joint pstn17601=1.872)
	(atposition oven#1::knob_joint_2 pstn17604=0.0)
	(atposition counter#1::chewie_door_left_joint pstn17602=-1.872)
	(atposition oven#1::knob_joint_3 pstn17605=0.0)
	(atposition fridge#1::fridge_door pstn17603=1.78)
	...
	(isclosedposition oven#1::knob_joint_3 pstn17605=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn17604=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn17606=0.0)

	(position counter#1::chewie_door_left_joint pstn17602=-1.872)
	(position fridge#1::fridge_door pstn17603=1.78)
	(position oven#1::knob_joint_3 pstn17605=0.0)
	(position oven#1::knob_joint_2 pstn17604=0.0)
	(position faucet#1::joint_faucet_0 pstn17606=0.0)
	(position counter#1::chewie_door_right_joint pstn17601=1.872)

	(pose braiserbody#1 p58116=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(pose salt-shaker p58120=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose chicken-leg p58117=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose pepper-shaker p58121=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p58118=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))

	(atpose braiserbody#1 p58116=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571))
	(atpose salt-shaker p58120=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p58117=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose pepper-shaker p58121=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserlid#1 p58118=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647))

	(isopenedposition counter#1::chewie_door_left_joint pstn17602=-1.872)
	(isopenedposition fridge#1::fridge_door pstn17603=1.78)
	(isopenedposition counter#1::chewie_door_right_joint pstn17601=1.872)
	...
	(contained pepper-shaker p58121=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p58120=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p58118=(0.567, 7.872, 0.712, 0.0, -0.0, 1.647) counter#1::front_left_stove)
	(supported braiserbody#1 p58119=(0.7, 8.983, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
