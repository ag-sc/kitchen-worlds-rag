...
(define
  (problem test_kitchen_chicken_soup_250825_225935_seed_607747)
  (:domain domain)
  ...
  (:init
	...
	(position fridge#1::fridge_door pstn18868=1.78)
	(position oven#1::knob_joint_3 pstn18870=0.0)
	(position counter#1::chewie_door_right_joint pstn18866=1.872)
	(position counter#1::chewie_door_left_joint pstn18867=-1.872)
	(position faucet#1::joint_faucet_0 pstn18871=0.0)
	(position oven#1::knob_joint_2 pstn18869=0.0)

	(atposition fridge#1::fridge_door pstn18868=1.78)
	(atposition oven#1::knob_joint_3 pstn18870=0.0)
	(atposition counter#1::chewie_door_left_joint pstn18867=-1.872)
	(atposition faucet#1::joint_faucet_0 pstn18871=0.0)
	(atposition counter#1::chewie_door_right_joint pstn18866=1.872)
	(atposition oven#1::knob_joint_2 pstn18869=0.0)
	...
	(isclosedposition oven#1::knob_joint_2 pstn18869=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn18870=0.0)
	(isclosedposition faucet#1::joint_faucet_0 pstn18871=0.0)

	(pose salt-shaker p67406=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose braiserlid#1 p67404=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	(pose pepper-shaker p67407=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(pose braiserbody#1 p67402=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose chicken-leg p67403=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))

	(atpose chicken-leg p67403=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(atpose braiserlid#1 p67404=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098))
	(atpose salt-shaker p67406=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p67402=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose pepper-shaker p67407=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(aconf left aq632=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(aconf right aq968=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))
	(isopenedposition counter#1::chewie_door_left_joint pstn18867=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn18866=1.872)
	(isopenedposition fridge#1::fridge_door pstn18868=1.78)

	(ataconf left aq632=(0.677, -0.343, 1.2, -1.467, 1.242, -1.954, 2.223))
	(ataconf right aq968=(-0.677, -0.343, -1.2, -1.467, -1.242, -1.954, -2.223))

	(contained salt-shaker p67406=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained pepper-shaker p67407=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)

	(supported braiserlid#1 p67404=(0.567, 7.872, 0.712, 0.0, -0.0, 2.098) counter#1::front_left_stove)
	(supported braiserbody#1 p67405=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
