...
(define
  (problem test_kitchen_chicken_soup_250825_203552_seed_891066)
  (:domain domain)
  ...
  (:init
	...
	(position faucet#1::joint_faucet_0 pstn16548=0.0)
	(position counter#1::chewie_door_right_joint pstn16543=1.872)
	(position fridge#1::fridge_door pstn16545=1.78)
	(position oven#1::knob_joint_3 pstn16547=0.0)
	(position counter#1::chewie_door_left_joint pstn16544=-1.872)
	(position oven#1::knob_joint_2 pstn16546=0.0)
	...
	(isclosedposition faucet#1::joint_faucet_0 pstn16548=0.0)
	(isclosedposition oven#1::knob_joint_3 pstn16547=0.0)
	(isclosedposition oven#1::knob_joint_2 pstn16546=0.0)

	(atposition counter#1::chewie_door_left_joint pstn16544=-1.872)
	(atposition counter#1::chewie_door_right_joint pstn16543=1.872)
	(atposition faucet#1::joint_faucet_0 pstn16548=0.0)
	(atposition fridge#1::fridge_door pstn16545=1.78)
	(atposition oven#1::knob_joint_2 pstn16546=0.0)
	(atposition oven#1::knob_joint_3 pstn16547=0.0)
	(pose braiserbody#1 p52920=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(pose braiserlid#1 p52922=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(pose chicken-leg p52921=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(pose salt-shaker p52924=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(pose pepper-shaker p52925=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))

	(atpose pepper-shaker p52925=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142))
	(atpose braiserbody#1 p52920=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571))
	(atpose braiserlid#1 p52922=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605))
	(atpose salt-shaker p52924=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142))
	(atpose chicken-leg p52921=(0.654, 4.846, 1.384, 0.0, 0.0, -0.366))
	(isopenedposition counter#1::chewie_door_left_joint pstn16544=-1.872)
	(isopenedposition counter#1::chewie_door_right_joint pstn16543=1.872)
	(isopenedposition fridge#1::fridge_door pstn16545=1.78)
	...
	(supported braiserbody#1 p52923=(0.7, 8.9, 0.923, 0.0, -0.0, 1.571) counter#1::indigo_tmp)
	(supported braiserlid#1 p52922=(0.567, 7.872, 0.712, 0.0, -0.0, 1.605) counter#1::front_left_stove)

	(contained pepper-shaker p52925=(0.764, 7.303, 1.164, 0.0, -0.0, 3.142) counter#1::sektion)
	(contained salt-shaker p52924=(0.771, 7.071, 1.152, 0.0, -0.0, 3.142) counter#1::sektion)
